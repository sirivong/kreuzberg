...
## Dart API Reference <span class="version-badge">v1.0.0-rc.34</span>
...
```dart
void classifyChunks(ExtractedDocument result, ChunkClassificationConfig config)
```

**Example:**

```dart
await classifyChunks(ExtractedDocument(), ChunkClassificationConfig());
```
