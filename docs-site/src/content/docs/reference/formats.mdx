...
Xberg supports 97 file formats across major categories through native Rust extractors.
...
- [Extraction Guide](/guides/extraction/) - Extraction examples
- [OCR Guide](/guides/ocr/) - OCR configuration and usage
- [Plugin System](/concepts/plugin-system/) - Custom extractor development
