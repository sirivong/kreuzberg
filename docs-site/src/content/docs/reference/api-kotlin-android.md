...
## Kotlin (Android) API Reference <span class="version-badge">v1.0.0-rc.34</span>
...
```kotlin
@Throws(Error::class)
fun classifyChunks(result: ExtractedDocument, config: ChunkClassificationConfig)
```

**Example:**

```kotlin
classifyChunks(ExtractedDocument(), ChunkClassificationConfig())
```
