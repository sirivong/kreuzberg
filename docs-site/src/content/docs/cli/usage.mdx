...
import { Content as Snip_cli_install_script } from "../../../snippets/cli/install_script.md";
import { Content as Snip_cli_install_homebrew } from "../../../snippets/cli/install_homebrew.md";
import { Content as Snip_cli_install_cargo } from "../../../snippets/cli/install_cargo.md";
import { Content as Snip_cli_install_docker } from "../../../snippets/cli/install_docker.md";
import { Content as Snip_cli_install_go_sdk } from "../../../snippets/cli/install_go_sdk.md";
...
<Tabs syncKey="lang">
<TabItem label="Install Script (Linux/macOS)">

<Snip_cli_install_script />

</TabItem>
<TabItem label="Homebrew (macOS/Linux)">

<Snip_cli_install_homebrew />

</TabItem>
<TabItem label="Cargo (Cross-platform)">

<Snip_cli_install_cargo />

</TabItem>
<TabItem label="Docker">

<Snip_cli_install_docker />

</TabItem>
<TabItem label="Go (SDK)">

<Snip_cli_install_go_sdk />
...
:::
    ...
    - ✅ Text extraction (PDF, Office, images, 97 formats)
    - ✅ OCR with Tesseract
...
| `--ocr-backend <BACKEND>`         | OCR backend: `tesseract`, `paddle-ocr`, `candle-trocr`, `candle-paddleocr-vl`, `candle-paddleocr-vl-15`, `candle-glm-ocr`, `candle-deepseek-ocr`, or `vlm`. |
...
Candle-based backends (`candle-trocr`, `candle-paddleocr-vl`, `candle-paddleocr-vl-15`, `candle-glm-ocr`, `candle-deepseek-ocr`) are pure-Rust VLM and vision-transformer OCR engines. No ONNX Runtime required; GPU-accelerated on Metal (macOS) and CUDA (Linux).
