...
//! ```sh
//! XBERG_PADDLEOCR_VL_MODEL_PATH=/path/to/model \
//!     cargo test -p xberg-candle-ocr \
...
use xberg_candle_ocr::models::paddleocr_vl::{PaddleOcrVlEngine, PaddleOcrVlTask};

const ENV_MODEL_PATH: &str = "XBERG_PADDLEOCR_VL_MODEL_PATH";
...
///
/// Gated on `XBERG_PADDLEOCR_VL_MODEL_PATH` pointing to a local model directory.
