...
//!
//! ```sh
//! XBERG_NETWORK_TESTS=1 cargo test -p xberg-candle-ocr \
...
use xberg_candle_ocr::models::{PaddleOcrVlEngine, PaddleOcrVlTask};

const ENV_GATE: &str = "XBERG_NETWORK_TESTS";
...
#[test]
#[ignore = "pulls ~1.8 GB from HF Hub; gated on XBERG_NETWORK_TESTS=1"]
