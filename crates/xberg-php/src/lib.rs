...
pub struct ExtractionOutput {
    ...
    pub crawl: HashMap<String, serde_json::Value>,
}
...
impl ExtractionOutput {
    ...
    pub fn get_crawl(&self) -> Option<String> {
        serde_json::to_string(&self.crawl).ok()
    }
}
...
impl XbergApi {
    ...
    #[php(name = "extractSync")]
    pub fn extract_sync(
        input: Option<&ExtractInput>,
        ...
        let result = xberg::extract_sync(input_core.unwrap_or_default(), &config_core.unwrap_or_default())
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into())
    }
    ...
    pub fn extract_batch_sync(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        let result = xberg::extract_batch_sync(inputs_core, &config_core.unwrap_or_default())
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into())
    }
...
impl From<ExtractionOutput> for xberg::ExtractionOutput {
    fn from(val: ExtractionOutput) -> Self {
        Self {
            ...
            crawl: val.crawl.into_iter().map(|(k, v)| (k.into(), v)).collect(),
        }
    }
}
