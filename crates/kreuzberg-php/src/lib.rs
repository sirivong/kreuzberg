...
// alef:hash:58b9baede053e36cc3d54a7ddb9b8b9fdcdd3fa01c2bfecda69e2cb8e723c76e
    ...
    pub fn needs_image_processing(&self) -> bool {
        ...
        let core_self = kreuzberg::ExtractionConfig {
            ...
            result_format: match self.result_format.as_str() {
                ...
                _ => kreuzberg::ResultFormat::Unified,
            },
...
impl KreuzbergApi {
     ...
     * @throws KreuzbergException Returns an error if the PDF is invalid, the page index is out of bounds,
    ...
    pub fn render_pdf_page_to_png(
        ...
        let result = kreuzberg::render_pdf_page_to_png(&pdf_bytes, page_index as usize, dpi, password.as_deref())
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.to_vec())
    }
    ...
    pub fn detect_mime_type(path: String, check_exists: bool) -> PhpResult<String> {
        let result = kreuzberg::detect_mime_type(path, check_exists)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    fn from(val: AccelerationConfig) -> Self {
        Self {
            provider: match val.provider.as_str() {
                ...
                _ => kreuzberg::ExecutionProviderType::Auto,
            },
    ...
    fn from(val: PdfConfig) -> Self {
        Self {
            backend: match val.backend.as_str() {
                "Pdfium" => kreuzberg::PdfBackend::Pdfium,
                "PdfOxide" => kreuzberg::PdfBackend::PdfOxide,
                "Auto" => kreuzberg::PdfBackend::Auto,
                _ => kreuzberg::PdfBackend::Pdfium,
            },
            extract_images: val.extract_images,
    ...
    fn from(val: TreeSitterProcessConfig) -> Self {
        Self {
            ...
            content_mode: match val.content_mode.as_str() {
                ...
                _ => kreuzberg::CodeContentMode::Chunks,
            },
        }
    }
}
    ...
    fn from(val: TokenReductionConfig) -> Self {
        Self {
            level: match val.level.as_str() {
                ...
                _ => kreuzberg::ReductionLevel::Off,
            },
