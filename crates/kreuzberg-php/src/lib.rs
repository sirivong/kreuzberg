...
#[derive(Clone, serde::Serialize, serde::Deserialize, Default)]
#[php_class]
#[php(name = "Kreuzberg\\GlineBackend")]
#[serde(default, rename_all = "camelCase")]
pub struct GlineBackend {
    #[php(prop, name = "repoId")]
    pub repo_id: String,
    #[php(prop, name = "modelPath")]
    pub model_path: String,
    #[php(prop, name = "tokenizerPath")]
...
impl GlineBackend {
    #[php(constructor)]
    pub fn new(repoId: String, modelPath: String, tokenizerPath: String) -> Self {
        Self {
            repo_id: repoId,
     ...
     */
    #[php(name = "new")]
    pub fn new(repoId: Option<String>) -> PhpResult<GlineBackend> {
        kreuzberg::GlineBackend::new(repoId.as_deref())
            .map(|val| val.into())
...
impl TokenCounter {
     ...
     */
    pub fn next_token(&self, category: String, original: String) -> String {
        let category_core: kreuzberg::PiiCategory = category.clone().into();
...
impl Segment {
    #[php(constructor)]
    pub fn new(text: String, byteStart: i64) -> Self {
        Self {
            text,
            byte_start: byteStart,
        }
...
// NerBackendKind enum values
pub const NERBACKENDKIND_ONNX: &str = "Onnx";
pub const NERBACKENDKIND_LLM: &str = "Llm";
...
pub const LISTTYPE_BULLET: &str = "Bullet";
pub const LISTTYPE_NUMBERED: &str = "Numbered";
pub const LISTTYPE_LETTERED: &str = "Lettered";
pub const LISTTYPE_INDENTED: &str = "Indented";
...
// EntityCategory enum values
pub const ENTITYCATEGORY_PERSON: &str = "Person";
pub const ENTITYCATEGORY_ORGANIZATION: &str = "Organization";
pub const ENTITYCATEGORY_LOCATION: &str = "Location";
pub const ENTITYCATEGORY_DATE: &str = "Date";
pub const ENTITYCATEGORY_TIME: &str = "Time";
pub const ENTITYCATEGORY_MONEY: &str = "Money";
pub const ENTITYCATEGORY_PERCENT: &str = "Percent";
pub const ENTITYCATEGORY_EMAIL: &str = "Email";
pub const ENTITYCATEGORY_PHONE: &str = "Phone";
pub const ENTITYCATEGORY_URL: &str = "Url";
pub const ENTITYCATEGORY_CUSTOM: &str = "Custom";
...
pub const IMAGEKIND_PAGERASTER: &str = "PageRaster";
...
// RedactionStrategy enum values
pub const REDACTIONSTRATEGY_MASK: &str = "Mask";
pub const REDACTIONSTRATEGY_HASH: &str = "Hash";
pub const REDACTIONSTRATEGY_TOKENREPLACE: &str = "TokenReplace";
pub const REDACTIONSTRATEGY_DROP: &str = "Drop";

// PiiCategory enum values
pub const PIICATEGORY_EMAIL: &str = "Email";
pub const PIICATEGORY_PHONE: &str = "Phone";
pub const PIICATEGORY_SSN: &str = "Ssn";
pub const PIICATEGORY_CREDITCARD: &str = "CreditCard";
pub const PIICATEGORY_POSTALCODE: &str = "PostalCode";
pub const PIICATEGORY_IPADDRESS: &str = "IpAddress";
pub const PIICATEGORY_IBAN: &str = "Iban";
pub const PIICATEGORY_SWIFTBIC: &str = "SwiftBic";
pub const PIICATEGORY_DATEOFBIRTH: &str = "DateOfBirth";
pub const PIICATEGORY_PERSON: &str = "Person";
pub const PIICATEGORY_ORGANIZATION: &str = "Organization";
pub const PIICATEGORY_LOCATION: &str = "Location";
pub const PIICATEGORY_CUSTOM: &str = "Custom";
...
// RevisionKind enum values
pub const REVISIONKIND_INSERTION: &str = "Insertion";
pub const REVISIONKIND_DELETION: &str = "Deletion";
pub const REVISIONKIND_FORMATCHANGE: &str = "FormatChange";
pub const REVISIONKIND_COMMENT: &str = "Comment";
...
// SummaryStrategy enum values
pub const SUMMARYSTRATEGY_EXTRACTIVE: &str = "Extractive";
pub const SUMMARYSTRATEGY_ABSTRACTIVE: &str = "Abstractive";
...
// RegionKind enum values
pub const REGIONKIND_FIGURE: &str = "Figure";
pub const REGIONKIND_DENSETABLE: &str = "DenseTable";
pub const REGIONKIND_COMPLEXLAYOUT: &str = "ComplexLayout";
pub const REGIONKIND_CAPTION: &str = "Caption";
...
impl KreuzbergApi {
    ...
    pub fn classify_pages(result: Option<&ExtractionResult>, config: &PageClassificationConfig) -> PhpResult<()> {
        ...
        WORKER_RUNTIME.block_on(async {
            let result =
                kreuzberg::text::classification::classify_pages(&result_core.unwrap_or_default(), &config_core)
                    .await
                    .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result)
        })
    ...
    pub fn redact(result: Option<&ExtractionResult>, config: Option<&RedactionConfig>) -> PhpResult<()> {
        ...
        WORKER_RUNTIME.block_on(async {
            let result =
                kreuzberg::text::redaction::redact(&result_core.unwrap_or_default(), &config_core.unwrap_or_default())
                    .await
                    .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result)
        })
    ...
    pub fn scan_text(text: String, categories: Vec<String>) -> Vec<PatternMatch> {
        ...
        for (_, item) in categories.iter() {
            if let Some(parsed) = <&PiiCategory as ext_php_rs::convert::FromZval>::from_zval(item) {
                categories_core_result.push(parsed.clone().into());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to PiiCategory".to_string(),
                ));
            }
        }
     ...
     */
    #[php(name = "applyStrategy")]
    pub fn apply_strategy(strategy: String, original: String, category: String, counter: &TokenCounter) -> String {
        let strategy_core: kreuzberg::RedactionStrategy = strategy.clone().into();
        let category_core: kreuzberg::PiiCategory = category.clone().into();
    ...
    pub fn translate_result(result: Option<&ExtractionResult>, config: &TranslationConfig) -> PhpResult<()> {
        ...
        WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::text::translation::translate_result(&result_core.unwrap_or_default(), &config_core)
                .await
                .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result)
        })
    ...
    pub fn extract_region_with_vlm(
        ...
        let region_kind_core: kreuzberg::RegionKind = region_kind.clone().into();
        let llm_config_core: Option<kreuzberg::LlmConfig> = llm_config.map(|v| v.clone().into());
        WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::llm::region_extractor::extract_region_with_vlm(
                &imageBytes.0[..],
                &imageMime,
                regionKind_core,
                &llm_config_core.unwrap_or_default(),
     ...
     */
    #[php(name = "embedTexts")]
    pub fn embed_texts(texts: Vec<String>, config: Option<&EmbeddingConfig>) -> PhpResult<Vec<Vec<f32>>> {
        let config_core: Option<kreuzberg::EmbeddingConfig> = config.map(|v| v.clone().into());
        let result = kreuzberg::embed_texts(texts, &config_core.unwrap_or_default())
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<Segment> for kreuzberg::chunking::semantic::merge::Segment {
