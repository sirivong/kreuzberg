...
impl ExtractionConfig {
    ...
    pub fn get_html_options(&self) -> Option<String> {
    ...
    pub fn get_concurrency(&self) -> Option<String> {
    ...
    pub fn get_cancel_token(&self) -> Option<String> {
...
#[derive(Clone, serde::Serialize, serde::Deserialize, Default)]
#[php_class]
#[php(name = "Kreuzberg\\ExtractedImageMetadata")]
#[serde(default, rename_all = "camelCase")]
...
impl ExtractedImageMetadata {
    ...
    pub fn get_exif_data(&self) -> HashMap<String, String> {
...
pub struct SecurityLimits {
    ...
    #[serde(default = "crate::serde_defaults::max_archive_size")]
...
impl DjotContent {
    ...
    #[php(constructor)]
    pub fn new(plainText: String, attributes: Vec<String>) -> Self {
        Self {
...
impl FormattedBlock {
    ...
    pub fn get_attributes(&self) -> Option<String> {
        self.attributes.clone()
    }
...
impl InlineElement {
    ...
    #[php(constructor)]
    pub fn new(elementType: String, content: String, attributes: Option<String>) -> Self {
        Self {
...
pub struct ExtractionResult {
    ...
    #[php(prop, name = "ocrInternalDocument")]
    #[serde(skip)]
...
impl ExtractionResult {
    ...
    pub fn get_ocr_internal_document(&self) -> Option<String> {
...
impl Element {
    ...
    #[php(constructor)]
    pub fn new(elementId: String, elementType: String, text: String) -> Self {
        Self {
...
impl TextExtractionResult {
    ...
    pub fn new(
        ...
        codeBlocks: Option<Vec<Vec<String>>>,
    ) -> Self {
        Self {
            content,
    ...
    pub fn get_links(&self) -> Option<Vec<Vec<String>>> {
        self.links.clone()
    }

    pub fn get_code_blocks(&self) -> Option<Vec<Vec<String>>> {
...
impl PptxExtractionResult {
    ...
    #[php(constructor)]
    pub fn new(content: String, slideCount: i64, imageCount: i64, tableCount: i64, hyperlinks: Vec<String>) -> Self {
        Self {
            content,
            metadata: Default::default(),
    ...
    pub fn get_hyperlinks(&self) -> Vec<String> {
...
pub struct OcrExtractionResult {
    ...
    #[php(prop, name = "internalDocument")]
    #[serde(skip)]
...
impl OcrExtractionResult {
    ...
    #[php(constructor)]
    pub fn new(content: String, mimeType: String, internalDocument: Option<String>) -> Self {
        Self {
            content,
            mime_type: mimeType,
            metadata: Default::default(),
    ...
    pub fn get_internal_document(&self) -> Option<String> {
...
pub struct ImagePreprocessingMetadata {
    ...
    #[php(prop, name = "originalDimensions")]
    #[serde(skip)]
    pub original_dimensions: Vec<i64>,
    /// Original image DPI (horizontal, vertical)
    #[php(prop, name = "originalDpi")]
    #[serde(skip)]
...
impl ImagePreprocessingMetadata {
    #[php(constructor)]
    pub fn new(
        originalDimensions: Vec<i64>,
        originalDpi: Vec<f64>,
        targetDpi: i32,
        scaleFactor: f64,
        autoAdjusted: bool,
        finalDpi: i32,
        newDimensions: Option<Vec<i64>>,
    ...
    pub fn get_original_dimensions(&self) -> Vec<i64> {
        self.original_dimensions.clone()
    }

    pub fn get_original_dpi(&self) -> Vec<f64> {
    ...
    pub fn get_new_dimensions(&self) -> Option<Vec<i64>> {
...
impl LinkMetadata {
    ...
    pub fn get_attributes(&self) -> Vec<Vec<String>> {
        self.attributes.clone()
    }
}
...
impl HierarchicalBlock {
    #[php(constructor)]
    pub fn new(text: String, fontSize: f32, level: String, bbox: Option<Vec<f32>>) -> Self {
        Self {
            text,
            font_size: fontSize,
            level,
...
impl KeywordConfig {
    ...
    pub fn get_ngram_range(&self) -> Vec<i64> {
...
impl Default for OcrCacheStats {
    fn default() -> Self {
        <kreuzberg::ocr::OcrCacheStats as Default>::default().into()
    }
}
...
impl OcrCacheStats {
    ...
    #[php(constructor)]
    pub fn new(totalFiles: i64, totalSizeMb: f64) -> Self {
        Self {
...
impl EmbeddedFile {
    ...
    #[php(constructor)]
    pub fn new(name: String, data: PhpBytes, mimeType: Option<String>) -> Self {
        Self {
            name,
            data: data.0,
            mime_type: mimeType,
...
impl KreuzbergApi {
    ...
    pub fn extract_bytes(
        ...
        WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::extract_bytes(&content.0[..], &mimeType, &config_core)
                .await
    ...
    pub fn extract_bytes_sync(
        ...
        let config_core: kreuzberg::ExtractionConfig = config.clone().into();
        let result = kreuzberg::extract_bytes_sync(&content.0[..], &mimeType, &config_core)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into())
    }
    ...
    pub fn embed_texts_async(texts: Vec<String>, config: &EmbeddingConfig) -> PhpResult<Vec<Vec<f32>>> {
...
pub fn register_document_extractor(backend: &mut ext_php_rs::types::ZendObject) -> ext_php_rs::prelude::PhpResult<()> {
    if backend.try_call_method("extract_bytes", vec![]).is_err() {
        return Err(ext_php_rs::exception::PhpException::default(format!(
            "Backend missing required method: {}",
            "extract_bytes"
        )));
    }
    if backend.try_call_method("supported_mime_types", vec![]).is_err() {
        return Err(ext_php_rs::exception::PhpException::default(format!(
            "Backend missing required method: {}",
...
#[php_function]
pub fn register_renderer(backend: &mut ext_php_rs::types::ZendObject) -> ext_php_rs::prelude::PhpResult<()> {
    if backend.try_call_method("render", vec![]).is_err() {
        return Err(ext_php_rs::exception::PhpException::default(format!(
            "Backend missing required method: {}",
            "render"
        )));
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<ExtractedImageMetadata> for kreuzberg::extraction::image::ExtractedImageMetadata {
    fn from(val: ExtractedImageMetadata) -> Self {
        Self {
            width: val.width,
            height: val.height,
            format: val.format,
