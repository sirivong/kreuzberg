...
// WhisperModel enum values
pub const WHISPERMODEL_TINY: &str = "Tiny";
pub const WHISPERMODEL_BASE: &str = "Base";
pub const WHISPERMODEL_SMALL: &str = "Small";
pub const WHISPERMODEL_MEDIUM: &str = "Medium";
pub const WHISPERMODEL_LARGEV3: &str = "LargeV3";
