...
// alef:hash:9bcc434ad6b08a0f9f233c0300b191d1df0bae519041695494f3bfe312b503dd
...
pub struct DocxAppProperties {
    ...
    #[php(prop, name = "characters_with_spaces")]
...
pub struct CoreProperties {
    ...
    #[php(prop, name = "last_modified_by")]
...
impl KreuzbergApi {
    ...
    pub fn extract_bytes_async(
        ...
        WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::extract_bytes(content.as_bytes(), &mimeType, &config_core)
                .await
                .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result.into())
        })
    ...
    pub fn extract_bytes_sync(
        ...
        let config_core: kreuzberg::ExtractionConfig =
            serde_json::from_str(&config_json).map_err(|e| format!("{e}"))?;
        let result = kreuzberg::extract_bytes_sync(content.as_bytes(), &mimeType, &config_core)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into())
    }
     ...
     */
    pub fn detect_mime_type_from_bytes(content: String) -> PhpResult<String> {
        let result = kreuzberg::detect_mime_type_from_bytes(content.as_bytes())
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn render_pdf_page_to_png(
        ...
        let result =
            kreuzberg::render_pdf_page_to_png(pdfBytes.as_bytes(), pageIndex as usize, dpi, password.as_deref())
                .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.to_vec())
    }
