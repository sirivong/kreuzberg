...
// alef:hash:65e3015a460095f09e50cefb4bff39af1077d3ee51351e668e3e146636a451db
...
impl DocxMetadata {
    ...
    #[php(getter)]
    pub fn get_core_properties(&self) -> Option<String> {
        self.core_properties.clone()
    }

    #[php(getter)]
    pub fn get_app_properties(&self) -> Option<String> {
