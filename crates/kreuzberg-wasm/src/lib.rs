...
// alef:hash:db7949f0a06c9bf99d9ea0333b099938ef63eccfbeb2fe92c3b90e5c93a2cffb
...
impl WasmPostProcessorConfig {
    ...
    pub fn new(
        ...
        enabledSet: Option<String>,
        disabledSet: Option<String>,
...
impl WasmDocxMetadata {
    ...
    #[wasm_bindgen(constructor)]
    pub fn new(
        coreProperties: Option<String>,
        appProperties: Option<String>,
