...
// alef:hash:1218af31ff7d82254a8dcc0232b2665bb76fb4ee2fb60f460fb952cc55dee0fc
...
pub struct WasmDocxMetadata {
    core_properties: Option<JsValue>,
    app_properties: Option<JsValue>,
...
pub struct WasmPdfUnifiedExtractionResult {
    pub(crate) inner: Arc<kreuzberg::pdf::text::PdfUnifiedExtractionResult>,
}
