...
// alef:hash:b5fad629851fcb45eaa75df6daf1b30c2f6960f45628534f49aa69ca23019c36
...
impl WasmExtractionResult {
    ...
    pub fn set_extraction_method(&mut self, value: Option<String>) {
...
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
pub enum WasmTransformListType {
    Bullet = 0,
    Numbered = 1,
    Lettered = 2,
    Indented = 3,
...
#[allow(clippy::derivable_impls)]
impl Default for WasmTransformListType {
    fn default() -> Self {
        Self::Bullet
    }
}

impl WasmTransformListType {
    /// Returns the serde wire string for this variant (e.g. `"stop"`, `"tool_calls"`).
    pub fn to_api_str(self) -> &'static str {
        match self {
            Self::Bullet => "Bullet",
...
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
pub enum WasmDrawingType {
    Inline = 0,
    Anchored = 1,
}

#[allow(clippy::derivable_impls)]
impl Default for WasmDrawingType {
    fn default() -> Self {
        Self::Inline
    }
}

impl WasmDrawingType {
    /// Returns the serde wire string for this variant (e.g. `"stop"`, `"tool_calls"`).
    pub fn to_api_str(self) -> &'static str {
        match self {
            Self::Inline => "Inline",
...
#[wasm_bindgen]
impl WasmNodeContent2 {
    #[wasm_bindgen(constructor)]
    pub fn new() -> WasmNodeContent2 {
        Self::default()
    }

    #[wasm_bindgen]
    #[allow(clippy::should_implement_trait)]
    pub fn default() -> WasmNodeContent2 {
        <Self as ::core::default::Default>::default()
    }
...
#[wasm_bindgen]
#[derive(Clone, Copy, PartialEq, Eq)]
pub enum WasmExtractionMethod2 {
    Native = 0,
    Ocr = 1,
    Mixed = 2,
}
...
#[allow(clippy::derivable_impls)]
impl Default for WasmExtractionMethod2 {
    fn default() -> Self {
        Self::Native
    }
}

impl WasmExtractionMethod2 {
    /// Returns the serde wire string for this variant (e.g. `"stop"`, `"tool_calls"`).
    pub fn to_api_str(self) -> &'static str {
        match self {
            Self::Native => "native",
...
#[wasm_bindgen]
#[derive(Clone, Default)]
pub struct WasmFormatMetadata2 {
    pub(crate) format_type: String,
    pub(crate) _0: Option<JsValue>,
}

#[wasm_bindgen]
impl WasmFormatMetadata2 {
    #[wasm_bindgen(constructor)]
    pub fn new() -> WasmFormatMetadata2 {
        Self::default()
    }

    #[wasm_bindgen]
    #[allow(clippy::should_implement_trait)]
    pub fn default() -> WasmFormatMetadata2 {
        <Self as ::core::default::Default>::default()
    }
...
impl From<kreuzberg::extraction::transform::ListType> for WasmTransformListType {
...
impl From<kreuzberg::extraction::docx::drawing::DrawingType> for WasmDrawingType {
...
impl From<kreuzberg::NodeContent> for WasmNodeContent2 {
...
impl From<kreuzberg::ExtractionMethod> for WasmExtractionMethod2 {
...
impl From<kreuzberg::FormatMetadata> for WasmFormatMetadata2 {
