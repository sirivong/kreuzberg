...
// alef:hash:4973888f1d35bad947542fdfd07aaba81baf0579c23e6b63959b2072dee6bca3
...
pub struct WasmCustomProperties {
    pub(crate) inner: Arc<kreuzberg::extraction::office_metadata::custom_properties::CustomProperties>,
}
...
pub fn clear_ocr_backends() -> Result<(), JsValue> {
    let result = kreuzberg::clear_ocr_backends().map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn clear_post_processors() -> Result<(), JsValue> {
    let result = kreuzberg::clear_post_processors().map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn clear_validators() -> Result<(), JsValue> {
    let result = kreuzberg::clear_validators().map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
mod __alef_wasm_bridge_ocrbackend {
    ...
    impl kreuzberg::plugins::OcrBackend for WasmOcrBackendBridge {
        ...
        async fn process_document(
            ...
            let func_val = js_sys::Reflect::get(&self.inner, &key).map_err(|_| {
                kreuzberg::KreuzbergError::Other(format!("Failed to get method '{}'", "process_document"))
            })?;
            ...
            let result = func.apply(&self.inner, &args).map_err(|_| {
                kreuzberg::KreuzbergError::Other(format!("Failed to call method '{}'", "process_document"))
            })?;
...
mod __alef_wasm_bridge_validator {
    ...
    impl kreuzberg::plugins::Validator for WasmValidatorBridge {
        ...
        fn should_validate(
            &self,
            _result: &kreuzberg::ExtractionResult,
