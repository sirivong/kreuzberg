//! Defines the [PdfPageRedactedAnnotation] struct, exposing functionality related to a single
//! user annotation of type [PdfPageAnnotationType::Redacted].
...
pub struct PdfPageRedactedAnnotation<'a> {
...
impl<'a> PdfPageRedactedAnnotation<'a> {
    pub(crate) fn from_pdfium(
        ...
        PdfPageRedactedAnnotation {
            ...
            objects: PdfPageAnnotationObjects::from_pdfium(document_handle, page_handle, annotation_handle, bindings),
            attachment_points: PdfPageAnnotationAttachmentPoints::from_pdfium(annotation_handle, bindings),
            bindings,
        }
    }
}

impl<'a> PdfPageAnnotationPrivate<'a> for PdfPageRedactedAnnotation<'a> {
    #[inline]
