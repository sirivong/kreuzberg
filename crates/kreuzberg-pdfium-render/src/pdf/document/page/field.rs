...
use crate::bindgen::{
    ...
    FPDF_FORMFIELD_PUSHBUTTON, FPDF_FORMFIELD_RADIOBUTTON, FPDF_FORMFIELD_SIGNATURE, FPDF_FORMFIELD_TEXTFIELD,
    FPDF_FORMFIELD_UNKNOWN, FPDF_FORMHANDLE,
};
...
impl<'a> PdfFormField<'a> {
    pub(crate) fn from_pdfium(
        ...
        let form_field_type = PdfFormFieldType::from_pdfium(result).unwrap_or(PdfFormFieldType::Unknown);

        Some(match form_field_type {
            PdfFormFieldType::PushButton => PdfFormField::PushButton(PdfFormPushButtonField::from_pdfium(
                form_handle,
                annotation_handle,
                bindings,
            )),
            PdfFormFieldType::Checkbox => PdfFormField::Checkbox(PdfFormCheckboxField::from_pdfium(
                form_handle,
                annotation_handle,
                bindings,
            )),
            PdfFormFieldType::RadioButton => PdfFormField::RadioButton(PdfFormRadioButtonField::from_pdfium(
                form_handle,
                annotation_handle,
                bindings,
            )),
            PdfFormFieldType::ComboBox => PdfFormField::ComboBox(PdfFormComboBoxField::from_pdfium(
                form_handle,
                annotation_handle,
                bindings,
            )),
            ...
            PdfFormFieldType::Text => {
                PdfFormField::Text(PdfFormTextField::from_pdfium(form_handle, annotation_handle, bindings))
            }
            PdfFormFieldType::Signature => PdfFormField::Signature(PdfFormSignatureField::from_pdfium(
                form_handle,
                annotation_handle,
                bindings,
            )),
