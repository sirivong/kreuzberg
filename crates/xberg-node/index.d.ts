 ...
 * @throws Returns an error only when the `heuristics-pdf` feature is active and
 * the PDF text-layer analysis itself returns a hard error.  In all other
 * cases the function returns a `ChunkingDecision`.
 */
export declare function analyzeDocument(metadata: DocumentMetadata, config?: HeuristicsConfig | undefined | null, documentBytes?: Uint8Array | undefined | null): ChunkingDecision;
 ...
 */
export declare function analyzeWithUserChunks(userRanges: Array<PageRange>, totalPages: number, sizeBytes: number, config?: HeuristicsConfig | undefined | null): ChunkingDecision;
 ...
 */
export declare function boundariesFromExtractionResult(result?: ExtractionResult | undefined | null, thresholds?: MultidocThresholds | undefined | null): Array<DocumentBoundary>;
 ...
 */
export declare function calculateChunkPlan(pageCount: number, sizeBytes: number, needsOcr: boolean, config?: HeuristicsConfig | undefined | null): ChunkPlan;
 ...
 */
export declare function calculatePlanFromOverrides(userChunks: Array<PageRange>, totalPages: number, sizeBytes: number, config?: HeuristicsConfig | undefined | null): ChunkPlan;
 ...
 *
 * @throws Returns an error if the VLM call fails or if image format detection fails.
 */
export declare function captionImage(imageBytes: Uint8Array, llmConfig?: LlmConfig | undefined | null, customPrompt?: string | undefined | null): Promise<string>;
 ...
 * @returns The generated caption text.
 *
 * @throws Returns an error if the file cannot be read, if image format detection fails,
 * or if the VLM call fails.
 */
export declare function captionImageFile(path: string, llmConfig?: LlmConfig | undefined | null, customPrompt?: string | undefined | null): Promise<string>;
 ...
 */
export declare function checkFormatLimits(mimeType: string, sheetCount?: number | undefined | null, workbookCells?: number | undefined | null, embeddedCount?: number | undefined | null, config?: HeuristicsConfig | undefined | null): string | null;
 ...
 *   `Skip`).
 */
export declare function chooseCallMode(input: StructuredInput, t?: StructuredThresholds | undefined | null): StructuredCallMode;
 ...
 *
 * @throws Propagates any error from the underlying chunker (e.g. invalid overlap).
 */
export declare function chunkForRag(text: string, config?: ChunkingConfig | undefined | null): ChunkingResult;
 ...
 *
 * @throws Returns an error if `config.labels` is empty or if LLM calls fail.
 */
export declare function classifyDocument(pages: Array<string>, config: PageClassificationConfig): Promise<Array<ClassificationLabel>>;
 ...
 */
export declare function detectBoundaries(input: MultidocInput, thresholds?: MultidocThresholds | undefined | null): Array<DocumentBoundary>;
 ...
 *
 * @throws Returns `XbergError::UnsupportedFormat` if MIME type cannot be determined.
 */
...
export declare function extract(input?: ExtractInput | undefined | null, config?: ExtractionConfig | undefined | null): Promise<ExtractionOutput>;

/** Extract content from multiple bytes or URI inputs. */
export declare function extractBatch(inputs: Array<ExtractInput>, config?: ExtractionConfig | undefined | null): Promise<ExtractionOutput>;

/** Synchronous wrapper for `extract_batch`. */
export declare function extractBatchSync(inputs: Array<ExtractInput>, config?: ExtractionConfig | undefined | null): ExtractionOutput;
 ...
 *
 * @param preset_spec_json` — JSON string - `{"named":"id"}` or `{"inline":{...}}`.
 *
 ...
 *
 * @throws Returns `Validation` when either JSON argument is
 ...
 */
export declare function extractStructuredJson(bytes: Uint8Array, mime: string, presetSpecJson: string, optionsJson: string): string;

/** Synchronous wrapper for `extract`. */
export declare function extractSync(input?: ExtractInput | undefined | null, config?: ExtractionConfig | undefined | null): ExtractionOutput;
 ...
 */
export declare function findFootnoteAnchors(markdown: string): Array<FootnoteAnchor>;
 ...
 */
export declare function findInferenceMarkers(markdown: string): Array<number>;
...
export declare function fingerprint(raw: Uint8Array): string;
 ...
 */
export interface CaptioningEnrichmentConfig {
...
export type ChunkingDecision =
  | { type: 'NoChunking'; reason: NoChunkingReason }
  | { type: 'Chunk'; 0: ChunkPlan }
  | { type: 'UseOverrides'; userChunks: Array<PageRange> }
...
export interface ChunkPlan {
  ...
  readonly chunks?: Array<ChunkInfo>
  /** Estimated total processing time in milliseconds. */
  readonly totalEstimatedTimeMs?: number
  /** Whether to use disk-based processing for large files. */
  readonly useDiskProcessing?: boolean
  /** Reason for chunking. */
  readonly reason?: ChunkingReason
}
...
export interface ClassificationEnrichmentConfig {
  /** Label set and LLM settings for the classification stage. */
  readonly config: PageClassificationConfig
}
...
export interface DocumentExtractor {
   ...
   *
   * @throws - `XbergError::Parsing` - Document parsing failed
   ...
   */
  extractBytes(content: Uint8Array, mimeType: string, config?: ExtractionConfig | undefined | null): Promise<InternalDocument>
  /**
   ...
   */
  extractFile?(path: string, mimeType: string, config?: ExtractionConfig | undefined | null): Promise<InternalDocument>
  /**
...
export type EnrichStatus =
  | { status: 'pending' }
  | { status: 'completed'; result: EnrichResult }
...
export interface ExtractionOutput {
  ...
  readonly results?: Array<ExtractionResult>
  ...
  readonly crawl?: Record<string, JsonValue>
}
...
export interface OcrBackend {
   ...
   * ```
   */
  processImage(imageBytes: Uint8Array, config?: OcrConfig | undefined | null): Promise<ExtractionResult>
  /**
   ...
   */
  processImageFile?(path: string, config?: OcrConfig | undefined | null): Promise<ExtractionResult>
  /**
   ...
   * @param config - OCR configuration
   */
  processDocument?(path: string, config?: OcrConfig | undefined | null): Promise<ExtractionResult>
}
...
export interface PostProcessor {
   ...
   */
  shouldProcess?(result?: ExtractionResult | undefined | null, config?: ExtractionConfig | undefined | null): boolean
  /**
   ...
   */
  estimatedDurationMs?(result?: ExtractionResult | undefined | null): number
  /**
 ...
 * pipeline.
 */
export declare enum StructuredCallMode {
...
export interface StructuredInput {
  ...
  readonly userForceVision: boolean
}
 ...
 * ```
 */
export interface StructuredThresholds {
  /**
   ...
   */
  readonly scanMaxCoverage?: number
  /**
   ...
   * config after measuring their document corpus.
   */
  readonly digitalMinCoverage?: number
  /**
   ...
   * config after measuring their document corpus.
   */
  readonly docxTextMinDensity?: number
  /**
   ...
   * config.
   */
  readonly enableVisionFallback?: boolean
}
...
export interface Validator {
   ...
   */
  shouldValidate?(result?: ExtractionResult | undefined | null, config?: ExtractionConfig | undefined | null): boolean
  /**
 ...
 */
export declare function parseCitations(markdown: string): Array<Citation>;
 ...
 */
export declare function parseFootnoteDefinitions(markdown: string): Array<FootnoteDefinition>;
 ...
 *
 * @throws Returns `XbergError::Parsing` if the PDF cannot be opened, authenticated,
 * or its page count read.
 */
export declare function pdfPageCount(pdfBytes: Uint8Array, password?: string | undefined | null): number;
 ...
 * configured.
 * @throws - [`XbergError::Validation`] if `query` is empty or blank.
 ...
 */
export declare function resolve(preset: Preset, context: Record<string, string>, customSchema?: JsonValue | undefined | null): ResolvedPreset;
 ...
 */
export declare function scoreConfidence(signals: ConfidenceSignals, weights?: ConfidenceWeights | undefined | null): ExtractionConfidence;
 ...
 * via [`From<StructuredError>`](super::StructuredError).
 */
export declare function splitAndExtractJson(bytes: Uint8Array, mime: string, presetSpecJson: string, optionsJson: string): string;
