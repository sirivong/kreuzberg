...
#define KREUZBERG_VERSION_PATCH 6
#define KREUZBERG_VERSION "4.4.6"
...
#include <stdlib.h>
/* Symbol visibility */
#ifndef KREUZBERG_EXPORT
  #if defined(KREUZBERG_STATIC)
    #define KREUZBERG_EXPORT
  #elif defined(_WIN32) || defined(__CYGWIN__)
    #ifdef KREUZBERG_BUILDING
      #define KREUZBERG_EXPORT __declspec(dllexport)
    #else
      #define KREUZBERG_EXPORT __declspec(dllimport)
    #endif
  #elif defined(__GNUC__) || defined(__clang__)
    #define KREUZBERG_EXPORT __attribute__((visibility("default")))
  #else
    #define KREUZBERG_EXPORT
  #endif
#endif
 ...
 */
KREUZBERG_EXPORT ExtractionConfig *kreuzberg_config_from_json(const char *json_config);
 ...
 */
KREUZBERG_EXPORT void kreuzberg_config_free(ExtractionConfig *config);
 ...
 * - `json_config` must be a valid null-terminated C string
 */
KREUZBERG_EXPORT int32_t kreuzberg_config_is_valid(const char *json_config);
 ...
 */
KREUZBERG_EXPORT char *kreuzberg_config_to_json(const ExtractionConfig *config);
 ...
 */
KREUZBERG_EXPORT
char *kreuzberg_config_get_field(const ExtractionConfig *config,
 ...
 */
KREUZBERG_EXPORT
int32_t kreuzberg_config_merge(ExtractionConfig *base,
                               const ExtractionConfig *override_config);
 ...
 */
KREUZBERG_EXPORT char *kreuzberg_load_extraction_config_from_file(const char *file_path);
 ...
 * - The returned pointer must be freed with `kreuzberg_config_free`
 */
KREUZBERG_EXPORT ExtractionConfig *kreuzberg_config_from_file(const char *path);
 ...
 * - The returned string must be freed with `kreuzberg_free_string`
 */
KREUZBERG_EXPORT char *kreuzberg_config_discover(void);
 ...
 */
KREUZBERG_EXPORT char *kreuzberg_list_embedding_presets(void);
 ...
 * ```
 */
KREUZBERG_EXPORT struct ConfigBuilder *kreuzberg_config_builder_new(void);
 ...
 */
KREUZBERG_EXPORT
int32_t kreuzberg_config_builder_set_acceleration(struct ConfigBuilder *builder,
 ...
 * - The returned ExtractionConfig must be freed with kreuzberg_config_free()
 */
KREUZBERG_EXPORT ExtractionConfig *kreuzberg_config_builder_build(struct ConfigBuilder *builder);
 ...
 * ```
 */
KREUZBERG_EXPORT uint32_t kreuzberg_error_code_validation(void);
 ...
 * ```
 */
KREUZBERG_EXPORT uint32_t kreuzberg_error_code_parsing(void);
 ...
 * ```
 */
KREUZBERG_EXPORT uint32_t kreuzberg_error_code_ocr(void);
 ...
 * ```
 */
KREUZBERG_EXPORT uint32_t kreuzberg_error_code_missing_dependency(void);
 ...
 * ```
 */
KREUZBERG_EXPORT uint32_t kreuzberg_error_code_io(void);
 ...
 * ```
 */
KREUZBERG_EXPORT uint32_t kreuzberg_error_code_plugin(void);
 ...
 * ```
 */
KREUZBERG_EXPORT uint32_t kreuzberg_error_code_unsupported_format(void);
 ...
 * ```
 */
KREUZBERG_EXPORT uint32_t kreuzberg_error_code_count(void);
 ...
 * ```
 */
KREUZBERG_EXPORT const char *kreuzberg_error_code_name(uint32_t code);
 ...
 * ```
 */
KREUZBERG_EXPORT const char *kreuzberg_error_code_description(uint32_t code);
 ...
 * ```
 */
KREUZBERG_EXPORT struct CErrorDetails *kreuzberg_get_error_details_ptr(void);
 ...
 * ```
 */
KREUZBERG_EXPORT void kreuzberg_free_error_details(struct CErrorDetails *details);
 ...
 * ```
 */
KREUZBERG_EXPORT uint32_t kreuzberg_classify_error(const char *error_message);
 ...
 * ```
 */
KREUZBERG_EXPORT struct CExtractionResult *kreuzberg_extract_file_sync(const char *file_path);
 ...
 */
KREUZBERG_EXPORT int32_t kreuzberg_parse_heading_style(const char *value);
 ...
 */
KREUZBERG_EXPORT const char *kreuzberg_heading_style_to_string(int32_t discriminant);
 ...
 * - `value` must be a valid null-terminated C string or NULL
 */
KREUZBERG_EXPORT int32_t kreuzberg_parse_code_block_style(const char *value);

/**
 * Convert CodeBlockStyle discriminant to string.
 */
KREUZBERG_EXPORT const char *kreuzberg_code_block_style_to_string(int32_t discriminant);
 ...
 * - `value` must be a valid null-terminated C string or NULL
 */
KREUZBERG_EXPORT int32_t kreuzberg_parse_highlight_style(const char *value);

/**
 * Convert HighlightStyle discriminant to string.
 */
KREUZBERG_EXPORT const char *kreuzberg_highlight_style_to_string(int32_t discriminant);
 ...
 * - `value` must be a valid null-terminated C string or NULL
 */
KREUZBERG_EXPORT int32_t kreuzberg_parse_list_indent_type(const char *value);

/**
 * Convert ListIndentType discriminant to string.
 */
KREUZBERG_EXPORT const char *kreuzberg_list_indent_type_to_string(int32_t discriminant);
 ...
 * - `value` must be a valid null-terminated C string or NULL
 */
KREUZBERG_EXPORT int32_t kreuzberg_parse_whitespace_mode(const char *value);

/**
 * Convert WhitespaceMode discriminant to string.
 */
KREUZBERG_EXPORT const char *kreuzberg_whitespace_mode_to_string(int32_t discriminant);
 ...
 * - `value` must be a valid null-terminated C string or NULL
 */
KREUZBERG_EXPORT int32_t kreuzberg_parse_newline_style(const char *value);

/**
 * Convert NewlineStyle discriminant to string.
 */
KREUZBERG_EXPORT const char *kreuzberg_newline_style_to_string(int32_t discriminant);
 ...
 * - `value` must be a valid null-terminated C string or NULL
 */
KREUZBERG_EXPORT int32_t kreuzberg_parse_preprocessing_preset(const char *value);

/**
 * Convert PreprocessingPreset discriminant to string.
 */
KREUZBERG_EXPORT const char *kreuzberg_preprocessing_preset_to_string(int32_t discriminant);
 ...
 * ```
 */
KREUZBERG_EXPORT void kreuzberg_free_batch_result(struct CBatchResult *batch_result);
 ...
 * ```
 */
KREUZBERG_EXPORT void kreuzberg_free_string(char *s);
 ...
 */
KREUZBERG_EXPORT char *kreuzberg_clone_string(const char *s);
 ...
 * ```
 */
KREUZBERG_EXPORT void kreuzberg_free_result(struct CExtractionResult *result);
 ...
 * - Returns NULL on error (check `kreuzberg_last_error`)
 */
KREUZBERG_EXPORT char *kreuzberg_detect_mime_type(const char *file_path, bool check_exists);
 ...
 * - Returns NULL on error (check `kreuzberg_last_error`)
 */
KREUZBERG_EXPORT char *kreuzberg_validate_mime_type(const char *mime_type);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_detect_mime_type_from_bytes(const uint8_t *bytes, uintptr_t len);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_detect_mime_type_from_path(const char *file_path);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_get_extensions_for_mime(const char *mime_type);
 ...
 * ```
 */
KREUZBERG_EXPORT bool kreuzberg_unregister_document_extractor(const char *name);
 ...
 * - Returns NULL on error (check `kreuzberg_last_error`).
 */
KREUZBERG_EXPORT char *kreuzberg_list_document_extractors(void);
 ...
 * ```
 */
KREUZBERG_EXPORT bool kreuzberg_clear_document_extractors(void);
 ...
 * ```
 */
KREUZBERG_EXPORT bool kreuzberg_register_ocr_backend(const char *name, OcrBackendCallback callback);
 ...
 * ```
 */
KREUZBERG_EXPORT bool kreuzberg_unregister_ocr_backend(const char *name);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_list_ocr_backends(void);
 ...
 * ```
 */
KREUZBERG_EXPORT bool kreuzberg_clear_ocr_backends(void);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_get_ocr_languages(const char *backend);
 ...
 */
KREUZBERG_EXPORT int32_t kreuzberg_is_language_supported(const char *backend, const char *language);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_list_ocr_backends_with_languages(void);
 ...
 * ```
 */
KREUZBERG_EXPORT bool kreuzberg_unregister_post_processor(const char *name);
 ...
 * - Returns true on success, false on error.
 */
KREUZBERG_EXPORT bool kreuzberg_clear_post_processors(void);
 ...
 * - Returns NULL on error (check `kreuzberg_last_error`).
 */
KREUZBERG_EXPORT char *kreuzberg_list_post_processors(void);
 ...
 */
KREUZBERG_EXPORT
bool kreuzberg_register_validator(const char *name,
 ...
 * ```
 */
KREUZBERG_EXPORT bool kreuzberg_unregister_validator(const char *name);
 ...
 * - Returns true on success, false on error.
 */
KREUZBERG_EXPORT bool kreuzberg_clear_validators(void);
 ...
 * ```
 */
KREUZBERG_EXPORT int32_t kreuzberg_result_get_page_count(const ExtractionResult *result);
 ...
 * ```
 */
KREUZBERG_EXPORT int32_t kreuzberg_result_get_chunk_count(const ExtractionResult *result);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_result_get_detected_language(const ExtractionResult *result);
 ...
 * ```
 */
KREUZBERG_EXPORT struct ResultPool *kreuzberg_result_pool_new(uintptr_t capacity);
 ...
 * ```
 */
KREUZBERG_EXPORT void kreuzberg_result_pool_reset(struct ResultPool *pool);
 ...
 * ```
 */
KREUZBERG_EXPORT void kreuzberg_result_pool_free(struct ResultPool *pool);
 ...
 * ```
 */
KREUZBERG_EXPORT struct CResultPoolStats kreuzberg_result_pool_stats(const struct ResultPool *pool);
 ...
 * ```
 */
KREUZBERG_EXPORT const char *kreuzberg_intern_string(const char *s);
 ...
 * ```
 */
KREUZBERG_EXPORT void kreuzberg_free_interned_string(const char *s);
 ...
 * ```
 */
KREUZBERG_EXPORT struct CStringInternStats kreuzberg_string_intern_stats(void);
 ...
 */
KREUZBERG_EXPORT void kreuzberg_string_intern_reset(void);
 ...
 * ```
 */
KREUZBERG_EXPORT const char *kreuzberg_last_error(void);
 ...
 * ```
 */
KREUZBERG_EXPORT int32_t kreuzberg_last_error_code(void);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_last_panic_context(void);
 ...
 * ```
 */
KREUZBERG_EXPORT const char *kreuzberg_version(void);
 ...
 * ```
 */
KREUZBERG_EXPORT int32_t kreuzberg_validate_binarization_method(const char *method);
 ...
 * ```
 */
KREUZBERG_EXPORT int32_t kreuzberg_validate_language_code(const char *code);
 ...
 * ```
 */
KREUZBERG_EXPORT int32_t kreuzberg_validate_token_reduction_level(const char *level);
 ...
 * ```
 */
KREUZBERG_EXPORT int32_t kreuzberg_validate_tesseract_psm(int32_t psm);
 ...
 * ```
 */
KREUZBERG_EXPORT int32_t kreuzberg_validate_tesseract_oem(int32_t oem);
 ...
 * ```
 */
KREUZBERG_EXPORT int32_t kreuzberg_validate_output_format(const char *format);
 ...
 * ```
 */
KREUZBERG_EXPORT int32_t kreuzberg_validate_confidence(double confidence);
 ...
 * ```
 */
KREUZBERG_EXPORT int32_t kreuzberg_validate_dpi(int32_t dpi);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_get_valid_binarization_methods(void);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_get_valid_language_codes(void);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_get_valid_ocr_backends(void);
 ...
 * ```
 */
KREUZBERG_EXPORT char *kreuzberg_get_valid_token_reduction_levels(void);
