...
//! validated structured JSON. It runs the regular xberg extraction pipeline, decides whether
...
/// Maps a [`StructuredError`] onto the canonical [`crate::XbergError`] so the
...
impl From<StructuredError> for crate::XbergError {
