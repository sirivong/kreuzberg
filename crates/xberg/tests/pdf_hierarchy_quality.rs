...
fn calculate_quality_metrics(
    extracted_blocks: &[xberg::pdf::hierarchy::HierarchyBlock],
...
fn test_hierarchy_quality_on_ground_truth() {
    ...
    for doc in &ground_truth_file.documents {
        ...
        for page in &doc.pages {
            ...
            let extracted_blocks: Vec<xberg::pdf::hierarchy::HierarchyBlock> = hierarchy_assignments
                .iter()
                .map(|(block, level)| xberg::pdf::hierarchy::HierarchyBlock {
...
fn test_hierarchy_clustering_consistency() {
    ...
    let quality_metrics = calculate_quality_metrics(
        &assignments
            .iter()
            .map(|(b, l)| xberg::pdf::hierarchy::HierarchyBlock {
                text: b.text.clone(),
                bbox: b.bbox,
...
fn test_quality_metrics_calculation() {
    ...
    let extracted = vec![
        xberg::pdf::hierarchy::HierarchyBlock {
            text: "Title".to_string(),
            bbox: BoundingBox {
                left: 0.0,
                top: 0.0,
