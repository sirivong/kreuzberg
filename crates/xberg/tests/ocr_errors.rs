...
fn test_ocr_invalid_language_code() {
    ...
    let config = ExtractionConfig {
        ocr: Some(OcrConfig {
            ...
            language: vec!["invalid_lang_99999".to_string()],
            ..Default::default()
        }),
        force_ocr: false,
        ..Default::default()
...
fn test_ocr_invalid_backend_name() {
    ...
    match result {
        ...
        Err(XbergError::MissingDependency(msg)) => {
...
fn test_ocr_empty_language() {
    ...
    match result {
        ...
        Err(XbergError::Validation { message, .. }) | Err(XbergError::Ocr { message, .. }) => {
...
fn test_ocr_malformed_multi_language() {
    ...
    let config = ExtractionConfig {
        ocr: Some(OcrConfig {
            backend: "tesseract".to_string(),
            language: vec!["eng++deu++fra".to_string()],
            ..Default::default()
        }),
        force_ocr: false,
        ..Default::default()
...
fn test_ocr_with_preprocessing_extreme_dpi() {
    ...
    use xberg::types::ImagePreprocessingConfig;
    ...
    match result {
        ...
        Err(XbergError::ImageProcessing { message, .. }) | Err(XbergError::Validation { message, .. }) => {
...
fn test_ocr_with_invalid_binarization_method() {
    ...
    match result {
        ...
        Err(XbergError::Validation { message, .. }) | Err(XbergError::ImageProcessing { message, .. }) => {
