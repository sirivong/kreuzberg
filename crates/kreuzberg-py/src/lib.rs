...
impl ExtractedImageMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (width, height, format, exif_data))]
    #[new]
    pub fn new(width: u32, height: u32, format: String, exif_data: HashMap<String, String>) -> Self {
        Self {
            width,
            height,
            format,
...
impl PageContent {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (page_number, content, tables, image_indices, hierarchy=None, is_blank=None, layout_regions=None, speaker_notes=None, section_name=None))]
    #[new]
    pub fn new(
        page_number: u32,
        content: String,
...
impl OcrCacheStats {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (total_files=Self::default().total_files, total_size_mb=Self::default().total_size_mb))]
    #[new]
    pub fn new(total_files: usize, total_size_mb: f64) -> Self {
        Self {
            total_files,
            total_size_mb,
        }
...
impl FracType {
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(self)
            ...
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize FracType: {e}")))
    }
...
pub fn _kreuzberg(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<ExtractedImageMetadata>()?;
