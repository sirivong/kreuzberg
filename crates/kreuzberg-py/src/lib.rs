...
#[pyfunction]
#[pyo3(signature = ())]
pub fn clear_embedding_backends() -> PyResult<()> {
    kreuzberg::clear_embedding_backends().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = ())]
pub fn list_embedding_backends() -> PyResult<Vec<String>> {
    kreuzberg::list_embedding_backends().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn list_document_extractors() -> PyResult<Vec<String>> {
    kreuzberg::list_document_extractors().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn clear_document_extractors() -> PyResult<()> {
    kreuzberg::clear_document_extractors().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn list_ocr_backends() -> PyResult<Vec<String>> {
    kreuzberg::list_ocr_backends().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn clear_ocr_backends() -> PyResult<()> {
    kreuzberg::clear_ocr_backends().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = ())]
pub fn register_builtin() -> PyResult<()> {
...
pub fn list_post_processors() -> PyResult<Vec<String>> {
    kreuzberg::list_post_processors().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = ())]
pub fn clear_post_processors() -> PyResult<()> {
    kreuzberg::clear_post_processors().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = ())]
pub fn list_renderers() -> PyResult<Vec<String>> {
    kreuzberg::list_renderers().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn clear_renderers() -> PyResult<()> {
    kreuzberg::clear_renderers().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = ())]
pub fn clear_reranker_backends() -> PyResult<()> {
    kreuzberg::clear_reranker_backends().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = ())]
pub fn list_reranker_backends() -> PyResult<Vec<String>> {
    kreuzberg::list_reranker_backends().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn list_validators() -> PyResult<Vec<String>> {
    kreuzberg::list_validators().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn clear_validators() -> PyResult<()> {
    kreuzberg::clear_validators().map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn download_model(name: String, cache_dir: Option<String>) -> PyResult<String> {
...
pub fn find_footnote_anchors(markdown: String) -> Vec<FootnoteAnchor> {
    kreuzberg::find_footnote_anchors(&markdown)
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn parse_footnote_definitions(markdown: String) -> Vec<FootnoteDefinition> {
    kreuzberg::parse_footnote_definitions(&markdown)
        .into_iter()
        .map(Into::into)
        .collect()
}
...
#[pyfunction]
#[pyo3(signature = (markdown))]
pub fn find_inference_markers(markdown: String) -> Vec<usize> {
...
pub fn find_unmarked_claims(markdown: String) -> Vec<String> {
    kreuzberg::find_unmarked_claims(&markdown)
}

#[pyfunction]
#[pyo3(signature = (markdown))]
pub fn parse_citations(markdown: String) -> Vec<Citation> {
    kreuzberg::parse_citations(&markdown)
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn verify_excerpt(excerpt: String, source_text: String) -> bool {
    kreuzberg::verify_excerpt(&excerpt, &source_text)
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (text, config))]
pub fn chunk_for_rag(text: String, config: ChunkingConfig) -> PyResult<ChunkingResult> {
    let config_core: kreuzberg::ChunkingConfig = config.into();

    kreuzberg::chunking::chunk_for_rag(&text, &config_core)
        .map(Into::into)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn compare(a: ExtractionResult, b: ExtractionResult, opts: DiffOptions) -> ExtractionDiff {
    ...
    kreuzberg::compare(&a_core, &b_core, &opts_core).into()
}
...
pub fn extract_keywords(text: String, config: KeywordConfig) -> PyResult<Vec<Keyword>> {
    ...
    kreuzberg::keywords::extract_keywords(&text, &config_core)
        .map(|val| val.into_iter().map(Into::into).collect())
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn analyze_document(
    ...
    kreuzberg::analyze_document(&metadata_core, &config_core, document_bytes.as_deref())
        .map(Into::into)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn analyze_with_user_chunks(
    ...
    kreuzberg::analyze_with_user_chunks(&user_ranges_core, total_pages, size_bytes, &config_core).into()
}
...
pub fn score_confidence(signals: ConfidenceSignals, weights: ConfidenceWeights) -> ExtractionConfidence {
    ...
    kreuzberg::score_confidence(signals_core, weights_core).into()
}
...
pub fn check_format_limits(
    ...
    kreuzberg::check_format_limits(&mime_type, sheet_count, workbook_cells, embedded_count, &config_core)
}
...
pub fn boundaries_from_extraction_result(
    ...
    kreuzberg::boundaries_from_extraction_result(&result_core, &thresholds_core)
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn detect_boundaries(input: MultidocInput, thresholds: MultidocThresholds) -> Vec<DocumentBoundary> {
    ...
    kreuzberg::detect_boundaries(&input_core, &thresholds_core)
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn choose_call_mode(input: StructuredInput, t: StructuredThresholds) -> StructuredCallMode {
    ...
    kreuzberg::choose_call_mode(&input_core, &t_core).into()
}
...
pub fn calculate_chunk_plan(page_count: u32, size_bytes: u64, needs_ocr: bool, config: HeuristicsConfig) -> ChunkPlan {
    ...
    kreuzberg::calculate_chunk_plan(page_count, size_bytes, needs_ocr, &config_core).into()
}
...
pub fn calculate_plan_from_overrides(
    ...
    kreuzberg::calculate_plan_from_overrides(&user_chunks_core, total_pages, size_bytes, &config_core).into()
}

#[pyfunction]
#[pyo3(signature = (raw))]
pub fn fingerprint(raw: Vec<u8>) -> String {
    kreuzberg::presets::loader::fingerprint(&raw)
}
...
pub fn extract_structured_json(
    ...
    kreuzberg::extract_structured_json(&bytes, &mime, &preset_spec_json, &options_json)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn split_and_extract_json(
    ...
    kreuzberg::split_and_extract_json(&bytes, &mime, &preset_spec_json, &options_json)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn render_pdf_page_to_png(
    ...
    kreuzberg::render_pdf_page_to_png(&pdf_bytes, page_index, dpi, password.as_deref())
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
#[pyfunction]
#[pyo3(signature = (query, documents, config))]
pub fn rerank(query: String, documents: Vec<String>, config: RerankerConfig) -> PyResult<Vec<RerankedDocument>> {
    let config_core: kreuzberg::RerankerConfig = config.into();

    kreuzberg::rerank(query, documents, &config_core)
        .map(|val| val.into_iter().map(Into::into).collect())
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
impl kreuzberg::plugins::Plugin for PyOcrBackendBridge {
    ...
    fn shutdown(&self) -> std::result::Result<(), kreuzberg::KreuzbergError> {
        Python::attach(|py| {
            self.inner.bind(py).call_method0("shutdown").map(|_| ()).map_err(|e| {
                kreuzberg::KreuzbergError::Other(format!(
        ...
        tokio::task::spawn_blocking(move || {
            Python::attach(|py| {
                ...
                let json_val: String = py
                    ...
                    .map_err(|e| {
                        kreuzberg::KreuzbergError::Other(format!(
                            "Plugin '{}': JSON serialization failed: {}",
                            cached_name, e
                        ))
                    })?;
                serde_json::from_str::<kreuzberg::ExtractionResult>(&json_val).map_err(|e| {
                    kreuzberg::KreuzbergError::Other(format!("Plugin '{}': deserialization failed: {}", cached_name, e))
                })
            })
        })
        .await
    ...
    fn backend_type(&self) -> kreuzberg::OcrBackendType {
        Python::attach(|py| {
            self.inner
                ...
                .and_then(|v| v.extract::<String>())
                .and_then(|s| {
                    serde_json::from_str::<kreuzberg::OcrBackendType>(&s)
                        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
                })
                .unwrap_or_default()
        })
...
impl kreuzberg::PostProcessor for PyPostProcessorBridge {
    async fn process(
        ...
        tokio::task::spawn_blocking(move || {
            Python::attach(|py| {
                ...
                obj.call_method1("process", (result_json.as_str(), config_json.as_str()))
                    .map(|_| ())
                    .map_err(|e| {
                        kreuzberg::KreuzbergError::Other(format!(
    ...
    fn processing_stage(&self) -> kreuzberg::ProcessingStage {
        Python::attach(|py| {
            self.inner
                .bind(py)
                .call_method0("processing_stage")
                .and_then(|v| v.extract::<String>())
                .and_then(|s| {
                    serde_json::from_str::<kreuzberg::ProcessingStage>(&s)
                        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
                })
                .unwrap_or_default()
        })
    ...
    async fn validate(
        ...
        tokio::task::spawn_blocking(move || {
            Python::attach(|py| {
                ...
                obj.call_method1("validate", (result_json.as_str(), config_json.as_str()))
                    .map(|_| ())
                    .map_err(|e| {
                        kreuzberg::KreuzbergError::Other(format!(
        ...
        tokio::task::spawn_blocking(move || {
            Python::attach(|py| {
                ...
                let py_result = obj
                    .call_method1(
                        "extract_bytes",
                        (pyo3::types::PyBytes::new(py, &content), mime_type, config_json.as_str()),
                    )
                    .map_err(|e| {
                        kreuzberg::KreuzbergError::Other(format!(
                ...
                serde_json::from_str::<kreuzberg::InternalDocument>(&json_val).map_err(|e| {
                    kreuzberg::KreuzbergError::Other(format!("Plugin '{}': deserialization failed: {}", cached_name, e))
                })
            })
        })
    ...
    fn supported_mime_types(&self) -> &[&str] {
        let __types: Vec<String> = {
            Python::attach(|py| {
                self.inner
                    .bind(py)
                    .call_method0("supported_mime_types")
...
impl kreuzberg::Renderer for PyRendererBridge {
    fn render(&self, doc: &kreuzberg::InternalDocument) -> std::result::Result<String, kreuzberg::KreuzbergError> {
        Python::attach(|py| {
            self.inner
                .bind(py)
                .call_method1("render", (serde_json::to_string(doc).unwrap_or_default(),))
                .and_then(|v| v.extract::<String>())
                .map_err(|e| {
                    kreuzberg::KreuzbergError::Other(format!(
    ...
    async fn rerank(
        ...
        tokio::task::spawn_blocking(move || {
            Python::attach(|py| {
                ...
                obj.call_method1("rerank", (query, documents))
