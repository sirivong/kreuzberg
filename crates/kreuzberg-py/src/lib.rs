...
impl ImageExtractionConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (extract_images=Self::default().extract_images, target_dpi=Self::default().target_dpi, max_image_dimension=Self::default().max_image_dimension, inject_placeholders=Self::default().inject_placeholders, auto_adjust_dpi=Self::default().auto_adjust_dpi, min_dpi=Self::default().min_dpi, max_dpi=Self::default().max_dpi, classify=Self::default().classify, include_page_rasters=Self::default().include_page_rasters, run_ocr_on_images=Self::default().run_ocr_on_images, ocr_text_only=Self::default().ocr_text_only, append_ocr_text=Self::default().append_ocr_text, output_format=Self::default().output_format, svg=None, max_images_per_page=None))]
    #[new]
    pub fn new(
        extract_images: bool,
        target_dpi: i32,
