...
impl ImageExtractionConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (extract_images=Self::default().extract_images, target_dpi=Self::default().target_dpi, max_image_dimension=Self::default().max_image_dimension, inject_placeholders=Self::default().inject_placeholders, auto_adjust_dpi=Self::default().auto_adjust_dpi, min_dpi=Self::default().min_dpi, max_dpi=Self::default().max_dpi, classify=Self::default().classify, include_page_rasters=Self::default().include_page_rasters, run_ocr_on_images=Self::default().run_ocr_on_images, ocr_text_only=Self::default().ocr_text_only, append_ocr_text=Self::default().append_ocr_text, output_format=Self::default().output_format, max_images_per_page=None))]
    #[new]
    pub fn new(
        extract_images: bool,
        target_dpi: i32,
...
impl LayoutDetectionConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (apply_heuristics=Self::default().apply_heuristics, table_model=Self::default().table_model, confidence_threshold=None, acceleration=None))]
    #[new]
    pub fn new(
...
impl PdfConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (extract_images=Self::default().extract_images, extract_tables=Self::default().extract_tables, extract_metadata=Self::default().extract_metadata, extract_annotations=Self::default().extract_annotations, allow_single_column_tables=Self::default().allow_single_column_tables, ocr_inline_images=Self::default().ocr_inline_images, passwords=None, hierarchy=None, top_margin_fraction=None, bottom_margin_fraction=None))]
    #[new]
    pub fn new(
        extract_images: bool,
        extract_tables: bool,
...
impl ChunkingConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (max_chars=Self::default().max_characters, max_overlap=Self::default().overlap, trim=Self::default().trim, chunker_type=Self::default().chunker_type, sizing=Self::default().sizing, prepend_heading_context=Self::default().prepend_heading_context, embedding=None, preset=None, topic_threshold=None))]
    #[new]
    pub fn new(
        max_chars: usize,
        max_overlap: usize,
...
impl ExtractionResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (content=Self::default().content, mime_type=Self::default().mime_type, metadata=None, tables=Self::default().tables, processing_warnings=Self::default().processing_warnings, extraction_method=None, detected_languages=None, chunks=None, images=None, pages=None, elements=None, djot_content=None, ocr_elements=None, document=None, extracted_keywords=None, quality_score=None, annotations=None, children=None, uris=None, revisions=None, structured_output=None, code_intelligence=None, llm_usage=None, entities=None, summary=None, translation=None, page_classifications=None, redaction_report=None, formatted_content=None))]
    #[new]
    pub fn new(
        content: String,
        mime_type: String,
...
impl ChunkMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (byte_start, byte_end, chunk_index, total_chunks, image_indices, token_count=None, first_page=None, last_page=None, heading_context=None))]
    #[new]
    pub fn new(
        byte_start: usize,
        byte_end: usize,
...
impl ExtractedImage {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (data=Self::default().data, format=Self::default().format, image_index=Self::default().image_index, is_mask=Self::default().is_mask, page_number=None, width=None, height=None, colorspace=None, bits_per_component=None, description=None, ocr_result=None, bounding_box=None, source_path=None, image_kind=None, kind_confidence=None, cluster_id=None, caption=None, qr_codes=None))]
    #[new]
    pub fn new(
        data: Vec<u8>,
        format: String,
...
impl ExtractionDiff {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (content_diff, tables_added, tables_removed, tables_changed, metadata_changed, embedded_changes))]
    #[new]
    pub fn new(
...
impl EmbeddedChanges {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (added, removed, changed))]
    #[new]
...
impl PcmAudio {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (samples, sample_rate_hz, channels, duration_ms))]
    #[new]
    pub fn new(samples: Vec<f32>, sample_rate_hz: u32, channels: u16, duration_ms: u64) -> Self {
        Self {
            samples,
            sample_rate_hz,
            channels,
...
impl WhisperModelPaths {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (encoder, decoder, decoder_with_past, tokenizer, config, n_mels))]
    #[new]
    pub fn new(
        encoder: String,
        decoder: String,
        decoder_with_past: String,
        tokenizer: String,
        config: String,
        n_mels: u32,
    ) -> Self {
...
impl AudioTags {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (title=None, artist=None, year=None, language=None, duration_ms=None, sample_rate_hz=None, channels=None, bitrate=None, container=None))]
    #[new]
    pub fn new(
        title: Option<String>,
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        ...
        if let Ok(n) = value.extract::<i32>() {
            match n {
                ...
                1 => return Ok(Self::Footnote),
                2 => return Ok(Self::Formula),
                3 => return Ok(Self::ListItem),
                4 => return Ok(Self::PageFooter),
                5 => return Ok(Self::PageHeader),
                6 => return Ok(Self::Picture),
                7 => return Ok(Self::SectionHeader),
                8 => return Ok(Self::Table),
                9 => return Ok(Self::Text),
                10 => return Ok(Self::Title),
                11 => return Ok(Self::DocumentIndex),
                12 => return Ok(Self::Code),
                13 => return Ok(Self::CheckboxSelected),
                14 => return Ok(Self::CheckboxUnselected),
                15 => return Ok(Self::Form),
                16 => return Ok(Self::KeyValueRegion),
                _ => {}
            }
        }
...
#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (bytes, max_bytes=None))]
pub fn decode_audio_to_pcm(bytes: Vec<u8>, max_bytes: Option<u64>) -> PyResult<PcmAudio> {
    kreuzberg::transcription::decode::decode_audio_to_pcm(&bytes, max_bytes)
        .map(Into::into)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (model, cache_dir=None, allow_network=false, verify_hash=false))]
pub fn ensure_whisper_model(
    model: WhisperModel,
    cache_dir: Option<String>,
    allow_network: Option<bool>,
    verify_hash: Option<bool>,
) -> PyResult<WhisperModelPaths> {
    let model_core: kreuzberg::WhisperModel = model.into();

    kreuzberg::transcription::model::ensure_whisper_model(
        model_core,
...
pub fn read_audio_tags(bytes: Vec<u8>) -> AudioTags {
    kreuzberg::transcription::tags::read_audio_tags(&bytes).into()
}
...
#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (_query, _documents, _config))]
pub fn rerank_async<'py>(
    ...
    pyo3_async_runtimes::tokio::future_into_py(py, async move {
        let _config_core: kreuzberg::RerankerConfig = _config.into();

        let result = kreuzberg::rerank_async(_query, _documents, &_config_core)
            .await
            .map_err(|e| PyErr::new::<PyRuntimeError, _>(e.to_string()))?;
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<PcmAudio> for kreuzberg::transcription::decode::PcmAudio {
    fn from(val: PcmAudio) -> Self {
        Self {
            samples: val.samples.into_iter().collect(),
            sample_rate_hz: val.sample_rate_hz,
            channels: val.channels,
            duration_ms: val.duration_ms,
        }
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::transcription::decode::PcmAudio> for PcmAudio {
    fn from(val: kreuzberg::transcription::decode::PcmAudio) -> Self {
        Self {
            samples: val.samples.into_iter().collect(),
            sample_rate_hz: val.sample_rate_hz,
            channels: val.channels,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WhisperModelPaths> for kreuzberg::transcription::model::WhisperModelPaths {
    fn from(val: WhisperModelPaths) -> Self {
        Self {
            encoder: val.encoder.into(),
            decoder: val.decoder.into(),
            decoder_with_past: val.decoder_with_past.into(),
            tokenizer: val.tokenizer.into(),
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::transcription::model::WhisperModelPaths> for WhisperModelPaths {
    fn from(val: kreuzberg::transcription::model::WhisperModelPaths) -> Self {
        Self {
            encoder: val.encoder.to_string_lossy().to_string(),
            decoder: val.decoder.to_string_lossy().to_string(),
            decoder_with_past: val.decoder_with_past.to_string_lossy().to_string(),
            tokenizer: val.tokenizer.to_string_lossy().to_string(),
            config: val.config.to_string_lossy().to_string(),
            n_mels: val.n_mels,
        }
    }
}
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<AudioTags> for kreuzberg::transcription::tags::AudioTags {
    fn from(val: AudioTags) -> Self {
        Self {
            title: val.title,
            artist: val.artist,
            year: val.year,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::transcription::tags::AudioTags> for AudioTags {
    fn from(val: kreuzberg::transcription::tags::AudioTags) -> Self {
        Self {
            title: val.title.map(|v| v.to_string()),
            artist: val.artist.map(|v| v.to_string()),
            year: val.year.map(|v| v.to_string()),
            language: val.language.map(|v| v.to_string()),
            duration_ms: val.duration_ms,
            sample_rate_hz: val.sample_rate_hz,
            channels: val.channels,
...
pub fn _kreuzberg(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<PcmAudio>()?;
    m.add_class::<WhisperModelPaths>()?;
    m.add_class::<AudioTags>()?;
    ...
    m.add_function(wrap_pyfunction!(decode_audio_to_pcm, m)?)?;
    m.add_function(wrap_pyfunction!(ensure_whisper_model, m)?)?;
