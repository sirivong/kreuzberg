...
// alef:hash:a0773782ddb1b3a9d1cebdc8b594e80dea6dd23925b8d197c4e40bf10ace6c17
...
impl ExtractionConfig {
    ...
    #[must_use]
    #[pyo3(signature = (use_cache=None, enable_quality_processing=None, force_ocr=None, disable_ocr=None, result_format=None, output_format=None, use_layout_for_markdown=None, include_document_structure=None, max_archive_depth=None, ocr=None, force_ocr_pages=None, chunking=None, content_filter=None, images=None, pdf_options=None, token_reduction=None, language_detection=None, pages=None, keywords=None, postprocessor=None, html_options=None, html_output=None, extraction_timeout_secs=None, max_concurrent_extractions=None, security_limits=None, layout=None, acceleration=None, cache_namespace=None, cache_ttl_secs=None, email=None, concurrency=None, tree_sitter=None, structured_extraction=None, cancel_token=None))]
    #[new]
    pub fn new(
        ...
        Self {
            ...
            layout,
            use_layout_for_markdown: use_layout_for_markdown.unwrap_or(false),
...
impl ImageExtractionConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (extract_images=None, target_dpi=None, max_image_dimension=None, inject_placeholders=None, auto_adjust_dpi=None, min_dpi=None, max_dpi=None, classify=None, max_images_per_page=None))]
    #[new]
    pub fn new(
...
impl OcrConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (enabled=None, backend=None, language=None, auto_rotate=None, tesseract_config=None, output_format=None, paddle_ocr_config=None, backend_options=None, element_config=None, quality_thresholds=None, pipeline=None, vlm_config=None, vlm_prompt=None, acceleration=None, tessdata_bytes=None))]
    #[new]
    pub fn new(
        enabled: Option<bool>,
...
impl PdfConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (extract_images=None, extract_tables=None, extract_metadata=None, extract_annotations=None, allow_single_column_tables=None, ocr_inline_images=None, passwords=None, hierarchy=None, top_margin_fraction=None, bottom_margin_fraction=None))]
    #[new]
    pub fn new(
        extract_images: Option<bool>,
        ...
        Self {
            ...
            ocr_inline_images: ocr_inline_images.unwrap_or(false),
        }
    }
...
impl EmbeddingConfig {
    #[must_use]
    #[pyo3(signature = (model=None, normalize=None, batch_size=None, show_download_progress=None, cache_dir=None, acceleration=None, max_embed_duration_secs=None))]
    #[new]
    pub fn new(
...
impl DocumentStructure {
    #[must_use]
    #[pyo3(signature = (nodes=None, relationships=None, node_types=None, source_format=None))]
    #[new]
    pub fn new(
...
impl Metadata {
    ...
    pub fn new(
        ...
        Self {
            ...
            abstract_text,
            output_format,
            ocr_used: ocr_used.unwrap_or_default(),
...
impl ImageMetadata {
    #[must_use]
    #[pyo3(signature = (width=None, height=None, format=None, exif=None))]
    #[new]
    pub fn new(
        width: Option<u32>,
        height: Option<u32>,
...
impl XmlMetadata {
    ...
    #[new]
    pub fn new(element_count: Option<u32>, unique_elements: Option<Vec<String>>) -> Self {
        Self {
...
impl LayoutRegion {
    #[must_use]
    #[pyo3(signature = (class_name=None, confidence=None, bounding_box=None, area_fraction=None))]
    #[new]
    pub fn new(
...
impl TableCell {
    ...
    #[new]
    pub fn new(content: Option<String>, row_span: Option<u32>, col_span: Option<u32>, is_header: Option<bool>) -> Self {
        Self {
            content: content.unwrap_or_default(),
...
impl LayoutDetection {
    ...
    #[new]
    pub fn new(class_name: String, confidence: f32, bbox: BBox) -> Self {
        Self {
            class_name,
            confidence,
            bbox,
...
impl TransformListType {
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(self)
            ...
            .map_err(|e| {
                pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize TransformListType: {e}"))
            })
    }
...
#[derive(Clone)]
#[pyclass(frozen)]
pub struct DrawingType {
    pub(crate) inner: kreuzberg::extraction::docx::drawing::DrawingType,
}
...
impl DrawingType {
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(&self.inner)
            ...
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize DrawingType: {e}")))
    }
    ...
    #[getter]
    fn inline(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::types::PyDict>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "tag";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
    ...
    #[getter]
    fn anchored(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::types::PyDict>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let tag_field = "tag";
        let tag_value = json.get(tag_field).and_then(|v| v.as_str()).unwrap_or("");
        if tag_value != "anchored" {
            return Ok(None);
        }
        let json_str = json.to_string();
        let json_mod = py.import("json")?;
...
impl serde::Serialize for DrawingType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        self.inner.serialize(serializer)
    }
}
...
impl<'de> serde::Deserialize<'de> for DrawingType {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let inner = kreuzberg::extraction::docx::drawing::DrawingType::deserialize(deserializer)?;
        Ok(Self { inner })
    }
}
...
impl NodeContent2 {
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(&self.inner)
            ...
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize NodeContent2: {e}")))
    }
...
impl From<NodeContent2> for kreuzberg::NodeContent {
    fn from(val: NodeContent2) -> Self {
        val.inner
    }
}
...
impl serde::Serialize for NodeContent2 {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        self.inner.serialize(serializer)
    }
}

impl Default for NodeContent2 {
    fn default() -> Self {
        Self {
            inner: Default::default(),
        }
...
impl<'de> serde::Deserialize<'de> for NodeContent2 {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
...
impl ExtractionMethod2 {
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(self)
            ...
            .map_err(|e| {
                pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize ExtractionMethod2: {e}"))
            })
    }
...
impl FormatMetadata2 {
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(&self.inner)
            ...
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize FormatMetadata2: {e}")))
    }
    ...
    #[getter]
    fn pdf(&self, py: Python<'_>) -> PyResult<Option<pyo3::Py<pyo3::types::PyDict>>> {
        let json =
            serde_json::to_value(&self.inner).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
...
impl From<FormatMetadata2> for kreuzberg::FormatMetadata {
    fn from(val: FormatMetadata2) -> Self {
        val.inner
    }
}
...
impl serde::Serialize for FormatMetadata2 {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        self.inner.serialize(serializer)
    }
}

impl Default for FormatMetadata2 {
    fn default() -> Self {
        Self {
            inner: Default::default(),
        }
...
impl<'de> serde::Deserialize<'de> for FormatMetadata2 {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
...
impl PaddleLanguage2 {
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(self)
            ...
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize PaddleLanguage2: {e}")))
    }
...
impl LayoutClass2 {
    fn __str__(&self) -> PyResult<String> {
        serde_json::to_value(self)
            ...
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(format!("Failed to serialize LayoutClass2: {e}")))
    }
    ...
    async fn extract_bytes(
        ...
        tokio::task::spawn_blocking(move || {
            Python::attach(|py| {
                ...
                serde_json::from_str::<kreuzberg::internal::InternalDocument>(&json_val).map_err(|e| {
                    kreuzberg::KreuzbergError::Other(format!("Plugin '{}': deserialization failed: {}", cached_name, e))
                })
            })
        })
...
impl From<kreuzberg::ExtractionResult> for ExtractionResult {
    fn from(val: kreuzberg::ExtractionResult) -> Self {
        Self {
            ...
            metadata: val.metadata.into(),
            extraction_method: val.extraction_method.as_ref().map(|v| format!("{v:?}")),
            tables: val.tables.into_iter().map(Into::into).collect(),
            detected_languages: val.detected_languages.map(|v| v.into_iter().collect()),
            chunks: val.chunks.map(|v| v.into_iter().map(Into::into).collect()),
            images: val.images.map(|v| v.into_iter().map(Into::into).collect()),
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::EmbeddingPreset> for EmbeddingPreset2 {
...
impl From<kreuzberg::LayoutDetection> for LayoutDetection {
    fn from(val: kreuzberg::LayoutDetection) -> Self {
        Self {
            class_name: format!("{:?}", val.class_name),
            confidence: val.confidence,
            bbox: val.bbox.into(),
        }
    }
...
pub fn _kreuzberg(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<TransformListType>()?;
    m.add_class::<DrawingType>()?;
    ...
    m.add_class::<PSMMode>()?;
    m.add_class::<PaddleLanguage2>()?;
    m.add_class::<LayoutClass2>()?;
