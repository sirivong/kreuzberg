...
impl FileExtractionConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (enable_quality_processing=None, ocr=None, force_ocr=None, force_ocr_pages=None, disable_ocr=None, chunking=None, content_filter=None, images=None, pdf_options=None, token_reduction=None, language_detection=None, pages=None, keywords=None, postprocessor=None, html_options=None, result_format=None, output_format=None, include_document_structure=None, layout=None, timeout_secs=None, tree_sitter=None, structured_extraction=None))]
    #[new]
    pub fn new(
...
impl OcrConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (enabled=Self::default().enabled, backend=Self::default().backend, language=Self::default().language, auto_rotate=Self::default().auto_rotate, tesseract_config=None, output_format=None, paddle_ocr_config=None, backend_options=None, element_config=None, quality_thresholds=None, pipeline=None, vlm_config=None, vlm_prompt=None, acceleration=None, tessdata_bytes=None))]
    #[new]
    pub fn new(
        enabled: bool,
        backend: String,
...
impl ExtractedImage {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (data, format, image_index, is_mask, page_number=None, width=None, height=None, colorspace=None, bits_per_component=None, description=None, ocr_result=None, bounding_box=None, source_path=None, image_kind=None, kind_confidence=None, cluster_id=None))]
    #[new]
    pub fn new(
        data: Vec<u8>,
        format: String,
...
impl PptxExtractionResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (content, metadata, slide_count, image_count, table_count, images, hyperlinks, office_metadata, page_structure=None, page_contents=None, document=None, revisions=None))]
    #[new]
    pub fn new(
        content: String,
...
impl TextMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (line_count=Self::default().line_count, word_count=Self::default().word_count, character_count=Self::default().character_count, headers=None, links=None, code_blocks=None))]
    #[new]
    pub fn new(
        line_count: u32,
        word_count: u32,
...
impl PageInfo {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (number, has_vector_graphics, title=None, dimensions=None, image_count=None, table_count=None, hidden=None, is_blank=None))]
    #[new]
    pub fn new(
        number: u32,
...
impl KeywordConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (algorithm=Self::default().algorithm, max_keywords=Self::default().max_keywords, min_score=Self::default().min_score, ngram_range=Self::default().ngram_range, language=None, yake_params=None, rake_params=None))]
    #[new]
    pub fn new(
