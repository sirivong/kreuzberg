...
// alef:hash:4c526909fb68e4bf2084d1dd0803516dc969f628c254dbc9ee30c39ad094fb9d
...
impl AccelerationConfig {
    ...
    #[must_use]
    #[pyo3(signature = (provider, device_id))]
    #[new]
...
impl ContentFilterConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (include_headers, include_footers, strip_repeating_text, include_watermarks))]
    #[new]
    pub fn new(
...
impl ExtractionConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (use_cache, enable_quality_processing, force_ocr, disable_ocr, result_format, output_format, use_layout_for_markdown, include_document_structure, max_archive_depth, ocr=None, force_ocr_pages=None, chunking=None, content_filter=None, images=None, token_reduction=None, language_detection=None, pages=None, postprocessor=None, extraction_timeout_secs=None, max_concurrent_extractions=None, security_limits=None, acceleration=None, cache_namespace=None, cache_ttl_secs=None, email=None, concurrency=None, structured_extraction=None, cancel_token=None))]
    #[new]
    pub fn new(
        use_cache: bool,
...
impl FileExtractionConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (enable_quality_processing=None, ocr=None, force_ocr=None, force_ocr_pages=None, disable_ocr=None, chunking=None, content_filter=None, images=None, token_reduction=None, language_detection=None, pages=None, postprocessor=None, result_format=None, output_format=None, include_document_structure=None, timeout_secs=None, structured_extraction=None))]
    #[new]
    pub fn new(
...
impl ImageExtractionConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (extract_images, target_dpi, max_image_dimension, inject_placeholders, auto_adjust_dpi, min_dpi, max_dpi, classify, max_images_per_page=None))]
    #[new]
    pub fn new(
        extract_images: bool,
        target_dpi: i32,
...
impl HtmlOutputConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (theme, class_prefix, embed_css, css=None, css_file=None))]
    #[new]
    pub fn new(
        theme: HtmlTheme,
        class_prefix: String,
...
impl LayoutDetectionConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (apply_heuristics, table_model, confidence_threshold=None, acceleration=None))]
    #[new]
    pub fn new(
...
impl OcrConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (enabled, backend, language, auto_rotate, tesseract_config=None, output_format=None, paddle_ocr_config=None, backend_options=None, element_config=None, quality_thresholds=None, pipeline=None, vlm_config=None, vlm_prompt=None, acceleration=None, tessdata_bytes=None))]
    #[new]
    pub fn new(
        enabled: bool,
        backend: String,
...
impl PageConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (extract_pages, insert_page_markers, marker_format))]
    #[new]
...
impl PdfConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (extract_images, extract_tables, extract_metadata, extract_annotations, allow_single_column_tables, ocr_inline_images, passwords=None, hierarchy=None, top_margin_fraction=None, bottom_margin_fraction=None))]
    #[new]
    pub fn new(
        extract_images: bool,
        extract_tables: bool,
...
impl HierarchyConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (enabled, k_clusters, include_bbox, ocr_coverage_threshold=None))]
    #[new]
...
impl PostProcessorConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (enabled, enabled_processors=None, disabled_processors=None, enabled_set=None, disabled_set=None))]
    #[new]
    pub fn new(
        enabled: bool,
...
impl ChunkingConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (max_chars, max_overlap, trim, chunker_type, sizing, prepend_heading_context, embedding=None, preset=None, topic_threshold=None))]
    #[new]
    pub fn new(
        max_chars: usize,
        max_overlap: usize,
...
impl EmbeddingConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (model, normalize, batch_size, show_download_progress, cache_dir=None, acceleration=None, max_embed_duration_secs=None))]
    #[new]
    pub fn new(
...
impl TreeSitterConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (enabled, process, cache_dir=None, languages=None, groups=None))]
    #[new]
    pub fn new(
        enabled: bool,
...
impl TreeSitterProcessConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (structure, imports, exports, comments, docstrings, symbols, diagnostics, content_mode, chunk_max_size=None))]
    #[new]
    pub fn new(
        structure: bool,
        imports: bool,
...
impl ServerConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (host, port, cors_origins, max_request_body_bytes, max_multipart_field_bytes))]
    #[new]
    pub fn new(
        host: String,
        port: u16,
...
impl XlsxAppProperties {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (worksheet_names, application=None, app_version=None, doc_security=None, scale_crop=None, links_up_to_date=None, shared_doc=None, hyperlinks_changed=None, company=None))]
    #[new]
    pub fn new(
...
impl PptxAppProperties {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (slide_titles, application=None, app_version=None, total_time=None, company=None, doc_security=None, scale_crop=None, links_up_to_date=None, shared_doc=None, hyperlinks_changed=None, slides=None, notes=None, hidden_slides=None, multimedia_clips=None, presentation_format=None))]
    #[new]
    pub fn new(
...
impl SecurityLimits {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (max_archive_size, max_compression_ratio, max_files_in_archive, max_nesting_depth, max_entity_length, max_content_size, max_iterations, max_xml_depth, max_table_cells))]
    #[new]
    pub fn new(
...
impl TokenReductionConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (level, preserve_markdown, preserve_code, semantic_threshold, enable_parallel, use_simd, preserve_patterns, enable_semantic_clustering, language_hint=None, custom_stopwords=None, target_reduction=None))]
    #[new]
    pub fn new(
...
impl DocumentStructure {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (nodes, relationships, node_types, source_format=None))]
    #[new]
    pub fn new(
...
impl TableGrid {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (rows, cols, cells))]
    #[new]
...
impl ExtractionResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (content, mime_type, metadata, tables, processing_warnings, extraction_method=None, detected_languages=None, chunks=None, images=None, pages=None, elements=None, djot_content=None, ocr_elements=None, document=None, quality_score=None, annotations=None, children=None, uris=None, structured_output=None, llm_usage=None, formatted_content=None, ocr_internal_document=None))]
    #[new]
    pub fn new(
        content: String,
        mime_type: String,
...
impl LlmUsage {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (model, source, input_tokens=None, output_tokens=None, total_tokens=None, estimated_cost=None, finish_reason=None))]
    #[new]
    pub fn new(
        model: String,
        source: String,
...
impl ImagePreprocessingConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (target_dpi, auto_rotate, deskew, denoise, contrast_enhance, binarization_method, invert_colors))]
    #[new]
    pub fn new(
        target_dpi: i32,
        auto_rotate: bool,
...
impl TesseractConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (language, psm, output_format, oem, min_confidence, enable_table_detection, table_min_confidence, table_column_threshold, table_row_threshold_ratio, use_cache, classify_use_pre_adapted_templates, language_model_ngram_on, tessedit_dont_blkrej_good_wds, tessedit_dont_rowrej_good_wds, tessedit_enable_dict_correction, tessedit_char_whitelist, tessedit_char_blacklist, tessedit_use_primary_params_model, textord_space_size_is_variable, thresholding_method, preprocessing=None))]
    #[new]
    pub fn new(
        language: String,
        psm: i32,
...
impl ImageMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (width, height, format, exif))]
    #[new]
...
impl HtmlMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (keywords, open_graph, twitter_card, meta_tags, headers, links, images, structured_data, title=None, description=None, author=None, canonical_url=None, base_href=None, language=None, text_direction=None))]
    #[new]
    pub fn new(
        keywords: Vec<String>,
...
impl CsvMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (row_count, column_count, has_header, delimiter=None, column_types=None))]
    #[new]
    pub fn new(
        row_count: u32,
        column_count: u32,
...
impl BibtexMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (entry_count, citation_keys, authors, year_range=None, entry_types=None))]
    #[new]
    pub fn new(
        entry_count: usize,
...
impl CitationMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (citation_count, authors, dois, keywords, format=None, year_range=None))]
    #[new]
    pub fn new(
...
impl FictionBookMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (genres, sequences, annotation=None))]
    #[new]
...
impl DbfMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (record_count, field_count, fields))]
    #[new]
...
impl JatsMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (history_dates, contributor_roles, copyright=None, license=None))]
    #[new]
    pub fn new(
...
impl OcrConfidence {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (recognition, detection=None))]
    #[new]
...
impl OcrElement {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (text, geometry, confidence, level, page_number, backend_metadata, rotation=None, parent_id=None))]
    #[new]
    pub fn new(
        text: String,
...
impl OcrElementConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (include_elements, min_level, min_confidence, build_hierarchy))]
    #[new]
...
impl PageContent {
    #[must_use]
    #[pyo3(signature = (page_number, content, tables, image_indices, hierarchy=None, is_blank=None, layout_regions=None))]
    #[new]
    pub fn new(
        page_number: u32,
        content: String,
...
impl LayoutRegion {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (class_name, confidence, bounding_box, area_fraction))]
    #[new]
    pub fn new(class_name: String, confidence: f64, bounding_box: String, area_fraction: f64) -> Self {
        Self {
            class_name,
            confidence,
            bounding_box,
...
impl Table {
    ...
    #[pyo3(signature = (cells, markdown, page_number, bounding_box=None))]
    #[new]
    pub fn new(cells: Vec<Vec<String>>, markdown: String, page_number: u32, bounding_box: Option<String>) -> Self {
        Self {
            cells,
            markdown,
            page_number,
...
impl RakeParams {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (min_word_length, max_words_per_phrase))]
    #[new]
...
impl KeywordConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (algorithm, max_keywords, min_score, ngram_range, language=None))]
    #[new]
    pub fn new(
...
impl OcrCacheStats {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (total_files, total_size_mb))]
    #[new]
...
impl PaddleOcrConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (language, use_angle_cls, enable_table_detection, det_db_thresh, det_db_box_thresh, det_db_unclip_ratio, det_limit_side_len, rec_batch_num, padding, drop_score, model_tier, cache_dir=None))]
    #[new]
    pub fn new(
        language: String,
        use_angle_cls: bool,
...
#[async_trait::async_trait]
impl kreuzberg::plugins::PostProcessor for PyPostProcessorBridge {
    async fn process(
        &self,
    ...
    fn processing_stage(&self) -> kreuzberg::plugins::ProcessingStage {
        Python::attach(|py| {
            self.inner
                ...
                .and_then(|v| v.extract::<String>())
                .and_then(|s| {
                    serde_json::from_str::<kreuzberg::plugins::ProcessingStage>(&s)
                        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
                })
                .unwrap_or_default()
        })
...
#[async_trait::async_trait]
impl kreuzberg::plugins::Validator for PyValidatorBridge {
    async fn validate(
        &self,
...
#[async_trait::async_trait]
impl kreuzberg::plugins::EmbeddingBackend for PyEmbeddingBackendBridge {
...
#[async_trait::async_trait]
impl kreuzberg::plugins::DocumentExtractor for PyDocumentExtractorBridge {
...
pub fn register_document_extractor(py: Python<'_>, backend: Py<PyAny>) -> PyResult<()> {
    ...
    let arc: Arc<dyn kreuzberg::plugins::DocumentExtractor> = Arc::new(wrapper);
...
impl kreuzberg::plugins::Renderer for PyRendererBridge {
...
pub fn register_renderer(py: Python<'_>, backend: Py<PyAny>) -> PyResult<()> {
    ...
    let arc: Arc<dyn kreuzberg::plugins::Renderer> = Arc::new(wrapper);
