...
impl ExecutionProviderType {
    #[new]
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        // Try to extract as int first
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to ExecutionProviderType: {}",
                        int_val, e
                    ))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                .or_else(|_| {
                    // Fallback: try to deserialize the string directly as JSON
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ExecutionProviderType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to OutputFormat: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert '{}' to OutputFormat: {}",
                        str_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create OutputFormat from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to HtmlTheme: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to HtmlTheme: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create HtmlTheme from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to TableModel: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to TableModel: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create TableModel from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to NerBackendKind: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create NerBackendKind from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to VlmFallbackPolicy: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create VlmFallbackPolicy from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to ChunkerType: {}", int_val, e))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ChunkerType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to ChunkSizing: {}", int_val, e))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ChunkSizing from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to EmbeddingModelType: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create EmbeddingModelType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to WhisperModel: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert '{}' to WhisperModel: {}",
                        str_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create WhisperModel from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to CodeContentMode: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create CodeContentMode from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to ListType: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to ListType: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ListType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to OcrBackendType: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create OcrBackendType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to ProcessingStage: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ProcessingStage from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to ReductionLevel: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ReductionLevel from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to PdfAnnotationType: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create PdfAnnotationType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to BlockType: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to BlockType: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create BlockType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to InlineType: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to InlineType: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create InlineType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to RelationshipKind: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create RelationshipKind from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to ContentLayer: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert '{}' to ContentLayer: {}",
                        str_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ContentLayer from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to NodeContent: {}", int_val, e))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create NodeContent from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to AnnotationKind: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create AnnotationKind from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to EntityCategory: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create EntityCategory from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to ExtractionMethod: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ExtractionMethod from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to ChunkType: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to ChunkType: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ChunkType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to ImageKind: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to ImageKind: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ImageKind from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to ResultFormat: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert '{}' to ResultFormat: {}",
                        str_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ResultFormat from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to ElementType: {}", int_val, e))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ElementType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to FormatMetadata: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create FormatMetadata from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to TextDirection: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create TextDirection from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to LinkType: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to LinkType: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create LinkType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to ImageType: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to ImageType: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create ImageType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to StructuredDataType: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create StructuredDataType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to OcrBoundingGeometry: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create OcrBoundingGeometry from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to OcrElementLevel: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create OcrElementLevel from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to PageUnitType: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert '{}' to PageUnitType: {}",
                        str_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create PageUnitType from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to RedactionStrategy: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create RedactionStrategy from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to PiiCategory: {}", int_val, e))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create PiiCategory from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to DiffLine: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to DiffLine: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create DiffLine from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to RevisionKind: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert '{}' to RevisionKind: {}",
                        str_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create RevisionKind from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to RevisionAnchor: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create RevisionAnchor from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to SummaryStrategy: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create SummaryStrategy from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to UriKind: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to UriKind: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create UriKind from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to RegionKind: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to RegionKind: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create RegionKind from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to KeywordAlgorithm: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create KeywordAlgorithm from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to PSMMode: {}", int_val, e))
                });
        }
        ...
        if let Ok(str_val) = value.extract::<String>(py) {
            return serde_json::from_str::<Self>(&format!("\"{}\"", str_val))
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert '{}' to PSMMode: {}", str_val, e))
                });
        }

        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create PSMMode from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                ...
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!(
                        "Cannot convert {} to PaddleLanguage: {}",
                        int_val, e
                    ))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create PaddleLanguage from {}; expected int or str",
            value.get_type(py)
        )))
    }
    ...
    fn __new__(py: pyo3::Python<'_>, value: pyo3::PyObject) -> PyResult<Self> {
        ...
        if let Ok(int_val) = value.extract::<i32>(py) {
            return serde_json::to_value(int_val)
                .and_then(|json| serde_json::from_value(json))
                .map_err(|e| {
                    pyo3::exceptions::PyTypeError::new_err(format!("Cannot convert {} to LayoutClass: {}", int_val, e))
                });
        }
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(format!(
            "Cannot create LayoutClass from {}; expected int or str",
            value.get_type(py)
        )))
    }
