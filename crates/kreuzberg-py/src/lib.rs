...
// alef:hash:da1e10ac71290194004153cf655d0775c2b8f93cac30489cd5b771dca2119b8a
...
impl SecurityLimits {
    ...
    pub fn new(
        ...
        Self {
            max_archive_size: max_archive_size.unwrap_or_default(),
            ...
            max_entity_length: max_entity_length.unwrap_or_default(),
            max_content_size: max_content_size.unwrap_or_default(),
...
impl Metadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (additional=None, title=None, subject=None, authors=None, keywords=None, language=None, created_at=None, modified_at=None, created_by=None, modified_by=None, pages=None, format=None, image_preprocessing=None, json_schema=None, error=None, extraction_duration_ms=None, category=None, tags=None, document_version=None, abstract_text=None, output_format=None, sheet_count=None, sheet_names=None))]
    #[new]
    pub fn new(
