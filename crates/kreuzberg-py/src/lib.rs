...
// alef:hash:0ea5e3e26684af79d934641f5688285107773f00385ced8a133fa48c89e89b3b
...
impl PdfConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (extract_images=None, extract_metadata=None, extract_annotations=None, allow_single_column_tables=None, passwords=None, hierarchy=None, top_margin_fraction=None, bottom_margin_fraction=None))]
    #[new]
    pub fn new(
        extract_images: Option<bool>,
...
impl CharShape {
    #[must_use]
    #[pyo3(signature = (bold=None, italic=None, underline=None))]
    #[new]
    pub fn new(bold: Option<bool>, italic: Option<bool>, underline: Option<bool>) -> Self {
        Self {
...
impl HwpImage {
    #[must_use]
    #[pyo3(signature = (name=None, data=None))]
    #[new]
    pub fn new(name: Option<String>, data: Option<Vec<u8>>) -> Self {
        Self {
...
pub fn _kreuzberg(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<CharShape>()?;
    m.add_class::<HwpImage>()?;
