...
pub struct JsExtractionDiff {
    ...
    pub content_diff: Vec<JsDiffHunk>,
    ...
    pub tables_removed: Vec<JsTable>,
    ...
    pub tables_changed: Vec<JsTableDiff>,
    ...
    pub embedded_changes: JsEmbeddedChanges,
}
...
pub struct JsEmbeddedChanges {
    ...
    pub added: Vec<JsArchiveEntry>,
    /// Children present in `a` but not in `b` (matched by `path`).
    pub removed: Vec<JsArchiveEntry>,
    ...
    pub changed: Vec<JsEmbeddedDiff>,
}
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "PcmAudio")]
pub struct JsPcmAudio {
    pub samples: Vec<f64>,
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "WhisperModelPaths")]
pub struct JsWhisperModelPaths {
    ...
    #[napi(js_name = "decoderWithPast")]
    #[serde(rename = "decoderWithPast")]
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "AudioTags")]
pub struct JsAudioTags {
    pub title: Option<String>,
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "decodeAudioToPcm")]
pub fn decode_audio_to_pcm(bytes: napi::bindgen_prelude::Buffer, max_bytes: Option<i64>) -> Result<JsPcmAudio> {
    let bytes: Vec<u8> = bytes.to_vec();
    kreuzberg::transcription::decode::decode_audio_to_pcm(&bytes, max_bytes.map(|v| v as u64))
        .map(|val| val.into())
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
#[napi(js_name = "readAudioTags")]
pub fn read_audio_tags(bytes: napi::bindgen_prelude::Buffer) -> JsAudioTags {
    let bytes: Vec<u8> = bytes.to_vec();
...
pub async fn rerank_async(
    ...
    _config: Option<JsRerankerConfig>,
) -> Result<Vec<JsRerankedDocument>> {
    let _config_core: kreuzberg::RerankerConfig = _config.unwrap_or_default().into();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPcmAudio> for kreuzberg::transcription::decode::PcmAudio {
    fn from(val: JsPcmAudio) -> Self {
        Self {
            samples: val.samples.into_iter().map(|v| v as f32).collect(),
            sample_rate_hz: val.sample_rate_hz,
            channels: val.channels,
            duration_ms: val.duration_ms as u64,
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::transcription::decode::PcmAudio> for JsPcmAudio {
    fn from(val: kreuzberg::transcription::decode::PcmAudio) -> Self {
        Self {
            samples: val.samples.iter().map(|&v| v as f64).collect(),
            sample_rate_hz: val.sample_rate_hz,
            channels: val.channels,
            duration_ms: val.duration_ms as i64,
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsWhisperModelPaths> for kreuzberg::transcription::model::WhisperModelPaths {
    fn from(val: JsWhisperModelPaths) -> Self {
        Self {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::transcription::model::WhisperModelPaths> for JsWhisperModelPaths {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsAudioTags> for kreuzberg::transcription::tags::AudioTags {
    fn from(val: JsAudioTags) -> Self {
        let mut __result = kreuzberg::transcription::tags::AudioTags::default();
        __result.title = val.title;
        __result.artist = val.artist;
        __result.year = val.year;
        __result.language = val.language;
        __result.duration_ms = val.duration_ms.map(|v| v as u64);
        __result.sample_rate_hz = val.sample_rate_hz;
        __result.channels = val.channels;
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::transcription::tags::AudioTags> for JsAudioTags {
