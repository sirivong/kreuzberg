...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "GlineBackend")]
pub struct JsGlineBackend {
    #[napi(js_name = "repoId")]
    #[serde(rename = "repoId")]
    pub repo_id: String,
...
#[napi(js_name = "glineBackendNew")]
pub fn gline_backend_new(repo_id: Option<String>) -> napi::Result<Result<JsGlineBackend>> {
    kreuzberg::GlineBackend::new(repo_id.as_deref()).into()
}
...
impl JsLlmBackend {
    ...
    pub async fn detect_with_custom(
        ...
        let inner = self.inner.clone();
        let result = inner
            .detect_with_custom(&text, &categories, &custom_labels_refs)
            .await
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        Ok(result.into_iter().map(Into::into).collect())
    }
...
impl JsTokenCounter {
    ...
    #[napi(js_name = "nextToken")]
    pub fn next_token(&self, category: JsPiiCategory, original: String) -> String {
...
impl kreuzberg::OcrBackend for JsOcrBackendBridge {
    async fn process_image(
        ...
        > = match self.inner.get_named_property("processImage") {
            Ok(f) => f,
            Err(e) => {
    ...
    fn supports_language(&self, lang: &str) -> bool {
        let func: napi::bindgen_prelude::Function<
            ...
            napi::bindgen_prelude::Unknown,
        > = match self.inner.get_named_property("supportsLanguage") {
            Ok(f) => f,
            Err(_) => return Default::default(),
        };
    ...
    fn backend_type(&self) -> kreuzberg::OcrBackendType {
        let func: napi::bindgen_prelude::Function<(), napi::bindgen_prelude::Unknown> =
            match self.inner.get_named_property("backendType") {
                Ok(f) => f,
                Err(_) => return Default::default(),
            };
...
impl kreuzberg::PostProcessor for JsPostProcessorBridge {
    ...
    fn processing_stage(&self) -> kreuzberg::ProcessingStage {
        let func: napi::bindgen_prelude::Function<(), napi::bindgen_prelude::Unknown> =
            match self.inner.get_named_property("processingStage") {
                Ok(f) => f,
                Err(_) => return Default::default(),
            };
...
impl kreuzberg::DocumentExtractor for JsDocumentExtractorBridge {
    async fn extract_bytes(
        ...
        let func: napi::bindgen_prelude::Function<
            ...
            napi::bindgen_prelude::Unknown,
        > = match self.inner.get_named_property("extractBytes") {
            Ok(f) => f,
            Err(e) => {
                return Err(kreuzberg::KreuzbergError::Other(format!(
                    "Method '{}' not found on bridge object: {}",
    ...
    fn supported_mime_types(&self) -> &[&str] {
        let __types: Vec<String> = {
            let func: napi::bindgen_prelude::Function<(), napi::bindgen_prelude::Unknown> =
                match self.inner.get_named_property("supportedMimeTypes") {
                    Ok(f) => f,
                    Err(_) => return Default::default(),
                };
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsGlineBackend> for kreuzberg::GlineBackend {
    fn from(val: JsGlineBackend) -> Self {
        Self {
            repo_id: val.repo_id,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::GlineBackend> for JsGlineBackend {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::chunking::semantic::merge::Segment> for JsSegment {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsSegment> for kreuzberg::chunking::semantic::merge::Segment {
    fn from(val: JsSegment) -> Self {
        Self {
            text: val.text,
            byte_start: val.byte_start as usize,
        }
