...
// alef:hash:cc89ba20603ded1774bc5b9cfceb158b99a43c54a8f57bb2558dd03a599598d9
...
impl JsFormatMetadata {
    ...
    #[napi(getter, js_name = "fictionBook")]
...
impl From<JsDocxMetadata> for kreuzberg::DocxMetadata {
    fn from(val: JsDocxMetadata) -> Self {
        ...
        __result.core_properties = val.core_properties.as_ref().and_then(|s| serde_json::from_str(s).ok());
        __result.app_properties = val.app_properties.as_ref().and_then(|s| serde_json::from_str(s).ok());
