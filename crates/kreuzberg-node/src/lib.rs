...
impl kreuzberg::plugins::Plugin for JsOcrBackendBridge {
    ...
    fn version(&self) -> String {
        let func: napi::bindgen_prelude::Function<(), napi::bindgen_prelude::Unknown> = match self
            .inner
            .get_named_property("version")
            .or_else(|_| self.inner.get_named_property("version"))
        {
            Ok(f) => f,
    ...
    fn initialize(&self) -> std::result::Result<(), kreuzberg::KreuzbergError> {
        let func: napi::bindgen_prelude::Function<(), napi::bindgen_prelude::Unknown> = match self
            ...
            .or_else(|_| self.inner.get_named_property("initialize"))
        {
            Ok(f) => f,
    ...
    fn shutdown(&self) -> std::result::Result<(), kreuzberg::KreuzbergError> {
        let func: napi::bindgen_prelude::Function<(), napi::bindgen_prelude::Unknown> = match self
            ...
            .or_else(|_| self.inner.get_named_property("shutdown"))
        {
            Ok(f) => f,
            // Method has a default impl on the Rust trait — treat missing JS property as a no-op
            // (the foreign object opted out of overriding it).
...
impl kreuzberg::OcrBackend for JsOcrBackendBridge {
    async fn process_image(
        ...
        > = match self
            ...
            .or_else(|_| self.inner.get_named_property("process_image"))
        {
            Ok(f) => f,
            Err(e) => {
    ...
    fn supports_language(&self, lang: &str) -> bool {
        ...
        > = match self
            ...
            .or_else(|_| self.inner.get_named_property("supports_language"))
        {
            Ok(f) => f,
            Err(_) => return Default::default(),
        };
    ...
    fn backend_type(&self) -> kreuzberg::OcrBackendType {
        let func: napi::bindgen_prelude::Function<(), napi::bindgen_prelude::Unknown> = match self
            ...
            .or_else(|_| self.inner.get_named_property("backend_type"))
        {
            Ok(f) => f,
            Err(_) => return Default::default(),
        };
...
impl kreuzberg::PostProcessor for JsPostProcessorBridge {
    async fn process(
        ...
        > = match self
            ...
            .or_else(|_| self.inner.get_named_property("process"))
        {
            Ok(f) => f,
            Err(e) => {
                return Err(kreuzberg::KreuzbergError::Other(format!(
    ...
    fn processing_stage(&self) -> kreuzberg::ProcessingStage {
        let func: napi::bindgen_prelude::Function<(), napi::bindgen_prelude::Unknown> = match self
            ...
            .or_else(|_| self.inner.get_named_property("processing_stage"))
        {
            Ok(f) => f,
            Err(_) => return Default::default(),
        };
...
impl kreuzberg::Validator for JsValidatorBridge {
    async fn validate(
        ...
        > = match self
            ...
            .or_else(|_| self.inner.get_named_property("validate"))
        {
            Ok(f) => f,
            Err(e) => {
                return Err(kreuzberg::KreuzbergError::Other(format!(
...
impl kreuzberg::EmbeddingBackend for JsEmbeddingBackendBridge {
    fn dimensions(&self) -> usize {
        let func: napi::bindgen_prelude::Function<(), napi::bindgen_prelude::Unknown> = match self
            ...
            .or_else(|_| self.inner.get_named_property("dimensions"))
        {
            Ok(f) => f,
            Err(_) => return Default::default(),
        };
    ...
    async fn embed(&self, texts: Vec<String>) -> std::result::Result<Vec<Vec<f32>>, kreuzberg::KreuzbergError> {
        ...
        > = match self
            ...
            .or_else(|_| self.inner.get_named_property("embed"))
        {
            Ok(f) => f,
            Err(e) => {
                return Err(kreuzberg::KreuzbergError::Other(format!(
...
impl kreuzberg::DocumentExtractor for JsDocumentExtractorBridge {
    async fn extract_bytes(
        ...
        > = match self
            ...
            .or_else(|_| self.inner.get_named_property("extract_bytes"))
        {
            Ok(f) => f,
            Err(e) => {
                return Err(kreuzberg::KreuzbergError::Other(format!(
    ...
    fn supported_mime_types(&self) -> &[&str] {
        let __types: Vec<String> = {
            let func: napi::bindgen_prelude::Function<(), napi::bindgen_prelude::Unknown> = match self
                ...
                .or_else(|_| self.inner.get_named_property("supported_mime_types"))
            {
                Ok(f) => f,
                Err(_) => return Default::default(),
            };
...
impl kreuzberg::Renderer for JsRendererBridge {
    fn render(&self, doc: &kreuzberg::InternalDocument) -> std::result::Result<String, kreuzberg::KreuzbergError> {
        ...
        > = match self
            ...
            .or_else(|_| self.inner.get_named_property("render"))
        {
            Ok(f) => f,
            Err(e) => {
                return Err(kreuzberg::KreuzbergError::Other(format!(
...
impl kreuzberg::RerankerBackend for JsRerankerBackendBridge {
    async fn rerank(
        ...
        > = match self
            ...
            .or_else(|_| self.inner.get_named_property("rerank"))
        {
            Ok(f) => f,
            Err(e) => {
                return Err(kreuzberg::KreuzbergError::Other(format!(
