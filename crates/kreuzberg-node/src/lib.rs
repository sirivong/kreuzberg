...
impl JsLlmBackend {
    ...
    pub async fn detect(&self, text: String, categories: Vec<JsEntityCategory>) -> Result<Vec<JsEntity>> {
        ...
        let categories_core: Vec<kreuzberg::EntityCategory> = serde_json::from_str(&categories_json)
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        let result = self
            .inner
    ...
    pub fn new(config: JsLlmConfig) -> JsLlmBackend {
        Self {
            inner: Arc::new(kreuzberg::LlmBackend::new(config.into())),
        }
    }
}
...
impl JsTokenCounter {
    ...
    pub fn new_constructor() -> Self {
        Self {
            inner: std::sync::Arc::new(kreuzberg::TokenCounter::new()),
        }
    }
}
...
pub fn footnote_config_with_parse_citations(cfg: JsFootnoteConfig, enabled: bool) -> napi::Result<JsFootnoteConfig> {
    ...
    let _core: kreuzberg::FootnoteConfig =
...
pub fn confidence_signals_from_extraction_result(
    ...
    kreuzberg::ConfidenceSignals::from_extraction_result(&result_core, schema_compliance_core, text_coverage as f32)
        .into()
}
...
pub fn page_signals_from_page_text(page_number: u32, text: String, layout_text_density: f64) -> JsPageSignals {
    kreuzberg::PageSignals::from_page_text(page_number, &text, layout_text_density as f32).into()
}
...
#[cfg(any(feature = "tokio-runtime", not(feature = "tokio-runtime")))]
...
pub fn list_reranker_backends() -> Result<Vec<String>> {
    kreuzberg::list_reranker_backends().map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub async fn classify_pages(
    ...
    let mut result_core: kreuzberg::ExtractionResult = result.unwrap_or_default().into();

    let config_core: kreuzberg::PageClassificationConfig = config.unwrap_or_default().into();
...
pub async fn redact(result: Option<JsExtractionResult>, config: Option<JsRedactionConfig>) -> Result<()> {
    ...
    let config_core: kreuzberg::RedactionConfig = config.unwrap_or_default().into();
...
pub async fn translate_result(result: Option<JsExtractionResult>, config: Option<JsTranslationConfig>) -> Result<()> {
    ...
    let config_core: kreuzberg::TranslationConfig = config.unwrap_or_default().into();
...
pub fn chunk_for_rag(text: String, config: Option<JsChunkingConfig>) -> Result<JsChunkingResult> {
    let config_core: kreuzberg::ChunkingConfig = config.unwrap_or_default().into();
...
pub fn compare(
    ...
    let a_core: kreuzberg::ExtractionResult = a.unwrap_or_default().into();

    let b_core: kreuzberg::ExtractionResult = b.unwrap_or_default().into();

    let opts_core: kreuzberg::DiffOptions = opts.unwrap_or_default().into();
...
pub async fn extract_region_with_vlm(
    ...
    let llm_config_core: kreuzberg::LlmConfig = llm_config.unwrap_or_default().into();
...
pub async fn rerank_async(
    ...
    let config_core: kreuzberg::RerankerConfig = config.unwrap_or_default().into();
...
pub fn extract_keywords(text: String, config: Option<JsKeywordConfig>) -> Result<Vec<JsKeyword>> {
    let config_core: kreuzberg::KeywordConfig = config.unwrap_or_default().into();
...
pub fn analyze_with_user_chunks(
    ...
    kreuzberg::analyze_with_user_chunks(&user_ranges_core, total_pages, size_bytes as u64, &config_core).into()
}
...
pub fn score_confidence(signals: JsConfidenceSignals, weights: Option<JsConfidenceWeights>) -> JsExtractionConfidence {
    ...
    let weights_core: kreuzberg::ConfidenceWeights = weights.unwrap_or_default().into();
...
pub fn boundaries_from_extraction_result(
    ...
    let result_core: kreuzberg::ExtractionResult = result.unwrap_or_default().into();

    let thresholds_core: kreuzberg::MultidocThresholds = thresholds.unwrap_or_default().into();
...
pub fn choose_call_mode(input: JsStructuredInput, t: Option<JsStructuredThresholds>) -> JsStructuredCallMode {
    ...
    let t_core: kreuzberg::StructuredThresholds = t.unwrap_or_default().into();
...
pub fn calculate_chunk_plan(
    ...
    kreuzberg::calculate_chunk_plan(page_count, size_bytes as u64, needs_ocr, &config_core).into()
}
...
pub fn calculate_plan_from_overrides(
    ...
    kreuzberg::calculate_plan_from_overrides(&user_chunks_core, total_pages, size_bytes as u64, &config_core).into()
}
...
pub fn pdf_page_count(pdf_bytes: napi::bindgen_prelude::Buffer, password: Option<String>) -> Result<i64> {
    let pdf_bytes: Vec<u8> = pdf_bytes.to_vec();
    kreuzberg::pdf_page_count(&pdf_bytes, password.as_deref())
        .map(|val| val as i64)
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub async fn embed_texts_async(_texts: Vec<String>, _config: Option<JsEmbeddingConfig>) -> Result<Vec<Vec<f64>>> {
    let _config_core: kreuzberg::EmbeddingConfig = _config.unwrap_or_default().into();
...
impl JsDocumentExtractorBridge {
    ...
    /// Validates that the object provides all required methods.
    pub fn new(js_obj: napi::bindgen_prelude::Object<'_>) -> napi::Result<Self> {
        if !js_obj.has_named_property("extractBytes").unwrap_or(false)
            && !js_obj.has_named_property("extract_bytes").unwrap_or(false)
        {
            return Err(napi::Error::new(
                napi::Status::GenericFailure,
                format!("Object missing required method: {}", "extractBytes"),
            ));
        }
...
impl kreuzberg::DocumentExtractor for JsDocumentExtractorBridge {
    async fn extract_bytes(
        ...
        let func: napi::bindgen_prelude::Function<
            ...
            napi::bindgen_prelude::Unknown,
        > = match __obj
            .get_named_property("extractBytes")
            .or_else(|_| __obj.get_named_property("extract_bytes"))
        {
            Ok(f) => f,
            Err(e) => {
                return Err(kreuzberg::KreuzbergError::Other(format!(
...
impl kreuzberg::plugins::Plugin for JsRerankerBackendBridge {
    fn name(&self) -> &str {
        &self.cached_name
    }
...
#[async_trait::async_trait]
impl kreuzberg::RerankerBackend for JsRerankerBackendBridge {
    async fn rerank(
        &self,
        query: String,
        documents: Vec<String>,
        ...
        match result {
            ...
            Ok(val) => {
                ...
                let s = val
                    ...
                    .map_err(|e| {
                        kreuzberg::KreuzbergError::Other(format!(
                            "Failed to extract return value from method 'rerank': {}",
                            e
                        ))
                    })?;
                // null/empty is a protocol error for Result-returning methods: the JS
                ...
                match s.as_str() {
                    ...
                    _ => serde_json::from_str::<_>(&s).map_err(|_| {
                        kreuzberg::KreuzbergError::Other("Failed to parse return value for method 'rerank'".to_string())
                    }),
                }
            }
        }
...
pub fn register_reranker_backend(obj: napi::bindgen_prelude::Object) -> napi::Result<()> {
    ...
    let arc: Arc<dyn kreuzberg::RerankerBackend> = Arc::new(bridge);
...
impl From<kreuzberg::CacheStats> for JsCacheStats {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsCaptioningConfig> for kreuzberg::CaptioningConfig {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::CaptioningConfig> for JsCaptioningConfig {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPageClassificationConfig> for kreuzberg::PageClassificationConfig {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::PageClassificationConfig> for JsPageClassificationConfig {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsSvgOptions> for kreuzberg::core::config::extraction::SvgOptions {
    fn from(val: JsSvgOptions) -> Self {
        let mut __result = kreuzberg::core::config::extraction::SvgOptions::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::core::config::extraction::SvgOptions> for JsSvgOptions {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsNerConfig> for kreuzberg::NerConfig {
    fn from(val: JsNerConfig) -> Self {
        let mut __result = kreuzberg::NerConfig::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::NerConfig> for JsNerConfig {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsRedactionConfig> for kreuzberg::RedactionConfig {
    fn from(val: JsRedactionConfig) -> Self {
        let mut __result = kreuzberg::RedactionConfig::default();
        if let Some(__v) = val.categories {
            __result.categories = __v.into_iter().map(Into::into).collect();
        }
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::RedactionConfig> for JsRedactionConfig {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsRedactionTerm> for kreuzberg::RedactionTerm {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::RedactionTerm> for JsRedactionTerm {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsRedactionPattern> for kreuzberg::RedactionPattern {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::RedactionPattern> for JsRedactionPattern {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsRerankerConfig> for kreuzberg::RerankerConfig {
    fn from(val: JsRerankerConfig) -> Self {
        let mut __result = kreuzberg::RerankerConfig::default();
        if let Some(__v) = val.model {
            __result.model = __v.into();
        }
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::RerankerConfig> for JsRerankerConfig {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsSummarizationConfig> for kreuzberg::SummarizationConfig {
    fn from(val: JsSummarizationConfig) -> Self {
        let mut __result = kreuzberg::SummarizationConfig::default();
        if let Some(__v) = val.strategy {
            __result.strategy = __v.into();
        }
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::SummarizationConfig> for JsSummarizationConfig {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsTranscriptionConfig> for kreuzberg::TranscriptionConfig {
    fn from(val: JsTranscriptionConfig) -> Self {
        let mut __result = kreuzberg::TranscriptionConfig::default();
        if let Some(__v) = val.enabled {
            __result.enabled = __v;
        }
        if let Some(__v) = val.model {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::TranscriptionConfig> for JsTranscriptionConfig {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsTranslationConfig> for kreuzberg::TranslationConfig {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::TranslationConfig> for JsTranslationConfig {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPatternMatch> for kreuzberg::text::redaction::patterns::PatternMatch {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::text::redaction::patterns::PatternMatch> for JsPatternMatch {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsFootnoteConfig> for kreuzberg::FootnoteConfig {
    fn from(val: JsFootnoteConfig) -> Self {
        let mut __result = kreuzberg::FootnoteConfig::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::FootnoteConfig> for JsFootnoteConfig {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsFootnoteAnchor> for kreuzberg::FootnoteAnchor {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::FootnoteAnchor> for JsFootnoteAnchor {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsFootnoteDefinition> for kreuzberg::FootnoteDefinition {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::FootnoteDefinition> for JsFootnoteDefinition {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsCitation> for kreuzberg::Citation {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::Citation> for JsCitation {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPageClassification> for kreuzberg::PageClassification {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::PageClassification> for JsPageClassification {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsClassificationLabel> for kreuzberg::ClassificationLabel {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ClassificationLabel> for JsClassificationLabel {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsEntity> for kreuzberg::Entity {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::Entity> for JsEntity {
...
impl From<JsExtractedImage> for kreuzberg::ExtractedImage {
    fn from(val: JsExtractedImage) -> Self {
        let mut __result = kreuzberg::ExtractedImage::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPdfFormField> for kreuzberg::PdfFormField {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::PdfFormField> for JsPdfFormField {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsFormula> for kreuzberg::Formula {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::Formula> for JsFormula {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsAudioMetadata> for kreuzberg::AudioMetadata {
    fn from(val: JsAudioMetadata) -> Self {
        let mut __result = kreuzberg::AudioMetadata::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::AudioMetadata> for JsAudioMetadata {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsQrCode> for kreuzberg::QrCode {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::QrCode> for JsQrCode {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsQrBoundingBox> for kreuzberg::QrBoundingBox {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::QrBoundingBox> for JsQrBoundingBox {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsRedactionReport> for kreuzberg::RedactionReport {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::RedactionReport> for JsRedactionReport {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsRedactionFinding> for kreuzberg::RedactionFinding {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::RedactionFinding> for JsRedactionFinding {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsCellChange> for kreuzberg::CellChange {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::CellChange> for JsCellChange {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsDocumentRevision> for kreuzberg::DocumentRevision {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DocumentRevision> for JsDocumentRevision {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsRevisionDelta> for kreuzberg::RevisionDelta {
    fn from(val: JsRevisionDelta) -> Self {
        let mut __result = kreuzberg::RevisionDelta::default();
        if let Some(__v) = val.content {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::RevisionDelta> for JsRevisionDelta {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsDocumentSummary> for kreuzberg::DocumentSummary {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DocumentSummary> for JsDocumentSummary {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsTranslation> for kreuzberg::Translation {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::Translation> for JsTranslation {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsExtractedUri> for kreuzberg::ExtractedUri {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ExtractedUri> for JsExtractedUri {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsDiffOptions> for kreuzberg::DiffOptions {
    fn from(val: JsDiffOptions) -> Self {
        let mut __result = kreuzberg::DiffOptions::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DiffOptions> for JsDiffOptions {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsExtractionDiff> for kreuzberg::ExtractionDiff {
    fn from(val: JsExtractionDiff) -> Self {
        let mut __result = kreuzberg::ExtractionDiff::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ExtractionDiff> for JsExtractionDiff {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsDiffHunk> for kreuzberg::DiffHunk {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DiffHunk> for JsDiffHunk {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsTableDiff> for kreuzberg::TableDiff {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::TableDiff> for JsTableDiff {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsEmbeddedChanges> for kreuzberg::EmbeddedChanges {
    fn from(val: JsEmbeddedChanges) -> Self {
        let mut __result = kreuzberg::EmbeddedChanges::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::EmbeddedChanges> for JsEmbeddedChanges {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsEmbeddedDiff> for kreuzberg::EmbeddedDiff {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::EmbeddedDiff> for JsEmbeddedDiff {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsRerankedDocument> for kreuzberg::RerankedDocument {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::RerankedDocument> for JsRerankedDocument {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsRerankerPreset> for kreuzberg::RerankerPreset {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::RerankerPreset> for JsRerankerPreset {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::enrichment::EnrichOptions> for JsEnrichOptions {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::enrichment::EnrichResult> for JsEnrichResult {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsDocumentMetadata> for kreuzberg::DocumentMetadata {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DocumentMetadata> for JsDocumentMetadata {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsUserChunkConfig> for kreuzberg::UserChunkConfig {
    fn from(val: JsUserChunkConfig) -> Self {
        let mut __result = kreuzberg::UserChunkConfig::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::UserChunkConfig> for JsUserChunkConfig {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsConfidenceSignals> for kreuzberg::ConfidenceSignals {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ConfidenceSignals> for JsConfidenceSignals {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsConfidenceWeights> for kreuzberg::ConfidenceWeights {
    fn from(val: JsConfidenceWeights) -> Self {
        let mut __result = kreuzberg::ConfidenceWeights::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ConfidenceWeights> for JsConfidenceWeights {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsExtractionConfidence> for kreuzberg::heuristics::ExtractionConfidence {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::heuristics::ExtractionConfidence> for JsExtractionConfidence {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsHeuristicsConfig> for kreuzberg::HeuristicsConfig {
    fn from(val: JsHeuristicsConfig) -> Self {
        let mut __result = kreuzberg::HeuristicsConfig::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::HeuristicsConfig> for JsHeuristicsConfig {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsChunkPlan> for kreuzberg::ChunkPlan {
    fn from(val: JsChunkPlan) -> Self {
        let mut __result = kreuzberg::ChunkPlan::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ChunkPlan> for JsChunkPlan {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsChunkInfo> for kreuzberg::ChunkInfo {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ChunkInfo> for JsChunkInfo {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPageRange> for kreuzberg::PageRange {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::PageRange> for JsPageRange {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsMultidocInput> for kreuzberg::MultidocInput {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::MultidocInput> for JsMultidocInput {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPageSignals> for kreuzberg::PageSignals {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::PageSignals> for JsPageSignals {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsDocumentBoundary> for kreuzberg::DocumentBoundary {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::DocumentBoundary> for JsDocumentBoundary {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsMultidocThresholds> for kreuzberg::MultidocThresholds {
    fn from(val: JsMultidocThresholds) -> Self {
        let mut __result = kreuzberg::MultidocThresholds::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::MultidocThresholds> for JsMultidocThresholds {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsStructuredInput> for kreuzberg::StructuredInput {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::StructuredInput> for JsStructuredInput {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsStructuredThresholds> for kreuzberg::StructuredThresholds {
    fn from(val: JsStructuredThresholds) -> Self {
        let mut __result = kreuzberg::StructuredThresholds::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::StructuredThresholds> for JsStructuredThresholds {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsResolvedPreset> for kreuzberg::ResolvedPreset {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ResolvedPreset> for JsResolvedPreset {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPresetSample> for kreuzberg::PresetSample {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::PresetSample> for JsPresetSample {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPreset> for kreuzberg::Preset {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::Preset> for JsPreset {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPresetSummary> for kreuzberg::PresetSummary {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::PresetSummary> for JsPresetSummary {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ClassificationEnrichmentConfig> for JsClassificationEnrichmentConfig {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::CaptioningEnrichmentConfig> for JsCaptioningEnrichmentConfig {
...
impl From<JsImageOutputFormat> for kreuzberg::core::config::extraction::ImageOutputFormat {
...
impl From<kreuzberg::core::config::extraction::ImageOutputFormat> for JsImageOutputFormat {
    fn from(val: kreuzberg::core::config::extraction::ImageOutputFormat) -> Self {
        match val {
            kreuzberg::core::config::extraction::ImageOutputFormat::Native => Self {
                type_tag: "native".to_string(),
                quality: None,
            },
            kreuzberg::core::config::extraction::ImageOutputFormat::Png => Self {
                type_tag: "png".to_string(),
                quality: None,
            },
            kreuzberg::core::config::extraction::ImageOutputFormat::Jpeg { quality } => Self {
                type_tag: "jpeg".to_string(),
                quality: Some(quality),
            },
            kreuzberg::core::config::extraction::ImageOutputFormat::Webp { quality } => Self {
                type_tag: "webp".to_string(),
                quality: Some(quality),
            },
            kreuzberg::core::config::extraction::ImageOutputFormat::Heif { quality } => Self {
                type_tag: "heif".to_string(),
                quality: Some(quality),
            },
            kreuzberg::core::config::extraction::ImageOutputFormat::Svg => Self {
...
impl From<JsCallMode> for kreuzberg::CallMode {
...
impl From<kreuzberg::CallMode> for JsCallMode {
...
impl From<JsMergeMode> for kreuzberg::MergeMode {
...
impl From<kreuzberg::MergeMode> for JsMergeMode {
...
impl From<JsNerBackendKind> for kreuzberg::NerBackendKind {
...
impl From<kreuzberg::NerBackendKind> for JsNerBackendKind {
...
impl From<JsVlmFallbackPolicy> for kreuzberg::VlmFallbackPolicy {
...
impl From<kreuzberg::VlmFallbackPolicy> for JsVlmFallbackPolicy {
...
impl From<JsTableChunkingMode> for kreuzberg::TableChunkingMode {
...
impl From<kreuzberg::TableChunkingMode> for JsTableChunkingMode {
...
impl From<JsRerankerModelType> for kreuzberg::RerankerModelType {
...
impl From<kreuzberg::RerankerModelType> for JsRerankerModelType {
...
impl From<JsWhisperModel> for kreuzberg::WhisperModel {
...
impl From<kreuzberg::WhisperModel> for JsWhisperModel {
...
impl From<JsEntityCategory> for kreuzberg::EntityCategory {
...
impl From<kreuzberg::EntityCategory> for JsEntityCategory {
...
impl From<JsFormFieldType> for kreuzberg::FormFieldType {
...
impl From<kreuzberg::FormFieldType> for JsFormFieldType {
...
impl From<kreuzberg::FormatMetadata> for JsFormatMetadata {
    fn from(val: kreuzberg::FormatMetadata) -> Self {
        match val {
            ...
            kreuzberg::FormatMetadata::Audio(audio) => Self {
...
impl From<JsRedactionStrategy> for kreuzberg::RedactionStrategy {
...
impl From<kreuzberg::RedactionStrategy> for JsRedactionStrategy {
...
impl From<JsPiiCategory> for kreuzberg::PiiCategory {
...
impl From<kreuzberg::PiiCategory> for JsPiiCategory {
...
impl From<JsDiffLine> for kreuzberg::DiffLine {
...
impl From<kreuzberg::DiffLine> for JsDiffLine {
    fn from(val: kreuzberg::DiffLine) -> Self {
        match val {
            kreuzberg::DiffLine::Context(context) => Self {
                kind_tag: "context".to_string(),
                added: None,
                context: Some(context),
                removed: None,
            },
            kreuzberg::DiffLine::Added(added) => Self {
                kind_tag: "added".to_string(),
                added: Some(added),
                context: None,
                removed: None,
            },
            kreuzberg::DiffLine::Removed(removed) => Self {
...
impl From<JsRevisionKind> for kreuzberg::RevisionKind {
...
impl From<kreuzberg::RevisionKind> for JsRevisionKind {
...
impl From<JsRevisionAnchor> for kreuzberg::RevisionAnchor {
...
impl From<kreuzberg::RevisionAnchor> for JsRevisionAnchor {
...
impl From<JsSummaryStrategy> for kreuzberg::SummaryStrategy {
...
impl From<kreuzberg::SummaryStrategy> for JsSummaryStrategy {
...
impl From<JsRegionKind> for kreuzberg::RegionKind {
...
impl From<kreuzberg::RegionKind> for JsRegionKind {
...
impl From<JsEnrichStatus> for kreuzberg::enrichment::EnrichStatus {
...
impl From<kreuzberg::enrichment::EnrichStatus> for JsEnrichStatus {
    fn from(val: kreuzberg::enrichment::EnrichStatus) -> Self {
        match val {
            kreuzberg::enrichment::EnrichStatus::Pending => Self {
                status_tag: "pending".to_string(),
                error: None,
                result: None,
            },
            kreuzberg::enrichment::EnrichStatus::Completed { result } => Self {
                status_tag: "completed".to_string(),
                error: None,
                result: Some((result).into()),
            },
            kreuzberg::enrichment::EnrichStatus::Failed { error } => Self {
...
impl From<JsSchemaCompliance> for kreuzberg::SchemaCompliance {
...
impl From<kreuzberg::SchemaCompliance> for JsSchemaCompliance {
...
impl From<JsChunkingDecision> for kreuzberg::ChunkingDecision {
...
impl From<kreuzberg::ChunkingDecision> for JsChunkingDecision {
    fn from(val: kreuzberg::ChunkingDecision) -> Self {
        match val {
            kreuzberg::ChunkingDecision::NoChunking { reason } => Self {
                type_tag: "nochunking".to_string(),
                reason: Some((reason).into()),
                user_chunks: None,
                chunk: None,
            },
            kreuzberg::ChunkingDecision::Chunk(chunk) => Self {
                type_tag: "chunk".to_string(),
                reason: None,
                user_chunks: None,
                chunk: Some(chunk.into()),
            },
            kreuzberg::ChunkingDecision::UseOverrides { user_chunks } => Self {
...
impl From<JsNoChunkingReason> for kreuzberg::NoChunkingReason {
...
impl From<kreuzberg::NoChunkingReason> for JsNoChunkingReason {
    fn from(val: kreuzberg::NoChunkingReason) -> Self {
        match val {
            ...
            kreuzberg::NoChunkingReason::FewPages { page_count, threshold } => Self {
            ...
            kreuzberg::NoChunkingReason::FormatNotChunkable { mime_type } => Self {
            ...
            kreuzberg::NoChunkingReason::ChunkingDisabled => Self {
            ...
            kreuzberg::NoChunkingReason::FastTextExtraction => Self {
...
impl From<JsChunkingReason> for kreuzberg::ChunkingReason {
...
impl From<kreuzberg::ChunkingReason> for JsChunkingReason {
    fn from(val: kreuzberg::ChunkingReason) -> Self {
        match val {
            ...
            kreuzberg::ChunkingReason::ManyPages { page_count, threshold } => Self {
            ...
            kreuzberg::ChunkingReason::OcrRequired { page_count, force_ocr } => Self {
            ...
            kreuzberg::ChunkingReason::LargeAndManyPages { size_bytes, page_count } => Self {
...
impl From<JsBoundaryReason> for kreuzberg::BoundaryReason {
...
impl From<kreuzberg::BoundaryReason> for JsBoundaryReason {
...
impl From<JsStructuredCallMode> for kreuzberg::StructuredCallMode {
...
impl From<kreuzberg::StructuredCallMode> for JsStructuredCallMode {
...
impl From<JsPresetCategory> for kreuzberg::PresetCategory {
...
impl From<kreuzberg::PresetCategory> for JsPresetCategory {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsEnrichResult> for kreuzberg::enrichment::EnrichResult {
    fn from(val: JsEnrichResult) -> Self {
        let mut __result = kreuzberg::enrichment::EnrichResult::default();
        if let Some(__v) = val.keywords {
            __result.keywords = __v.into_iter().collect();
        }
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsCacheStats> for kreuzberg::CacheStats {
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsEnrichOptions> for kreuzberg::enrichment::EnrichOptions {
    fn from(val: JsEnrichOptions) -> Self {
        let mut __result = kreuzberg::enrichment::EnrichOptions::default();
        if let Some(__v) = val.keywords {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsClassificationEnrichmentConfig> for kreuzberg::ClassificationEnrichmentConfig {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsCaptioningEnrichmentConfig> for kreuzberg::CaptioningEnrichmentConfig {
...
pub const KREUZBERG_ERROR_ERROR_RERANKING: &str = "Reranking";
pub const KREUZBERG_ERROR_ERROR_TRANSCRIPTION: &str = "Transcription";
...
/// Convert a `kreuzberg::heuristics::error::HeuristicsError` error to a NAPI error.
#[allow(dead_code)]
fn heuristics_error_to_napi_err(e: kreuzberg::heuristics::error::HeuristicsError) -> napi::Error {
    let msg = e.to_string();
    #[allow(unreachable_patterns)]
    match &e {
        kreuzberg::heuristics::error::HeuristicsError::ConfigError(..) => {
            napi::Error::new(napi::Status::GenericFailure, format!("[ConfigError] {}", msg))
        }
        kreuzberg::heuristics::error::HeuristicsError::PdfAnalysisError(..) => {
...
/// Convert a `kreuzberg::presets::loader::LoadError` error to a NAPI error.
#[allow(dead_code)]
fn load_error_to_napi_err(e: kreuzberg::presets::loader::LoadError) -> napi::Error {
    let msg = e.to_string();
    #[allow(unreachable_patterns)]
    match &e {
        kreuzberg::presets::loader::LoadError::Parse { .. } => {
            napi::Error::new(napi::Status::GenericFailure, format!("[Parse] {}", msg))
        }
        kreuzberg::presets::loader::LoadError::SchemaValidation { .. } => {
            napi::Error::new(napi::Status::GenericFailure, format!("[SchemaValidation] {}", msg))
        }
        kreuzberg::presets::loader::LoadError::Deserialize { .. } => {
            napi::Error::new(napi::Status::GenericFailure, format!("[Deserialize] {}", msg))
        }
        kreuzberg::presets::loader::LoadError::IdMismatch { .. } => {
            napi::Error::new(napi::Status::GenericFailure, format!("[IdMismatch] {}", msg))
        }
        kreuzberg::presets::loader::LoadError::BadMetaSchema(..) => {
            napi::Error::new(napi::Status::GenericFailure, format!("[BadMetaSchema] {}", msg))
        }
        kreuzberg::presets::loader::LoadError::Io(..) => {
            napi::Error::new(napi::Status::GenericFailure, format!("[Io] {}", msg))
        }
        _ => napi::Error::new(napi::Status::GenericFailure, msg),
    }
...
/// Convert a `kreuzberg::presets::resolve::ResolveError` error to a NAPI error.
#[allow(dead_code)]
fn resolve_error_to_napi_err(e: kreuzberg::presets::resolve::ResolveError) -> napi::Error {
    let msg = e.to_string();
    #[allow(unreachable_patterns)]
    match &e {
        kreuzberg::presets::resolve::ResolveError::SchemaNotObject => {
