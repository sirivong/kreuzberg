 ...
 */
export declare function applyStrategy(strategy: RedactionStrategy, original: string, category: PiiCategory, counter?: TokenCounter | undefined | null): string;
