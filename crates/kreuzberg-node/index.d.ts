...
// alef:hash:ecc3739a81b59b983fbb132c0c9b126b1c7f755aa635347666de13e883ce50cd
 ...
 * ```typescript
 */
export declare function extractFile(path: string, config: JsExtractionConfig, mimeType?: string | undefined | null): Promise<JsExtractionResult>;
 ...
 * ```typescript
 */
export declare function extractFileSync(path: string, config: JsExtractionConfig, mimeType?: string | undefined | null): JsExtractionResult;
 ...
 */
export declare function getEmbeddingPreset(name: string): JsEmbeddingPreset | undefined | null;
 ...
 * ```typescript
 */
export interface JsDocumentExtractor {
  /**
   * Extract content from a byte array.
   *
 ...
 * `block_in_place`.
 */
export interface JsEmbeddingBackend {
  /**
...
export declare enum JsExtractionMethod {
  Native = "native",
  Ocr = "ocr",
  Mixed = "mixed",
}
...
export declare enum JsImageKind {
 ...
 * ```typescript
 */
export interface JsPostProcessor {
  /**
 ...
 */
export declare enum JsResultFormat {
 ...
 * ```typescript
 */
export interface JsSyncExtractor {
  /**
 ...
 * @throws Returns an error if the PDF is invalid, the page index is out of bounds,
