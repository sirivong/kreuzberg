...
export interface DocumentExtractor {
   ...
   */
  extract_bytes(content: Uint8Array, mimeType: string, config?: ExtractionConfig | undefined | null): Promise<string>
  /**
   * Extract content from a file.
   *
   ...
   */
  extract_file?(path: string, mimeType: string, config?: ExtractionConfig | undefined | null): Promise<string>
  /**
   ...
   */
  can_handle?(path: string, mimeType: string): string
}
...
export interface OcrBackend {
   ...
   * ```
   */
  process_image(imageBytes: Uint8Array, config?: OcrConfig | undefined | null): Promise<string>
  /**
   ...
   */
  process_image_file?(path: string, config?: OcrConfig | undefined | null): Promise<string>
  /**
   ...
   */
  supports_language(lang: string): string
  /**
   ...
   */
  supports_table_detection?(): string
  /**
   * Check if the backend supports direct document-level processing (e.g. for PDFs).
   *
   * Defaults to `false`. Override if the backend has optimized document processing.
   */
  supports_document_processing?(): string
  /**
   ...
   * @param config - OCR configuration
   */
  process_document?(path: string, config?: OcrConfig | undefined | null): Promise<string>
}
...
export interface PostProcessor {
   ...
   */
  should_process?(result?: ExtractionResult | undefined | null, config?: ExtractionConfig | undefined | null): string
  /**
   ...
   */
  estimated_duration_ms?(result?: ExtractionResult | undefined | null): string
  /**
...
export interface Validator {
   ...
   */
  should_validate?(result?: ExtractionResult | undefined | null, config?: ExtractionConfig | undefined | null): string
  /**
