...
impl From<xberg::LateInteractionModelType> for WasmLateInteractionModelType {
    fn from(val: xberg::LateInteractionModelType) -> Self {
        match val {
            ...
            _ => ::std::todo!("unmapped LateInteractionModelType variant"),
        }
    }
}
...
impl From<WasmRerankerHead> for xberg::core::config::reranker::RerankerHead {
...
impl From<xberg::core::config::reranker::RerankerHead> for WasmRerankerHead {
    fn from(val: xberg::core::config::reranker::RerankerHead) -> Self {
        match val {
            xberg::core::config::reranker::RerankerHead::CrossEncoder => Self::CrossEncoder,
            xberg::core::config::reranker::RerankerHead::Qwen3Generative => Self::Qwen3Generative,
        }
    }
}
...
impl From<xberg::SparseEmbeddingModelType> for WasmSparseEmbeddingModelType {
    fn from(val: xberg::SparseEmbeddingModelType) -> Self {
        match val {
            ...
            _ => ::std::todo!("unmapped SparseEmbeddingModelType variant"),
        }
    }
}
