...
//! `(query, document)` pairs and returns raw logits; kreuzberg handles sorting
...
//!
//! ```rust,no_run
//! use kreuzberg::plugins::{RerankerBackend, Plugin, register_reranker_backend};
...
/// # Errors
///
/// - [`crate::KreuzbergError::Validation`] if the name is empty or contains whitespace.
