...
```python
def extract_sync(input: ExtractInput, config: ExtractionConfig) -> ExtractionOutput
```

**Example:**

```python
result = extract_sync(ExtractInput(), ExtractionConfig())
```
...
```python
def extract_batch_sync(inputs: list[ExtractInput], config: ExtractionConfig) -> ExtractionOutput
```

**Example:**

```python
result = extract_batch_sync([], ExtractionConfig())
```
