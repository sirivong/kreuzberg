...
- `model_tier` (str | None): <span class="version-badge">v4.5.0</span> PaddleOCR model tier: "server" (high accuracy, ~88MB det model) or "mobile" (lightweight, ~4.5MB det model). Default: "server"
