...
## Dart API Reference <span class="version-badge">v5.0.0-rc.3</span>
...
| `entryTypes` | `Map<String, int>?` | `{}` | Entry types |
...
| `semanticThreshold` | `double` | `0.3` | Semantic threshold |
...
| `targetReduction` | `double?` | `null` | Target reduction |
