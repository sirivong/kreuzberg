...
## Zig API Reference <span class="version-badge">v5.0.0-rc.3</span>
...
| `availableSpaceMb` | `f64` | — | Available space mb |
| `oldestFileAgeDays` | `f64` | — | Oldest file age days |
| `newestFileAgeDays` | `f64` | — | Newest file age days |
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `rowCount` | `u32` | — | Number of rows |
| `columnCount` | `u32` | — | Number of columns |
...
| `tables` | `[]const Table` | `[]` | Tables extracted from the document |
...
| `tableRows` | `u32?` | `null` | Table rows |
| `tableCols` | `u32?` | `null` | Table cols |
...
| `min` | `u32?` | `null` | Min |
| `max` | `u32?` | `null` | Max |
| `years` | `[]const u32` | `/* serde(default) */` | Years |
...
| `Phone` | Phone |
| `Url` | Url |
| `Custom` | Custom — Fields: `0`: `[:0]const u8` |
