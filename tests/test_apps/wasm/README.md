...
cd test_apps/wasm
pnpm install
# WASM binaries are linked from kreuzberg/crates/kreuzberg-wasm/dist/pkg/
```
...
Note: The published npm package requires proper distribution of WASM binaries in the package tarball.
