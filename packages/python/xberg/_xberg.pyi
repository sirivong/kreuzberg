...
class PostProcessor(Protocol):
    ...
    def should_process(self, _result: ExtractedDocument, _config: ExtractionConfig) -> bool: ...
    def estimated_duration_ms(self, _result: ExtractedDocument) -> int: ...
    def priority(self) -> int: ...

class Validator(Protocol):
    def validate(self, result: ExtractedDocument, config: ExtractionConfig) -> None: ...
    def should_validate(self, _result: ExtractedDocument, _config: ExtractionConfig) -> bool: ...
    def priority(self) -> int: ...
