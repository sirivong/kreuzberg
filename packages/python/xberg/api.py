...
from ._xberg import ChunkingDecision, ChunkingResult, Citation, ClassificationLabel, ConfidenceSignals, DocumentBoundary, DocumentExtractor, DocumentMetadata, EmbeddingBackend, EmbeddingPreset, ExtractionConfidence, ExtractionDiff, ExtractionResult, FootnoteAnchor, FootnoteDefinition, Keyword, MultidocInput, OcrBackend, PageClassificationConfig, PageRange, PatternMatch, PiiCategory, PostProcessor, Preset, QrCode, RegionKind, Renderer, RerankedDocument, RerankerBackend, RerankerPreset, ResolvedPreset, StructuredCallMode, StructuredInput, SupportedFormat, TranslationConfig, Validator
...
def extract_sync(
    ...
    return _rust.extract_sync(input=_rust_input, config=_rust_config)
...
def extract_batch_sync(
    ...
    _rust_config = _to_rust_extraction_config(config) if config is not None else _rust.ExtractionConfig()
    return _rust.extract_batch_sync(inputs=_rust_inputs, config=_rust_config)
