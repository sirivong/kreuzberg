...
if TYPE_CHECKING:
    from ._xberg import (
        ...
        Chunk,  # noqa: F401
        ChunkClassificationConfig,  # noqa: F401
...
class OcrQualityThresholds:
    ...
    min_undecodable_ratio: float = 0.0
    ...
    min_provenance_fallback_ratio: float = 0.0
...
def _from_native_file_extraction_config(native: Any) -> FileExtractionConfig:
    ...
    return FileExtractionConfig(
        ...
        chunk_classification=native.chunk_classification,
