...
# alef:hash:ee4f95d193b6d861f7becbd49bb374763656320217183793809c09c71bc92cf9
...
def clear_ocr_backends() -> None:
    """Clear all registered clear_ocr_backends backends."""
    return _rust.clear_ocr_backends()
def clear_post_processors() -> None:
    """Clear all registered clear_post_processors backends."""
    return _rust.clear_post_processors()
def clear_validators() -> None:
    """Clear all registered clear_validators backends."""
    return _rust.clear_validators()
def clear_embedding_backends() -> None:
    """Clear all registered clear_embedding_backends backends."""
    return _rust.clear_embedding_backends()
def clear_document_extractors() -> None:
    """Clear all registered clear_document_extractors backends."""
    return _rust.clear_document_extractors()
def clear_renderers() -> None:
    """Clear all registered clear_renderers backends."""
