...
# alef:hash:5c1b8e4e372af6b759b5cf5a018e5d582356af096c9edb665a7f57d78681d3e6
...
from typing import TYPE_CHECKING, Any, TypedDict  # noqa: F401
...
ChunkerType.TEXT = ChunkerType.Text
ChunkerType.MARKDOWN = ChunkerType.Markdown
ChunkerType.YAML = ChunkerType.Yaml
ChunkerType.SEMANTIC = ChunkerType.Semantic

CodeContentMode.CHUNKS = CodeContentMode.Chunks
CodeContentMode.RAW = CodeContentMode.Raw
CodeContentMode.STRUCTURE = CodeContentMode.Structure

ExecutionProviderType.AUTO = ExecutionProviderType.Auto
ExecutionProviderType.CPU = ExecutionProviderType.Cpu
ExecutionProviderType.CORE_ML = ExecutionProviderType.CoreMl
ExecutionProviderType.CUDA = ExecutionProviderType.Cuda
ExecutionProviderType.TENSOR_RT = ExecutionProviderType.TensorRt

ExtractionMethod.NATIVE = ExtractionMethod.Native
ExtractionMethod.OCR = ExtractionMethod.Ocr
ExtractionMethod.MIXED = ExtractionMethod.Mixed

HtmlTheme.DEFAULT = HtmlTheme.Default
HtmlTheme.GIT_HUB = HtmlTheme.GitHub
HtmlTheme.DARK = HtmlTheme.Dark
HtmlTheme.LIGHT = HtmlTheme.Light
HtmlTheme.UNSTYLED = HtmlTheme.Unstyled

KeywordAlgorithm.YAKE = KeywordAlgorithm.Yake
KeywordAlgorithm.RAKE = KeywordAlgorithm.Rake

OcrElementLevel.WORD = OcrElementLevel.Word
OcrElementLevel.LINE = OcrElementLevel.Line
OcrElementLevel.BLOCK = OcrElementLevel.Block
OcrElementLevel.PAGE = OcrElementLevel.Page

PdfBackend.PDFIUM = PdfBackend.Pdfium
PdfBackend.PDF_OXIDE = PdfBackend.PdfOxide
PdfBackend.AUTO = PdfBackend.Auto

ReductionLevel.OFF = ReductionLevel.Off
ReductionLevel.LIGHT = ReductionLevel.Light
ReductionLevel.MODERATE = ReductionLevel.Moderate
ReductionLevel.AGGRESSIVE = ReductionLevel.Aggressive
ReductionLevel.MAXIMUM = ReductionLevel.Maximum

ResultFormat.UNIFIED = ResultFormat.Unified
ResultFormat.ELEMENT_BASED = ResultFormat.ElementBased

TableModel.TATR = TableModel.Tatr
TableModel.SLANET_WIRED = TableModel.SlanetWired
TableModel.SLANET_WIRELESS = TableModel.SlanetWireless
TableModel.SLANET_PLUS = TableModel.SlanetPlus
TableModel.SLANET_AUTO = TableModel.SlanetAuto
TableModel.DISABLED = TableModel.Disabled
