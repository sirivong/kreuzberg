...
class OcrBackend(Protocol):
    async def process_image(self, image_bytes: bytes, config: OcrConfig) -> ExtractionResult: ...
    async def process_image_file(self, path: str, config: OcrConfig) -> ExtractionResult: ...
    ...
    async def process_document(self, _path: str, _config: OcrConfig) -> ExtractionResult: ...

class PostProcessor(Protocol):
    async def process(self, result: ExtractionResult, config: ExtractionConfig) -> None: ...
...
class Validator(Protocol):
    async def validate(self, result: ExtractionResult, config: ExtractionConfig) -> None: ...
...
class DocumentExtractor(Protocol):
    async def extract_bytes(self, content: bytes, mime_type: str, config: ExtractionConfig) -> InternalDocument: ...
    async def extract_file(self, path: str, mime_type: str, config: ExtractionConfig) -> InternalDocument: ...
    def supported_mime_types(self) -> list[str]: ...
    def priority(self) -> int: ...
    def can_handle(self, _path: str, _mime_type: str) -> bool: ...
