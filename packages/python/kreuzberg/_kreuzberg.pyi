...
# alef:hash:24773f8297e5a3f89bf64fecbc36552fffcd29c27972db48e5ac291e35318e75
...
class LayoutDetection:
    ...
    confidence: float
    bbox: BBox
    def __init__(self, class_name: str, confidence: float, bbox: BBox) -> None: ...
...
class TransformListType:
    BULLET: TransformListType = ...
    NUMBERED: TransformListType = ...
    LETTERED: TransformListType = ...
    INDENTED: TransformListType = ...
    def __init__(self, value: int | str) -> None: ...
...
class NodeContent2TitleVariant(TypedDict):
    node_type: Literal["title"]
    text: str

class NodeContent2HeadingVariant(TypedDict):
    node_type: Literal["heading"]
    level: int
    text: str

class NodeContent2ParagraphVariant(TypedDict):
    node_type: Literal["paragraph"]
    text: str

class NodeContent2ListVariant(TypedDict):
    node_type: Literal["list"]
    ordered: bool

class NodeContent2ListItemVariant(TypedDict):
    node_type: Literal["list_item"]
    text: str

class NodeContent2TableVariant(TypedDict):
    node_type: Literal["table"]
    grid: TableGrid

class NodeContent2ImageVariant(TypedDict):
    node_type: Literal["image"]
    description: str | None
    image_index: int | None
    src: str | None

class NodeContent2CodeVariant(TypedDict):
    node_type: Literal["code"]
    text: str
    language: str | None

class NodeContent2QuoteVariant(TypedDict):
    node_type: Literal["quote"]

class NodeContent2FormulaVariant(TypedDict):
    node_type: Literal["formula"]
    text: str

class NodeContent2FootnoteVariant(TypedDict):
    node_type: Literal["footnote"]
    text: str

class NodeContent2GroupVariant(TypedDict):
    node_type: Literal["group"]
    label: str | None
    heading_level: int | None
    heading_text: str | None

class NodeContent2PageBreakVariant(TypedDict):
    node_type: Literal["page_break"]

class NodeContent2SlideVariant(TypedDict):
    node_type: Literal["slide"]
    number: int
    title: str | None

class NodeContent2DefinitionListVariant(TypedDict):
    node_type: Literal["definition_list"]

class NodeContent2DefinitionItemVariant(TypedDict):
    node_type: Literal["definition_item"]
    term: str
    definition: str

class NodeContent2CitationVariant(TypedDict):
    node_type: Literal["citation"]
    key: str
    text: str

class NodeContent2AdmonitionVariant(TypedDict):
    node_type: Literal["admonition"]
    kind: str
    title: str | None

class NodeContent2RawBlockVariant(TypedDict):
    node_type: Literal["raw_block"]
    format: str
    content: str

class NodeContent2MetadataBlockVariant(TypedDict):
...
class ExtractionMethod2:
    NATIVE: ExtractionMethod2 = ...
    OCR: ExtractionMethod2 = ...
    MIXED: ExtractionMethod2 = ...
    def __init__(self, value: int | str) -> None: ...
...
class FormatMetadata2PdfVariant(TypedDict):
    format_type: Literal["pdf"]
    _0: str

class FormatMetadata2DocxVariant(TypedDict):
    format_type: Literal["docx"]
    _0: DocxMetadata

class FormatMetadata2ExcelVariant(TypedDict):
    format_type: Literal["excel"]
    _0: ExcelMetadata

class FormatMetadata2EmailVariant(TypedDict):
    format_type: Literal["email"]
    _0: EmailMetadata

class FormatMetadata2PptxVariant(TypedDict):
    format_type: Literal["pptx"]
    _0: PptxMetadata

class FormatMetadata2ArchiveVariant(TypedDict):
    format_type: Literal["archive"]
    _0: ArchiveMetadata

class FormatMetadata2ImageVariant(TypedDict):
    format_type: Literal["image"]
    _0: ImageMetadata

class FormatMetadata2XmlVariant(TypedDict):
    format_type: Literal["xml"]
    _0: XmlMetadata

class FormatMetadata2TextVariant(TypedDict):
    format_type: Literal["text"]
    _0: TextMetadata

class FormatMetadata2HtmlVariant(TypedDict):
    format_type: Literal["html"]
    _0: HtmlMetadata

class FormatMetadata2OcrVariant(TypedDict):
    format_type: Literal["ocr"]
    _0: OcrMetadata

class FormatMetadata2CsvVariant(TypedDict):
    format_type: Literal["csv"]
    _0: CsvMetadata

class FormatMetadata2BibtexVariant(TypedDict):
    format_type: Literal["bibtex"]
    _0: BibtexMetadata

class FormatMetadata2CitationVariant(TypedDict):
    format_type: Literal["citation"]
    _0: CitationMetadata

class FormatMetadata2FictionBookVariant(TypedDict):
    format_type: Literal["fiction_book"]
    _0: FictionBookMetadata

class FormatMetadata2DbfVariant(TypedDict):
    format_type: Literal["dbf"]
    _0: DbfMetadata

class FormatMetadata2JatsVariant(TypedDict):
    format_type: Literal["jats"]
    _0: JatsMetadata

class FormatMetadata2EpubVariant(TypedDict):
    format_type: Literal["epub"]
    _0: EpubMetadata

class FormatMetadata2PstVariant(TypedDict):
    format_type: Literal["pst"]
    _0: PstMetadata

class FormatMetadata2CodeVariant(TypedDict):
    format_type: Literal["code"]
    _0: str

class FormatMetadata2:
    format_type: str
    def __str__(self) -> str: ...  # noqa: PYI029
    def __repr__(self) -> str: ...  # noqa: PYI029
...
class PaddleLanguage2:
    ENGLISH: PaddleLanguage2 = ...
    CHINESE: PaddleLanguage2 = ...
    JAPANESE: PaddleLanguage2 = ...
    KOREAN: PaddleLanguage2 = ...
    GERMAN: PaddleLanguage2 = ...
    FRENCH: PaddleLanguage2 = ...
    LATIN: PaddleLanguage2 = ...
    CYRILLIC: PaddleLanguage2 = ...
    TRADITIONAL_CHINESE: PaddleLanguage2 = ...
    THAI: PaddleLanguage2 = ...
    GREEK: PaddleLanguage2 = ...
    EAST_SLAVIC: PaddleLanguage2 = ...
    ARABIC: PaddleLanguage2 = ...
    DEVANAGARI: PaddleLanguage2 = ...
    TAMIL: PaddleLanguage2 = ...
    TELUGU: PaddleLanguage2 = ...
    def __init__(self, value: int | str) -> None: ...

class LayoutClass2:
    CAPTION: LayoutClass2 = ...
    FOOTNOTE: LayoutClass2 = ...
    FORMULA: LayoutClass2 = ...
    LIST_ITEM: LayoutClass2 = ...
    PAGE_FOOTER: LayoutClass2 = ...
    PAGE_HEADER: LayoutClass2 = ...
    PICTURE: LayoutClass2 = ...
    SECTION_HEADER: LayoutClass2 = ...
    TABLE: LayoutClass2 = ...
    TEXT: LayoutClass2 = ...
    TITLE: LayoutClass2 = ...
    DOCUMENT_INDEX: LayoutClass2 = ...
    CODE: LayoutClass2 = ...
    CHECKBOX_SELECTED: LayoutClass2 = ...
    CHECKBOX_UNSELECTED: LayoutClass2 = ...
    FORM: LayoutClass2 = ...
    KEY_VALUE_REGION: LayoutClass2 = ...
    def __init__(self, value: int | str) -> None: ...
...
def get_embedding_preset(name: str) -> str | None: ...
