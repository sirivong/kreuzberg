...
class GlineBackend:
    ...
    model_path: str
    tokenizer_path: str
    def __init__(self, repo_id: str, model_path: str, tokenizer_path: str) -> None: ...
    ...
    @staticmethod
    def new(repo_id: str | None = None) -> GlineBackend: ...
...
class Segment:
    text: str
    byte_start: int
    def __init__(self, text: str, byte_start: int) -> None: ...
