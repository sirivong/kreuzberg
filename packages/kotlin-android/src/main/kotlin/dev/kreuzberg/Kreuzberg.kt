...
object Kreuzberg {
    ...
    fun findFootnoteAnchors(markdown: String): List<FootnoteAnchor> {
        val resultJson = KreuzbergBridge.nativeFindFootnoteAnchors(markdown)
    ...
    fun parseFootnoteDefinitions(markdown: String): List<FootnoteDefinition> {
        val resultJson = KreuzbergBridge.nativeParseFootnoteDefinitions(markdown)
    ...
    fun findInferenceMarkers(markdown: String): List<Long> {
        val resultJson = KreuzbergBridge.nativeFindInferenceMarkers(markdown)
    ...
    fun findUnmarkedClaims(markdown: String): List<String> {
        val resultJson = KreuzbergBridge.nativeFindUnmarkedClaims(markdown)
        return mapper.readValue(resultJson, object : TypeReference<List<String>>() {})
    }
    /**
     * Find unmarked claims in markdown text.
    ...
    fun parseCitations(markdown: String): List<Citation> {
        val resultJson = KreuzbergBridge.nativeParseCitations(markdown)
     ...
     */
    fun verifyExcerpt(excerpt: String, sourceText: String): Boolean = KreuzbergBridge.nativeVerifyExcerpt(excerpt, sourceText)
    /**
     ...
     */
    fun pdfPageCount(pdfBytes: ByteArray, password: String? = null): Long = KreuzbergBridge.nativePdfPageCount(java.util.Base64.getEncoder().encodeToString(pdfBytes), password ?: "")
    /**
