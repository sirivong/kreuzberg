...
object KreuzbergBridge {
    ...
    @Throws(KreuzbergBridgeException::class)
    external fun nativeDecodeAudioToPcm(bytes: String, maxBytes: Long): String

    @Throws(KreuzbergBridgeException::class)
    external fun nativeEnsureWhisperModel(model: String, cacheDir: String, allowNetwork: Boolean, verifyHash: Boolean): String

    @Throws(KreuzbergBridgeException::class)
    external fun nativeReadAudioTags(bytes: String): String
