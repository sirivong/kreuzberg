...
typedef struct ExtractedImageMetadata ExtractedImageMetadata;
void __swift_bridge__$ExtractedImageMetadata$_free(void* self);

void* __swift_bridge__$Vec_ExtractedImageMetadata$new(void);
void __swift_bridge__$Vec_ExtractedImageMetadata$drop(void* vec_ptr);
void __swift_bridge__$Vec_ExtractedImageMetadata$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_ExtractedImageMetadata$pop(void* vec_ptr);
void* __swift_bridge__$Vec_ExtractedImageMetadata$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_ExtractedImageMetadata$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_ExtractedImageMetadata$len(void* vec_ptr);
void* __swift_bridge__$Vec_ExtractedImageMetadata$as_ptr(void* vec_ptr);
...
void* __swift_bridge__$ImageExtractionConfig$new(bool extract_images, int32_t target_dpi, int32_t max_image_dimension, bool inject_placeholders, bool auto_adjust_dpi, int32_t min_dpi, int32_t max_dpi, struct __private__OptionU32 max_images_per_page, bool classify, bool include_page_rasters);
...
uint32_t __swift_bridge__$ExtractedImageMetadata$width(void* self);
uint32_t __swift_bridge__$ExtractedImageMetadata$height(void* self);
void* __swift_bridge__$ExtractedImageMetadata$format(void* self);
void* __swift_bridge__$ExtractedImageMetadata$exif_data(void* self);
...
void* __swift_bridge__$ExcelMetadata$new(struct __private__OptionU32 sheet_count, void* sheet_names);
...
void* __swift_bridge__$TextMetadata$new(uint32_t line_count, uint32_t word_count, uint32_t character_count, void* headers, void* links, void* code_blocks);
...
void* __swift_bridge__$CsvMetadata$new(uint32_t row_count, uint32_t column_count, void* delimiter, bool has_header, void* column_types);
...
void* __swift_bridge__$OcrElement$new(void* text, void* geometry, void* confidence, void* level, void* rotation, uint32_t page_number, void* parent_id, void* backend_metadata);
...
void* __swift_bridge__$Table$new(void* cells, void* markdown, uint32_t page_number, void* bounding_box);
...
void* __swift_bridge__$PdfMetadata$new(void* pdf_version, void* producer, struct __private__OptionBool is_encrypted, struct __private__OptionI64 width, struct __private__OptionI64 height, struct __private__OptionU32 page_count);
...
void* __swift_bridge__$FracType$to_string(void* self);
...
struct __private__ResultPtrAndPtr __swift_bridge__$uri_from_json(void* json);
struct __private__ResultPtrAndPtr __swift_bridge__$detect_response_from_json(void* json);
struct __private__ResultPtrAndPtr __swift_bridge__$embedding_preset_from_json(void* json);
