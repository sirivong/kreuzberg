...
public func batchExtractFilesSync(_ items: RustVec<BatchFileItem>, _ config: ExtractionConfig)
  throws -> RustVec<ExtractionResult>
{
  try {
    let val = __swift_bridge__$batch_extract_files_sync(
      {
        let val = items
        val.isOwned = false
        return val.ptr
...
public func batchExtractBytesSync(_ items: RustVec<BatchBytesItem>, _ config: ExtractionConfig)
  throws -> RustVec<ExtractionResult>
{
  try {
...
public func batchExtractFiles(_ items: RustVec<BatchFileItem>, _ config: ExtractionConfig) throws
  -> RustVec<ExtractionResult>
{
  try {
    let val = __swift_bridge__$batch_extract_files(
      {
        let val = items
        val.isOwned = false
        return val.ptr
...
public func batchExtractBytes(_ items: RustVec<BatchBytesItem>, _ config: ExtractionConfig) throws
  -> RustVec<ExtractionResult>
{
  try {
...
public func listEmbeddingBackends() throws -> RustVec<RustString> {
  try {
    let val = __swift_bridge__$list_embedding_backends()
    if val.is_ok {
      return RustVec(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
...
public func listDocumentExtractors() throws -> RustVec<RustString> {
  try {
    let val = __swift_bridge__$list_document_extractors()
    if val.is_ok {
      return RustVec(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
...
public func embedTextsAsync<GenericIntoRustString: IntoRustString>(
  _ texts: RustVec<GenericIntoRustString>, _ config: EmbeddingConfig
) throws -> RustString {
  try {
    let val = __swift_bridge__$embed_texts_async(
      {
        let val = texts
        val.isOwned = false
        return val.ptr
...
public func detectMimeType<GenericIntoRustString: IntoRustString>(
  _ path: GenericIntoRustString, _ check_exists: Bool
) throws -> RustString {
  try {
    let val = __swift_bridge__$detect_mime_type(
      {
        let rustString = path.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func embedTexts<GenericIntoRustString: IntoRustString>(
  _ texts: RustVec<GenericIntoRustString>, _ config: EmbeddingConfig
) throws -> RustString {
  try {
    let val = __swift_bridge__$embed_texts(
      {
        let val = texts
        val.isOwned = false
        return val.ptr
...
public func ocr_backend_call_process_image(
  ...
  RustString(
    ptr: __swift_bridge__$ocr_backend_call_process_image(
      this.ptr,
      {
        let val = image_bytes
        val.isOwned = false
...
public func post_processor_call_process(
  ...
  RustString(
    ptr: __swift_bridge__$post_processor_call_process(
      this.ptr,
      {
...
public func validator_call_validate(
  ...
  RustString(
    ptr: __swift_bridge__$validator_call_validate(
      this.ptr,
      {
        result.isOwned = false
        return result.ptr
...
public func embedding_backend_call_embed<GenericIntoRustString: IntoRustString>(
  ...
  RustString(
    ptr: __swift_bridge__$embedding_backend_call_embed(
      this.ptr,
      {
        let val = texts
        val.isOwned = false
...
public func document_extractor_call_extract_bytes<GenericIntoRustString: IntoRustString>(
  _ this: DocumentExtractorBoxRef, _ content: RustVec<UInt8>, _ mime_type: GenericIntoRustString,
  _ config: ExtractionConfig
) -> RustString {
  RustString(
    ptr: __swift_bridge__$document_extractor_call_extract_bytes(
      this.ptr,
      {
        let val = content
        val.isOwned = false
...
public func document_extractor_call_supported_mime_types(_ this: DocumentExtractorBoxRef)
  -> RustVec<RustString>
{
...
public func renderer_call_render<GenericIntoRustString: IntoRustString>(
  _ this: RendererBoxRef, _ doc: GenericIntoRustString
) -> RustString {
  RustString(
    ptr: __swift_bridge__$renderer_call_render(
      this.ptr,
      {
        let rustString = doc.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
      }()))
}
public func registerOcrBackend(_ swift_box: SwiftOcrBackendBox) throws {
  try {
    let val = __swift_bridge__$register_ocr_backend(Unmanaged.passRetained(swift_box).toOpaque())
...
public func registerPostProcessor(_ swift_box: SwiftPostProcessorBox) throws {
  try {
    let val = __swift_bridge__$register_post_processor(Unmanaged.passRetained(swift_box).toOpaque())
    if val != nil { throw RustString(ptr: val!) } else { return }
  }()
}
public func unregisterPostProcessor<GenericIntoRustString: IntoRustString>(
  _ name: GenericIntoRustString
) throws {
  try {
    let val = __swift_bridge__$unregister_post_processor(
      {
        let rustString = name.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func clearPostProcessors() throws {
  try {
    let val = __swift_bridge__$clear_post_processors()
    if val != nil { throw RustString(ptr: val!) } else { return }
  }()
}
public func registerValidator(_ swift_box: SwiftValidatorBox) throws {
  try {
    let val = __swift_bridge__$register_validator(Unmanaged.passRetained(swift_box).toOpaque())
    if val != nil { throw RustString(ptr: val!) } else { return }
  }()
}
public func unregisterValidator<GenericIntoRustString: IntoRustString>(
  _ name: GenericIntoRustString
) throws {
  try {
    let val = __swift_bridge__$unregister_validator(
      {
        let rustString = name.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func registerEmbeddingBackend(_ swift_box: SwiftEmbeddingBackendBox) throws {
  try {
    let val = __swift_bridge__$register_embedding_backend(
      Unmanaged.passRetained(swift_box).toOpaque())
    if val != nil { throw RustString(ptr: val!) } else { return }
  }()
}
public func unregisterEmbeddingBackend<GenericIntoRustString: IntoRustString>(
  _ name: GenericIntoRustString
) throws {
  try {
    let val = __swift_bridge__$unregister_embedding_backend(
      {
        let rustString = name.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func clearEmbeddingBackends() throws {
  try {
    let val = __swift_bridge__$clear_embedding_backends()
    if val != nil { throw RustString(ptr: val!) } else { return }
  }()
}
public func registerDocumentExtractor(_ swift_box: SwiftDocumentExtractorBox) throws {
  try {
    let val = __swift_bridge__$register_document_extractor(
      Unmanaged.passRetained(swift_box).toOpaque())
    if val != nil { throw RustString(ptr: val!) } else { return }
  }()
}
public func unregisterDocumentExtractor<GenericIntoRustString: IntoRustString>(
  _ name: GenericIntoRustString
) throws {
  try {
    let val = __swift_bridge__$unregister_document_extractor(
      {
        let rustString = name.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func clearDocumentExtractors() throws {
  try {
    let val = __swift_bridge__$clear_document_extractors()
    if val != nil { throw RustString(ptr: val!) } else { return }
  }()
}
public func registerRenderer(_ swift_box: SwiftRendererBox) throws {
  try {
    let val = __swift_bridge__$register_renderer(Unmanaged.passRetained(swift_box).toOpaque())
    if val != nil { throw RustString(ptr: val!) } else { return }
  }()
}
...
func __swift_bridge__SwiftOcrBackendBox_alef_name(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue()
      .alef_name().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
}
...
func __swift_bridge__SwiftOcrBackendBox_alef_version(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue()
      .alef_version().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
}
...
func __swift_bridge__SwiftOcrBackendBox_alef_initialize(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue()
      .alef_initialize().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
}
...
func __swift_bridge__SwiftOcrBackendBox_alef_shutdown(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue()
      .alef_shutdown().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
}
...
func __swift_bridge__SwiftOcrBackendBox_alef_process_image(
  _ this: UnsafeMutableRawPointer, _ image_bytes: UnsafeMutableRawPointer,
  _ config: UnsafeMutableRawPointer
) -> UnsafeMutableRawPointer {
  {
    let rustString = Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue()
      .alef_process_image(image_bytes: RustVec(ptr: image_bytes), config: RustString(ptr: config))
      .intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftOcrBackendBox_alef_process_image_file(
  _ this: UnsafeMutableRawPointer, _ path: UnsafeMutableRawPointer,
  _ config: UnsafeMutableRawPointer
) -> UnsafeMutableRawPointer {
  {
    let rustString = Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue()
      .alef_process_image_file(path: RustString(ptr: path), config: RustString(ptr: config))
      .intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftOcrBackendBox_alef_supports_language(
  _ this: UnsafeMutableRawPointer, _ lang: UnsafeMutableRawPointer
) -> Bool {
  Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue().alef_supports_language(
    lang: RustString(ptr: lang))
}

@_cdecl("__swift_bridge__$SwiftOcrBackendBox$alef_backend_type")
func __swift_bridge__SwiftOcrBackendBox_alef_backend_type(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue()
      .alef_backend_type().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
}
...
func __swift_bridge__SwiftOcrBackendBox_alef_supported_languages(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let val = Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue()
      .alef_supported_languages()
    val.isOwned = false
    return val.ptr
  }()
}
...
func __swift_bridge__SwiftOcrBackendBox_alef_supports_table_detection(
  _ this: UnsafeMutableRawPointer
) -> Bool {
  Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue()
    .alef_supports_table_detection()
}

@_cdecl("__swift_bridge__$SwiftOcrBackendBox$alef_supports_document_processing")
func __swift_bridge__SwiftOcrBackendBox_alef_supports_document_processing(
  _ this: UnsafeMutableRawPointer
) -> Bool {
  Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue()
    .alef_supports_document_processing()
}

@_cdecl("__swift_bridge__$SwiftOcrBackendBox$alef_process_document")
func __swift_bridge__SwiftOcrBackendBox_alef_process_document(
  _ this: UnsafeMutableRawPointer, _ path: UnsafeMutableRawPointer,
  _ config: UnsafeMutableRawPointer
) -> UnsafeMutableRawPointer {
  {
    let rustString = Unmanaged<SwiftOcrBackendBox>.fromOpaque(this).takeUnretainedValue()
      .alef_process_document(path: RustString(ptr: path), config: RustString(ptr: config))
      .intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftPostProcessorBox_alef_name(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftPostProcessorBox>.fromOpaque(this).takeUnretainedValue()
      .alef_name().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftPostProcessorBox_alef_version(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftPostProcessorBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftPostProcessorBox_alef_initialize(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftPostProcessorBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftPostProcessorBox_alef_shutdown(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftPostProcessorBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftPostProcessorBox_alef_process(
  _ this: UnsafeMutableRawPointer, _ result: UnsafeMutableRawPointer,
  _ config: UnsafeMutableRawPointer
) -> UnsafeMutableRawPointer {
  {
    let rustString = Unmanaged<SwiftPostProcessorBox>.fromOpaque(this).takeUnretainedValue()
      .alef_process(result: RustString(ptr: result), config: RustString(ptr: config))
      .intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftPostProcessorBox_alef_processing_stage(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftPostProcessorBox>.fromOpaque(this).takeUnretainedValue()
      .alef_processing_stage().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
}
...
func __swift_bridge__SwiftPostProcessorBox_alef_should_process(
  _ this: UnsafeMutableRawPointer, _ result: UnsafeMutableRawPointer,
  _ config: UnsafeMutableRawPointer
) -> Bool {
  Unmanaged<SwiftPostProcessorBox>.fromOpaque(this).takeUnretainedValue().alef_should_process(
    result: RustString(ptr: result), config: RustString(ptr: config))
}

@_cdecl("__swift_bridge__$SwiftPostProcessorBox$alef_estimated_duration_ms")
func __swift_bridge__SwiftPostProcessorBox_alef_estimated_duration_ms(
  _ this: UnsafeMutableRawPointer, _ result: UnsafeMutableRawPointer
) -> UInt64 {
  Unmanaged<SwiftPostProcessorBox>.fromOpaque(this).takeUnretainedValue()
    .alef_estimated_duration_ms(result: RustString(ptr: result))
}
...
func __swift_bridge__SwiftValidatorBox_alef_name(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftValidatorBox>.fromOpaque(this).takeUnretainedValue().alef_name()
      .intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftValidatorBox_alef_version(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftValidatorBox>.fromOpaque(this).takeUnretainedValue()
      .alef_version().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftValidatorBox_alef_initialize(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftValidatorBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftValidatorBox_alef_shutdown(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftValidatorBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftValidatorBox_alef_validate(
  _ this: UnsafeMutableRawPointer, _ result: UnsafeMutableRawPointer,
  _ config: UnsafeMutableRawPointer
) -> UnsafeMutableRawPointer {
  {
    let rustString = Unmanaged<SwiftValidatorBox>.fromOpaque(this).takeUnretainedValue()
      .alef_validate(result: RustString(ptr: result), config: RustString(ptr: config))
      .intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftValidatorBox_alef_should_validate(
  _ this: UnsafeMutableRawPointer, _ result: UnsafeMutableRawPointer,
  _ config: UnsafeMutableRawPointer
) -> Bool {
  Unmanaged<SwiftValidatorBox>.fromOpaque(this).takeUnretainedValue().alef_should_validate(
    result: RustString(ptr: result), config: RustString(ptr: config))
}
...
func __swift_bridge__SwiftEmbeddingBackendBox_alef_name(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftEmbeddingBackendBox>.fromOpaque(this).takeUnretainedValue()
      .alef_name().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftEmbeddingBackendBox_alef_version(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftEmbeddingBackendBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftEmbeddingBackendBox_alef_initialize(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftEmbeddingBackendBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftEmbeddingBackendBox_alef_shutdown(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftEmbeddingBackendBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftEmbeddingBackendBox_alef_dimensions(_ this: UnsafeMutableRawPointer)
  -> UInt
{
...
func __swift_bridge__SwiftEmbeddingBackendBox_alef_embed(
  _ this: UnsafeMutableRawPointer, _ texts: UnsafeMutableRawPointer
) -> UnsafeMutableRawPointer {
  {
    let rustString = Unmanaged<SwiftEmbeddingBackendBox>.fromOpaque(this).takeUnretainedValue()
      .alef_embed(texts: RustVec(ptr: texts)).intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
}
...
func __swift_bridge__SwiftDocumentExtractorBox_alef_name(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftDocumentExtractorBox>.fromOpaque(this).takeUnretainedValue()
      .alef_name().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftDocumentExtractorBox_alef_version(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftDocumentExtractorBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftDocumentExtractorBox_alef_initialize(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftDocumentExtractorBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftDocumentExtractorBox_alef_shutdown(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftDocumentExtractorBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftDocumentExtractorBox_alef_extract_bytes(
  _ this: UnsafeMutableRawPointer, _ content: UnsafeMutableRawPointer,
  _ mime_type: UnsafeMutableRawPointer, _ config: UnsafeMutableRawPointer
) -> UnsafeMutableRawPointer {
  {
    let rustString = Unmanaged<SwiftDocumentExtractorBox>.fromOpaque(this).takeUnretainedValue()
      .alef_extract_bytes(
        content: RustVec(ptr: content), mime_type: RustString(ptr: mime_type),
        config: RustString(ptr: config)
      ).intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftDocumentExtractorBox_alef_extract_file(
  _ this: UnsafeMutableRawPointer, _ path: UnsafeMutableRawPointer,
  _ mime_type: UnsafeMutableRawPointer, _ config: UnsafeMutableRawPointer
) -> UnsafeMutableRawPointer {
  {
    let rustString = Unmanaged<SwiftDocumentExtractorBox>.fromOpaque(this).takeUnretainedValue()
      .alef_extract_file(
        path: RustString(ptr: path), mime_type: RustString(ptr: mime_type),
        config: RustString(ptr: config)
      ).intoRustString()
    rustString.isOwned = false
    return rustString.ptr
...
func __swift_bridge__SwiftDocumentExtractorBox_alef_supported_mime_types(
  _ this: UnsafeMutableRawPointer
) -> UnsafeMutableRawPointer {
  {
    let val = Unmanaged<SwiftDocumentExtractorBox>.fromOpaque(this).takeUnretainedValue()
      .alef_supported_mime_types()
    val.isOwned = false
    return val.ptr
  }()
}
...
func __swift_bridge__SwiftDocumentExtractorBox_alef_priority(_ this: UnsafeMutableRawPointer)
  -> Int32
{
...
func __swift_bridge__SwiftDocumentExtractorBox_alef_can_handle(
  _ this: UnsafeMutableRawPointer, _ path: UnsafeMutableRawPointer,
  _ mime_type: UnsafeMutableRawPointer
) -> Bool {
  Unmanaged<SwiftDocumentExtractorBox>.fromOpaque(this).takeUnretainedValue().alef_can_handle(
    path: RustString(ptr: path), mime_type: RustString(ptr: mime_type))
}

@_cdecl("__swift_bridge__$SwiftDocumentExtractorBox$alef_as_sync_extractor")
func __swift_bridge__SwiftDocumentExtractorBox_alef_as_sync_extractor(
  _ this: UnsafeMutableRawPointer
) -> UnsafeMutableRawPointer {
  {
    let rustString = Unmanaged<SwiftDocumentExtractorBox>.fromOpaque(this).takeUnretainedValue()
      .alef_as_sync_extractor().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
}
...
func __swift_bridge__SwiftRendererBox_alef_name(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftRendererBox>.fromOpaque(this).takeUnretainedValue().alef_name()
      .intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftRendererBox_alef_version(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftRendererBox>.fromOpaque(this).takeUnretainedValue()
      .alef_version().intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
func __swift_bridge__SwiftRendererBox_alef_initialize(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftRendererBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftRendererBox_alef_shutdown(_ this: UnsafeMutableRawPointer)
  -> UnsafeMutableRawPointer
{
  {
    let rustString = Unmanaged<SwiftRendererBox>.fromOpaque(this).takeUnretainedValue()
...
func __swift_bridge__SwiftRendererBox_alef_render(
  _ this: UnsafeMutableRawPointer, _ doc: UnsafeMutableRawPointer
) -> UnsafeMutableRawPointer {
  {
    let rustString = Unmanaged<SwiftRendererBox>.fromOpaque(this).takeUnretainedValue().alef_render(
      doc: RustString(ptr: doc)
    ).intoRustString()
    rustString.isOwned = false
    return rustString.ptr
  }()
...
public func extractionConfigFromJson<GenericIntoRustString: IntoRustString>(
  ...
  try {
    let val = __swift_bridge__$extraction_config_from_json(
      {
    ...
    if val.is_ok {
      return ExtractionConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func batchBytesItemFromJson<GenericIntoRustString: IntoRustString>(
  ...
  try {
    let val = __swift_bridge__$batch_bytes_item_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BatchBytesItem(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func batchFileItemFromJson<GenericIntoRustString: IntoRustString>(
  ...
  try {
    let val = __swift_bridge__$batch_file_item_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BatchFileItem(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func ocrConfigFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> OcrConfig
{
  try {
    let val = __swift_bridge__$ocr_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func embeddingConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> EmbeddingConfig {
  try {
    let val = __swift_bridge__$embedding_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return EmbeddingConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func extractionResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ExtractionResult {
  try {
    let val = __swift_bridge__$extraction_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func ocrExtractionResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrExtractionResult {
  try {
    let val = __swift_bridge__$ocr_extraction_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrExtractionResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func structuredExtractionConfigFromJson<GenericIntoRustString: IntoRustString>(
  ...
  try {
    let val = __swift_bridge__$structured_extraction_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return StructuredExtractionConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func ocrPipelineStageFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrPipelineStage {
  try {
    let val = __swift_bridge__$ocr_pipeline_stage_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrPipelineStage(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func ocrPipelineConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrPipelineConfig {
  try {
    let val = __swift_bridge__$ocr_pipeline_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrPipelineConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func supportedFormatFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> SupportedFormat {
  try {
    let val = __swift_bridge__$supported_format_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return SupportedFormat(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func structuredDataResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> StructuredDataResult {
  try {
    let val = __swift_bridge__$structured_data_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return StructuredDataResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pdfAnnotationFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PdfAnnotation {
  try {
    let val = __swift_bridge__$pdf_annotation_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PdfAnnotation(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func djotContentFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> DjotContent {
  try {
    let val = __swift_bridge__$djot_content_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DjotContent(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func formattedBlockFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> FormattedBlock {
  try {
    let val = __swift_bridge__$formatted_block_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return FormattedBlock(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func inlineElementFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> InlineElement {
  try {
    let val = __swift_bridge__$inline_element_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return InlineElement(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func djotImageFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> DjotImage
{
  try {
    let val = __swift_bridge__$djot_image_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DjotImage(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func djotLinkFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> DjotLink
{
  try {
    let val = __swift_bridge__$djot_link_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DjotLink(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func footnoteFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> Footnote
{
  try {
    let val = __swift_bridge__$footnote_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return Footnote(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func documentRelationshipFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> DocumentRelationship {
  try {
    let val = __swift_bridge__$document_relationship_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DocumentRelationship(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func archiveEntryFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ArchiveEntry {
  try {
    let val = __swift_bridge__$archive_entry_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ArchiveEntry(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func chunkFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> Chunk
{
  try {
    let val = __swift_bridge__$chunk_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return Chunk(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func headingContextFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> HeadingContext {
  try {
    let val = __swift_bridge__$heading_context_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return HeadingContext(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func headingLevelFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> HeadingLevel {
  try {
    let val = __swift_bridge__$heading_level_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return HeadingLevel(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func chunkMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ChunkMetadata {
  try {
    let val = __swift_bridge__$chunk_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ChunkMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func extractedImageFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ExtractedImage {
  try {
    let val = __swift_bridge__$extracted_image_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ExtractedImage(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func elementMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ElementMetadata {
  try {
    let val = __swift_bridge__$element_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ElementMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func elementFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> Element
{
  try {
    let val = __swift_bridge__$element_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return Element(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func excelWorkbookFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ExcelWorkbook {
  try {
    let val = __swift_bridge__$excel_workbook_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ExcelWorkbook(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func excelSheetFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> ExcelSheet
{
  try {
    let val = __swift_bridge__$excel_sheet_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ExcelSheet(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func xmlExtractionResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> XmlExtractionResult {
  try {
    let val = __swift_bridge__$xml_extraction_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return XmlExtractionResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func textExtractionResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> TextExtractionResult {
  try {
    let val = __swift_bridge__$text_extraction_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return TextExtractionResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pptxExtractionResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PptxExtractionResult {
  try {
    let val = __swift_bridge__$pptx_extraction_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PptxExtractionResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func emailExtractionResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> EmailExtractionResult {
  try {
    let val = __swift_bridge__$email_extraction_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func emailAttachmentFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> EmailAttachment {
  try {
    let val = __swift_bridge__$email_attachment_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return EmailAttachment(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func ocrTableFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> OcrTable
{
  try {
    let val = __swift_bridge__$ocr_table_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrTable(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func imagePreprocessingMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ImagePreprocessingMetadata {
  try {
    let val = __swift_bridge__$image_preprocessing_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ImagePreprocessingMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func imageMetadataTypeFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ImageMetadataType {
  try {
    let val = __swift_bridge__$image_metadata_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ImageMetadataType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func errorMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ErrorMetadata {
  try {
    let val = __swift_bridge__$error_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ErrorMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func yearRangeFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> YearRange
{
  try {
    let val = __swift_bridge__$year_range_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return YearRange(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func dbfFieldInfoFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> DbfFieldInfo {
  try {
    let val = __swift_bridge__$dbf_field_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DbfFieldInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func contributorRoleFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ContributorRole {
  try {
    let val = __swift_bridge__$contributor_role_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ContributorRole(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pageStructureFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PageStructure {
  try {
    let val = __swift_bridge__$page_structure_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PageStructure(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pageInfoFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> PageInfo
{
  try {
    let val = __swift_bridge__$page_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PageInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pageContentFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PageContent {
  try {
    let val = __swift_bridge__$page_content_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PageContent(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pageHierarchyFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PageHierarchy {
  try {
    let val = __swift_bridge__$page_hierarchy_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PageHierarchy(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func hierarchicalBlockFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> HierarchicalBlock {
  try {
    let val = __swift_bridge__$hierarchical_block_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return HierarchicalBlock(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func uriFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString) throws
  -> Uri
{
  try {
    let val = __swift_bridge__$uri_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
      }())
    if val.is_ok { return Uri(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) }
  }()
}
public func detectResponseFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> DetectResponse {
  try {
    let val = __swift_bridge__$detect_response_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DetectResponse(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func keywordFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> Keyword
{
  try {
    let val = __swift_bridge__$keyword_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return Keyword(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func modelPathsFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> ModelPaths
{
  try {
    let val = __swift_bridge__$model_paths_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ModelPaths(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func layoutDetectionFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> LayoutDetection {
  try {
    let val = __swift_bridge__$layout_detection_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return LayoutDetection(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func recognizedTableFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> RecognizedTable {
  try {
    let val = __swift_bridge__$recognized_table_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return RecognizedTable(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func detectionResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> DetectionResult {
  try {
    let val = __swift_bridge__$detection_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DetectionResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func embeddedFileFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> EmbeddedFile {
  try {
    let val = __swift_bridge__$embedded_file_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return EmbeddedFile(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
extension ExtractionConfig {
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    _ force_ocr_pages: RustVec<UInt32>?, _ disable_ocr: Bool, _ chunking: ChunkingConfig?,
    ...
    _ keywords: KeywordConfig?, _ postprocessor: PostProcessorConfig?,
    _ html_options: GenericIntoRustString?, _ html_output: HtmlOutputConfig?,
    _ extraction_timeout_secs: UInt64?, _ max_concurrent_extractions: UInt?,
    _ result_format: ResultFormat, _ security_limits: SecurityLimits?,
    _ output_format: OutputFormat, _ layout: LayoutDetectionConfig?,
    _ use_layout_for_markdown: Bool, _ include_document_structure: Bool,
    ...
    self.init(
      ptr: __swift_bridge__$ExtractionConfig$new(
        ...
        {
          result_format.isOwned = false
          return result_format.ptr
        }(),
        {
          if let val = security_limits {
            val.isOwned = false
            return val.ptr
          } else {
            return nil
        ...
        }(), use_layout_for_markdown, include_document_structure,
        {
...
extension ExtractionConfigRef {
  ...
  public func force_ocr_pages() -> RustVec<UInt32>? {
    {
  ...
  public func keywords() -> KeywordConfig? {
    {
      let val = __swift_bridge__$ExtractionConfig$keywords(ptr)
      if val != nil { return KeywordConfig(ptr: val!) } else { return nil }
    }()
  }
  ...
  public func security_limits() -> SecurityLimits? {
    {
      let val = __swift_bridge__$ExtractionConfig$security_limits(ptr)
      if val != nil { return SecurityLimits(ptr: val!) } else { return nil }
    }()
  }
...
extension FileExtractionConfig {
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    _ language_detection: LanguageDetectionConfig?, _ pages: PageConfig?,
    _ keywords: KeywordConfig?, _ postprocessor: PostProcessorConfig?,
    _ html_options: GenericIntoRustString?, _ result_format: ResultFormat?,
    _ output_format: OutputFormat?, _ include_document_structure: Bool?,
    _ layout: LayoutDetectionConfig?, _ timeout_secs: UInt64?, _ tree_sitter: TreeSitterConfig?,
    _ structured_extraction: StructuredExtractionConfig?
  ) {
    self.init(
...
extension FileExtractionConfigRef {
  ...
  public func keywords() -> KeywordConfig? {
    {
      let val = __swift_bridge__$FileExtractionConfig$keywords(ptr)
      if val != nil { return KeywordConfig(ptr: val!) } else { return nil }
    }()
  }
...
extension BatchBytesItemRef {
  ...
  public func config() -> FileExtractionConfig? {
    {
      let val = __swift_bridge__$BatchBytesItem$config(ptr)
      if val != nil { return FileExtractionConfig(ptr: val!) } else { return nil }
    }()
  }
}
extension BatchBytesItem: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: BatchBytesItem) {
    __swift_bridge__$Vec_BatchBytesItem$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    BatchBytesItemRef
  > {
    UnsafePointer<BatchBytesItemRef>(
      OpaquePointer(__swift_bridge__$Vec_BatchBytesItem$as_ptr(vecPtr)))
  }
...
extension BatchFileItemRef {
  ...
  public func config() -> FileExtractionConfig? {
    {
      let val = __swift_bridge__$BatchFileItem$config(ptr)
      if val != nil { return FileExtractionConfig(ptr: val!) } else { return nil }
    }()
  }
}
extension BatchFileItem: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: BatchFileItem) {
    __swift_bridge__$Vec_BatchFileItem$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> BatchFileItemRef?
  {
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    BatchFileItemRef
  > {
    UnsafePointer<BatchFileItemRef>(
      OpaquePointer(__swift_bridge__$Vec_BatchFileItem$as_ptr(vecPtr)))
  }
...
extension ImageExtractionConfig {
  public convenience init(
    ...
    _ max_images_per_page: UInt32?, _ classify: Bool
  ) {
    self.init(
      ptr: __swift_bridge__$ImageExtractionConfig$new(
        ...
        min_dpi, max_dpi, max_images_per_page.intoFfiRepr(), classify))
  }
}
...
extension LayoutDetectionConfigRef {
  ...
  public func table_model() -> RustString {
...
extension OcrPipelineStageRef {
  ...
  public func backend_options() -> RustString? {
    {
      let val = __swift_bridge__$OcrPipelineStage$backend_options(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
}
...
extension OcrConfig {
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    _ tesseract_config: TesseractConfig?, _ output_format: OutputFormat?,
    _ paddle_ocr_config: GenericIntoRustString?, _ backend_options: GenericIntoRustString?,
    _ element_config: OcrElementConfig?, _ quality_thresholds: OcrQualityThresholds?,
    _ pipeline: OcrPipelineConfig?, _ auto_rotate: Bool, _ vlm_config: LlmConfig?,
    _ vlm_prompt: GenericIntoRustString?, _ acceleration: AccelerationConfig?,
    _ tessdata_bytes: GenericIntoRustString
  ) {
    self.init(
      ptr: __swift_bridge__$OcrConfig$new(
        ...
        {
          if let rustString = optionalStringIntoRustString(backend_options) {
            rustString.isOwned = false
            return rustString.ptr
          } else {
            return nil
        ...
        {
          let rustString = tessdata_bytes.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
        }()))
  }
...
extension OcrConfigRef {
  ...
  public func backend_options() -> RustString? {
    {
      let val = __swift_bridge__$OcrConfig$backend_options(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
  ...
  public func tessdata_bytes() -> RustString {
...
extension PdfConfig {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ extract_images: Bool, _ extract_tables: Bool, _ passwords: RustVec<GenericIntoRustString>?,
    ...
    _ allow_single_column_tables: Bool, _ ocr_inline_images: Bool
  ) {
    self.init(
...
extension PdfConfigRef {
  ...
  public func extract_tables() -> Bool {
...
extension TreeSitterProcessConfigRef {
  ...
  public func content_mode() -> RustString {
...
extension SecurityLimits {
  public convenience init(
    _ max_archive_size: UInt, _ max_compression_ratio: UInt, _ max_files_in_archive: UInt,
    _ max_nesting_depth: UInt, _ max_entity_length: UInt, _ max_content_size: UInt,
    _ max_iterations: UInt, _ max_xml_depth: UInt, _ max_table_cells: UInt
  ) {
    self.init(
      ptr: __swift_bridge__$SecurityLimits$new(
        max_archive_size, max_compression_ratio, max_files_in_archive, max_nesting_depth,
        max_entity_length, max_content_size, max_iterations, max_xml_depth, max_table_cells))
  }
}
...
extension SecurityLimits: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: SecurityLimits) {
    __swift_bridge__$Vec_SecurityLimits$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    SecurityLimitsRef
  > {
    UnsafePointer<SecurityLimitsRef>(
      OpaquePointer(__swift_bridge__$Vec_SecurityLimits$as_ptr(vecPtr)))
  }
...
extension PdfAnnotationRef {
  public func annotation_type() -> RustString {
  ...
  public func page_number() -> UInt32 {
...
extension FormattedBlockRef {
  public func block_type() -> RustString {
...
extension InlineElementRef {
  public func element_type() -> RustString {
...
extension DocumentStructure {
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    _ relationships: RustVec<DocumentRelationship>, _ node_types: RustVec<GenericIntoRustString>
  ) {
    self.init(
...
extension DocumentNodeRef {
  ...
  public func content_layer() -> RustString {
...
extension ExtractionResult {
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    _ ocr_elements: RustVec<OcrElement>?, _ document: DocumentStructure?,
    _ extracted_keywords: RustVec<Keyword>?, _ quality_score: Double?,
...
extension ExtractionResultRef {
  ...
  public func extraction_method() -> RustString? {
    {
      let val = __swift_bridge__$ExtractionResult$extraction_method(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
  ...
  public func extracted_keywords() -> RustVec<Keyword>? {
    {
      let val = __swift_bridge__$ExtractionResult$extracted_keywords(ptr)
      if val != nil { return RustVec(ptr: val!) } else { return nil }
    }()
  }
...
extension ChunkRef {
  ...
  public func chunk_type() -> RustString {
...
extension ChunkMetadataRef {
  ...
  public func image_indices() -> RustVec<UInt32> {
...
extension ExtractedImageRef {
  ...
  public func image_index() -> UInt32 {
  ...
  public func image_kind() -> RustString? {
    {
      let val = __swift_bridge__$ExtractedImage$image_kind(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }

  public func kind_confidence() -> Float? {
    __swift_bridge__$ExtractedImage$kind_confidence(ptr).intoSwiftRepr()
  }

  public func cluster_id() -> UInt32? {
...
extension ExcelMetadata {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ sheet_count: UInt32?, _ sheet_names: RustVec<GenericIntoRustString>?
  ) {
    self.init(
      ptr: __swift_bridge__$ExcelMetadata$new(
        sheet_count.intoFfiRepr(),
        {
          if let val = sheet_names {
            val.isOwned = false
            return val.ptr
          } else {
            return nil
...
extension ArchiveMetadata {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ format: GenericIntoRustString, _ file_count: UInt32,
    _ file_list: RustVec<GenericIntoRustString>, _ total_size: UInt64, _ compressed_size: UInt64?
  ) {
    self.init(
...
extension ArchiveMetadataRef {
  ...
  public func total_size() -> UInt64 {
    __swift_bridge__$ArchiveMetadata$total_size(ptr)
  }

  public func compressed_size() -> UInt64? {
...
extension ImageMetadata {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ width: UInt32, _ height: UInt32, _ format: GenericIntoRustString,
    _ exif: GenericIntoRustString
  ) {
    self.init(
      ptr: __swift_bridge__$ImageMetadata$new(
        width, height,
        {
          let rustString = format.intoRustString()
          rustString.isOwned = false
        ...
        {
          let rustString = exif.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
        }()))
  }
...
extension XmlMetadata {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ element_count: UInt32, _ unique_elements: RustVec<GenericIntoRustString>
  ) {
    self.init(
...
extension XmlMetadataRef {
  public func element_count() -> UInt32 {
...
extension TextMetadata {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ line_count: UInt32, _ word_count: UInt32, _ character_count: UInt32,
...
extension TextMetadataRef {
  public func line_count() -> UInt32 {
    __swift_bridge__$TextMetadata$line_count(ptr)
  }

  public func word_count() -> UInt32 {
    __swift_bridge__$TextMetadata$word_count(ptr)
  }

  public func character_count() -> UInt32 {
...
extension HeaderMetadataRef {
  ...
  public func html_offset() -> UInt32 {
...
extension OcrMetadata {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ language: GenericIntoRustString, _ psm: Int32, _ output_format: GenericIntoRustString,
    _ table_count: UInt32, _ table_rows: UInt32?, _ table_cols: UInt32?
  ) {
    self.init(
...
extension PptxMetadata {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ slide_count: UInt32, _ slide_names: RustVec<GenericIntoRustString>, _ image_count: UInt32?,
    _ table_count: UInt32?
  ) {
    self.init(
...
extension PptxMetadataRef {
  public func slide_count() -> UInt32 {
  ...
  public func image_count() -> UInt32? {
...
extension CsvMetadata {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ row_count: UInt32, _ column_count: UInt32, _ delimiter: GenericIntoRustString?,
...
extension CsvMetadataRef {
  public func row_count() -> UInt32 {
    __swift_bridge__$CsvMetadata$row_count(ptr)
  }

  public func column_count() -> UInt32 {
...
extension OcrElement {
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    _ level: OcrElementLevel, _ rotation: OcrRotation?, _ page_number: UInt32,
...
extension OcrElementConfigRef {
  ...
  public func min_level() -> RustString {
...
extension PageStructureRef {
  public func total_count() -> UInt32 {
    __swift_bridge__$PageStructure$total_count(ptr)
  }

  public func unit_type() -> RustString {
...
extension PageHierarchyRef {
  public func block_count() -> UInt32 {
...
extension Table {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ cells: GenericIntoRustString, _ markdown: GenericIntoRustString, _ page_number: UInt32,
    _ bounding_box: GenericIntoRustString?
  ) {
    self.init(
      ptr: __swift_bridge__$Table$new(
        {
...
extension TableRef {
  ...
  public func bounding_box() -> RustString? {
    {
      let val = __swift_bridge__$Table$bounding_box(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
}
extension Table: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: Table) {
    __swift_bridge__$Vec_Table$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> TableRef? {
  ...
  public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> TableRefMut? {
...
extension TableCell {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ content: GenericIntoRustString, _ row_span: UInt32, _ col_span: UInt32, _ is_header: Bool
  ) {
    self.init(
      ptr: __swift_bridge__$TableCell$new(
        {
          let rustString = content.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
        }(), row_span, col_span, is_header))
  }
}
...
extension TableCell: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: TableCell) {
    __swift_bridge__$Vec_TableCell$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> TableCellRef? {
...
public class DrawingType: DrawingTypeRefMut {
  var isOwned: Bool = true
  ...
  deinit {
    if isOwned {
      __swift_bridge__$DrawingType$_free(ptr)
    }
  }
}
public class DrawingTypeRefMut: DrawingTypeRef {
  public override init(ptr: UnsafeMutableRawPointer) {
    super.init(ptr: ptr)
  }
}
public class DrawingTypeRef {
  var ptr: UnsafeMutableRawPointer
...
extension DrawingTypeRef {
  public func to_string() -> RustString {
    RustString(ptr: __swift_bridge__$DrawingType$to_string(ptr))
  }
}
extension DrawingType: Vectorizable {
  public static func vecOfSelfNew() -> UnsafeMutableRawPointer {
    __swift_bridge__$Vec_DrawingType$new()
  }

  public static func vecOfSelfFree(vecPtr: UnsafeMutableRawPointer) {
    __swift_bridge__$Vec_DrawingType$drop(vecPtr)
  }

  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: DrawingType) {
    __swift_bridge__$Vec_DrawingType$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfPop(vecPtr: UnsafeMutableRawPointer) -> Self? {
    let pointer = __swift_bridge__$Vec_DrawingType$pop(vecPtr)
    if pointer == nil {
      return nil
    } else {
      return (DrawingType(ptr: pointer!) as! Self)
    }
  }

  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> DrawingTypeRef? {
    let pointer = __swift_bridge__$Vec_DrawingType$get(vecPtr, index)
    if pointer == nil {
      return nil
    } else {
      return DrawingTypeRef(ptr: pointer!)
    }
  }
  ...
  public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt)
    -> DrawingTypeRefMut?
  {
    let pointer = __swift_bridge__$Vec_DrawingType$get_mut(vecPtr, index)
    if pointer == nil {
      return nil
    } else {
      return DrawingTypeRefMut(ptr: pointer!)
    }
  }
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    DrawingTypeRef
  > {
    UnsafePointer<DrawingTypeRef>(OpaquePointer(__swift_bridge__$Vec_DrawingType$as_ptr(vecPtr)))
  }

  public static func vecOfSelfLen(vecPtr: UnsafeMutableRawPointer) -> UInt {
    __swift_bridge__$Vec_DrawingType$len(vecPtr)
  }
}
...
extension ImageKind: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ImageKind) {
    __swift_bridge__$Vec_ImageKind$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> ImageKindRef? {
...
extension ResultFormat: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ResultFormat) {
    __swift_bridge__$Vec_ResultFormat$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> ResultFormatRef?
  {
...
extension DocumentExtractorBox: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: DocumentExtractorBox) {
    __swift_bridge__$Vec_DocumentExtractorBox$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    DocumentExtractorBoxRef
  > {
    UnsafePointer<DocumentExtractorBoxRef>(
      OpaquePointer(__swift_bridge__$Vec_DocumentExtractorBox$as_ptr(vecPtr)))
  }
...
extension RendererBox: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: RendererBox) {
    __swift_bridge__$Vec_RendererBox$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> RendererBoxRef? {
