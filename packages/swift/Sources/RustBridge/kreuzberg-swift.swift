...
extension ExtractionConfigRef {
    ...
    public func force_ocr_pages() -> Optional<RustVec<UInt32>> {
...
extension FileExtractionConfigRef {
    ...
    public func result_format() -> Optional<RustString> {
...
extension OcrPipelineStageRef {
    ...
    public func backend_options() -> Optional<RustString> {
...
extension ExtractionResultRef {
    ...
    public func extraction_method() -> Optional<RustString> {
...
extension ChunkMetadataRef {
    ...
    public func first_page() -> Optional<UInt32> {
        __swift_bridge__$ChunkMetadata$first_page(ptr).intoSwiftRepr()
    }

    public func last_page() -> Optional<UInt32> {
...
extension ExtractedImageRef {
    ...
    public func page_number() -> Optional<UInt32> {
    ...
    public func image_kind() -> Optional<RustString> {
...
extension ExcelMetadataRef {
    public func sheet_count() -> Optional<UInt32> {
...
extension ArchiveMetadataRef {
    ...
    public func compressed_size() -> Optional<UInt64> {
...
extension OcrMetadataRef {
    ...
    public func table_rows() -> Optional<UInt32> {
        __swift_bridge__$OcrMetadata$table_rows(ptr).intoSwiftRepr()
    }

    public func table_cols() -> Optional<UInt32> {
...
extension PptxMetadataRef {
    ...
    public func image_count() -> Optional<UInt32> {
        __swift_bridge__$PptxMetadata$image_count(ptr).intoSwiftRepr()
    }

    public func table_count() -> Optional<UInt32> {
...
extension PdfMetadataRef {
    ...
    public func page_count() -> Optional<UInt32> {
...
extension DrawingType: Vectorizable {
    ...
    public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: DrawingType) {
        __swift_bridge__$Vec_DrawingType$push(vecPtr, {value.isOwned = false; return value.ptr;}())
    }
    ...
    public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<DrawingTypeRef> {
    ...
    public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> Optional<DrawingTypeRefMut> {
    ...
    public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<DrawingTypeRef> {
