...
pub struct PdfFormField(pub kreuzberg::PdfFormField);
impl PdfFormField {
...
pub struct Formula(pub kreuzberg::Formula);
impl Formula {
...
impl ExtractionDiff {
    pub fn new(
        ...
        let mut __target: kreuzberg::ExtractionDiff = ::std::default::Default::default();
...
impl EmbeddedChanges {
    pub fn new(added: Vec<ArchiveEntry>, removed: Vec<ArchiveEntry>, changed: Vec<EmbeddedDiff>) -> EmbeddedChanges {
        let mut __target: kreuzberg::EmbeddedChanges = ::std::default::Default::default();
...
pub fn chunk_for_rag(text: String, config: ChunkingConfig) -> Result<ChunkingResult, String> {
    kreuzberg::chunking::chunk_for_rag(&text, &config.0)
        .map_err(|e| e.to_string())
        .map(ChunkingResult)
}
...
pub fn pdf_page_count(pdf_bytes: Vec<u8>, password: Option<String>) -> Result<usize, String> {
    kreuzberg::pdf_page_count(&pdf_bytes, password.as_deref()).map_err(|e| e.to_string())
}
...
pub fn call_mode_from_json(json: String) -> Result<CallMode, String> {
    serde_json::from_str::<kreuzberg::CallMode>(&json)
        .map(CallMode::from)
        .map_err(|e| e.to_string())
}
pub fn merge_mode_from_json(json: String) -> Result<MergeMode, String> {
    serde_json::from_str::<kreuzberg::MergeMode>(&json)
        .map(MergeMode::from)
        .map_err(|e| e.to_string())
}
...
pub fn table_chunking_mode_from_json(json: String) -> Result<TableChunkingMode, String> {
    serde_json::from_str::<kreuzberg::TableChunkingMode>(&json)
...
pub fn form_field_type_from_json(json: String) -> Result<FormFieldType, String> {
    serde_json::from_str::<kreuzberg::FormFieldType>(&json)
