...
mod ffi {
    ...
    extern "Rust" {
        type PcmAudio;
        #[swift_bridge(init)]
        fn new(samples: Vec<f32>, sample_rate_hz: u32, channels: u16, duration_ms: u64) -> PcmAudio;
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "decoderWithPast")]
        fn decoder_with_past(&self) -> String;
        fn tokenizer(&self) -> String;
        fn config(&self) -> String;
        #[swift_bridge(swift_name = "nMels")]
        fn n_mels(&self) -> u32;
    }
    ...
    #[cfg(feature = "transcription")]
    extern "Rust" {
        #[swift_bridge(swift_name = "decodeAudioToPcm")]
        fn decode_audio_to_pcm(bytes: Vec<u8>, max_bytes: Option<u64>) -> Result<PcmAudio, String>;
        #[swift_bridge(swift_name = "ensureWhisperModel")]
        ...
        #[swift_bridge(swift_name = "readAudioTags")]
        fn read_audio_tags(bytes: Vec<u8>) -> AudioTags;
    }
    ...
    extern "Rust" {
        ...
        //
        // These declarations are paired with phantom_impl functions below the bridge module.
        fn __alef_phantom_vec_pcm_audio() -> Vec<PcmAudio>;
    }
    ...
    extern "Rust" {
        ...
        //
        // These declarations are paired with phantom_impl functions below the bridge module.
        fn __alef_phantom_vec_whisper_model_paths() -> Vec<WhisperModelPaths>;
    }
    ...
    extern "Rust" {
        ...
        //
        // These declarations are paired with phantom_impl functions below the bridge module.
        fn __alef_phantom_vec_audio_tags() -> Vec<AudioTags>;
    }
...
#[cfg(feature = "transcription")]
#[doc(hidden)]
pub fn __alef_phantom_vec_pcm_audio() -> Vec<PcmAudio> {
    Vec::new()
}
#[cfg(feature = "transcription")]
#[doc(hidden)]
pub fn __alef_phantom_vec_whisper_model_paths() -> Vec<WhisperModelPaths> {
    Vec::new()
}
#[cfg(feature = "transcription")]
#[doc(hidden)]
pub fn __alef_phantom_vec_audio_tags() -> Vec<AudioTags> {
    Vec::new()
}
#[cfg(feature = "classification")]
#[doc(hidden)]
...
#[cfg(feature = "svg")]
pub struct SvgOptions(pub kreuzberg::core::config::extraction::SvgOptions);
#[cfg(feature = "svg")]
impl SvgOptions {
    pub fn new(sanitize: bool, render_dpi: f32) -> SvgOptions {
        SvgOptions(kreuzberg::core::config::extraction::SvgOptions { sanitize, render_dpi })
    }
...
#[cfg(feature = "transcription")]
pub struct PcmAudio(pub kreuzberg::transcription::decode::PcmAudio);
#[cfg(feature = "transcription")]
impl PcmAudio {
    pub fn new(samples: Vec<f32>, sample_rate_hz: u32, channels: u16, duration_ms: u64) -> PcmAudio {
        PcmAudio(kreuzberg::transcription::decode::PcmAudio {
            samples,
            sample_rate_hz,
            channels,
            duration_ms,
    ...
    pub fn sample_rate_hz(&self) -> u32 {
        self.0.sample_rate_hz.clone()
    }
    pub fn channels(&self) -> u16 {
        self.0.channels.clone()
    }
    pub fn duration_ms(&self) -> u64 {
        self.0.duration_ms.clone()
    }
}

#[cfg(feature = "transcription")]
pub struct WhisperModelPaths(pub kreuzberg::transcription::model::WhisperModelPaths);
#[cfg(feature = "transcription")]
impl WhisperModelPaths {
    pub fn encoder(&self) -> String {
        format!("{:?}", &self.0.encoder)
    }
    pub fn decoder(&self) -> String {
        format!("{:?}", &self.0.decoder)
    }
    pub fn decoder_with_past(&self) -> String {
        format!("{:?}", &self.0.decoder_with_past)
    }
    pub fn tokenizer(&self) -> String {
        format!("{:?}", &self.0.tokenizer)
    }
    pub fn config(&self) -> String {
        format!("{:?}", &self.0.config)
    }
    pub fn n_mels(&self) -> u32 {
        self.0.n_mels.clone()
    }
}

#[cfg(feature = "transcription")]
pub struct AudioTags(pub kreuzberg::transcription::tags::AudioTags);
#[cfg(feature = "transcription")]
impl AudioTags {
    pub fn new(
        title: Option<String>,
        ...
        let mut __target: kreuzberg::transcription::tags::AudioTags = ::std::default::Default::default();
        // alef: title — String fallback in non-serde struct, left at default
        // alef: artist — String fallback in non-serde struct, left at default
        // alef: year — String fallback in non-serde struct, left at default
        // alef: language — String fallback in non-serde struct, left at default
        __target.duration_ms = duration_ms;
        __target.sample_rate_hz = sample_rate_hz;
        __target.channels = channels;
        __target.bitrate = bitrate;
        // alef: container — String fallback in non-serde struct, left at default
        AudioTags(__target)
    }
    pub fn title(&self) -> Option<String> {
    ...
    pub fn artist(&self) -> Option<String> {
        self.0.artist.as_ref().map(|v| format!("{v:?}"))
    }
    pub fn year(&self) -> Option<String> {
        self.0.year.as_ref().map(|v| format!("{v:?}"))
    }
    pub fn language(&self) -> Option<String> {
    ...
    pub fn bitrate(&self) -> Option<u32> {
        self.0.bitrate.clone()
    }
    pub fn container(&self) -> Option<String> {
        self.0.container.as_ref().map(|v| format!("{v:?}"))
    }
}

#[cfg(feature = "classification")]
pub struct ClassificationEnrichmentConfig(pub kreuzberg::ClassificationEnrichmentConfig);
#[cfg(feature = "classification")]
...
#[cfg(feature = "captioning")]
pub struct CaptioningEnrichmentConfig(pub kreuzberg::CaptioningEnrichmentConfig);
#[cfg(feature = "captioning")]
...
impl From<kreuzberg::core::config::extraction::ImageOutputFormat> for ImageOutputFormat {
    fn from(val: kreuzberg::core::config::extraction::ImageOutputFormat) -> Self {
        match val {
            ...
            kreuzberg::core::config::extraction::ImageOutputFormat::Jpeg { .. } => Self::Jpeg,
            kreuzberg::core::config::extraction::ImageOutputFormat::Webp { .. } => Self::Webp,
            #[cfg(feature = "heic")]
            kreuzberg::core::config::extraction::ImageOutputFormat::Heif { .. } => Self::Heif,
            #[cfg(feature = "svg")]
...
pub fn classify_document(
    ...
    crate::__alef_tokio_runtime().block_on(async {
        kreuzberg::classify_document(&pages.iter().map(|s| s.as_str()).collect::<Vec<_>>(), &config.0)
            .await
            .map_err(|e| e.to_string())
            .map(|v| v.into_iter().map(ClassificationLabel).collect::<Vec<_>>())
    })
...
#[cfg(feature = "transcription")]
pub fn decode_audio_to_pcm(bytes: Vec<u8>, max_bytes: Option<u64>) -> Result<PcmAudio, String> {
...
pub fn ensure_whisper_model(
    ...
    kreuzberg::transcription::model::ensure_whisper_model(
        <kreuzberg::WhisperModel as ::std::convert::From<String>>::from(model),
        cache_dir.as_ref().map(std::path::Path::new),
        allow_network,
        verify_hash,
    )
    .map_err(|e| e.to_string())
    .map(WhisperModelPaths)
}

#[cfg(feature = "transcription")]
pub fn read_audio_tags(bytes: Vec<u8>) -> AudioTags {
    AudioTags(kreuzberg::transcription::tags::read_audio_tags(&bytes))
}
...
pub fn caption_image(
    ...
    crate::__alef_tokio_runtime().block_on(async {
        kreuzberg::caption_image(&image_bytes, &llm_config.0, custom_prompt.as_deref())
            .await
            .map_err(|e| e.to_string())
            .map(|s| s.to_string())
    })
...
pub fn caption_image_file(
    ...
    crate::__alef_tokio_runtime().block_on(async {
        kreuzberg::caption_image_file(std::path::PathBuf::from(path), &llm_config.0, custom_prompt.as_deref())
            .await
            .map_err(|e| e.to_string())
            .map(|s| s.to_string())
    })
...
pub fn image_output_format_from_json(json: String) -> Result<ImageOutputFormat, String> {
    serde_json::from_str::<kreuzberg::core::config::extraction::ImageOutputFormat>(&json)
