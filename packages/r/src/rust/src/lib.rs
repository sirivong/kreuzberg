...
// alef:hash:16fe872fa38d382c23505fb2dd85910f1b3d6a1dbaaa01ebb55f0240a1cb71d4
...
pub fn new_docxmetadata(
    ...
    if let Some(v) = core_properties {
        __out.core_properties = Some(v);
    }
    if let Some(v) = app_properties {
        __out.app_properties = Some(v);
    }
...
impl From<kreuzberg::pdf::images::PdfImage> for PdfImage {
    fn from(val: kreuzberg::pdf::images::PdfImage) -> Self {
        Self {
            ...
            bits_per_component: val.bits_per_component.map(|v| v as f64),
            filters: val.filters,
            data: val.data.to_vec().into(),
...
impl From<kreuzberg::pdf::layout_runner::PageLayoutResult> for PageLayoutResult {
    fn from(val: kreuzberg::pdf::layout_runner::PageLayoutResult) -> Self {
        Self {
            page_index: val.page_index as f64,
            ...
            render_width_px: val.render_width_px as i32,
            render_height_px: val.render_height_px as i32,
        }
    }
}
...
pub fn extract_bytes(content: Vec<u8>, mime_type: String, config: &ExtractionConfig) -> Result<String> {
    ...
    serde_json::to_string(&result).map_err(|e| extendr_api::Error::Other(e.to_string()))
}
...
pub fn batch_extract_files_sync(items: String, config: &ExtractionConfig) -> Result<String> {
    let items_core: Vec<kreuzberg::BatchFileItem> =
        serde_json::from_str(&items).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
    let config_core: kreuzberg::ExtractionConfig = config.clone().into();
...
pub fn batch_extract_bytes_sync(items: String, config: &ExtractionConfig) -> Result<String> {
    let items_core: Vec<kreuzberg::BatchBytesItem> =
        serde_json::from_str(&items).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
    let config_core: kreuzberg::ExtractionConfig = config.clone().into();
...
pub fn detect_mime_type_from_bytes(content: Vec<u8>) -> Result<String> {
    kreuzberg::detect_mime_type_from_bytes(&content).map_err(|e| extendr_api::Error::Other(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn get_extensions_for_mime(mime_type: String) -> Result<Vec<String>> {
    kreuzberg::get_extensions_for_mime(&mime_type).map_err(|e| extendr_api::Error::Other(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn list_document_extractors() -> Result<Vec<String>> {
    kreuzberg::list_document_extractors().map_err(|e| extendr_api::Error::Other(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn list_ocr_backends() -> Result<Vec<String>> {
    kreuzberg::list_ocr_backends().map_err(|e| extendr_api::Error::Other(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn clear_ocr_backends() -> Result<()> {
    kreuzberg::clear_ocr_backends().map_err(|e| extendr_api::Error::Other(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn list_post_processors() -> Result<Vec<String>> {
    kreuzberg::list_post_processors().map_err(|e| extendr_api::Error::Other(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn clear_post_processors() -> Result<()> {
    kreuzberg::clear_post_processors().map_err(|e| extendr_api::Error::Other(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn list_validators() -> Result<Vec<String>> {
    kreuzberg::list_validators().map_err(|e| extendr_api::Error::Other(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn clear_validators() -> Result<()> {
    kreuzberg::clear_validators().map_err(|e| extendr_api::Error::Other(e.to_string()))
}
...
pub fn embed_texts_async(texts: Vec<String>, config: &EmbeddingConfig) -> Result<String> {
    ...
    let rt = tokio::runtime::Runtime::new().map_err(|e| extendr_api::Error::Other(e.to_string()))?;
    let result = rt.block_on(async {
        kreuzberg::embed_texts_async(texts, &config_core)
            .await
            .map_err(|e| extendr_api::Error::Other(e.to_string()))
    })?;
...
pub fn detect_mime_type(path: String, check_exists: bool) -> Result<String> {
    kreuzberg::detect_mime_type(path, check_exists).map_err(|e| extendr_api::Error::Other(e.to_string()))
}
...
pub fn embed_texts(texts: Vec<String>, config: &EmbeddingConfig) -> Result<String> {
    let config_core: kreuzberg::EmbeddingConfig = config.clone().into();
    let result = kreuzberg::embed_texts(texts, &config_core).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
