...
// alef:hash:c6cba1c7fbafe8140c6a049afc2291666581d196a0aad7a502ce20a498d45dc5
...
#[extendr]
#[derive(Clone, Debug, Default, serde::Serialize, serde::Deserialize)]
#[serde(from = "kreuzberg::NodeContent2", into = "kreuzberg::NodeContent2")]
...
impl From<kreuzberg::NodeContent2> for NodeContent2 {
    fn from(value: kreuzberg::NodeContent2) -> Self {
        Self {
            __inner: serde_json::to_string(&value).unwrap_or_else(|_| "null".to_string()),
        }
    }
...
impl From<NodeContent2> for kreuzberg::NodeContent2 {
    fn from(value: NodeContent2) -> Self {
        if value.__inner.is_empty() {
            return <kreuzberg::NodeContent2>::default();
        }
        serde_json::from_str(&value.__inner).unwrap_or_default()
    }
}
...
impl NodeContent2 {
    #[allow(clippy::should_implement_trait)]
    pub fn default() -> NodeContent2 {
        <kreuzberg::NodeContent2>::default().into()
    }
    pub fn from_json(json: String) -> extendr_api::Result<NodeContent2> {
        let core: kreuzberg::NodeContent2 =
            serde_json::from_str(&json).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
        Ok(core.into())
    }
}
...
impl From<kreuzberg::DrawingType> for DrawingType {
    fn from(val: kreuzberg::DrawingType) -> Self {
        match val {
            kreuzberg::DrawingType::Inline => Self {
                format_type: "Inline".to_string(),
                ..Default::default()
            },
            kreuzberg::DrawingType::Anchored(_0) => Self {
                format_type: "Anchored".to_string(),
                anchored: Some(format!("{:?}", _0)),
                ..Default::default()
            },
        }
    }
...
impl From<DrawingType> for kreuzberg::DrawingType {
    fn from(val: DrawingType) -> Self {
        match val.format_type.as_str() {
            "Inline" => Self::Inline,
            "Anchored" => Self::Anchored(val.anchored.unwrap_or_default().into()),
            _ => Self::default(),
        }
    }
}
...
impl From<kreuzberg::FormatMetadata2> for FormatMetadata2 {
    fn from(val: kreuzberg::FormatMetadata2) -> Self {
        match val {
            kreuzberg::FormatMetadata2::Pdf(_0) => Self {
                format_type: "pdf".to_string(),
                pdf: Some(format!("{:?}", _0)),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Docx(_0) => Self {
                format_type: "docx".to_string(),
                docx: Some((*_0).into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Excel(_0) => Self {
                format_type: "excel".to_string(),
                excel: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Email(_0) => Self {
                format_type: "email".to_string(),
                email: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Pptx(_0) => Self {
                format_type: "pptx".to_string(),
                pptx: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Archive(_0) => Self {
                format_type: "archive".to_string(),
                archive: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Image(_0) => Self {
                format_type: "image".to_string(),
                image: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Xml(_0) => Self {
                format_type: "xml".to_string(),
                xml: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Text(_0) => Self {
                format_type: "text".to_string(),
                text: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Html(_0) => Self {
                format_type: "html".to_string(),
                html: Some((*_0).into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Ocr(_0) => Self {
                format_type: "ocr".to_string(),
                ocr: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Csv(_0) => Self {
                format_type: "csv".to_string(),
                csv: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Bibtex(_0) => Self {
                format_type: "bibtex".to_string(),
                bibtex: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Citation(_0) => Self {
                format_type: "citation".to_string(),
                citation: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::FictionBook(_0) => Self {
                format_type: "fiction_book".to_string(),
                fiction_book: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Dbf(_0) => Self {
                format_type: "dbf".to_string(),
                dbf: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Jats(_0) => Self {
                format_type: "jats".to_string(),
                jats: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Epub(_0) => Self {
                format_type: "epub".to_string(),
                epub: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Pst(_0) => Self {
                format_type: "pst".to_string(),
                pst: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::FormatMetadata2::Code(_0) => Self {
...
impl kreuzberg::plugins::OcrBackend for ROcrBackendBridge {
    ...
    fn backend_type(&self) -> kreuzberg::plugins::OcrBackendType {
        ...
        match result {
            ...
            Ok(val) => {
                let payload = val.as_str().unwrap_or("");
                match serde_json::from_str::<kreuzberg::plugins::OcrBackendType>(payload) {
                    Ok(parsed) => parsed,
                    Err(_) => Default::default(),
                }
            }
...
impl kreuzberg::plugins::PostProcessor for RPostProcessorBridge {
    ...
    fn processing_stage(&self) -> kreuzberg::plugins::ProcessingStage {
        ...
        match result {
            ...
            Ok(val) => {
                let payload = val.as_str().unwrap_or("");
                match serde_json::from_str::<kreuzberg::plugins::ProcessingStage>(payload) {
                    Ok(parsed) => parsed,
                    Err(_) => Default::default(),
                }
            }
...
#[async_trait::async_trait]
impl kreuzberg::plugins::DocumentExtractor for RDocumentExtractorBridge {
    async fn extract_bytes(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            match result {
                ...
                Ok(val) => {
                    let payload = val.as_str().unwrap_or("");
                    serde_json::from_str::<kreuzberg::internal::InternalDocument>(payload).map_err(|_| {
                        kreuzberg::KreuzbergError::Other(format!(
...
impl kreuzberg::plugins::Renderer for RRendererBridge {
    fn render(
        &self,
