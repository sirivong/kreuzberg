...
impl LlmBackend {
    ...
    pub fn detect(&self, text: String, categories: Vec<EntityCategory>) -> Result<Vec<Entity>> {
        let categories_core: Vec<_> = categories.into_iter().map(Into::into).collect();

        let _ = (text, categories);
        compile_error!(
            "alef cannot auto-delegate `LlmBackend.detect`; configure an adapter body or exclude this item from the backend"
        )
    }
    ...
    pub fn detect_with_custom(
        ...
        compile_error!(
            "alef cannot auto-delegate `LlmBackend.detect_with_custom`; configure an adapter body or exclude this item from the backend"
        )
    }
}
...
impl DiffOptions {
    ...
    pub fn from_json(json: String) -> extendr_api::Result<DiffOptions> {
        let core: kreuzberg::DiffOptions =
            serde_json::from_str(&json).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
        Ok(core.into())
    }
}
...
impl From<kreuzberg::ExecutionProviderType> for ExecutionProviderType {
    fn from(value: kreuzberg::ExecutionProviderType) -> Self {
...
impl From<ExecutionProviderType> for kreuzberg::ExecutionProviderType {
    fn from(value: ExecutionProviderType) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::ExecutionProviderType>::default(),
        }
    }
}
...
impl From<kreuzberg::HtmlTheme> for HtmlTheme {
    fn from(value: kreuzberg::HtmlTheme) -> Self {
        let mode = match value {
...
impl From<kreuzberg::TableModel> for TableModel {
    fn from(value: kreuzberg::TableModel) -> Self {
        let mode = match value {
            kreuzberg::TableModel::Tatr => "tatr".to_string(),
            kreuzberg::TableModel::SlanetWired => "slanet_wired".to_string(),
            kreuzberg::TableModel::SlanetWireless => "slanet_wireless".to_string(),
            kreuzberg::TableModel::SlanetPlus => "slanet_plus".to_string(),
            kreuzberg::TableModel::SlanetAuto => "slanet_auto".to_string(),
            kreuzberg::TableModel::Disabled => "disabled".to_string(),
        };
        Self { mode }
    }
}
...
impl From<TableModel> for kreuzberg::TableModel {
    fn from(value: TableModel) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::TableModel>::default(),
        }
    }
}
...
impl From<kreuzberg::NerBackendKind> for NerBackendKind {
    fn from(value: kreuzberg::NerBackendKind) -> Self {
        let mode = match value {
            kreuzberg::NerBackendKind::Onnx => "onnx".to_string(),
            kreuzberg::NerBackendKind::Llm => "llm".to_string(),
        };
        Self { mode }
    }
}
...
impl From<NerBackendKind> for kreuzberg::NerBackendKind {
    fn from(value: NerBackendKind) -> Self {
        match value.mode.as_str() {
            "onnx" => kreuzberg::NerBackendKind::Onnx,
            "llm" => kreuzberg::NerBackendKind::Llm,
            _ => <kreuzberg::NerBackendKind>::default(),
        }
    }
}
...
impl From<kreuzberg::ChunkerType> for ChunkerType {
    fn from(value: kreuzberg::ChunkerType) -> Self {
        let mode = match value {
...
impl From<ChunkerType> for kreuzberg::ChunkerType {
    fn from(value: ChunkerType) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::ChunkerType>::default(),
        }
    }
}
...
impl From<kreuzberg::WhisperModel> for WhisperModel {
    fn from(value: kreuzberg::WhisperModel) -> Self {
        let mode = match value {
            kreuzberg::WhisperModel::Tiny => "tiny".to_string(),
            kreuzberg::WhisperModel::Base => "base".to_string(),
            kreuzberg::WhisperModel::Small => "small".to_string(),
            kreuzberg::WhisperModel::Medium => "medium".to_string(),
            kreuzberg::WhisperModel::LargeV3 => "large_v3".to_string(),
        };
        Self { mode }
    }
}
...
impl From<WhisperModel> for kreuzberg::WhisperModel {
    fn from(value: WhisperModel) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::WhisperModel>::default(),
        }
    }
}
...
impl From<kreuzberg::CodeContentMode> for CodeContentMode {
    fn from(value: kreuzberg::CodeContentMode) -> Self {
        let mode = match value {
            kreuzberg::CodeContentMode::Chunks => "chunks".to_string(),
            kreuzberg::CodeContentMode::Raw => "raw".to_string(),
            kreuzberg::CodeContentMode::Structure => "structure".to_string(),
        };
        Self { mode }
    }
}
...
impl From<kreuzberg::ListType> for ListType {
    fn from(value: kreuzberg::ListType) -> Self {
        let mode = match value {
            kreuzberg::ListType::Bullet => "Bullet".to_string(),
            kreuzberg::ListType::Numbered => "Numbered".to_string(),
            kreuzberg::ListType::Lettered => "Lettered".to_string(),
            kreuzberg::ListType::Indented => "Indented".to_string(),
        };
        Self { mode }
    }
}

impl From<ListType> for kreuzberg::ListType {
    fn from(value: ListType) -> Self {
        match value.mode.as_str() {
            "Bullet" => kreuzberg::ListType::Bullet,
            "Numbered" => kreuzberg::ListType::Numbered,
            "Lettered" => kreuzberg::ListType::Lettered,
            "Indented" => kreuzberg::ListType::Indented,
            _ => <kreuzberg::ListType>::default(),
        }
    }
}
...
impl From<kreuzberg::OcrBackendType> for OcrBackendType {
    fn from(value: kreuzberg::OcrBackendType) -> Self {
        let mode = match value {
            kreuzberg::OcrBackendType::Tesseract => "Tesseract".to_string(),
            kreuzberg::OcrBackendType::EasyOCR => "EasyOCR".to_string(),
            kreuzberg::OcrBackendType::PaddleOCR => "PaddleOCR".to_string(),
            kreuzberg::OcrBackendType::Custom => "Custom".to_string(),
        };
        Self { mode }
    }
}
...
impl From<OcrBackendType> for kreuzberg::OcrBackendType {
    fn from(value: OcrBackendType) -> Self {
        match value.mode.as_str() {
            "Tesseract" => kreuzberg::OcrBackendType::Tesseract,
            "EasyOCR" => kreuzberg::OcrBackendType::EasyOCR,
            "PaddleOCR" => kreuzberg::OcrBackendType::PaddleOCR,
            "Custom" => kreuzberg::OcrBackendType::Custom,
            _ => <kreuzberg::OcrBackendType>::default(),
        }
    }
}
...
impl From<kreuzberg::ProcessingStage> for ProcessingStage {
    fn from(value: kreuzberg::ProcessingStage) -> Self {
        let mode = match value {
            kreuzberg::ProcessingStage::Early => "Early".to_string(),
            kreuzberg::ProcessingStage::Middle => "Middle".to_string(),
            kreuzberg::ProcessingStage::Late => "Late".to_string(),
        };
        Self { mode }
    }
}
...
impl From<ProcessingStage> for kreuzberg::ProcessingStage {
    fn from(value: ProcessingStage) -> Self {
        match value.mode.as_str() {
            "Early" => kreuzberg::ProcessingStage::Early,
            "Middle" => kreuzberg::ProcessingStage::Middle,
            "Late" => kreuzberg::ProcessingStage::Late,
            _ => <kreuzberg::ProcessingStage>::default(),
        }
    }
}
...
impl From<kreuzberg::ReductionLevel> for ReductionLevel {
    fn from(value: kreuzberg::ReductionLevel) -> Self {
        let mode = match value {
            kreuzberg::ReductionLevel::Off => "Off".to_string(),
            kreuzberg::ReductionLevel::Light => "Light".to_string(),
            kreuzberg::ReductionLevel::Moderate => "Moderate".to_string(),
            kreuzberg::ReductionLevel::Aggressive => "Aggressive".to_string(),
            kreuzberg::ReductionLevel::Maximum => "Maximum".to_string(),
        };
        Self { mode }
    }
}
...
impl From<ReductionLevel> for kreuzberg::ReductionLevel {
    fn from(value: ReductionLevel) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::ReductionLevel>::default(),
        }
    }
}
...
impl From<kreuzberg::PdfAnnotationType> for PdfAnnotationType {
    fn from(value: kreuzberg::PdfAnnotationType) -> Self {
        let mode = match value {
            kreuzberg::PdfAnnotationType::Text => "text".to_string(),
            kreuzberg::PdfAnnotationType::Highlight => "highlight".to_string(),
            kreuzberg::PdfAnnotationType::Link => "link".to_string(),
            kreuzberg::PdfAnnotationType::Stamp => "stamp".to_string(),
            kreuzberg::PdfAnnotationType::Underline => "underline".to_string(),
            kreuzberg::PdfAnnotationType::StrikeOut => "strike_out".to_string(),
            kreuzberg::PdfAnnotationType::Other => "other".to_string(),
        };
        Self { mode }
    }
}
...
impl From<PdfAnnotationType> for kreuzberg::PdfAnnotationType {
    fn from(value: PdfAnnotationType) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::PdfAnnotationType>::default(),
        }
    }
}
...
impl From<kreuzberg::BlockType> for BlockType {
    fn from(value: kreuzberg::BlockType) -> Self {
        let mode = match value {
            kreuzberg::BlockType::Paragraph => "paragraph".to_string(),
            kreuzberg::BlockType::Heading => "heading".to_string(),
            kreuzberg::BlockType::Blockquote => "blockquote".to_string(),
            kreuzberg::BlockType::CodeBlock => "code_block".to_string(),
            kreuzberg::BlockType::ListItem => "list_item".to_string(),
            kreuzberg::BlockType::OrderedList => "ordered_list".to_string(),
            kreuzberg::BlockType::BulletList => "bullet_list".to_string(),
            kreuzberg::BlockType::TaskList => "task_list".to_string(),
            kreuzberg::BlockType::DefinitionList => "definition_list".to_string(),
            kreuzberg::BlockType::DefinitionTerm => "definition_term".to_string(),
            kreuzberg::BlockType::DefinitionDescription => "definition_description".to_string(),
            kreuzberg::BlockType::Div => "div".to_string(),
            kreuzberg::BlockType::Section => "section".to_string(),
            kreuzberg::BlockType::ThematicBreak => "thematic_break".to_string(),
            kreuzberg::BlockType::RawBlock => "raw_block".to_string(),
            kreuzberg::BlockType::MathDisplay => "math_display".to_string(),
        };
        Self { mode }
    }
}
...
impl From<kreuzberg::InlineType> for InlineType {
    fn from(value: kreuzberg::InlineType) -> Self {
        let mode = match value {
            kreuzberg::InlineType::Text => "text".to_string(),
            kreuzberg::InlineType::Strong => "strong".to_string(),
            kreuzberg::InlineType::Emphasis => "emphasis".to_string(),
            kreuzberg::InlineType::Highlight => "highlight".to_string(),
            kreuzberg::InlineType::Subscript => "subscript".to_string(),
            kreuzberg::InlineType::Superscript => "superscript".to_string(),
            kreuzberg::InlineType::Insert => "insert".to_string(),
            kreuzberg::InlineType::Delete => "delete".to_string(),
            kreuzberg::InlineType::Code => "code".to_string(),
            kreuzberg::InlineType::Link => "link".to_string(),
            kreuzberg::InlineType::Image => "image".to_string(),
            kreuzberg::InlineType::Span => "span".to_string(),
            kreuzberg::InlineType::Math => "math".to_string(),
            kreuzberg::InlineType::RawInline => "raw_inline".to_string(),
            kreuzberg::InlineType::FootnoteRef => "footnote_ref".to_string(),
            kreuzberg::InlineType::Symbol => "symbol".to_string(),
        };
        Self { mode }
    }
}
...
impl From<InlineType> for kreuzberg::InlineType {
    fn from(value: InlineType) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::InlineType>::default(),
        }
    }
}
...
impl From<kreuzberg::RelationshipKind> for RelationshipKind {
    fn from(value: kreuzberg::RelationshipKind) -> Self {
        let mode = match value {
            kreuzberg::RelationshipKind::FootnoteReference => "footnote_reference".to_string(),
            kreuzberg::RelationshipKind::CitationReference => "citation_reference".to_string(),
            kreuzberg::RelationshipKind::InternalLink => "internal_link".to_string(),
            kreuzberg::RelationshipKind::Caption => "caption".to_string(),
            kreuzberg::RelationshipKind::Label => "label".to_string(),
            kreuzberg::RelationshipKind::TocEntry => "toc_entry".to_string(),
            kreuzberg::RelationshipKind::CrossReference => "cross_reference".to_string(),
        };
        Self { mode }
    }
}
...
impl From<RelationshipKind> for kreuzberg::RelationshipKind {
    fn from(value: RelationshipKind) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::RelationshipKind>::default(),
        }
    }
}
...
impl From<kreuzberg::ContentLayer> for ContentLayer {
    fn from(value: kreuzberg::ContentLayer) -> Self {
        let mode = match value {
            kreuzberg::ContentLayer::Body => "body".to_string(),
            kreuzberg::ContentLayer::Header => "header".to_string(),
            kreuzberg::ContentLayer::Footer => "footer".to_string(),
            kreuzberg::ContentLayer::Footnote => "footnote".to_string(),
        };
        Self { mode }
    }
}
...
impl From<ContentLayer> for kreuzberg::ContentLayer {
    fn from(value: ContentLayer) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::ContentLayer>::default(),
        }
    }
}
...
impl From<kreuzberg::ExtractionMethod> for ExtractionMethod {
    fn from(value: kreuzberg::ExtractionMethod) -> Self {
        let mode = match value {
            kreuzberg::ExtractionMethod::Native => "native".to_string(),
            kreuzberg::ExtractionMethod::Ocr => "ocr".to_string(),
            kreuzberg::ExtractionMethod::Mixed => "mixed".to_string(),
        };
        Self { mode }
    }
}
...
impl From<ExtractionMethod> for kreuzberg::ExtractionMethod {
    fn from(value: ExtractionMethod) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::ExtractionMethod>::default(),
        }
    }
}
...
impl From<kreuzberg::ChunkType> for ChunkType {
    fn from(value: kreuzberg::ChunkType) -> Self {
        let mode = match value {
            kreuzberg::ChunkType::Heading => "heading".to_string(),
            kreuzberg::ChunkType::PartyList => "party_list".to_string(),
            kreuzberg::ChunkType::Definitions => "definitions".to_string(),
            kreuzberg::ChunkType::OperativeClause => "operative_clause".to_string(),
            kreuzberg::ChunkType::SignatureBlock => "signature_block".to_string(),
            kreuzberg::ChunkType::Schedule => "schedule".to_string(),
            kreuzberg::ChunkType::TableLike => "table_like".to_string(),
            kreuzberg::ChunkType::Formula => "formula".to_string(),
            kreuzberg::ChunkType::CodeBlock => "code_block".to_string(),
            kreuzberg::ChunkType::Image => "image".to_string(),
            kreuzberg::ChunkType::OrgChart => "org_chart".to_string(),
            kreuzberg::ChunkType::Diagram => "diagram".to_string(),
            kreuzberg::ChunkType::Unknown => "unknown".to_string(),
        };
        Self { mode }
    }
}
...
impl From<kreuzberg::ImageKind> for ImageKind {
    fn from(value: kreuzberg::ImageKind) -> Self {
        let mode = match value {
            kreuzberg::ImageKind::Photograph => "photograph".to_string(),
            kreuzberg::ImageKind::Diagram => "diagram".to_string(),
            kreuzberg::ImageKind::Chart => "chart".to_string(),
            kreuzberg::ImageKind::Drawing => "drawing".to_string(),
            kreuzberg::ImageKind::TextBlock => "text_block".to_string(),
            kreuzberg::ImageKind::Decoration => "decoration".to_string(),
            kreuzberg::ImageKind::Logo => "logo".to_string(),
            kreuzberg::ImageKind::Icon => "icon".to_string(),
            kreuzberg::ImageKind::TileFragment => "tile_fragment".to_string(),
            kreuzberg::ImageKind::Mask => "mask".to_string(),
            kreuzberg::ImageKind::PageRaster => "page_raster".to_string(),
            kreuzberg::ImageKind::Unknown => "unknown".to_string(),
        };
        Self { mode }
    }
}
...
impl From<kreuzberg::ResultFormat> for ResultFormat {
    fn from(value: kreuzberg::ResultFormat) -> Self {
        let mode = match value {
            kreuzberg::ResultFormat::Unified => "unified".to_string(),
            kreuzberg::ResultFormat::ElementBased => "element_based".to_string(),
        };
        Self { mode }
    }
}
...
impl From<kreuzberg::ElementType> for ElementType {
    fn from(value: kreuzberg::ElementType) -> Self {
        let mode = match value {
            kreuzberg::ElementType::Title => "title".to_string(),
            kreuzberg::ElementType::NarrativeText => "narrative_text".to_string(),
            kreuzberg::ElementType::Heading => "heading".to_string(),
            kreuzberg::ElementType::ListItem => "list_item".to_string(),
            kreuzberg::ElementType::Table => "table".to_string(),
            kreuzberg::ElementType::Image => "image".to_string(),
            kreuzberg::ElementType::PageBreak => "page_break".to_string(),
            kreuzberg::ElementType::CodeBlock => "code_block".to_string(),
            kreuzberg::ElementType::BlockQuote => "block_quote".to_string(),
            kreuzberg::ElementType::Footer => "footer".to_string(),
            kreuzberg::ElementType::Header => "header".to_string(),
        };
        Self { mode }
    }
}
...
impl From<ElementType> for kreuzberg::ElementType {
    fn from(value: ElementType) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::ElementType>::default(),
        }
    }
}
...
impl From<kreuzberg::TextDirection> for TextDirection {
    fn from(value: kreuzberg::TextDirection) -> Self {
        let mode = match value {
            kreuzberg::TextDirection::LeftToRight => "ltr".to_string(),
            kreuzberg::TextDirection::RightToLeft => "rtl".to_string(),
            kreuzberg::TextDirection::Auto => "auto".to_string(),
        };
        Self { mode }
    }
}
...
impl From<TextDirection> for kreuzberg::TextDirection {
    fn from(value: TextDirection) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::TextDirection>::default(),
        }
    }
}
...
impl From<kreuzberg::LinkType> for LinkType {
    fn from(value: kreuzberg::LinkType) -> Self {
        let mode = match value {
            kreuzberg::LinkType::Anchor => "anchor".to_string(),
            kreuzberg::LinkType::Internal => "internal".to_string(),
            kreuzberg::LinkType::External => "external".to_string(),
            kreuzberg::LinkType::Email => "email".to_string(),
            kreuzberg::LinkType::Phone => "phone".to_string(),
            kreuzberg::LinkType::Other => "other".to_string(),
        };
        Self { mode }
    }
}
...
impl From<kreuzberg::ImageType> for ImageType {
    fn from(value: kreuzberg::ImageType) -> Self {
        let mode = match value {
            kreuzberg::ImageType::DataUri => "data-uri".to_string(),
            kreuzberg::ImageType::InlineSvg => "inline-svg".to_string(),
            kreuzberg::ImageType::External => "external".to_string(),
            kreuzberg::ImageType::Relative => "relative".to_string(),
        };
        Self { mode }
    }
}
...
impl From<kreuzberg::StructuredDataType> for StructuredDataType {
    fn from(value: kreuzberg::StructuredDataType) -> Self {
        let mode = match value {
            kreuzberg::StructuredDataType::JsonLd => "json-ld".to_string(),
            kreuzberg::StructuredDataType::Microdata => "microdata".to_string(),
            kreuzberg::StructuredDataType::RDFa => "rdfa".to_string(),
        };
        Self { mode }
    }
}
...
impl From<StructuredDataType> for kreuzberg::StructuredDataType {
    fn from(value: StructuredDataType) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::StructuredDataType>::default(),
        }
    }
}
...
impl From<kreuzberg::OcrElementLevel> for OcrElementLevel {
    fn from(value: kreuzberg::OcrElementLevel) -> Self {
        let mode = match value {
...
impl From<OcrElementLevel> for kreuzberg::OcrElementLevel {
    fn from(value: OcrElementLevel) -> Self {
        match value.mode.as_str() {
...
impl From<kreuzberg::PageUnitType> for PageUnitType {
    fn from(value: kreuzberg::PageUnitType) -> Self {
        let mode = match value {
            kreuzberg::PageUnitType::Page => "page".to_string(),
            kreuzberg::PageUnitType::Slide => "slide".to_string(),
            kreuzberg::PageUnitType::Sheet => "sheet".to_string(),
        };
        Self { mode }
    }
}
...
impl From<kreuzberg::RedactionStrategy> for RedactionStrategy {
    fn from(value: kreuzberg::RedactionStrategy) -> Self {
        let mode = match value {
            kreuzberg::RedactionStrategy::Mask => "mask".to_string(),
            kreuzberg::RedactionStrategy::Hash => "hash".to_string(),
            kreuzberg::RedactionStrategy::TokenReplace => "token_replace".to_string(),
            kreuzberg::RedactionStrategy::Drop => "drop".to_string(),
        };
        Self { mode }
    }
}
...
impl From<RedactionStrategy> for kreuzberg::RedactionStrategy {
    fn from(value: RedactionStrategy) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::RedactionStrategy>::default(),
        }
    }
}
...
impl From<kreuzberg::RevisionKind> for RevisionKind {
    fn from(value: kreuzberg::RevisionKind) -> Self {
        let mode = match value {
            kreuzberg::RevisionKind::Insertion => "insertion".to_string(),
            kreuzberg::RevisionKind::Deletion => "deletion".to_string(),
            kreuzberg::RevisionKind::FormatChange => "format_change".to_string(),
            kreuzberg::RevisionKind::Comment => "comment".to_string(),
        };
        Self { mode }
    }
}
...
impl From<RevisionKind> for kreuzberg::RevisionKind {
    fn from(value: RevisionKind) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::RevisionKind>::default(),
        }
    }
}
...
impl From<kreuzberg::SummaryStrategy> for SummaryStrategy {
    fn from(value: kreuzberg::SummaryStrategy) -> Self {
        let mode = match value {
            kreuzberg::SummaryStrategy::Extractive => "extractive".to_string(),
            kreuzberg::SummaryStrategy::Abstractive => "abstractive".to_string(),
        };
        Self { mode }
    }
}
...
impl From<kreuzberg::UriKind> for UriKind {
    fn from(value: kreuzberg::UriKind) -> Self {
        let mode = match value {
            kreuzberg::UriKind::Hyperlink => "hyperlink".to_string(),
            kreuzberg::UriKind::Image => "image".to_string(),
            kreuzberg::UriKind::Anchor => "anchor".to_string(),
            kreuzberg::UriKind::Citation => "citation".to_string(),
            kreuzberg::UriKind::Reference => "reference".to_string(),
            kreuzberg::UriKind::Email => "email".to_string(),
        };
        Self { mode }
    }
}
...
impl From<kreuzberg::RegionKind> for RegionKind {
    fn from(value: kreuzberg::RegionKind) -> Self {
        let mode = match value {
            kreuzberg::RegionKind::Figure => "Figure".to_string(),
            kreuzberg::RegionKind::DenseTable => "DenseTable".to_string(),
            kreuzberg::RegionKind::ComplexLayout => "ComplexLayout".to_string(),
            kreuzberg::RegionKind::Caption => "Caption".to_string(),
        };
        Self { mode }
    }
}
...
impl From<RegionKind> for kreuzberg::RegionKind {
    fn from(value: RegionKind) -> Self {
        match value.mode.as_str() {
            "Figure" => kreuzberg::RegionKind::Figure,
            "DenseTable" => kreuzberg::RegionKind::DenseTable,
            "ComplexLayout" => kreuzberg::RegionKind::ComplexLayout,
            "Caption" => kreuzberg::RegionKind::Caption,
            _ => <kreuzberg::RegionKind>::default(),
        }
    }
}
...
impl From<kreuzberg::KeywordAlgorithm> for KeywordAlgorithm {
    fn from(value: kreuzberg::KeywordAlgorithm) -> Self {
        let mode = match value {
            kreuzberg::KeywordAlgorithm::Yake => "yake".to_string(),
            kreuzberg::KeywordAlgorithm::Rake => "rake".to_string(),
        };
        Self { mode }
    }
}
...
impl From<kreuzberg::PSMMode> for PSMMode {
    fn from(value: kreuzberg::PSMMode) -> Self {
        let mode = match value {
            kreuzberg::PSMMode::OsdOnly => "OsdOnly".to_string(),
            kreuzberg::PSMMode::AutoOsd => "AutoOsd".to_string(),
            kreuzberg::PSMMode::AutoOnly => "AutoOnly".to_string(),
            kreuzberg::PSMMode::Auto => "Auto".to_string(),
            kreuzberg::PSMMode::SingleColumn => "SingleColumn".to_string(),
            kreuzberg::PSMMode::SingleBlockVertical => "SingleBlockVertical".to_string(),
            kreuzberg::PSMMode::SingleBlock => "SingleBlock".to_string(),
            kreuzberg::PSMMode::SingleLine => "SingleLine".to_string(),
            kreuzberg::PSMMode::SingleWord => "SingleWord".to_string(),
            kreuzberg::PSMMode::CircleWord => "CircleWord".to_string(),
            kreuzberg::PSMMode::SingleChar => "SingleChar".to_string(),
        };
        Self { mode }
    }
}

impl From<PSMMode> for kreuzberg::PSMMode {
    fn from(value: PSMMode) -> Self {
        match value.mode.as_str() {
            "OsdOnly" => kreuzberg::PSMMode::OsdOnly,
            "AutoOsd" => kreuzberg::PSMMode::AutoOsd,
            "AutoOnly" => kreuzberg::PSMMode::AutoOnly,
            "Auto" => kreuzberg::PSMMode::Auto,
            "SingleColumn" => kreuzberg::PSMMode::SingleColumn,
            "SingleBlockVertical" => kreuzberg::PSMMode::SingleBlockVertical,
            "SingleBlock" => kreuzberg::PSMMode::SingleBlock,
            "SingleLine" => kreuzberg::PSMMode::SingleLine,
            "SingleWord" => kreuzberg::PSMMode::SingleWord,
            "CircleWord" => kreuzberg::PSMMode::CircleWord,
            "SingleChar" => kreuzberg::PSMMode::SingleChar,
            _ => <kreuzberg::PSMMode>::default(),
        }
    }
}
...
impl From<kreuzberg::PaddleLanguage> for PaddleLanguage {
    fn from(value: kreuzberg::PaddleLanguage) -> Self {
        let mode = match value {
            kreuzberg::PaddleLanguage::English => "English".to_string(),
            kreuzberg::PaddleLanguage::Chinese => "Chinese".to_string(),
            kreuzberg::PaddleLanguage::Japanese => "Japanese".to_string(),
            kreuzberg::PaddleLanguage::Korean => "Korean".to_string(),
            kreuzberg::PaddleLanguage::German => "German".to_string(),
            kreuzberg::PaddleLanguage::French => "French".to_string(),
            kreuzberg::PaddleLanguage::Latin => "Latin".to_string(),
            kreuzberg::PaddleLanguage::Cyrillic => "Cyrillic".to_string(),
            kreuzberg::PaddleLanguage::TraditionalChinese => "TraditionalChinese".to_string(),
            kreuzberg::PaddleLanguage::Thai => "Thai".to_string(),
            kreuzberg::PaddleLanguage::Greek => "Greek".to_string(),
            kreuzberg::PaddleLanguage::EastSlavic => "EastSlavic".to_string(),
            kreuzberg::PaddleLanguage::Arabic => "Arabic".to_string(),
            kreuzberg::PaddleLanguage::Devanagari => "Devanagari".to_string(),
            kreuzberg::PaddleLanguage::Tamil => "Tamil".to_string(),
            kreuzberg::PaddleLanguage::Telugu => "Telugu".to_string(),
        };
        Self { mode }
    }
}

impl From<PaddleLanguage> for kreuzberg::PaddleLanguage {
    fn from(value: PaddleLanguage) -> Self {
        match value.mode.as_str() {
            "English" => kreuzberg::PaddleLanguage::English,
            "Chinese" => kreuzberg::PaddleLanguage::Chinese,
            "Japanese" => kreuzberg::PaddleLanguage::Japanese,
            "Korean" => kreuzberg::PaddleLanguage::Korean,
            "German" => kreuzberg::PaddleLanguage::German,
            "French" => kreuzberg::PaddleLanguage::French,
            "Latin" => kreuzberg::PaddleLanguage::Latin,
            "Cyrillic" => kreuzberg::PaddleLanguage::Cyrillic,
            "TraditionalChinese" => kreuzberg::PaddleLanguage::TraditionalChinese,
            "Thai" => kreuzberg::PaddleLanguage::Thai,
            "Greek" => kreuzberg::PaddleLanguage::Greek,
            "EastSlavic" => kreuzberg::PaddleLanguage::EastSlavic,
            "Arabic" => kreuzberg::PaddleLanguage::Arabic,
            "Devanagari" => kreuzberg::PaddleLanguage::Devanagari,
            "Tamil" => kreuzberg::PaddleLanguage::Tamil,
            "Telugu" => kreuzberg::PaddleLanguage::Telugu,
            _ => <kreuzberg::PaddleLanguage>::default(),
        }
    }
}
...
impl From<kreuzberg::LayoutClass> for LayoutClass {
    fn from(value: kreuzberg::LayoutClass) -> Self {
        let mode = match value {
            kreuzberg::LayoutClass::Caption => "caption".to_string(),
            kreuzberg::LayoutClass::Footnote => "footnote".to_string(),
            kreuzberg::LayoutClass::Formula => "formula".to_string(),
            kreuzberg::LayoutClass::ListItem => "list_item".to_string(),
            kreuzberg::LayoutClass::PageFooter => "page_footer".to_string(),
            kreuzberg::LayoutClass::PageHeader => "page_header".to_string(),
            kreuzberg::LayoutClass::Picture => "picture".to_string(),
            kreuzberg::LayoutClass::SectionHeader => "section_header".to_string(),
            kreuzberg::LayoutClass::Table => "table".to_string(),
            kreuzberg::LayoutClass::Text => "text".to_string(),
            kreuzberg::LayoutClass::Title => "title".to_string(),
            kreuzberg::LayoutClass::DocumentIndex => "document_index".to_string(),
            kreuzberg::LayoutClass::Code => "code".to_string(),
            kreuzberg::LayoutClass::CheckboxSelected => "checkbox_selected".to_string(),
            kreuzberg::LayoutClass::CheckboxUnselected => "checkbox_unselected".to_string(),
            kreuzberg::LayoutClass::Form => "form".to_string(),
            kreuzberg::LayoutClass::KeyValueRegion => "key_value_region".to_string(),
        };
        Self { mode }
    }
}
...
impl From<LayoutClass> for kreuzberg::LayoutClass {
    fn from(value: LayoutClass) -> Self {
        match value.mode.as_str() {
            ...
            _ => <kreuzberg::LayoutClass>::default(),
        }
    }
}
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_bytes(content: Vec<u8>, mime_type: String, config: String) -> Result<String> {
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_file(path: String, mime_type: Option<String>, config: String) -> Result<String> {
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_file_sync(path: String, mime_type: Option<String>, config: String) -> Result<String> {
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_bytes_sync(content: Vec<u8>, mime_type: String, config: String) -> Result<String> {
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn batch_extract_files_sync(items: Vec<BatchFileItem>, config: String) -> Result<String> {
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
    ...
    let result = kreuzberg::batch_extract_files_sync(items, &config_core).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn batch_extract_bytes_sync(items: Vec<BatchBytesItem>, config: String) -> Result<String> {
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
    ...
    let result = kreuzberg::batch_extract_bytes_sync(items, &config_core).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn batch_extract_files(items: Vec<BatchFileItem>, config: String) -> Result<String> {
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
    ...
    let result = rt.block_on(async {
        kreuzberg::batch_extract_files(items, &config_core).await.map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn batch_extract_bytes(items: Vec<BatchBytesItem>, config: String) -> Result<String> {
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
    ...
    let result = rt.block_on(async {
        kreuzberg::batch_extract_bytes(items, &config_core).await.map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
...
pub fn list_embedding_backends() -> Result<Vec<String>> {
    kreuzberg::list_embedding_backends().map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
pub fn register_builtin() -> Result<()> {
    kreuzberg::plugins::processor::builtin::register_builtin().map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
pub fn list_renderers() -> Result<Vec<String>> {
    kreuzberg::list_renderers().map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn classify_pages(result: String, config: String) -> Result<String> {
    let mut result_core: kreuzberg::ExtractionResult = serde_json::from_str(&result).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
    ...
    let config_core: kreuzberg::PageClassificationConfig = serde_json::from_str(&config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
    ...
    let result = rt.block_on(async {
        kreuzberg::text::classification::classify_pages(&mut result_core, &config_core)
            .await
            .map_err(|e| {
                extendr_api::Error::Other(
                    e.to_string()
...
pub fn redact(result: String, config: String) -> Result<String> {
    ...
    let config_core: kreuzberg::RedactionConfig = serde_json::from_str(&config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
    ...
    let result = rt.block_on(async {
        kreuzberg::text::redaction::redact(&mut result_core, &config_core)
            .await
            .map_err(|e| {
                extendr_api::Error::Other(
                    e.to_string()
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn scan_text(text: String, categories: String) -> Result<String> {
    let categories_core: Vec<kreuzberg::PiiCategory> = serde_json::from_str(&categories).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
    ...
    let result = kreuzberg::text::redaction::patterns::scan_text(&text, categories_core);
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn translate_result(result: String, config: String) -> Result<String> {
    let mut result_core: kreuzberg::ExtractionResult = serde_json::from_str(&result).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
    ...
    let config_core: kreuzberg::TranslationConfig = serde_json::from_str(&config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
    ...
    let result = rt.block_on(async {
        kreuzberg::text::translation::translate_result(&mut result_core, &config_core)
            .await
            .map_err(|e| {
                extendr_api::Error::Other(
                    e.to_string()
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn compare(a: String, b: String, opts: String) -> Result<String> {
    let a_core: kreuzberg::ExtractionResult = serde_json::from_str(&a).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
    ...
    let b_core: kreuzberg::ExtractionResult = serde_json::from_str(&b).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
    ...
    let opts_core: kreuzberg::DiffOptions = serde_json::from_str(&opts).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
pub fn extract_region_with_vlm(
    ...
    let region_kind_core: kreuzberg::RegionKind = serde_json::from_str(&region_kind).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
    ...
    let llm_config_core: kreuzberg::LlmConfig = serde_json::from_str(&llm_config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn embed_texts_async(_texts: Vec<String>, _config: String) -> Result<String> {
    let _config_core: kreuzberg::EmbeddingConfig = serde_json::from_str(&_config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
    ...
    let result = rt.block_on(async {
        kreuzberg::embed_texts_async(_texts, &_config_core).await.map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
...
impl kreuzberg::plugins::Plugin for ROcrBackendBridge {
    ...
    fn initialize(&self) -> std::result::Result<(), kreuzberg::KreuzbergError> {
        ...
        match result {
            Err(_) if true => Err(kreuzberg::KreuzbergError::Other(format!(
...
impl kreuzberg::OcrBackend for ROcrBackendBridge {
    async fn process_image(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let args = extendr_api::Pairlist::from_pairs(&[
                ...
                ("config", extendr_api::Robj::from(config_json.as_str())),
            ]);
            ...
            // the R side.
            match result {
                Err(_) => Err(kreuzberg::KreuzbergError::Other(format!(
                    "Plugin '{}' method 'process_image' failed",
                    cached_name_inner
                ))),
                Ok(val) => {
                    let payload = val.as_str().unwrap_or("");
                    serde_json::from_str::<kreuzberg::ExtractionResult>(payload).map_err(|_| {
...
#[async_trait::async_trait]
impl kreuzberg::PostProcessor for RPostProcessorBridge {
    async fn process(
        &self,
...
#[async_trait::async_trait]
impl kreuzberg::Validator for RValidatorBridge {
    async fn validate(
        &self,
...
#[async_trait::async_trait]
impl kreuzberg::EmbeddingBackend for REmbeddingBackendBridge {
...
#[async_trait::async_trait]
impl kreuzberg::DocumentExtractor for RDocumentExtractorBridge {
    async fn extract_bytes(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let fn_robj = match maybe_fn {
                ...
                _ => {
                    return Err(kreuzberg::KreuzbergError::Other(format!(
                        "Plugin '{}' missing method 'extract_bytes'",
                        cached_name_inner
                    )));
                }
            };
            ...
            let args = extendr_api::Pairlist::from_pairs(&[
                ("content", extendr_api::Robj::from(&content[..])),
                ("mime_type", extendr_api::Robj::from(mime_type)),
                ("config", extendr_api::Robj::from(config_json.as_str())),
            ]);
            let result = fn_robj.call(args);
            ...
            match result {
                ...
                Ok(val) => {
                    let payload = val.as_str().unwrap_or("");
                    serde_json::from_str::<kreuzberg::InternalDocument>(payload).map_err(|_| {
                        kreuzberg::KreuzbergError::Other(format!(
                            "Plugin '{}' method 'extract_bytes' deserialization failed",
                            cached_name_inner
                        ))
                    })
                }
    ...
    fn supported_mime_types(&self) -> &[&str] {
        let __types: Vec<String> = {
            let maybe_fn = self.inner.dollar("supported_mime_types");
            let fn_robj = match maybe_fn {
                Ok(v) if !v.is_null() && !v.is_na() => v,
                _ => return Default::default(),
            };
        ...
        match result {
            ...
            Ok(val) => {
                if let Some(s) = val.as_str() {
                    ...
                    Err(kreuzberg::KreuzbergError::Other(format!(
