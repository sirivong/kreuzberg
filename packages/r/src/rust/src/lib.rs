...
// alef:hash:159e91bb60e7163c2eead2150a0f7a854f1db54814762d8fcd33860df91c2d28
...
impl Metadata {
    pub fn is_empty(&self) -> bool {
        let core_self = kreuzberg::Metadata {
            ...
            sheet_count: self.sheet_count.map(|v| v as usize),
...
pub fn new_table(
    ...
    let mut __out = <Table>::default();
    if let Some(v) = cells {
        __out.cells = v;
    }
    if let Some(v) = markdown {
        __out.markdown = v;
    }
    if let Some(v) = page_number {
        __out.page_number = v;
