...
#[extendr]
pub fn extract_bytes(content: Vec<u8>, mime_type: String, config: &kreuzberg::ExtractionConfig) -> Result<String> {
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_file(path: String, mime_type: Option<String>, config: &kreuzberg::ExtractionConfig) -> Result<String> {
    let config_core: kreuzberg::ExtractionConfig = config.clone().into();
    let rt = tokio::runtime::Runtime::new().map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
...
pub fn extract_file_sync(
    ...
    let config_core: kreuzberg::ExtractionConfig = config.clone().into();
    let result =
        kreuzberg::extract_file_sync(std::path::PathBuf::from(path), mime_type.as_deref(), config).map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn extract_bytes_sync(content: Vec<u8>, mime_type: String, config: &kreuzberg::ExtractionConfig) -> Result<String> {
    let config_core: kreuzberg::ExtractionConfig = config.clone().into();
    let result = kreuzberg::extract_bytes_sync(&content, &mime_type, config).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn classify_pages(result: &ExtractionResult, config: &kreuzberg::PageClassificationConfig) -> Result<String> {
    ...
    let result = rt.block_on(async {
        kreuzberg::text::classification::classify_pages(result, config)
            .await
            .map_err(|e| {
                extendr_api::Error::Other(
                    e.to_string()
...
pub fn redact(result: &ExtractionResult, config: &RedactionConfig) -> Result<String> {
    let result_core: kreuzberg::ExtractionResult = result.clone().into();
    let config_core: kreuzberg::RedactionConfig = config.clone().into();
    let rt = tokio::runtime::Runtime::new().map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
    ...
    let result = rt.block_on(async {
        kreuzberg::text::redaction::redact(result, config).await.map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn translate_result(result: &ExtractionResult, config: &kreuzberg::TranslationConfig) -> Result<String> {
    let result_core: kreuzberg::ExtractionResult = result.clone().into();
    ...
    let result = rt.block_on(async {
        kreuzberg::text::translation::translate_result(result, config)
            .await
            .map_err(|e| {
                extendr_api::Error::Other(
                    e.to_string()
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn compare(a: &ExtractionResult, b: &ExtractionResult, opts: &kreuzberg::DiffOptions) -> Result<String> {
    ...
    let result = kreuzberg::compare(a, b, opts);
...
pub fn extract_region_with_vlm(
    ...
    image_mime: String,
    region_kind: String,
    llm_config: &kreuzberg::LlmConfig,
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn embed_texts_async(_texts: Vec<String>, _config: &kreuzberg::EmbeddingConfig) -> Result<String> {
    ...
    let result = rt.block_on(async {
        kreuzberg::embed_texts_async(_texts, _config).await.map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
