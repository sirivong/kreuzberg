...
public sealed record OcrTable
{
    ...
    public static OcrTable FromJson(string json)
    {
        try
        {
            ...
            ?? throw new XbergException($"Failed to parse OcrTable from JSON: deserializer returned null");
        }
        ...
        {
            throw new XbergException($"Failed to parse OcrTable from JSON: {e.Message}", e);
        }
    }
