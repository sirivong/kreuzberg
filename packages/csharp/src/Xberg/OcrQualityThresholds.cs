...
public sealed record OcrQualityThresholds
{
    ...
    public double MinUndecodableRatio { get; init; } = 0.0;
    ...
    public bool EnableProvenanceOcrRouting { get; init; } = false;
    ...
    public double MinProvenanceFallbackRatio { get; init; } = 0.0;
    ...
    public static OcrQualityThresholds FromJson(string json)
    {
        ...
        {
            throw new XbergException($"Failed to parse OcrQualityThresholds from JSON: {e.Message}", e);
        }
    }
