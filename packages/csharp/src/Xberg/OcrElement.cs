...
public sealed record OcrElement
{
    ...
    public Dictionary<string, JsonElement> BackendMetadata { get; init; } = new Dictionary<string, JsonElement>();
    ...
    public static OcrElement FromJson(string json)
    {
        ...
        {
            throw new XbergException($"Failed to parse OcrElement from JSON: {e.Message}", e);
        }
    }
