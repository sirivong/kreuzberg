...
public sealed record ImageExtractionConfig
{
    ...
    public bool Classify { get; init; } = false;
    ...
    public ImageOutputFormat OutputFormat { get; init; } = new ImageOutputFormat.Native();
    ...
    public SvgOptions Svg { get; init; } = default!;
    ...
    public bool IncludeDataBase64 { get; init; } = false;
    ...
    public static ImageExtractionConfig FromJson(string json)
    {
        ...
        {
            throw new XbergException($"Failed to parse ImageExtractionConfig from JSON: {e.Message}", e);
        }
    }
