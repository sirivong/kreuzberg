...
public sealed record PdfMetadata
{
    ...
    public float? ScannedConfidence { get; init; } = null;
    ...
    public List<uint>? ScannedPages { get; init; } = null;
    ...
    public static PdfMetadata FromJson(string json)
    {
        ...
        {
            throw new XbergException($"Failed to parse PdfMetadata from JSON: {e.Message}", e);
        }
    }
