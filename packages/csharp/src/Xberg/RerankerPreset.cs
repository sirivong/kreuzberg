    ...
    public static RerankerPreset FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<RerankerPreset>(json, JsonOptions)
                ?? throw new XbergException($"Failed to parse RerankerPreset from JSON: deserializer returned null");
        }
        ...
        {
            throw new XbergException($"Failed to parse RerankerPreset from JSON: {e.Message}", e);
        }
    }
