...
public sealed record ContentFilterConfig
{
    ...
    public static ContentFilterConfig FromJson(string json)
    {
        try
        {
            ...
            ?? throw new XbergException($"Failed to parse ContentFilterConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new XbergException($"Failed to parse ContentFilterConfig from JSON: {e.Message}", e);
        }
    }
