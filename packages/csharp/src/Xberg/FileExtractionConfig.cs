...
public sealed record FileExtractionConfig
{
    ...
    public OcrStrategy? OcrStrategy { get; init; } = null;
    ...
    public UrlExtractionConfig? Url { get; init; } = null;
    ...
    public static FileExtractionConfig FromJson(string json)
    {
        ...
        {
            throw new XbergException($"Failed to parse FileExtractionConfig from JSON: {e.Message}", e);
        }
    }
