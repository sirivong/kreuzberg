...
public sealed record Metadata
{
    ...
    public JsonElement? JsonSchema { get; init; } = null;
    ...
    public Dictionary<string, JsonElement> Additional { get; init; } = new Dictionary<string, JsonElement>();
    ...
    public static Metadata FromJson(string json)
    {
        ...
        {
            throw new XbergException($"Failed to parse Metadata from JSON: {e.Message}", e);
        }
    }
