    ...
    public static RerankerConfig FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<RerankerConfig>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse RerankerConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse RerankerConfig from JSON: {e.Message}", e);
        }
    }
