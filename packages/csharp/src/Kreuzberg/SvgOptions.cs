    ...
    public static SvgOptions FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<SvgOptions>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse SvgOptions from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse SvgOptions from JSON: {e.Message}", e);
        }
    }
