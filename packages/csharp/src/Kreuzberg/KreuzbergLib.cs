...
public static class KreuzbergLib
{
    ...
    public static async Task ClassifyPagesAsync(ExtractionResult result, PageClassificationConfig? config)
    {
        ...
        var configJson = JsonSerializer.Serialize((config ?? throw new ArgumentNullException(nameof(config), "PageClassificationConfig has required members; null is not accepted.")), JsonSerializationOptions);
    ...
    public static async Task RedactAsync(ExtractionResult result, RedactionConfig? config)
    {
        ...
        var configJson = JsonSerializer.Serialize((config ?? new RedactionConfig()), JsonSerializationOptions);
    ...
    public static async Task TranslateResultAsync(ExtractionResult result, TranslationConfig? config)
    {
        ...
        var configJson = JsonSerializer.Serialize((config ?? throw new ArgumentNullException(nameof(config), "TranslationConfig has required members; null is not accepted.")), JsonSerializationOptions);
