...
// alef:hash:f45d6f4b6c5be700468f3a1cf899447aaff4279a5b4e43f05935808fec43a9f2
...
,
    ...
    /// <param name="mimeType">Optional.</param>
    /// <param name="config"></param>
    public static ExtractionResult ExtractFileSync(string path
, string? mimeType
, ExtractionConfig config
)
    {
...
,
    ...
    /// <param name="mimeType"></param>
    /// <param name="config"></param>
    public static ExtractionResult ExtractBytesSync(byte[] content
, string mimeType
, ExtractionConfig config
)
    {
...
,
    ...
    /// <param name="config"></param>
    public static List<ExtractionResult> BatchExtractFilesSync(List<BatchFileItem> items
, ExtractionConfig config
)
    {
        ArgumentNullException.ThrowIfNull(config);
...
,
    ...
    /// <param name="items"></param>
    /// <param name="config"></param>
    public static List<ExtractionResult> BatchExtractBytesSync(List<BatchBytesItem> items
, ExtractionConfig config
)
    {
        ArgumentNullException.ThrowIfNull(config);
...
,
    ...
    /// <param name="items"></param>
    /// <param name="config"></param>
    public static async Task<List<ExtractionResult>>
 BatchExtractFiles(List<BatchFileItem> items
, ExtractionConfig config
)
    {
        ArgumentNullException.ThrowIfNull(config);
...
,
    ...
    /// <param name="config"></param>
    public static async Task<List<ExtractionResult>>
 BatchExtractBytes(List<BatchBytesItem> items
, ExtractionConfig config
)
    {
        ArgumentNullException.ThrowIfNull(config);
...
,
    ...
    /// <param name="config"></param>
    public static async Task<List<List<float>>>
 EmbedTextsAsync(List<string> texts
...
,
    ...
    private static Exception GetLastError()
    {
        ...
        if (code == 2) return new KreuzbergErrorException(message);
