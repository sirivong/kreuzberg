    ...
    public static Entity FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<Entity>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse Entity from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse Entity from JSON: {e.Message}", e);
        }
    }
