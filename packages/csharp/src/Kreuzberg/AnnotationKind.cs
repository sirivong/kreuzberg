...
// alef:hash:79820294adf5c6019193517f545fcbee808ee55f559eb9503dfc80bae69adaa4
...
public sealed class AnnotationKindJsonConverter : JsonConverter<AnnotationKind>
{
    public override AnnotationKind Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return tagValue switch
        {
            ...
            "link" => JsonSerializer.Deserialize<AnnotationKind.Link>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "highlight" => new AnnotationKind.Highlight(),
            "color" => JsonSerializer.Deserialize<AnnotationKind.Color>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
