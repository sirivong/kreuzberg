    ...
    public static FootnoteConfig FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<FootnoteConfig>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse FootnoteConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse FootnoteConfig from JSON: {e.Message}", e);
        }
    }
