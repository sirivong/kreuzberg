    ...
    public static Preset FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<Preset>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse Preset from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse Preset from JSON: {e.Message}", e);
        }
    }
