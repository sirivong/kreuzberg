    ...
    public static StructuredInput FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<StructuredInput>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse StructuredInput from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse StructuredInput from JSON: {e.Message}", e);
        }
    }
