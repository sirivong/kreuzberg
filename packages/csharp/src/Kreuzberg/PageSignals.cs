    ...
    public static PageSignals FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<PageSignals>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse PageSignals from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse PageSignals from JSON: {e.Message}", e);
        }
    }
