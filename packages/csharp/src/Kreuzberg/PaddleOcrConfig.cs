...
// alef:hash:fd9c2277b33007fee1e35e816494c9f6a8f70afeb793423f2e4a487ca299287b
...
public sealed class PaddleOcrConfig
{
    ...
    public float DetDbThresh { get; set; } = 0.0f;
    ...
    public float DetDbBoxThresh { get; set; } = 0.0f;
    ...
    public float DetDbUnclipRatio { get; set; } = 0.0f;
    ...
    public float DropScore { get; set; } = 0.0f;
