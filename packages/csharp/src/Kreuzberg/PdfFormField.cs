    ...
    public static PdfFormField FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<PdfFormField>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse PdfFormField from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse PdfFormField from JSON: {e.Message}", e);
        }
    }
