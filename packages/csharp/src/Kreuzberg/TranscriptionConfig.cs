    ...
    public static TranscriptionConfig FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<TranscriptionConfig>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse TranscriptionConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse TranscriptionConfig from JSON: {e.Message}", e);
        }
    }
