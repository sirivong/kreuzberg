    ...
    public static EnrichOptions FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<EnrichOptions>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse EnrichOptions from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse EnrichOptions from JSON: {e.Message}", e);
        }
    }
