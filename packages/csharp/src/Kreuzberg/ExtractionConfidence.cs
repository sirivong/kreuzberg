    ...
    public static ExtractionConfidence FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<ExtractionConfidence>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse ExtractionConfidence from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse ExtractionConfidence from JSON: {e.Message}", e);
        }
    }
