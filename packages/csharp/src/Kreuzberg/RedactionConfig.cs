...
public sealed record RedactionConfig
{
    ...
    public RedactionStrategy? Strategy { get; init; } = null;
    ...
    public bool PreserveOffsets { get; init; } = true;
    ...
    public List<RedactionTerm> CustomTerms { get; init; } = [];
    ...
    public static RedactionConfig FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<RedactionConfig>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse RedactionConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse RedactionConfig from JSON: {e.Message}", e);
        }
    }
    ...
    public static RedactionConfig Default()
    {
        ...
        return JsonSerializer.Deserialize<RedactionConfig>(json ?? "null", JsonOptions)!;
    }
}
