...
// alef:hash:8d2b752e0321ecba871b919f31330a6e13825c6ed3d665a2629ba8fbefe9730b
...
public sealed record ImagePreprocessingConfig
{
    ...
    public int? TargetDpi { get; init; } = null;

    /// <summary>
    /// Auto-detect and correct image rotation.
    /// </summary>
    [JsonPropertyName("auto_rotate")]
    public bool? AutoRotate { get; init; } = null;

    /// <summary>
    /// Correct skew (tilted images).
    /// </summary>
    [JsonPropertyName("deskew")]
    public bool? Deskew { get; init; } = null;

    /// <summary>
    /// Remove noise from the image.
    /// </summary>
    [JsonPropertyName("denoise")]
    public bool? Denoise { get; init; } = null;

    /// <summary>
    /// Enhance contrast for better text visibility.
    /// </summary>
    [JsonPropertyName("contrast_enhance")]
    public bool? ContrastEnhance { get; init; } = null;

    /// <summary>
    /// Binarization method: "otsu", "sauvola", "adaptive".
    /// </summary>
    [JsonPropertyName("binarization_method")]
    public string? BinarizationMethod { get; init; } = null;

    /// <summary>
    /// Invert colors (white text on black → black on white).
    /// </summary>
    [JsonPropertyName("invert_colors")]
    public bool? InvertColors { get; init; } = null;
