    ...
    public static Translation FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<Translation>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse Translation from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse Translation from JSON: {e.Message}", e);
        }
    }
