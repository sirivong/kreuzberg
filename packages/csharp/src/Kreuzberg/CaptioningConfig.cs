    ...
    public static CaptioningConfig FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<CaptioningConfig>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse CaptioningConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse CaptioningConfig from JSON: {e.Message}", e);
        }
    }
