    ...
    public static HeuristicsConfig FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<HeuristicsConfig>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse HeuristicsConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse HeuristicsConfig from JSON: {e.Message}", e);
        }
    }
