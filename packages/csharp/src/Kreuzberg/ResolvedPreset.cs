    ...
    public static ResolvedPreset FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<ResolvedPreset>(json, JsonOptions)
                ?? throw new KreuzbergException($"Failed to parse ResolvedPreset from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzbergException($"Failed to parse ResolvedPreset from JSON: {e.Message}", e);
        }
    }
