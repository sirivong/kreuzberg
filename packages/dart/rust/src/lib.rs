...
impl From<xberg::LateInteractionModelType> for LateInteractionModelType {
    fn from(v: xberg::LateInteractionModelType) -> Self {
        match v {
            xberg::LateInteractionModelType::Preset { name } => LateInteractionModelType::Preset { name: name },
            ...
            xberg::LateInteractionModelType::Plugin { name } => LateInteractionModelType::Plugin { name: name },
        }
    }
}
...
impl From<xberg::EmbeddingModelType> for EmbeddingModelType {
    fn from(v: xberg::EmbeddingModelType) -> Self {
        match v {
            xberg::EmbeddingModelType::Preset { name } => EmbeddingModelType::Preset { name: name },
            ...
            xberg::EmbeddingModelType::Plugin { name } => EmbeddingModelType::Plugin { name: name },
        }
    }
}

impl From<xberg::core::config::reranker::RerankerHead> for RerankerHead {
    fn from(v: xberg::core::config::reranker::RerankerHead) -> Self {
        match v {
            xberg::core::config::reranker::RerankerHead::CrossEncoder => RerankerHead::CrossEncoder,
            xberg::core::config::reranker::RerankerHead::Qwen3Generative => RerankerHead::Qwen3Generative,
        }
    }
}
...
impl From<xberg::RerankerModelType> for RerankerModelType {
    fn from(v: xberg::RerankerModelType) -> Self {
        match v {
            xberg::RerankerModelType::Preset { name } => RerankerModelType::Preset { name: name },
            ...
            xberg::RerankerModelType::Plugin { name } => RerankerModelType::Plugin { name: name },
        }
    }
}
...
impl From<xberg::SparseEmbeddingModelType> for SparseEmbeddingModelType {
    fn from(v: xberg::SparseEmbeddingModelType) -> Self {
        match v {
            xberg::SparseEmbeddingModelType::Preset { name } => SparseEmbeddingModelType::Preset { name: name },
            ...
            xberg::SparseEmbeddingModelType::Plugin { name } => SparseEmbeddingModelType::Plugin { name: name },
        }
    }
}
...
impl From<xberg::NodeContent> for NodeContent {
    fn from(v: xberg::NodeContent) -> Self {
        match v {
            xberg::NodeContent::Title { text } => NodeContent::Title { text: text },
            xberg::NodeContent::Heading { level, text } => NodeContent::Heading {
                level: level as _,
                text: text,
            },
            xberg::NodeContent::Paragraph { text } => NodeContent::Paragraph { text: text },
            xberg::NodeContent::List { ordered } => NodeContent::List { ordered: ordered as _ },
            xberg::NodeContent::ListItem { text } => NodeContent::ListItem { text: text },
            ...
            xberg::NodeContent::Formula { text } => NodeContent::Formula { text: text },
            xberg::NodeContent::Footnote { text } => NodeContent::Footnote { text: text },
            ...
            xberg::NodeContent::DefinitionItem { term, definition } => NodeContent::DefinitionItem {
                term: term,
                definition: definition,
            },
            xberg::NodeContent::Citation { key, text } => NodeContent::Citation { key: key, text: text },
            xberg::NodeContent::Admonition { kind, title } => NodeContent::Admonition {
                kind: kind,
                title: title.unwrap_or_default(),
            },
            xberg::NodeContent::RawBlock { format, content } => NodeContent::RawBlock {
                format: format,
                content: content,
            },
...
impl From<xberg::AnnotationKind> for AnnotationKind {
    fn from(v: xberg::AnnotationKind) -> Self {
        match v {
            ...
            xberg::AnnotationKind::Color { value } => AnnotationKind::Color { value: value },
            xberg::AnnotationKind::FontSize { value } => AnnotationKind::FontSize { value: value },
    ...
    fn from(v: xberg::NoChunkingReason) -> Self {
        match v {
            ...
            xberg::NoChunkingReason::FormatNotChunkable { mime_type } => {
                NoChunkingReason::FormatNotChunkable { mime_type: mime_type }
            }
...
impl From<ExtractedDocument> for xberg::ExtractedDocument {
    fn from(v: ExtractedDocument) -> Self {
        ...
        __result.formatted_content = v.formatted_content.map(Into::into);
        __result
    }
}
...
impl From<EmbeddingModelType> for xberg::EmbeddingModelType {
    fn from(v: EmbeddingModelType) -> Self {
        match v {
            EmbeddingModelType::Preset { name } => xberg::EmbeddingModelType::Preset { name: name },
            ...
            EmbeddingModelType::Plugin { name } => xberg::EmbeddingModelType::Plugin { name: name },
        }
    }
}
...
impl From<NodeContent> for xberg::NodeContent {
    fn from(v: NodeContent) -> Self {
        match v {
            NodeContent::Title { text } => xberg::NodeContent::Title { text: text },
            NodeContent::Heading { level, text } => xberg::NodeContent::Heading {
                level: level as _,
                text: text,
            },
            NodeContent::Paragraph { text } => xberg::NodeContent::Paragraph { text: text },
            NodeContent::List { ordered } => xberg::NodeContent::List { ordered: ordered },
            NodeContent::ListItem { text } => xberg::NodeContent::ListItem { text: text },
            ...
            NodeContent::Formula { text } => xberg::NodeContent::Formula { text: text },
            NodeContent::Footnote { text } => xberg::NodeContent::Footnote { text: text },
            NodeContent::Group {
                label,
                heading_level,
                heading_text,
            ...
            NodeContent::DefinitionItem { term, definition } => xberg::NodeContent::DefinitionItem {
                term: term,
                definition: definition,
            },
            NodeContent::Citation { key, text } => xberg::NodeContent::Citation { key: key, text: text },
            NodeContent::Admonition { kind, title } => xberg::NodeContent::Admonition {
                kind: kind,
                title: if title.is_empty() { None } else { Some(title) },
            },
            NodeContent::RawBlock { format, content } => xberg::NodeContent::RawBlock {
                format: format,
                content: content,
            },
...
impl From<AnnotationKind> for xberg::AnnotationKind {
    fn from(v: AnnotationKind) -> Self {
        match v {
            ...
            AnnotationKind::Color { value } => xberg::AnnotationKind::Color { value: value },
            AnnotationKind::FontSize { value } => xberg::AnnotationKind::FontSize { value: value },
...
pub fn create_sparse_embedding_preset_from_json(json: String) -> Result<SparseEmbeddingPreset, String> {
    serde_json::from_str::<xberg::SparseEmbeddingPreset>(&json)
        .map(SparseEmbeddingPreset::from)
        .map_err(|e| e.to_string())
}
...
pub fn create_late_interaction_preset_from_json(json: String) -> Result<LateInteractionPreset, String> {
    serde_json::from_str::<xberg::LateInteractionPreset>(&json)
        .map(LateInteractionPreset::from)
        .map_err(|e| e.to_string())
}
    ...
    fn supports_language(&self, lang: &str) -> bool {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                eprintln!("[OcrBackendDartCallbacks] host 'supports_language' panicked; returning default: {msg}");
    ...
    fn backend_type(&self) -> xberg::OcrBackendType {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[OcrBackendDartCallbacks] host 'backend_type' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn supported_languages(&self) -> Vec<String> {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[OcrBackendDartCallbacks] host 'supported_languages' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result
    ...
    fn supports_table_detection(&self) -> bool {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // result to the caller.
                eprintln!(
                    "[OcrBackendDartCallbacks] host 'supports_table_detection' panicked; returning default: {msg}"
                );
                return Default::default();
            }
        };
    ...
    fn supports_document_processing(&self) -> bool {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // result to the caller.
                eprintln!(
                    "[OcrBackendDartCallbacks] host 'supports_document_processing' panicked; returning default: {msg}"
                );
                return Default::default();
            }
        };
    ...
    fn emits_structured_markdown(&self) -> bool {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // result to the caller.
                eprintln!(
                    "[OcrBackendDartCallbacks] host 'emits_structured_markdown' panicked; returning default: {msg}"
                );
                return Default::default();
            }
        };
    ...
    fn processing_stage(&self) -> xberg::ProcessingStage {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[PostProcessorDartCallbacks] host 'processing_stage' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result.into()
    ...
    fn should_process(&self, _result: &xberg::ExtractedDocument, _config: &xberg::ExtractionConfig) -> bool {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[PostProcessorDartCallbacks] host 'should_process' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result
    ...
    fn estimated_duration_ms(&self, _result: &xberg::ExtractedDocument) -> u64 {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // result to the caller.
                eprintln!(
                    "[PostProcessorDartCallbacks] host 'estimated_duration_ms' panicked; returning default: {msg}"
                );
                return Default::default();
            }
        };
    ...
    fn priority(&self) -> i32 {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[PostProcessorDartCallbacks] host 'priority' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result as i32
    ...
    fn should_validate(&self, _result: &xberg::ExtractedDocument, _config: &xberg::ExtractionConfig) -> bool {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[ValidatorDartCallbacks] host 'should_validate' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result
    ...
    fn priority(&self) -> i32 {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[ValidatorDartCallbacks] host 'priority' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result as i32
    ...
    fn supported_mime_types(&self) -> &[&str] {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // result to the caller.
                eprintln!(
                    "[DocumentExtractorDartCallbacks] host 'supported_mime_types' panicked; returning default: {msg}"
                );
                return Default::default();
            }
        };
    ...
    fn priority(&self) -> i32 {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[DocumentExtractorDartCallbacks] host 'priority' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result as i32
    ...
    fn can_handle(&self, _path: &std::path::Path, _mime_type: &str) -> bool {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[DocumentExtractorDartCallbacks] host 'can_handle' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result
    ...
    fn dimensions(&self) -> usize {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[EmbeddingBackendDartCallbacks] host 'dimensions' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result as usize
...
impl xberg::plugins::Plugin for TokenizerBackendDartCallbacks {
    fn name(&self) -> &str {
        &self.plugin_name
    }
    ...
    fn count_tokens(&self, text: &str) -> usize {
        ...
        .join()
        {
            ...
            Err(e) => {
                ...
                // default — a silent default is indistinguishable from a real
                // result to the caller.
                eprintln!("[TokenizerBackendDartCallbacks] host 'count_tokens' panicked; returning default: {msg}");
                return Default::default();
            }
        };
        __result as usize
