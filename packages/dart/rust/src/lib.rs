...
pub use xberg::InternalDocument;
...
pub struct ExtractionOutput {
    ...
    pub crawl: std::collections::HashMap<String, String>,
}
...
pub struct LlmBackend {
    pub(crate) inner: xberg::LlmBackend,
}

impl From<xberg::LlmBackend> for LlmBackend {
    fn from(inner: xberg::LlmBackend) -> Self {
        Self { inner }
    }
}

impl From<LlmBackend> for xberg::LlmBackend {
...
impl LlmBackend {
    ...
    pub fn new(config: LlmConfig) -> LlmBackend {
        {
            let v = xberg::LlmBackend::new(xberg::LlmConfig::from(config));
            LlmBackend::from(v)
        }
    }
    #[frb]
        ...
        self.inner
            .detect(&text, unsafe {
                ::std::slice::from_raw_parts(
                    ::std::mem::transmute::<*const EntityCategory, *const xberg::EntityCategory>(categories.as_ptr()),
                    categories.len(),
                )
            })
            .await
    ...
    pub async fn detect_with_custom(
        ...
        self.inner
            .detect_with_custom(
                ...
                unsafe {
                    ::std::slice::from_raw_parts(
                        ::std::mem::transmute::<*const EntityCategory, *const xberg::EntityCategory>(
                            categories.as_ptr(),
                        ),
                        categories.len(),
                    )
...
impl From<xberg::ExtractionOutput> for ExtractionOutput {
    fn from(v: xberg::ExtractionOutput) -> Self {
        ExtractionOutput {
            results: v.results.into_iter().map(ExtractionResult::from).collect::<Vec<_>>(),
...
impl From<xberg::chunking::ChunkingResult> for ChunkingResult {
    fn from(v: xberg::chunking::ChunkingResult) -> Self {
        ChunkingResult {
...
impl From<xberg::EmbeddingPreset> for EmbeddingPreset {
    fn from(v: xberg::EmbeddingPreset) -> Self {
        EmbeddingPreset {
            name: v.name.into(),
...
impl From<xberg::RerankerPreset> for RerankerPreset {
    fn from(v: xberg::RerankerPreset) -> Self {
        RerankerPreset {
            name: v.name.into(),
            model_repo: v.model_repo.into(),
            model_file: v.model_file.into(),
...
impl From<xberg::enrichment::EnrichOptions> for EnrichOptions {
    fn from(v: xberg::enrichment::EnrichOptions) -> Self {
        EnrichOptions {
...
impl From<xberg::enrichment::EnrichResult> for EnrichResult {
    fn from(v: xberg::enrichment::EnrichResult) -> Self {
        EnrichResult {
            keywords: v.keywords.into_iter().map(|s| s.into()).collect::<Vec<_>>(),
...
impl From<xberg::ConfidenceSignals> for ConfidenceSignals {
    fn from(v: xberg::ConfidenceSignals) -> Self {
        ConfidenceSignals {
...
impl From<xberg::ConfidenceWeights> for ConfidenceWeights {
    fn from(v: xberg::ConfidenceWeights) -> Self {
        ConfidenceWeights {
            text_coverage: v.text_coverage as _,
...
impl From<xberg::heuristics::ExtractionConfidence> for ExtractionConfidence {
    fn from(v: xberg::heuristics::ExtractionConfidence) -> Self {
...
impl From<xberg::ChunkPlan> for ChunkPlan {
    fn from(v: xberg::ChunkPlan) -> Self {
        ChunkPlan {
            total_chunks: v.total_chunks as _,
...
impl From<xberg::StructuredInput> for StructuredInput {
    fn from(v: xberg::StructuredInput) -> Self {
        StructuredInput {
            mime_type: v.mime_type.into(),
            page_count: v.page_count as _,
            text_coverage: v.text_coverage as _,
...
impl From<xberg::StructuredThresholds> for StructuredThresholds {
    fn from(v: xberg::StructuredThresholds) -> Self {
...
impl From<xberg::ClassificationEnrichmentConfig> for ClassificationEnrichmentConfig {
    fn from(v: xberg::ClassificationEnrichmentConfig) -> Self {
...
impl From<xberg::CaptioningEnrichmentConfig> for CaptioningEnrichmentConfig {
    fn from(v: xberg::CaptioningEnrichmentConfig) -> Self {
...
impl From<xberg::OutputFormat> for OutputFormat {
    fn from(v: xberg::OutputFormat) -> Self {
        match v {
            ...
            xberg::OutputFormat::Structured => OutputFormat::Structured,
...
impl From<xberg::OcrBackendType> for OcrBackendType {
    fn from(v: xberg::OcrBackendType) -> Self {
        match v {
            ...
            xberg::OcrBackendType::EasyOCR => OcrBackendType::EasyOCR,
...
impl From<xberg::NodeContent> for NodeContent {
    fn from(v: xberg::NodeContent) -> Self {
        match v {
            ...
            xberg::NodeContent::MetadataBlock { .. } => NodeContent::MetadataBlock,
        }
    }
}
...
impl From<xberg::FormatMetadata> for FormatMetadata {
    fn from(v: xberg::FormatMetadata) -> Self {
        match v {
            ...
            xberg::FormatMetadata::Code => FormatMetadata::Code,
...
impl From<xberg::OcrBoundingGeometry> for OcrBoundingGeometry {
    fn from(v: xberg::OcrBoundingGeometry) -> Self {
        match v {
            ...
            xberg::OcrBoundingGeometry::Quadrilateral { .. } => OcrBoundingGeometry::Quadrilateral,
        }
    }
}
...
impl From<xberg::enrichment::EnrichStatus> for EnrichStatus {
    fn from(v: xberg::enrichment::EnrichStatus) -> Self {
        match v {
            xberg::enrichment::EnrichStatus::Pending => EnrichStatus::Pending,
            xberg::enrichment::EnrichStatus::Completed { result } => EnrichStatus::Completed {
                result: EnrichResult::from(result),
            },
            xberg::enrichment::EnrichStatus::Failed { error } => EnrichStatus::Failed { error },
        }
    }
}
...
impl From<xberg::ChunkingDecision> for ChunkingDecision {
    fn from(v: xberg::ChunkingDecision) -> Self {
        match v {
            xberg::ChunkingDecision::NoChunking { reason } => ChunkingDecision::NoChunking {
                reason: NoChunkingReason::from(reason),
            },
            xberg::ChunkingDecision::Chunk(f0) => ChunkingDecision::Chunk {
                field0: ChunkPlan::from(f0),
            },
            xberg::ChunkingDecision::UseOverrides { user_chunks } => ChunkingDecision::UseOverrides {
...
impl From<xberg::StructuredCallMode> for StructuredCallMode {
    fn from(v: xberg::StructuredCallMode) -> Self {
        match v {
            xberg::StructuredCallMode::Skip => StructuredCallMode::Skip,
            xberg::StructuredCallMode::TextOnly => StructuredCallMode::TextOnly,
            xberg::StructuredCallMode::VisionOnly => StructuredCallMode::VisionOnly,
            xberg::StructuredCallMode::TextPlusVision => StructuredCallMode::TextPlusVision,
            xberg::StructuredCallMode::TextOnlyWithVisionFallback => StructuredCallMode::TextOnlyWithVisionFallback,
        }
    }
}
...
impl From<DocumentNode> for xberg::DocumentNode {
    fn from(v: DocumentNode) -> Self {
        xberg::DocumentNode {
            ...
            children: v.children.into_iter().map(|x| xberg::NodeIndex(x as _)).collect(),
...
impl From<ExtractionConfidence> for xberg::heuristics::ExtractionConfidence {
    fn from(v: ExtractionConfidence) -> Self {
        xberg::heuristics::ExtractionConfidence {
            text_coverage: v.text_coverage as _,
            ocr_aggregate: v.ocr_aggregate.map(|x| x as _),
            schema_compliance: v.schema_compliance.into(),
            combined: v.combined as _,
...
impl From<OutputFormat> for xberg::OutputFormat {
    fn from(v: OutputFormat) -> Self {
        match v {
            ...
            OutputFormat::Structured => xberg::OutputFormat::Structured,
...
impl From<CallMode> for xberg::CallMode {
    fn from(v: CallMode) -> Self {
        match v {
            CallMode::TextOnly => xberg::CallMode::TextOnly,
            CallMode::VisionOnly => xberg::CallMode::VisionOnly,
            CallMode::TextPlusVision => xberg::CallMode::TextPlusVision,
        }
    }
}
...
impl From<MergeMode> for xberg::MergeMode {
    fn from(v: MergeMode) -> Self {
        match v {
            MergeMode::ObjectMerge => xberg::MergeMode::ObjectMerge,
            MergeMode::ArrayConcat => xberg::MergeMode::ArrayConcat,
            MergeMode::ObjectFirst => xberg::MergeMode::ObjectFirst,
        }
    }
}
...
impl From<EmbeddingModelType> for xberg::EmbeddingModelType {
    fn from(v: EmbeddingModelType) -> Self {
        match v {
            ...
            EmbeddingModelType::Llm { llm } => xberg::EmbeddingModelType::Llm { llm: llm.into() },
...
impl From<RerankerModelType> for xberg::RerankerModelType {
    fn from(v: RerankerModelType) -> Self {
        match v {
            RerankerModelType::Preset { name } => xberg::RerankerModelType::Preset { name },
            RerankerModelType::Custom {
                model_id,
                model_file,
                additional_files,
            ...
            RerankerModelType::Llm { llm } => xberg::RerankerModelType::Llm { llm: llm.into() },
            RerankerModelType::Plugin { name } => xberg::RerankerModelType::Plugin { name },
        }
    }
}
...
impl From<OcrBackendType> for xberg::OcrBackendType {
    fn from(v: OcrBackendType) -> Self {
        match v {
            ...
            OcrBackendType::EasyOCR => xberg::OcrBackendType::EasyOCR,
...
impl From<NodeContent> for xberg::NodeContent {
    fn from(v: NodeContent) -> Self {
        match v {
            ...
            NodeContent::MetadataBlock => xberg::NodeContent::MetadataBlock {
...
impl From<FormatMetadata> for xberg::FormatMetadata {
    fn from(v: FormatMetadata) -> Self {
        match v {
            ...
            #[cfg(feature = "tree-sitter")]
            FormatMetadata::Code => xberg::FormatMetadata::Code,
            _ => unreachable!("cfg-gated variant of FormatMetadata not active in this build"),
        }
    }
}
...
impl From<OcrBoundingGeometry> for xberg::OcrBoundingGeometry {
    fn from(v: OcrBoundingGeometry) -> Self {
        match v {
            ...
            OcrBoundingGeometry::Quadrilateral => xberg::OcrBoundingGeometry::Quadrilateral {
...
impl From<PresetCategory> for xberg::PresetCategory {
    fn from(v: PresetCategory) -> Self {
        match v {
            PresetCategory::Finance => xberg::PresetCategory::Finance,
            PresetCategory::Identity => xberg::PresetCategory::Identity,
            PresetCategory::Legal => xberg::PresetCategory::Legal,
            PresetCategory::Logistics => xberg::PresetCategory::Logistics,
            PresetCategory::Medical => xberg::PresetCategory::Medical,
            PresetCategory::Hr => xberg::PresetCategory::Hr,
            PresetCategory::Other => xberg::PresetCategory::Other,
        }
    }
}
...
pub fn extract_sync(input: ExtractInput, config: ExtractionConfig) -> Result<ExtractionOutput, String> {
    xberg::extract_sync(xberg::ExtractInput::from(input), &xberg::ExtractionConfig::from(config))
...
#[cfg(feature = "tokio-runtime")]
pub fn extract_batch_sync(inputs: Vec<ExtractInput>, config: ExtractionConfig) -> Result<ExtractionOutput, String> {
    xberg::extract_batch_sync(
...
pub async fn extract(input: ExtractInput, config: ExtractionConfig) -> Result<ExtractionOutput, String> {
...
pub async fn extract_batch(inputs: Vec<ExtractInput>, config: ExtractionConfig) -> Result<ExtractionOutput, String> {
    xberg::extract_batch(
        inputs.into_iter().map(xberg::ExtractInput::from).collect::<Vec<_>>(),
        &xberg::ExtractionConfig::from(config),
    )
...
pub async fn classify_pages(result: ExtractionResult, config: PageClassificationConfig) -> Result<(), String> {
    xberg::text::classification::classify_pages(
        &mut xberg::ExtractionResult::from(result),
        &xberg::PageClassificationConfig::from(config),
    )
    .await
    .map(|v| v)
    .map_err(|e| e.to_string())
...
pub async fn classify_text(text: String, config: PageClassificationConfig) -> Result<Vec<ClassificationLabel>, String> {
    xberg::text::classification::classify_text(&text, &xberg::PageClassificationConfig::from(config))
        .await
...
pub async fn redact(result: ExtractionResult, config: RedactionConfig) -> Result<(), String> {
    xberg::text::redaction::redact(
        &mut xberg::ExtractionResult::from(result),
        &xberg::RedactionConfig::from(config),
    )
    .await
    .map(|v| v)
    .map_err(|e| e.to_string())
...
pub fn scan_text(text: String, categories: Vec<PiiCategory>) -> Vec<PatternMatch> {
    xberg::text::redaction::patterns::scan_text(&text, unsafe {
        std::slice::from_raw_parts(
            std::mem::transmute::<*const PiiCategory, *const xberg::PiiCategory>(categories.as_ptr()),
            categories.len(),
        )
    })
    .into_iter()
...
pub fn token_count(text: String) -> i64 {
    xberg::text::summarization::textrank::token_count(&text) as i64
}
...
pub async fn translate_result(result: ExtractionResult, config: TranslationConfig) -> Result<(), String> {
    xberg::text::translation::translate_result(
        &mut xberg::ExtractionResult::from(result),
        &xberg::TranslationConfig::from(config),
    )
    .await
    .map(|v| v)
    .map_err(|e| e.to_string())
...
pub fn parse_citations(markdown: String) -> Vec<Citation> {
    xberg::parse_citations(&markdown)
        .into_iter()
        .map(Citation::from)
        .collect::<Vec<_>>()
}
...
pub fn chunk_for_rag(text: String, config: ChunkingConfig) -> Result<ChunkingResult, String> {
    xberg::chunking::chunk_for_rag(&text, &xberg::ChunkingConfig::from(config))
...
pub fn compare(a: ExtractionResult, b: ExtractionResult, opts: DiffOptions) -> ExtractionDiff {
    ExtractionDiff::from(xberg::compare(
        &xberg::ExtractionResult::from(a),
        &xberg::ExtractionResult::from(b),
        &xberg::DiffOptions::from(opts),
    ))
}
...
pub async fn extract_region_with_vlm(
    ...
    xberg::llm::region_extractor::extract_region_with_vlm(
        &image_bytes,
        &image_mime,
        unsafe { std::mem::transmute::<RegionKind, xberg::RegionKind>(region_kind) },
        &xberg::LlmConfig::from(llm_config),
...
pub async fn rerank_async(
    ...
    xberg::rerank_async(query, documents, &xberg::RerankerConfig::from(config))
        .await
...
pub fn extract_keywords(text: String, config: KeywordConfig) -> Result<Vec<Keyword>, String> {
    xberg::keywords::extract_keywords(&text, &xberg::KeywordConfig::from(config))
...
pub fn analyze_document(
    ...
    xberg::analyze_document(
        &xberg::DocumentMetadata::from(metadata),
        &xberg::HeuristicsConfig::from(config),
...
pub fn analyze_with_user_chunks(
    ...
    ChunkingDecision::from(xberg::analyze_with_user_chunks(
        &user_ranges.into_iter().map(xberg::PageRange::from).collect::<Vec<_>>(),
        total_pages as u32,
        size_bytes as u64,
        &xberg::HeuristicsConfig::from(config),
    ))
...
pub fn score_confidence(signals: ConfidenceSignals, weights: ConfidenceWeights) -> ExtractionConfidence {
    ExtractionConfidence::from(xberg::score_confidence(
        xberg::ConfidenceSignals::from(signals),
        xberg::ConfidenceWeights::from(weights),
    ))
}
...
pub fn boundaries_from_extraction_result(
    ...
    xberg::boundaries_from_extraction_result(
        &xberg::ExtractionResult::from(result),
        &xberg::MultidocThresholds::from(thresholds),
    )
    .into_iter()
...
pub fn detect_boundaries(input: MultidocInput, thresholds: MultidocThresholds) -> Vec<DocumentBoundary> {
    xberg::detect_boundaries(
        &xberg::MultidocInput::from(input),
        &xberg::MultidocThresholds::from(thresholds),
    )
    .into_iter()
    .map(DocumentBoundary::from)
...
pub fn choose_call_mode(input: StructuredInput, t: StructuredThresholds) -> StructuredCallMode {
    StructuredCallMode::from(xberg::choose_call_mode(&xberg::StructuredInput::from(input), unsafe {
        std::mem::transmute::<&StructuredThresholds, &xberg::StructuredThresholds>(&t)
    }))
}
...
pub fn calculate_chunk_plan(page_count: i64, size_bytes: i64, needs_ocr: bool, config: HeuristicsConfig) -> ChunkPlan {
    ChunkPlan::from(xberg::calculate_chunk_plan(
        page_count as u32,
        size_bytes as u64,
        needs_ocr,
        &xberg::HeuristicsConfig::from(config),
...
pub fn calculate_plan_from_overrides(
    ...
    ChunkPlan::from(xberg::calculate_plan_from_overrides(
        &user_chunks.into_iter().map(xberg::PageRange::from).collect::<Vec<_>>(),
        total_pages as u32,
        size_bytes as u64,
        &xberg::HeuristicsConfig::from(config),
    ))
...
pub fn fingerprint(raw: Vec<u8>) -> String {
    xberg::presets::loader::fingerprint(&raw).to_string()
}
...
pub async fn embed_texts_async(_texts: Vec<String>, _config: EmbeddingConfig) -> Result<Vec<Vec<f64>>, String> {
    xberg::embed_texts_async(_texts, &xberg::EmbeddingConfig::from(_config))
        .await
        .map(|v| {
            v.into_iter()
...
pub fn get_embedding_preset(name: String) -> Option<EmbeddingPreset> {
    xberg::get_embedding_preset(&name).map(EmbeddingPreset::from)
}
...
pub fn rerank(query: String, documents: Vec<String>, config: RerankerConfig) -> Result<Vec<RerankedDocument>, String> {
    xberg::rerank(query, documents, &xberg::RerankerConfig::from(config))
        .map(|v| v.into_iter().map(RerankedDocument::from).collect::<Vec<_>>())
        .map_err(|e| e.to_string())
}
...
pub fn get_reranker_preset(name: String) -> Option<RerankerPreset> {
    xberg::get_reranker_preset(&name).map(RerankerPreset::from)
}
...
#[frb]
pub fn create_extraction_output_from_json(json: String) -> Result<ExtractionOutput, String> {
...
pub fn create_enrich_options_from_json(json: String) -> Result<EnrichOptions, String> {
    serde_json::from_str::<xberg::enrichment::EnrichOptions>(&json)
...
impl xberg::plugins::Plugin for OcrBackendDartCallbacks {
    fn name(&self) -> &str {
        &self.plugin_name
    }
...
impl xberg::OcrBackend for OcrBackendDartCallbacks {
    ...
    ) -> xberg::Result<xberg::ExtractionResult> {
...
impl xberg::plugins::Plugin for PostProcessorDartCallbacks {
    fn name(&self) -> &str {
        &self.plugin_name
    }
...
impl xberg::PostProcessor for PostProcessorDartCallbacks {
    ...
    fn should_process(&self, _result: &xberg::ExtractionResult, _config: &xberg::ExtractionConfig) -> bool {
    ...
    fn estimated_duration_ms(&self, _result: &xberg::ExtractionResult) -> u64 {
        let _result = ExtractionResult::from(_result.clone());
        let __result = ::tokio::runtime::Builder::new_current_thread()
            .build()
            .expect("build alef visitor tokio runtime")
...
impl xberg::plugins::Plugin for ValidatorDartCallbacks {
    fn name(&self) -> &str {
        &self.plugin_name
    }
...
impl xberg::Validator for ValidatorDartCallbacks {
    async fn validate(&self, result: &xberg::ExtractionResult, config: &xberg::ExtractionConfig) -> xberg::Result<()> {
        let result = ExtractionResult::from(result.clone());
        let config = ExtractionConfig::from(config.clone());
        Ok((self.validate)(result, config).await)
    }

    fn should_validate(&self, _result: &xberg::ExtractionResult, _config: &xberg::ExtractionConfig) -> bool {
        let _result = ExtractionResult::from(_result.clone());
        let _config = ExtractionConfig::from(_config.clone());
        let __result = ::tokio::runtime::Builder::new_current_thread()
            .build()
...
impl xberg::plugins::Plugin for EmbeddingBackendDartCallbacks {
    fn name(&self) -> &str {
        &self.plugin_name
    }
...
impl xberg::plugins::Plugin for DocumentExtractorDartCallbacks {
    fn name(&self) -> &str {
        &self.plugin_name
    }
...
impl xberg::DocumentExtractor for DocumentExtractorDartCallbacks {
    async fn extract_bytes(
        ...
        mime_type: &str,
        config: &xberg::ExtractionConfig,
    ) -> xberg::Result<xberg::InternalDocument> {
        let content = content.to_vec();
        let mime_type = mime_type.to_string();
        let config = ExtractionConfig::from(config.clone());
        let __ret_bridge: InternalDocumentBridge = (self.extract_bytes)(content, mime_type, config).await;
        let __ret: xberg::InternalDocument = serde_json::from_str(&__ret_bridge.json)?;
        Ok(__ret)
    }
...
impl xberg::plugins::Plugin for RendererDartCallbacks {
    fn name(&self) -> &str {
        &self.plugin_name
    }
...
impl xberg::Renderer for RendererDartCallbacks {
    fn render(&self, doc: &xberg::InternalDocument) -> xberg::Result<String> {
        let doc = doc.clone();
...
impl xberg::plugins::Plugin for RerankerBackendDartCallbacks {
    fn name(&self) -> &str {
        &self.plugin_name
    }
