...
pub struct LlmBackend {
    pub(crate) inner: kreuzberg::LlmBackend,
}

impl From<kreuzberg::LlmBackend> for LlmBackend {
    fn from(inner: kreuzberg::LlmBackend) -> Self {
        Self { inner }
    }
}

impl From<LlmBackend> for kreuzberg::LlmBackend {
...
pub struct TokenCounter {
    pub(crate) inner: kreuzberg::TokenCounter,
}

impl From<kreuzberg::TokenCounter> for TokenCounter {
    fn from(inner: kreuzberg::TokenCounter) -> Self {
        Self { inner }
    }
}

impl From<TokenCounter> for kreuzberg::TokenCounter {
...
/// };
/// ```
#[frb(mirror(StructuredThresholds))]
...
pub struct MetaSchema {
    pub(crate) inner: kreuzberg::MetaSchema,
}

impl From<kreuzberg::MetaSchema> for MetaSchema {
    fn from(inner: kreuzberg::MetaSchema) -> Self {
        Self { inner }
    }
}

impl From<MetaSchema> for kreuzberg::MetaSchema {
...
#[frb(opaque)]
pub struct Registry {
    pub(crate) inner: kreuzberg::Registry,
}

impl From<kreuzberg::Registry> for Registry {
    fn from(inner: kreuzberg::Registry) -> Self {
        Self { inner }
    }
}

impl From<Registry> for kreuzberg::Registry {
...
#[frb(mirror(ClassificationEnrichmentConfig))]
...
#[frb(mirror(CaptioningEnrichmentConfig))]
...
impl LlmBackend {
    ...
    pub fn new(config: LlmConfig) -> LlmBackend {
        {
            let v = kreuzberg::LlmBackend::new(kreuzberg::LlmConfig::from(config));
            LlmBackend::from(v)
        }
    }
    #[frb]
        ...
        self.inner
            .detect(&text, unsafe {
                ::std::slice::from_raw_parts(
                    ::std::mem::transmute::<*const EntityCategory, *const kreuzberg::EntityCategory>(
                        categories.as_ptr(),
                    ),
                    categories.len(),
                )
            ...
            .await
            .map(|v| v.into_iter().map(Entity::from).collect::<Vec<_>>())
...
impl TokenCounter {
    ...
    pub fn new() -> TokenCounter {
        {
            let v = kreuzberg::TokenCounter::new();
            TokenCounter::from(v)
        }
    }
}
...
impl Registry {
    ...
    pub fn global() -> Registry {
        {
            let v = kreuzberg::Registry::global();
...
/// ```
#[frb(mirror(EnrichStatus), unignore)]
...
#[frb(mirror(ChunkingDecision), unignore)]
...
/// pipeline.
#[frb(mirror(StructuredCallMode), unignore)]
...
impl From<kreuzberg::CaptioningConfig> for CaptioningConfig {
    fn from(v: kreuzberg::CaptioningConfig) -> Self {
        CaptioningConfig {
...
impl From<kreuzberg::PageClassificationConfig> for PageClassificationConfig {
    fn from(v: kreuzberg::PageClassificationConfig) -> Self {
...
impl From<kreuzberg::core::config::extraction::SvgOptions> for SvgOptions {
    fn from(v: kreuzberg::core::config::extraction::SvgOptions) -> Self {
        SvgOptions {
...
impl From<kreuzberg::NerConfig> for NerConfig {
    fn from(v: kreuzberg::NerConfig) -> Self {
        NerConfig {
...
impl From<kreuzberg::RedactionConfig> for RedactionConfig {
    fn from(v: kreuzberg::RedactionConfig) -> Self {
        RedactionConfig {
...
impl From<kreuzberg::RedactionTerm> for RedactionTerm {
    fn from(v: kreuzberg::RedactionTerm) -> Self {
        RedactionTerm {
            label: v.label.into(),
            value: v.value.into(),
...
impl From<kreuzberg::RedactionPattern> for RedactionPattern {
    fn from(v: kreuzberg::RedactionPattern) -> Self {
        RedactionPattern {
            label: v.label.into(),
...
impl From<kreuzberg::RerankerConfig> for RerankerConfig {
    fn from(v: kreuzberg::RerankerConfig) -> Self {
        RerankerConfig {
...
impl From<kreuzberg::SummarizationConfig> for SummarizationConfig {
    fn from(v: kreuzberg::SummarizationConfig) -> Self {
        SummarizationConfig {
...
impl From<kreuzberg::TranslationConfig> for TranslationConfig {
    fn from(v: kreuzberg::TranslationConfig) -> Self {
        TranslationConfig {
...
impl From<kreuzberg::FootnoteConfig> for FootnoteConfig {
    fn from(v: kreuzberg::FootnoteConfig) -> Self {
        FootnoteConfig {
...
impl From<kreuzberg::FootnoteAnchor> for FootnoteAnchor {
    fn from(v: kreuzberg::FootnoteAnchor) -> Self {
        FootnoteAnchor {
            label: v.label.into(),
...
impl From<kreuzberg::FootnoteDefinition> for FootnoteDefinition {
    fn from(v: kreuzberg::FootnoteDefinition) -> Self {
        FootnoteDefinition {
            label: v.label.into(),
            content: v.content.into(),
            offset: v.offset as _,
...
impl From<kreuzberg::Citation> for Citation {
    fn from(v: kreuzberg::Citation) -> Self {
        Citation {
            label: v.label.into(),
...
impl From<kreuzberg::PdfFormField> for PdfFormField {
    fn from(v: kreuzberg::PdfFormField) -> Self {
        PdfFormField {
            name: v.name.into(),
...
impl From<kreuzberg::Formula> for Formula {
    fn from(v: kreuzberg::Formula) -> Self {
        Formula {
            latex: v.latex.into(),
...
impl From<kreuzberg::chunking::ChunkingResult> for ChunkingResult {
    fn from(v: kreuzberg::chunking::ChunkingResult) -> Self {
        ChunkingResult {
            chunks: v.chunks.into_iter().map(Chunk::from).collect::<Vec<_>>(),
...
impl From<kreuzberg::RerankedDocument> for RerankedDocument {
    fn from(v: kreuzberg::RerankedDocument) -> Self {
        RerankedDocument {
            index: v.index as _,
            score: v.score as _,
...
impl From<kreuzberg::RerankerPreset> for RerankerPreset {
    fn from(v: kreuzberg::RerankerPreset) -> Self {
        RerankerPreset {
            name: v.name.into(),
            model_repo: v.model_repo.into(),
            model_file: v.model_file.into(),
...
impl From<kreuzberg::enrichment::EnrichOptions> for EnrichOptions {
    fn from(v: kreuzberg::enrichment::EnrichOptions) -> Self {
        EnrichOptions {
            keywords: v.keywords as _,
            entities: v.entities as _,
            labels: v.labels.into_iter().map(|s| s.into()).collect::<Vec<_>>(),
        }
    }
}
...
impl From<kreuzberg::enrichment::EnrichResult> for EnrichResult {
    fn from(v: kreuzberg::enrichment::EnrichResult) -> Self {
        EnrichResult {
            keywords: v.keywords.into_iter().map(|s| s.into()).collect::<Vec<_>>(),
            entities: v.entities.into_iter().map(Entity::from).collect::<Vec<_>>(),
            labels: v.labels.into_iter().map(|s| s.into()).collect::<Vec<_>>(),
        }
    }
}
...
impl From<kreuzberg::DocumentMetadata> for DocumentMetadata {
    fn from(v: kreuzberg::DocumentMetadata) -> Self {
        DocumentMetadata {
            mime_type: v.mime_type.into(),
...
impl From<kreuzberg::UserChunkConfig> for UserChunkConfig {
    fn from(v: kreuzberg::UserChunkConfig) -> Self {
        UserChunkConfig {
            page_ranges: v
                .page_ranges
...
impl From<kreuzberg::ConfidenceSignals> for ConfidenceSignals {
    fn from(v: kreuzberg::ConfidenceSignals) -> Self {
        ConfidenceSignals {
...
impl From<kreuzberg::ConfidenceWeights> for ConfidenceWeights {
    fn from(v: kreuzberg::ConfidenceWeights) -> Self {
        ConfidenceWeights {
            text_coverage: v.text_coverage as _,
            ocr_aggregate: v.ocr_aggregate as _,
            schema_compliance: v.schema_compliance as _,
        }
    }
}

impl From<kreuzberg::heuristics::ExtractionConfidence> for ExtractionConfidence {
    fn from(v: kreuzberg::heuristics::ExtractionConfidence) -> Self {
...
impl From<kreuzberg::HeuristicsConfig> for HeuristicsConfig {
    fn from(v: kreuzberg::HeuristicsConfig) -> Self {
        HeuristicsConfig {
...
impl From<kreuzberg::ChunkPlan> for ChunkPlan {
    fn from(v: kreuzberg::ChunkPlan) -> Self {
        ChunkPlan {
            total_chunks: v.total_chunks as _,
            chunks: v.chunks.into_iter().map(ChunkInfo::from).collect::<Vec<_>>(),
            total_estimated_time_ms: v.total_estimated_time_ms as _,
            use_disk_processing: v.use_disk_processing as _,
            reason: ChunkingReason::from(v.reason),
        }
    }
}

impl From<kreuzberg::ChunkInfo> for ChunkInfo {
    fn from(v: kreuzberg::ChunkInfo) -> Self {
        ChunkInfo {
            index: v.index as _,
...
impl From<kreuzberg::PageRange> for PageRange {
    fn from(v: kreuzberg::PageRange) -> Self {
        PageRange {
            start: v.start as _,
            end: v.end as _,
        }
...
impl From<kreuzberg::MultidocInput> for MultidocInput {
    fn from(v: kreuzberg::MultidocInput) -> Self {
        MultidocInput {
...
impl From<kreuzberg::PageSignals> for PageSignals {
    fn from(v: kreuzberg::PageSignals) -> Self {
        PageSignals {
            page_number: v.page_number as _,
...
impl From<kreuzberg::DocumentBoundary> for DocumentBoundary {
    fn from(v: kreuzberg::DocumentBoundary) -> Self {
        DocumentBoundary {
...
impl From<kreuzberg::MultidocThresholds> for MultidocThresholds {
    fn from(v: kreuzberg::MultidocThresholds) -> Self {
        MultidocThresholds {
...
impl From<kreuzberg::StructuredInput> for StructuredInput {
    fn from(v: kreuzberg::StructuredInput) -> Self {
        StructuredInput {
            mime_type: v.mime_type.into(),
            page_count: v.page_count as _,
            text_coverage: v.text_coverage as _,
            avg_chars_per_page: v.avg_chars_per_page as _,
            embedded_image_count: v.embedded_image_count as _,
            user_force_vision: v.user_force_vision as _,
        }
    }
}

impl From<kreuzberg::StructuredThresholds> for StructuredThresholds {
    fn from(v: kreuzberg::StructuredThresholds) -> Self {
        StructuredThresholds {
            scan_max_coverage: v.scan_max_coverage as _,
            digital_min_coverage: v.digital_min_coverage as _,
            docx_text_min_density: v.docx_text_min_density as _,
            enable_vision_fallback: v.enable_vision_fallback as _,
        }
    }
}

impl From<kreuzberg::ResolvedPreset> for ResolvedPreset {
    fn from(v: kreuzberg::ResolvedPreset) -> Self {
        ResolvedPreset {
            id: v.id.into(),
...
impl From<kreuzberg::PresetSample> for PresetSample {
    fn from(v: kreuzberg::PresetSample) -> Self {
        PresetSample {
...
impl From<kreuzberg::Preset> for Preset {
    fn from(v: kreuzberg::Preset) -> Self {
        Preset {
            id: v.id.into(),
            version: v.version.into(),
            schema_name: v.schema_name.into(),
...
impl From<kreuzberg::PresetSummary> for PresetSummary {
    fn from(v: kreuzberg::PresetSummary) -> Self {
        PresetSummary {
            id: v.id.into(),
            version: v.version.into(),
            schema_name: v.schema_name.into(),
...
impl From<kreuzberg::ClassificationEnrichmentConfig> for ClassificationEnrichmentConfig {
    fn from(v: kreuzberg::ClassificationEnrichmentConfig) -> Self {
        ClassificationEnrichmentConfig {
            config: PageClassificationConfig::from(v.config),
        }
    }
}

impl From<kreuzberg::CaptioningEnrichmentConfig> for CaptioningEnrichmentConfig {
    fn from(v: kreuzberg::CaptioningEnrichmentConfig) -> Self {
        CaptioningEnrichmentConfig {
            config: LlmConfig::from(v.config),
            custom_prompt: v.custom_prompt.map(|s| s.into()),
        }
    }
}
...
impl From<kreuzberg::core::config::extraction::ImageOutputFormat> for ImageOutputFormat {
    fn from(v: kreuzberg::core::config::extraction::ImageOutputFormat) -> Self {
        match v {
            kreuzberg::core::config::extraction::ImageOutputFormat::Native => ImageOutputFormat::Native,
            kreuzberg::core::config::extraction::ImageOutputFormat::Png => ImageOutputFormat::Png,
            kreuzberg::core::config::extraction::ImageOutputFormat::Jpeg { quality } => {
                ImageOutputFormat::Jpeg { quality: quality as _ }
            }
            kreuzberg::core::config::extraction::ImageOutputFormat::Webp { quality } => {
                ImageOutputFormat::Webp { quality: quality as _ }
            }
            #[cfg(feature = "heic")]
            kreuzberg::core::config::extraction::ImageOutputFormat::Heif { quality } => {
                ImageOutputFormat::Heif { quality: quality as _ }
            }
            #[cfg(feature = "svg")]
            kreuzberg::core::config::extraction::ImageOutputFormat::Svg => ImageOutputFormat::Svg,
            _ => unreachable!("cfg-gated variant of ImageOutputFormat not active in this build"),
        }
    }
}
...
impl From<kreuzberg::CallMode> for CallMode {
    fn from(v: kreuzberg::CallMode) -> Self {
        match v {
            kreuzberg::CallMode::TextOnly => CallMode::TextOnly,
            kreuzberg::CallMode::VisionOnly => CallMode::VisionOnly,
            kreuzberg::CallMode::TextPlusVision => CallMode::TextPlusVision,
        }
    }
}

impl From<kreuzberg::MergeMode> for MergeMode {
    fn from(v: kreuzberg::MergeMode) -> Self {
        match v {
            kreuzberg::MergeMode::ObjectMerge => MergeMode::ObjectMerge,
            kreuzberg::MergeMode::ArrayConcat => MergeMode::ArrayConcat,
            kreuzberg::MergeMode::ObjectFirst => MergeMode::ObjectFirst,
        }
    }
}

impl From<kreuzberg::NerBackendKind> for NerBackendKind {
    fn from(v: kreuzberg::NerBackendKind) -> Self {
        match v {
            kreuzberg::NerBackendKind::Onnx => NerBackendKind::Onnx,
            kreuzberg::NerBackendKind::Llm => NerBackendKind::Llm,
        }
    }
}
...
impl From<kreuzberg::TableChunkingMode> for TableChunkingMode {
    fn from(v: kreuzberg::TableChunkingMode) -> Self {
        match v {
            kreuzberg::TableChunkingMode::Split => TableChunkingMode::Split,
            kreuzberg::TableChunkingMode::RepeatHeader => TableChunkingMode::RepeatHeader,
        }
    }
}
...
impl From<kreuzberg::ChunkSizing> for ChunkSizing {
    fn from(v: kreuzberg::ChunkSizing) -> Self {
        match v {
            ...
            _ => unreachable!("cfg-gated variant of ChunkSizing not active in this build"),
        }
    }
}
...
impl From<kreuzberg::RerankerModelType> for RerankerModelType {
    fn from(v: kreuzberg::RerankerModelType) -> Self {
        match v {
            kreuzberg::RerankerModelType::Preset { name } => RerankerModelType::Preset { name },
            ...
            kreuzberg::RerankerModelType::Llm { llm } => RerankerModelType::Llm {
                llm: LlmConfig::from(llm),
            },
            kreuzberg::RerankerModelType::Plugin { name } => RerankerModelType::Plugin { name },
        }
    }
}
...
impl From<kreuzberg::NodeContent> for NodeContent {
    fn from(v: kreuzberg::NodeContent) -> Self {
        match v {
            ...
            kreuzberg::NodeContent::MetadataBlock { .. } => NodeContent::MetadataBlock,
        }
    }
}
...
impl From<kreuzberg::FormFieldType> for FormFieldType {
    fn from(v: kreuzberg::FormFieldType) -> Self {
        match v {
            kreuzberg::FormFieldType::Text => FormFieldType::Text,
            kreuzberg::FormFieldType::Checkbox => FormFieldType::Checkbox,
            kreuzberg::FormFieldType::Radio => FormFieldType::Radio,
            kreuzberg::FormFieldType::Choice => FormFieldType::Choice,
            kreuzberg::FormFieldType::Signature => FormFieldType::Signature,
            kreuzberg::FormFieldType::Button => FormFieldType::Button,
            kreuzberg::FormFieldType::Unknown => FormFieldType::Unknown,
        }
    }
}
...
impl From<kreuzberg::FormatMetadata> for FormatMetadata {
    fn from(v: kreuzberg::FormatMetadata) -> Self {
        match v {
            ...
            kreuzberg::FormatMetadata::Code => FormatMetadata::Code,
            _ => unreachable!("cfg-gated variant of FormatMetadata not active in this build"),
        }
    }
}
...
impl From<kreuzberg::OcrBoundingGeometry> for OcrBoundingGeometry {
    fn from(v: kreuzberg::OcrBoundingGeometry) -> Self {
        match v {
            ...
            kreuzberg::OcrBoundingGeometry::Quadrilateral { .. } => OcrBoundingGeometry::Quadrilateral,
        }
    }
}
...
impl From<kreuzberg::RegionKind> for RegionKind {
    fn from(v: kreuzberg::RegionKind) -> Self {
        match v {
            kreuzberg::RegionKind::Figure => RegionKind::Figure,
            kreuzberg::RegionKind::DenseTable => RegionKind::DenseTable,
            kreuzberg::RegionKind::ComplexLayout => RegionKind::ComplexLayout,
            kreuzberg::RegionKind::Caption => RegionKind::Caption,
        }
    }
}
...
impl From<kreuzberg::KeywordAlgorithm> for KeywordAlgorithm {
    fn from(v: kreuzberg::KeywordAlgorithm) -> Self {
        match v {
            ...
            _ => unreachable!("cfg-gated variant of KeywordAlgorithm not active in this build"),
        }
    }
}

impl From<kreuzberg::enrichment::EnrichStatus> for EnrichStatus {
    fn from(v: kreuzberg::enrichment::EnrichStatus) -> Self {
        match v {
            kreuzberg::enrichment::EnrichStatus::Pending => EnrichStatus::Pending,
            kreuzberg::enrichment::EnrichStatus::Completed { result } => EnrichStatus::Completed {
                result: EnrichResult::from(result),
            },
            kreuzberg::enrichment::EnrichStatus::Failed { error } => EnrichStatus::Failed { error },
        }
    }
}

impl From<kreuzberg::SchemaCompliance> for SchemaCompliance {
    fn from(v: kreuzberg::SchemaCompliance) -> Self {
        match v {
            kreuzberg::SchemaCompliance::AllValid => SchemaCompliance::AllValid,
            kreuzberg::SchemaCompliance::PartialValid => SchemaCompliance::PartialValid,
            kreuzberg::SchemaCompliance::AllInvalid => SchemaCompliance::AllInvalid,
        }
    }
}

impl From<kreuzberg::ChunkingDecision> for ChunkingDecision {
    fn from(v: kreuzberg::ChunkingDecision) -> Self {
        match v {
            kreuzberg::ChunkingDecision::NoChunking { reason } => ChunkingDecision::NoChunking {
                reason: NoChunkingReason::from(reason),
            },
            kreuzberg::ChunkingDecision::Chunk(f0) => ChunkingDecision::Chunk {
                field0: ChunkPlan::from(f0),
            },
            kreuzberg::ChunkingDecision::UseOverrides { user_chunks } => ChunkingDecision::UseOverrides {
                user_chunks: user_chunks.into_iter().map(PageRange::from).collect(),
            },
        }
    }
}
...
impl From<kreuzberg::NoChunkingReason> for NoChunkingReason {
    fn from(v: kreuzberg::NoChunkingReason) -> Self {
        match v {
            ...
            kreuzberg::NoChunkingReason::FewPages { page_count, threshold } => NoChunkingReason::FewPages {
            ...
            kreuzberg::NoChunkingReason::FormatNotChunkable { mime_type } => {
                NoChunkingReason::FormatNotChunkable { mime_type }
            }
            kreuzberg::NoChunkingReason::ChunkingDisabled => NoChunkingReason::ChunkingDisabled,
            kreuzberg::NoChunkingReason::FastTextExtraction => NoChunkingReason::FastTextExtraction,
        }
    }
}

impl From<kreuzberg::ChunkingReason> for ChunkingReason {
    fn from(v: kreuzberg::ChunkingReason) -> Self {
        match v {
            ...
            kreuzberg::ChunkingReason::ManyPages { page_count, threshold } => ChunkingReason::ManyPages {
                page_count: page_count as _,
                threshold: threshold as _,
            },
            kreuzberg::ChunkingReason::OcrRequired { page_count, force_ocr } => ChunkingReason::OcrRequired {
                page_count: page_count as _,
                force_ocr: force_ocr as _,
            },
            kreuzberg::ChunkingReason::LargeAndManyPages { size_bytes, page_count } => {
                ChunkingReason::LargeAndManyPages {
                    size_bytes: size_bytes as _,
                    page_count: page_count as _,
                }
            }
...
impl From<kreuzberg::BoundaryReason> for BoundaryReason {
    fn from(v: kreuzberg::BoundaryReason) -> Self {
        match v {
            kreuzberg::BoundaryReason::Start => BoundaryReason::Start,
            kreuzberg::BoundaryReason::PageOneMarker => BoundaryReason::PageOneMarker,
            kreuzberg::BoundaryReason::LetterheadReset => BoundaryReason::LetterheadReset,
            kreuzberg::BoundaryReason::DensityShift => BoundaryReason::DensityShift,
            kreuzberg::BoundaryReason::End => BoundaryReason::End,
        }
    }
}

impl From<kreuzberg::StructuredCallMode> for StructuredCallMode {
    fn from(v: kreuzberg::StructuredCallMode) -> Self {
        match v {
            kreuzberg::StructuredCallMode::Skip => StructuredCallMode::Skip,
            kreuzberg::StructuredCallMode::TextOnly => StructuredCallMode::TextOnly,
            kreuzberg::StructuredCallMode::VisionOnly => StructuredCallMode::VisionOnly,
            kreuzberg::StructuredCallMode::TextPlusVision => StructuredCallMode::TextPlusVision,
            kreuzberg::StructuredCallMode::TextOnlyWithVisionFallback => StructuredCallMode::TextOnlyWithVisionFallback,
        }
    }
}

impl From<kreuzberg::PresetCategory> for PresetCategory {
    fn from(v: kreuzberg::PresetCategory) -> Self {
        match v {
            kreuzberg::PresetCategory::Finance => PresetCategory::Finance,
            kreuzberg::PresetCategory::Identity => PresetCategory::Identity,
            kreuzberg::PresetCategory::Legal => PresetCategory::Legal,
            kreuzberg::PresetCategory::Logistics => PresetCategory::Logistics,
            kreuzberg::PresetCategory::Medical => PresetCategory::Medical,
            kreuzberg::PresetCategory::Hr => PresetCategory::Hr,
            kreuzberg::PresetCategory::Other => PresetCategory::Other,
        }
    }
}
...
impl From<kreuzberg::LayoutClass> for LayoutClass {
    fn from(v: kreuzberg::LayoutClass) -> Self {
        match v {
            ...
            kreuzberg::LayoutClass::Chart => LayoutClass::Chart,
...
impl From<PageClassificationConfig> for kreuzberg::PageClassificationConfig {
    fn from(v: PageClassificationConfig) -> Self {
        kreuzberg::PageClassificationConfig {
...
impl From<SvgOptions> for kreuzberg::core::config::extraction::SvgOptions {
    fn from(v: SvgOptions) -> Self {
        kreuzberg::core::config::extraction::SvgOptions {
            sanitize: v.sanitize as _,
            render_dpi: v.render_dpi as _,
        }
    }
...
impl From<RerankerConfig> for kreuzberg::RerankerConfig {
    fn from(v: RerankerConfig) -> Self {
        kreuzberg::RerankerConfig {
            model: v.model.into(),
            top_k: v.top_k.map(|x| x as _),
            batch_size: v.batch_size as _,
            show_download_progress: v.show_download_progress as _,
...
impl From<ExtractionResult> for kreuzberg::ExtractionResult {
    fn from(v: ExtractionResult) -> Self {
        kreuzberg::ExtractionResult {
            ...
            extraction_confidence: v.extraction_confidence.map(Into::into),
            translation: v.translation.map(Into::into),
            page_classifications: v
                .page_classifications
                .map(|vec| vec.into_iter().map(Into::into).collect()),
            redaction_report: v.redaction_report.map(Into::into),
            formulas: v.formulas.into_iter().map(Into::into).collect(),
            form_fields: v.form_fields.into_iter().map(Into::into).collect(),
...
impl From<DocumentMetadata> for kreuzberg::DocumentMetadata {
    fn from(v: DocumentMetadata) -> Self {
        kreuzberg::DocumentMetadata {
            mime_type: v.mime_type.into(),
            size_bytes: v.size_bytes as _,
            page_count: v.page_count.map(|x| x as _),
            force_ocr: v.force_ocr as _,
            user_chunk_config: v.user_chunk_config.map(Into::into),
            chunking_enabled: v.chunking_enabled as _,
        }
    }
}
...
impl From<UserChunkConfig> for kreuzberg::UserChunkConfig {
    fn from(v: UserChunkConfig) -> Self {
        kreuzberg::UserChunkConfig {
            page_ranges: v.page_ranges.map(|vec| vec.into_iter().map(Into::into).collect()),
            pages_per_chunk: v.pages_per_chunk.map(|x| x as _),
            force_chunking: v.force_chunking as _,
            disable_chunking: v.disable_chunking as _,
        }
...
impl From<ConfidenceSignals> for kreuzberg::ConfidenceSignals {
    fn from(v: ConfidenceSignals) -> Self {
        kreuzberg::ConfidenceSignals {
            text_coverage: v.text_coverage as _,
            ocr_aggregate: v.ocr_aggregate.map(|x| x as _),
...
impl From<ConfidenceWeights> for kreuzberg::ConfidenceWeights {
    fn from(v: ConfidenceWeights) -> Self {
        kreuzberg::ConfidenceWeights {
            text_coverage: v.text_coverage as _,
            ocr_aggregate: v.ocr_aggregate as _,
            schema_compliance: v.schema_compliance as _,
        }
...
impl From<ExtractionConfidence> for kreuzberg::heuristics::ExtractionConfidence {
    fn from(v: ExtractionConfidence) -> Self {
        kreuzberg::heuristics::ExtractionConfidence {
            text_coverage: v.text_coverage as _,
            ocr_aggregate: v.ocr_aggregate.map(|x| x as _),
            schema_compliance: v.schema_compliance.into(),
            combined: v.combined as _,
...
impl From<HeuristicsConfig> for kreuzberg::HeuristicsConfig {
    fn from(v: HeuristicsConfig) -> Self {
        kreuzberg::HeuristicsConfig {
            enable_pdf_text_heuristics: v.enable_pdf_text_heuristics as _,
            text_layer_threshold: v.text_layer_threshold as _,
            file_size_threshold_bytes: v.file_size_threshold_bytes as _,
            page_count_threshold: v.page_count_threshold as _,
...
impl From<MultidocInput> for kreuzberg::MultidocInput {
    fn from(v: MultidocInput) -> Self {
        kreuzberg::MultidocInput {
            page_count: v.page_count as _,
...
impl From<PageSignals> for kreuzberg::PageSignals {
    fn from(v: PageSignals) -> Self {
        kreuzberg::PageSignals {
            page_number: v.page_number as _,
            text_excerpt: v.text_excerpt.into(),
            starts_with_letterhead_like: v.starts_with_letterhead_like as _,
            has_page_number_one_marker: v.has_page_number_one_marker as _,
...
impl From<MultidocThresholds> for kreuzberg::MultidocThresholds {
    fn from(v: MultidocThresholds) -> Self {
        kreuzberg::MultidocThresholds {
            density_shift_threshold: v.density_shift_threshold as _,
            bigram_overlap_min: v.bigram_overlap_min as _,
        }
    }
...
impl From<StructuredInput> for kreuzberg::StructuredInput {
    fn from(v: StructuredInput) -> Self {
        kreuzberg::StructuredInput {
            mime_type: v.mime_type.into(),
            page_count: v.page_count as _,
            text_coverage: v.text_coverage as _,
            avg_chars_per_page: v.avg_chars_per_page as _,
...
impl From<PresetSample> for kreuzberg::PresetSample {
    fn from(v: PresetSample) -> Self {
        kreuzberg::PresetSample {
            input_path: v.input_path.into(),
            output_path: v.output_path.into(),
        }
    }
...
impl From<Preset> for kreuzberg::Preset {
    fn from(v: Preset) -> Self {
        kreuzberg::Preset {
            ...
            schema: serde_json::from_str(&v.schema).unwrap_or_default(),
            system_prompt: v.system_prompt.into(),
            context_template: v.context_template.map(Into::into),
            merge_mode: v.merge_mode.into(),
            preferred_call_mode: v.preferred_call_mode.into(),
            emit_citations: v.emit_citations as _,
            sample: v.sample.map(Into::into),
            fingerprint: v.fingerprint.into(),
        }
    }
}
...
impl From<ImageOutputFormat> for kreuzberg::core::config::extraction::ImageOutputFormat {
    fn from(v: ImageOutputFormat) -> Self {
        match v {
            ImageOutputFormat::Native => kreuzberg::core::config::extraction::ImageOutputFormat::Native,
            ImageOutputFormat::Png => kreuzberg::core::config::extraction::ImageOutputFormat::Png,
            ImageOutputFormat::Jpeg { quality } => {
                kreuzberg::core::config::extraction::ImageOutputFormat::Jpeg { quality: quality as _ }
            }
            ImageOutputFormat::Webp { quality } => {
                kreuzberg::core::config::extraction::ImageOutputFormat::Webp { quality: quality as _ }
            }
            #[cfg(feature = "heic")]
            ImageOutputFormat::Heif { quality } => {
                kreuzberg::core::config::extraction::ImageOutputFormat::Heif { quality: quality as _ }
            }
            #[cfg(feature = "svg")]
            ImageOutputFormat::Svg => kreuzberg::core::config::extraction::ImageOutputFormat::Svg,
            _ => unreachable!("cfg-gated variant of ImageOutputFormat not active in this build"),
        }
    }
}
...
impl From<CallMode> for kreuzberg::CallMode {
    fn from(v: CallMode) -> Self {
        match v {
            CallMode::TextOnly => kreuzberg::CallMode::TextOnly,
            CallMode::VisionOnly => kreuzberg::CallMode::VisionOnly,
            CallMode::TextPlusVision => kreuzberg::CallMode::TextPlusVision,
        }
    }
}

impl From<MergeMode> for kreuzberg::MergeMode {
    fn from(v: MergeMode) -> Self {
        match v {
            MergeMode::ObjectMerge => kreuzberg::MergeMode::ObjectMerge,
            MergeMode::ArrayConcat => kreuzberg::MergeMode::ArrayConcat,
            MergeMode::ObjectFirst => kreuzberg::MergeMode::ObjectFirst,
        }
    }
}
...
impl From<NerBackendKind> for kreuzberg::NerBackendKind {
    fn from(v: NerBackendKind) -> Self {
        match v {
            NerBackendKind::Onnx => kreuzberg::NerBackendKind::Onnx,
            NerBackendKind::Llm => kreuzberg::NerBackendKind::Llm,
        }
    }
}
...
impl From<TableChunkingMode> for kreuzberg::TableChunkingMode {
    fn from(v: TableChunkingMode) -> Self {
        match v {
            TableChunkingMode::Split => kreuzberg::TableChunkingMode::Split,
            TableChunkingMode::RepeatHeader => kreuzberg::TableChunkingMode::RepeatHeader,
        }
    }
}
...
impl From<RerankerModelType> for kreuzberg::RerankerModelType {
    fn from(v: RerankerModelType) -> Self {
        match v {
            RerankerModelType::Preset { name } => kreuzberg::RerankerModelType::Preset { name },
            RerankerModelType::Custom {
                model_id,
                model_file,
                additional_files,
            ...
            RerankerModelType::Llm { llm } => kreuzberg::RerankerModelType::Llm { llm: llm.into() },
            RerankerModelType::Plugin { name } => kreuzberg::RerankerModelType::Plugin { name },
        }
    }
}
...
impl From<WhisperModel> for kreuzberg::WhisperModel {
    fn from(v: WhisperModel) -> Self {
        match v {
            WhisperModel::Tiny => kreuzberg::WhisperModel::Tiny,
            WhisperModel::Base => kreuzberg::WhisperModel::Base,
            WhisperModel::Small => kreuzberg::WhisperModel::Small,
            WhisperModel::Medium => kreuzberg::WhisperModel::Medium,
            WhisperModel::LargeV3 => kreuzberg::WhisperModel::LargeV3,
        }
    }
}
...
impl From<NodeContent> for kreuzberg::NodeContent {
    fn from(v: NodeContent) -> Self {
        match v {
            ...
            NodeContent::MetadataBlock => kreuzberg::NodeContent::MetadataBlock {
...
impl From<FormFieldType> for kreuzberg::FormFieldType {
    fn from(v: FormFieldType) -> Self {
        match v {
            FormFieldType::Text => kreuzberg::FormFieldType::Text,
            FormFieldType::Checkbox => kreuzberg::FormFieldType::Checkbox,
            FormFieldType::Radio => kreuzberg::FormFieldType::Radio,
            FormFieldType::Choice => kreuzberg::FormFieldType::Choice,
            FormFieldType::Signature => kreuzberg::FormFieldType::Signature,
            FormFieldType::Button => kreuzberg::FormFieldType::Button,
            FormFieldType::Unknown => kreuzberg::FormFieldType::Unknown,
        }
    }
}
...
impl From<FormatMetadata> for kreuzberg::FormatMetadata {
    fn from(v: FormatMetadata) -> Self {
        match v {
            ...
            #[cfg(feature = "tree-sitter")]
            FormatMetadata::Code => kreuzberg::FormatMetadata::Code,
            _ => unreachable!("cfg-gated variant of FormatMetadata not active in this build"),
        }
    }
}
...
impl From<OcrBoundingGeometry> for kreuzberg::OcrBoundingGeometry {
    fn from(v: OcrBoundingGeometry) -> Self {
        match v {
            ...
            OcrBoundingGeometry::Quadrilateral => kreuzberg::OcrBoundingGeometry::Quadrilateral {
...
impl From<SchemaCompliance> for kreuzberg::SchemaCompliance {
    fn from(v: SchemaCompliance) -> Self {
        match v {
            SchemaCompliance::AllValid => kreuzberg::SchemaCompliance::AllValid,
            SchemaCompliance::PartialValid => kreuzberg::SchemaCompliance::PartialValid,
            SchemaCompliance::AllInvalid => kreuzberg::SchemaCompliance::AllInvalid,
        }
    }
}

impl From<PresetCategory> for kreuzberg::PresetCategory {
    fn from(v: PresetCategory) -> Self {
        match v {
            PresetCategory::Finance => kreuzberg::PresetCategory::Finance,
            PresetCategory::Identity => kreuzberg::PresetCategory::Identity,
            PresetCategory::Legal => kreuzberg::PresetCategory::Legal,
            PresetCategory::Logistics => kreuzberg::PresetCategory::Logistics,
            PresetCategory::Medical => kreuzberg::PresetCategory::Medical,
            PresetCategory::Hr => kreuzberg::PresetCategory::Hr,
            PresetCategory::Other => kreuzberg::PresetCategory::Other,
        }
    }
}
...
pub async fn classify_pages(result: ExtractionResult, config: PageClassificationConfig) -> Result<(), String> {
    kreuzberg::text::classification::classify_pages(
        ...
        &kreuzberg::PageClassificationConfig::from(config),
    )
    .await
    .map(|v| v)
    .map_err(|e| e.to_string())
...
pub async fn classify_text(text: String, config: PageClassificationConfig) -> Result<Vec<ClassificationLabel>, String> {
    kreuzberg::text::classification::classify_text(&text, &kreuzberg::PageClassificationConfig::from(config))
        .await
        .map(|v| v.into_iter().map(ClassificationLabel::from).collect::<Vec<_>>())
        .map_err(|e| e.to_string())
}
...
pub async fn redact(result: ExtractionResult, config: RedactionConfig) -> Result<(), String> {
    kreuzberg::text::redaction::redact(
        &mut kreuzberg::ExtractionResult::from(result),
        &kreuzberg::RedactionConfig::from(config),
    )
    .await
    .map(|v| v)
    .map_err(|e| e.to_string())
...
pub async fn translate_result(result: ExtractionResult, config: TranslationConfig) -> Result<(), String> {
    kreuzberg::text::translation::translate_result(
        &mut kreuzberg::ExtractionResult::from(result),
        &kreuzberg::TranslationConfig::from(config),
    )
    .await
    .map(|v| v)
    .map_err(|e| e.to_string())
...
pub fn chunk_for_rag(text: String, config: ChunkingConfig) -> Result<ChunkingResult, String> {
    kreuzberg::chunking::chunk_for_rag(&text, &kreuzberg::ChunkingConfig::from(config))
...
pub async fn extract_region_with_vlm(
    ...
    kreuzberg::llm::region_extractor::extract_region_with_vlm(
        &image_bytes,
        &image_mime,
        unsafe { std::mem::transmute::<RegionKind, kreuzberg::RegionKind>(region_kind) },
...
pub async fn rerank_async(
    ...
    kreuzberg::rerank_async(query, documents, &kreuzberg::RerankerConfig::from(config))
        .await
        .map(|v| v.into_iter().map(RerankedDocument::from).collect::<Vec<_>>())
        .map_err(|e| e.to_string())
}
...
pub fn extract_keywords(text: String, config: KeywordConfig) -> Result<Vec<Keyword>, String> {
    kreuzberg::keywords::extract_keywords(&text, &kreuzberg::KeywordConfig::from(config))
        .map(|v| v.into_iter().map(Keyword::from).collect::<Vec<_>>())
        .map_err(|e| e.to_string())
}
...
pub fn analyze_document(
    ...
    kreuzberg::analyze_document(
        &kreuzberg::DocumentMetadata::from(metadata),
        &kreuzberg::HeuristicsConfig::from(config),
        document_bytes.as_deref(),
    )
    .map(ChunkingDecision::from)
    .map_err(|e| e.to_string())
}
...
pub fn analyze_with_user_chunks(
    ...
    ChunkingDecision::from(kreuzberg::analyze_with_user_chunks(
        &user_ranges
            .into_iter()
            .map(kreuzberg::PageRange::from)
            .collect::<Vec<_>>(),
        total_pages as u32,
        size_bytes as u64,
        &kreuzberg::HeuristicsConfig::from(config),
...
pub fn score_confidence(signals: ConfidenceSignals, weights: ConfidenceWeights) -> ExtractionConfidence {
    ExtractionConfidence::from(kreuzberg::score_confidence(
        kreuzberg::ConfidenceSignals::from(signals),
        kreuzberg::ConfidenceWeights::from(weights),
    ))
}
...
pub fn check_format_limits(
    mime_type: String,
    sheet_count: Option<i64>,
    workbook_cells: Option<i64>,
    embedded_count: Option<i64>,
    config: HeuristicsConfig,
) -> Option<String> {
...
pub fn boundaries_from_extraction_result(
    ...
    kreuzberg::boundaries_from_extraction_result(
        ...
        &kreuzberg::MultidocThresholds::from(thresholds),
    )
    .into_iter()
...
pub fn detect_boundaries(input: MultidocInput, thresholds: MultidocThresholds) -> Vec<DocumentBoundary> {
    kreuzberg::detect_boundaries(
        &kreuzberg::MultidocInput::from(input),
        &kreuzberg::MultidocThresholds::from(thresholds),
    )
    .into_iter()
    .map(DocumentBoundary::from)
...
pub fn choose_call_mode(input: StructuredInput, t: StructuredThresholds) -> StructuredCallMode {
    StructuredCallMode::from(kreuzberg::choose_call_mode(
        &kreuzberg::StructuredInput::from(input),
        unsafe { std::mem::transmute::<&StructuredThresholds, &kreuzberg::StructuredThresholds>(&t) },
    ))
}
...
#[cfg(feature = "heuristics")]
pub fn calculate_chunk_plan(page_count: i64, size_bytes: i64, needs_ocr: bool, config: HeuristicsConfig) -> ChunkPlan {
    ChunkPlan::from(kreuzberg::calculate_chunk_plan(
        page_count as u32,
        size_bytes as u64,
        needs_ocr,
        &kreuzberg::HeuristicsConfig::from(config),
...
pub fn calculate_plan_from_overrides(
    ...
    ChunkPlan::from(kreuzberg::calculate_plan_from_overrides(
        &user_chunks
            .into_iter()
            .map(kreuzberg::PageRange::from)
            .collect::<Vec<_>>(),
...
pub fn fingerprint(raw: Vec<u8>) -> String {
    kreuzberg::presets::loader::fingerprint(&raw).to_string()
}
...
pub fn resolve(
    ...
    let __context_btree = context
        .into_iter()
        .collect::<std::collections::BTreeMap<String, String>>();
    kreuzberg::resolve(
        &kreuzberg::Preset::from(preset),
        custom_schema.as_deref().and_then(|s| serde_json::from_str(s).ok()),
        &__context_btree,
    )
...
pub fn rerank(query: String, documents: Vec<String>, config: RerankerConfig) -> Result<Vec<RerankedDocument>, String> {
    kreuzberg::rerank(query, documents, &kreuzberg::RerankerConfig::from(config))
        .map(|v| v.into_iter().map(RerankedDocument::from).collect::<Vec<_>>())
        .map_err(|e| e.to_string())
}
...
pub fn get_reranker_preset(name: String) -> Option<RerankerPreset> {
    kreuzberg::get_reranker_preset(&name).map(RerankerPreset::from)
}
...
#[frb]
pub fn create_reranker_preset_from_json(json: String) -> Result<RerankerPreset, String> {
...
#[frb]
pub fn create_enrich_options_from_json(json: String) -> Result<EnrichOptions, String> {
    serde_json::from_str::<kreuzberg::enrichment::EnrichOptions>(&json)
        .map(EnrichOptions::from)
        .map_err(|e| e.to_string())
}

#[frb]
pub fn create_enrich_result_from_json(json: String) -> Result<EnrichResult, String> {
...
#[frb]
pub fn create_confidence_signals_from_json(json: String) -> Result<ConfidenceSignals, String> {
...
#[frb]
pub fn create_confidence_weights_from_json(json: String) -> Result<ConfidenceWeights, String> {
...
#[frb]
pub fn create_chunk_plan_from_json(json: String) -> Result<ChunkPlan, String> {
...
#[frb]
pub fn create_structured_input_from_json(json: String) -> Result<StructuredInput, String> {
...
#[frb]
pub fn create_structured_thresholds_from_json(json: String) -> Result<StructuredThresholds, String> {
...
impl kreuzberg::OcrBackend for OcrBackendDartCallbacks {
    ...
    fn emits_structured_markdown(&self) -> bool {
        let __result = ::tokio::runtime::Builder::new_current_thread()
            .build()
            .expect("build alef visitor tokio runtime")
            .block_on(async { (self.emits_structured_markdown)().await });
        __result
    }
...
impl kreuzberg::plugins::Plugin for RerankerBackendDartCallbacks {
    fn name(&self) -> &str {
        &self.plugin_name
    }
...
#[async_trait::async_trait]
impl kreuzberg::RerankerBackend for RerankerBackendDartCallbacks {
    async fn rerank(&self, query: String, documents: Vec<String>) -> kreuzberg::Result<Vec<f32>> {
...
/// as a bare ident via its `use crate::*;` preamble.
pub use kreuzberg::RerankerBackend;
