...
impl From<xberg::enrich::ChunkClassificationEnrichmentConfig> for ChunkClassificationEnrichmentConfig {
    fn from(v: xberg::enrich::ChunkClassificationEnrichmentConfig) -> Self {
...
pub async fn classify_chunks(result: ExtractedDocument, config: ChunkClassificationConfig) -> Result<(), String> {
    xberg::text::classification::classify_chunks(
        &mut xberg::ExtractedDocument::from(result),
...
pub fn create_chunk_classification_config_from_json(json: String) -> Result<ChunkClassificationConfig, String> {
    serde_json::from_str::<xberg::ChunkClassificationConfig>(&json)
        .map(ChunkClassificationConfig::from)
        .map_err(|e| e.to_string())
}
