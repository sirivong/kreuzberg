...
class KreuzbergBridge {
  ...
  /// throws anyhow::Error on failure
  static Future<PcmAudio> decodeAudioToPcm(Uint8List bytes, {int? maxBytes}) async {
    return await rust_bridge.decodeAudioToPcm(bytes: bytes, maxBytes: maxBytes);
  }
  ...
  /// throws WhisperModelError on failure
  static Future<WhisperModelPaths> ensureWhisperModel(WhisperModel model, bool allowNetwork, bool verifyHash, {String? cacheDir}) async {
    return await rust_bridge.ensureWhisperModel(model: model, cacheDir: cacheDir, allowNetwork: allowNetwork, verifyHash: verifyHash);
  }
  ...
  static Future<AudioTags> readAudioTags(Uint8List bytes) async {
    return await rust_bridge.readAudioTags(bytes: bytes);
  }
