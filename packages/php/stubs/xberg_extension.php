...
final class ExtractionOutput
{
    public function __construct(
        ...
        /** @var array<string, string> Optional implementation-specific crawl metadata. */
        public readonly array $crawl
    ) { }
...
class XbergApi
{
    public static function extractSync(\Xberg\ExtractInput $input, \Xberg\ExtractionConfig $config): \Xberg\ExtractionOutput { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param array<\Xberg\ExtractInput> $inputs
     * @param \Xberg\ExtractionConfig $config
     * @return \Xberg\ExtractionOutput
     */
    public static function extractBatchSync(array $inputs, \Xberg\ExtractionConfig $config): \Xberg\ExtractionOutput { throw new \RuntimeException('Not implemented.'); }
