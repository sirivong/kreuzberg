...
namespace Xberg {
    ...
    final class ChunkClassificationConfig
    {
        public function __construct(
             ...
             * least one entry.
             *
             * @var array<ChunkClassificationDefinition>
             */
    ...
    final class ExtractionConfig
    {
        public function __construct(
             ...
             * @var OcrStrategy
             */
            public readonly OcrStrategy $ocrStrategy,
            /**
             ...
             */
            public readonly ?ConversionOptions $htmlOptions = null,
            /**
             ...
             *
             * @var ?ChunkClassificationConfig
             */
            public readonly ?ChunkClassificationConfig $chunkClassification = null,
            /**
    ...
    final class FileExtractionConfig
    {
        public function __construct(
            ...
            /** @var ?OcrStrategy Override the OCR page-selection strategy for this file. */
            public readonly ?OcrStrategy $ocrStrategy = null,
            ...
            public readonly ?PostProcessorConfig $postprocessor = null,
            /** @var ?HtmlOutputConfig Override styled HTML output configuration for this file. */
            public readonly ?HtmlOutputConfig $htmlOutput = null,
             ...
             */
            public readonly ?StructuredExtractionConfig $structuredExtraction = null,
            /** @var ?UrlExtractionConfig Override URL ingestion and crawl configuration for this file. */
            public readonly ?UrlExtractionConfig $url = null,
            /** @var ?NerConfig Override named-entity recognition configuration for this file. */
            public readonly ?NerConfig $ner = null,
            /** @var ?RedactionConfig Override redaction configuration for this file. */
            public readonly ?RedactionConfig $redaction = null,
            /** @var ?SummarizationConfig Override summarization configuration for this file. */
            public readonly ?SummarizationConfig $summarization = null,
            /** @var ?TranslationConfig Override translation configuration for this file. */
            public readonly ?TranslationConfig $translation = null,
            /** @var ?PageClassificationConfig Override per-page classification configuration for this file. */
            public readonly ?PageClassificationConfig $pageClassification = null,
            /** @var ?ChunkClassificationConfig Override per-chunk classification configuration for this file. */
            public readonly ?ChunkClassificationConfig $chunkClassification = null,
            /** @var ?CaptioningConfig Override VLM captioning configuration for this file. */
            public readonly ?CaptioningConfig $captioning = null,
    ...
    {
        public function __construct(
            /** @var array<ExtractedDocument> Extracted documents in discovery order. */
    ...
    final class UrlExtractionConfig
    {
        public function __construct(
            ...
            /** @var CrawlConfig Crawlberg crawl configuration used for HTTP(S) URL extraction. */
            public readonly CrawlConfig $crawl,
    ...
    {
        public function __construct(
            /** @var LateInteractionModelType The late-interaction model to use (defaults to the "gte-moderncolbert" preset). */
            public readonly LateInteractionModelType $model,
            /**
            ...
            /** @var ?AccelerationConfig Hardware acceleration for the late-interaction ONNX model. */
            public readonly ?AccelerationConfig $acceleration = null,
            /**
    ...
    {
        public function __construct(
            /** @var string Backend name: "tesseract", "paddleocr", "paddle-ocr", "vlm", or a custom registered name. */
    ...
    final class OcrConfig
    {
        public function __construct(
             ...
             */
            public readonly bool $enabled,
            /** @var string OCR backend: tesseract, paddleocr, paddle-ocr, or vlm */
            public readonly string $backend,
            /**
    ...
    {
        public function __construct(
            /** @var EmbeddingModelType The embedding model to use (defaults to "gte-modernbert-base" preset if not specified) */
    ...
    {
        public function __construct(
            /** @var SparseEmbeddingModelType The sparse-embedding model to use (defaults to the "opensearch-v3-distill" preset). */
            public readonly SparseEmbeddingModelType $model,
            /**
             * Batch size for local ONNX inference.
             *
             ...
             */
            public readonly ?string $cacheDir = null,
            /** @var ?AccelerationConfig Hardware acceleration for the sparse-embedding ONNX model. */
            public readonly ?AccelerationConfig $acceleration = null,
            /**
             * Maximum wall-clock duration (in seconds) for a single embed call when
    ...
    final class ExtractedDocument
    {
        public function __construct(
             ...
             * @var DocumentCounts
             */
            public readonly DocumentCounts $counts,
            /**
    ...
    final class ArchiveEntry
    {
        public function __construct(
            ...
            public readonly string $mimeType,
            /** @var ExtractedDocument Full extraction result for this file. */
            public readonly ExtractedDocument $result,
        ) {}
    }
    ...
    final class ChunkMetadata
    {
        public function __construct(
             ...
             * @var array<PageSpan>
             */
            public readonly array $pageSpans,
            /**
    ...
    final class PageSpan
    {
        public function __construct(
            ...
            /** @var ?BoundingBox Bounding box on this page, if known. */
            public readonly ?BoundingBox $bbox = null,
        ) {}
    }
    ...
    final class ExtractedImage
    {
        public function __construct(
             ...
             */
            public readonly ?ExtractedDocument $ocrResult = null,
            /**
    ...
    {
        public function __construct(
            /** @var array<CodeChunkInfo> Structural code chunks (function/class/module boundaries). */
             ...
             * @var ?CodeDataNode
             */
            public readonly ?CodeDataNode $data = null,
        ) {}
    }
    ...
    final class CodeDataNode
    {
        public function __construct(
             ...
             * other kinds.
             *
             * @var array<CodeDataAttribute>
             */
            public readonly array $attributes,
            /** @var array<CodeDataNode> Children for nested containers and XML element bodies. */
            public readonly array $children,
    ...
    final class RevisionDelta
    {
        public function __construct(
            ...
            /** @var array<PropertyChange> Formatting or metadata property changes for this revision. */
            public readonly array $propertyChanges,
        ) {}
    }
    ...
    {
        public function __construct(
            /** @var ChunkClassificationConfig Label-definition set and LLM/batching settings for the chunk-classification stage. */
            public readonly ChunkClassificationConfig $config,
        ) {}
    }
