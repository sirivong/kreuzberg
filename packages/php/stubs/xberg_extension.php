...
namespace Xberg {
    ...
    {
        public function __construct(
            /** @var LateInteractionModelType The late-interaction model to use (defaults to the "colbert" preset). */
    ...
    {
        public function __construct(
            /** @var SparseEmbeddingModelType The sparse-embedding model to use (defaults to the "splade" preset). */
