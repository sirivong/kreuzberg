...
// alef:hash:8df93421f03c5d0047e16f3f14d85c0d5dd00bd1e3a32573621071aed1872767
...
namespace Kreuzberg {
    ...
    class KreuzbergApi
    {
         ...
         * @return array<\Kreuzberg\ExtractionResult>
         */
        public static function batchExtractFilesAsync(array $items, \Kreuzberg\ExtractionConfig $config): array
        {
            throw new \RuntimeException('Not implemented.');
        }
        /**
         ...
         * @return array<array<float>>
         */
        public static function embedTextsAsyncAsync(array $texts, \Kreuzberg\EmbeddingConfig $config): array
        {
            throw new \RuntimeException('Not implemented.');
        }
