...
final class GlineBackend
{
    public function __construct(
        ...
        /** @var string */
        public readonly string $tokenizerPath
    ) { }
    public static function new(?string $repo_id = null): GlineBackend
    { throw new \RuntimeException('Not implemented — provided by the native extension.'); }
...
class KreuzbergApi
{
    ...
    public static function applyStrategy(\Kreuzberg\RedactionStrategy $strategy, string $original, \Kreuzberg\PiiCategory $category, \Kreuzberg\TokenCounter $counter): string { throw new \RuntimeException('Not implemented.'); }
