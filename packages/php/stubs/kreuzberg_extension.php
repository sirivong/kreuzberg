...
class KreuzbergApi
{
     ...
     * @return float
     */
    public static function calculateQualityScore(string $text, ?array $metadata = null): float { throw new \RuntimeException('Not implemented.'); }
    /**
