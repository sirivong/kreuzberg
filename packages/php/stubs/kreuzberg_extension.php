...
class KreuzbergApi
{
    ...
    public static function classifyPages(\Kreuzberg\ExtractionResult $result, \Kreuzberg\PageClassificationConfig $config): void { }
    /**
     * @param string $text
     * @param \Kreuzberg\PageClassificationConfig $config
     * @return array<\Kreuzberg\ClassificationLabel>
     */
    public static function classifyText(string $text, \Kreuzberg\PageClassificationConfig $config): array { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param array<string> $pages
     * @param \Kreuzberg\PageClassificationConfig $config
     * @return array<\Kreuzberg\ClassificationLabel>
     */
    public static function classifyDocument(array $pages, \Kreuzberg\PageClassificationConfig $config): array { throw new \RuntimeException('Not implemented.'); }
    ...
    public static function redact(\Kreuzberg\ExtractionResult $result, \Kreuzberg\RedactionConfig $config): void { }
    /**
     * @param string $text
     * @return array<\Kreuzberg\PatternMatch>
     */
    public static function findAll(string $text): array { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param string $text
     * @param array<\Kreuzberg\PiiCategory> $categories
     * @return array<\Kreuzberg\PatternMatch>
     */
    ...
    public static function translateResult(\Kreuzberg\ExtractionResult $result, \Kreuzberg\TranslationConfig $config): void { }
    /**
     * @param string $markdown
     * @return array<\Kreuzberg\FootnoteAnchor>
     */
    public static function findFootnoteAnchors(string $markdown): array { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param string $markdown
     * @return array<\Kreuzberg\FootnoteDefinition>
     */
    ...
    /**
     * @param string $markdown
     * @return array<\Kreuzberg\Citation>
     */
    ...
    public static function chunkForRag(string $text, \Kreuzberg\ChunkingConfig $config): \Kreuzberg\ChunkingResult { throw new \RuntimeException('Not implemented.'); }
    ...
    public static function extractRegionWithVlm(string $image_bytes, string $image_mime, \Kreuzberg\RegionKind $region_kind, \Kreuzberg\LlmConfig $llm_config, ?string $custom_prompt = null): string { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param string $query
     * @param array<string> $documents
     * @param \Kreuzberg\RerankerConfig $config
     * @return array<\Kreuzberg\RerankedDocument>
     */
    public static function rerankAsync(string $query, array $documents, \Kreuzberg\RerankerConfig $config): array { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param string $text
     * @param \Kreuzberg\KeywordConfig $config
     * @return array<\Kreuzberg\Keyword>
     */
    public static function extractKeywords(string $text, \Kreuzberg\KeywordConfig $config): array { throw new \RuntimeException('Not implemented.'); }
    public static function analyzeDocument(\Kreuzberg\DocumentMetadata $metadata, \Kreuzberg\HeuristicsConfig $config, ?string $document_bytes = null): \Kreuzberg\ChunkingDecision { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param array<\Kreuzberg\PageRange> $user_ranges
     * @param int $total_pages
     * @param int $size_bytes
     * @param \Kreuzberg\HeuristicsConfig $config
     * @return \Kreuzberg\ChunkingDecision
     */
    public static function analyzeWithUserChunks(array $user_ranges, int $total_pages, int $size_bytes, \Kreuzberg\HeuristicsConfig $config): \Kreuzberg\ChunkingDecision { throw new \RuntimeException('Not implemented.'); }
    public static function scoreConfidence(\Kreuzberg\ConfidenceSignals $signals, \Kreuzberg\ConfidenceWeights $weights): \Kreuzberg\ExtractionConfidence { throw new \RuntimeException('Not implemented.'); }
    public static function checkFormatLimits(string $mime_type, ?int $sheet_count = null, ?int $workbook_cells = null, ?int $embedded_count = null, ?\Kreuzberg\HeuristicsConfig $config = null): ?string { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param \Kreuzberg\ExtractionResult $result
     * @param \Kreuzberg\MultidocThresholds $thresholds
     * @return array<\Kreuzberg\DocumentBoundary>
     */
    public static function boundariesFromExtractionResult(\Kreuzberg\ExtractionResult $result, \Kreuzberg\MultidocThresholds $thresholds): array { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param \Kreuzberg\MultidocInput $input
     * @param \Kreuzberg\MultidocThresholds $thresholds
     * @return array<\Kreuzberg\DocumentBoundary>
     */
    public static function detectBoundaries(\Kreuzberg\MultidocInput $input, \Kreuzberg\MultidocThresholds $thresholds): array { throw new \RuntimeException('Not implemented.'); }
    public static function chooseCallMode(\Kreuzberg\StructuredInput $input, \Kreuzberg\StructuredThresholds $t): \Kreuzberg\StructuredCallMode { throw new \RuntimeException('Not implemented.'); }
    public static function calculateChunkPlan(int $page_count, int $size_bytes, bool $needs_ocr, \Kreuzberg\HeuristicsConfig $config): \Kreuzberg\ChunkPlan { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param array<\Kreuzberg\PageRange> $user_chunks
     * @param int $total_pages
     * @param int $size_bytes
     * @param \Kreuzberg\HeuristicsConfig $config
     * @return \Kreuzberg\ChunkPlan
     */
    public static function calculatePlanFromOverrides(array $user_chunks, int $total_pages, int $size_bytes, \Kreuzberg\HeuristicsConfig $config): \Kreuzberg\ChunkPlan { throw new \RuntimeException('Not implemented.'); }
    public static function fingerprint(string $raw): string { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param \Kreuzberg\Preset $preset
     * @param ?string $custom_schema
     * @param ?array<string, string> $context
     * @return \Kreuzberg\ResolvedPreset
     */
    public static function resolve(\Kreuzberg\Preset $preset, ?string $custom_schema = null, ?array $context = null): \Kreuzberg\ResolvedPreset { throw new \RuntimeException('Not implemented.'); }
    ...
    public static function captionImage(string $image_bytes, \Kreuzberg\LlmConfig $llm_config, ?string $custom_prompt = null): string { throw new \RuntimeException('Not implemented.'); }
    public static function captionImageFile(string $path, \Kreuzberg\LlmConfig $llm_config, ?string $custom_prompt = null): string { throw new \RuntimeException('Not implemented.'); }
     ...
     * @param \Kreuzberg\EmbeddingConfig $_config
     * @return array<array<float>>
     */
    public static function embedTextsAsync(array $_texts, \Kreuzberg\EmbeddingConfig $_config): array { throw new \RuntimeException('Not implemented.'); }
     ...
     * @return array<\Kreuzberg\RerankedDocument>
     */
    public static function rerank(string $query, array $documents, \Kreuzberg\RerankerConfig $config): array { throw new \RuntimeException('Not implemented.'); }
    public static function getRerankerPreset(string $name): ?\Kreuzberg\RerankerPreset { throw new \RuntimeException('Not implemented.'); }
    /**
     * @return array<string>
     */
    ...
    public static function clearRenderers(): void { }
    public static function registerRerankerBackend(\Kreuzberg\RerankerBackend $backend): void { }
