...
final class Xberg
{
     ...
     */
    public static function extractSync(
ExtractInput $input, ExtractionConfig $config): ExtractionOutput
    {
        return \Xberg\XbergApi::extractSync($input, $config); // delegate to native extension class
    }
    /**
     ...
     * @throws \Xberg\XbergException
     */
    public static function extractBatchSync(
array $inputs, ExtractionConfig $config): ExtractionOutput
    {
        return \Xberg\XbergApi::extractBatchSync($inputs, $config); // delegate to native extension class
    }
    /**
