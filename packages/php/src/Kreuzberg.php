...
// alef:hash:35677ad4a0d80a283ad42749260a3aeb85b85cf2b04652009b50075e4e4c9bae
...
OcrBackend $backend = null) : void        \Kreuzberg\KreuzbergApi::register_ocr_backend($backend); // delegate to native extension class
    }
    /**
...
string $name) : void        \Kreuzberg\KreuzbergApi::unregister_ocr_backend($name); // delegate to native extension class
    }
    /**
     * clearOcrBackends.
     *
...
) : void        \Kreuzberg\KreuzbergApi::clear_ocr_backends(); // delegate to native extension class
    }
    /**
...
PostProcessor $backend = null) : void        \Kreuzberg\KreuzbergApi::register_post_processor($backend); // delegate to native extension class
    }
    /**
...
string $name) : void        \Kreuzberg\KreuzbergApi::unregister_post_processor($name); // delegate to native extension class
    }
    /**
     * clearPostProcessors.
     *
...
) : void        \Kreuzberg\KreuzbergApi::clear_post_processors(); // delegate to native extension class
    }
    /**
     * registerValidator.
     *
...
Validator $backend = null) : void        \Kreuzberg\KreuzbergApi::register_validator($backend); // delegate to native extension class
    }
    /**
     * unregisterValidator.
     *
...
string $name) : void        \Kreuzberg\KreuzbergApi::unregister_validator($name); // delegate to native extension class
    }
    /**
     * clearValidators.
     *
...
) : void        \Kreuzberg\KreuzbergApi::clear_validators(); // delegate to native extension class
    }
    /**
...
EmbeddingBackend $backend = null) : void        \Kreuzberg\KreuzbergApi::register_embedding_backend($backend); // delegate to native extension class
    }
    /**
...
string $name) : void        \Kreuzberg\KreuzbergApi::unregister_embedding_backend($name); // delegate to native extension class
    }
    /**
...
) : void        \Kreuzberg\KreuzbergApi::clear_embedding_backends(); // delegate to native extension class
    }
    /**
...
DocumentExtractor $backend = null) : void        \Kreuzberg\KreuzbergApi::register_document_extractor($backend); // delegate to native extension class
    }
    /**
...
string $name) : void        \Kreuzberg\KreuzbergApi::unregister_document_extractor($name); // delegate to native extension class
    }
    /**
...
) : void        \Kreuzberg\KreuzbergApi::clear_document_extractors(); // delegate to native extension class
    }
    /**
     * registerRenderer.
     *
...
Renderer $backend = null) : void        \Kreuzberg\KreuzbergApi::register_renderer($backend); // delegate to native extension class
    }
    /**
     * unregisterRenderer.
     *
...
string $name) : void        \Kreuzberg\KreuzbergApi::unregister_renderer($name); // delegate to native extension class
    }
    /**
     * clearRenderers.
     *
...
) : void        \Kreuzberg\KreuzbergApi::clear_renderers(); // delegate to native extension class
    }
}
