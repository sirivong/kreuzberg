...
string $path, ExtractionConfig $config, ?string $mime_type = null): ExtractionResult
    {
...
string $name, ?string $cache_dir = null): string
     ...
     * @return string
     */
    public static function defaultModelName(
): string
    {
     ...
     * @return array<string>
     */
    public static function knownModels(
): array
    {
...
string $text, array $categories): array
     ...
     *
     * @param RedactionStrategy $strategy
     * @param string $original
     * @param PiiCategory $category
     * @param TokenCounter $counter
     * @return string
     */
    public static function applyStrategy(
RedactionStrategy $strategy, string $original, PiiCategory $category, ?TokenCounter $counter = null): string
    {
        return \Kreuzberg\KreuzbergApi::applyStrategy($strategy, $original, $category, $counter ?? new TokenCounter()); // delegate to native extension class
    }
    /**
