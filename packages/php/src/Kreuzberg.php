...
array $pages, PageClassificationConfig $config): array
    {
        return \Kreuzberg\KreuzbergApi::classifyDocument($pages, $config); // delegate to native extension class
    }
    /**
...
string $markdown): array
    {
        return \Kreuzberg\KreuzbergApi::findFootnoteAnchors($markdown); // delegate to native extension class
    }
    /**
...
string $markdown): array
    {
        return \Kreuzberg\KreuzbergApi::parseFootnoteDefinitions($markdown); // delegate to native extension class
    }
    /**
...
string $markdown): array
    {
        return \Kreuzberg\KreuzbergApi::findInferenceMarkers($markdown); // delegate to native extension class
    }
    /**
...
string $markdown): array
    {
        return \Kreuzberg\KreuzbergApi::findUnmarkedClaims($markdown); // delegate to native extension class
    }
    /**
...
string $markdown): array
    {
        return \Kreuzberg\KreuzbergApi::parseCitations($markdown); // delegate to native extension class
    }
    /**
...
string $excerpt, string $source_text): bool
    {
        return \Kreuzberg\KreuzbergApi::verifyExcerpt($excerpt, $source_text); // delegate to native extension class
    }
    /**
...
string $text, ChunkingConfig $config): ChunkingResult
    {
        return \Kreuzberg\KreuzbergApi::chunkForRag($text, $config); // delegate to native extension class
    }
    /**
...
string $query, array $documents, RerankerConfig $config): array
    {
        return \Kreuzberg\KreuzbergApi::rerankAsync($query, $documents, $config); // delegate to native extension class
    }
    /**
...
DocumentMetadata $metadata, HeuristicsConfig $config, ?string $document_bytes = null): ChunkingDecision
    {
        return \Kreuzberg\KreuzbergApi::analyzeDocument($metadata, $config, $document_bytes); // delegate to native extension class
    }
    /**
...
array $user_ranges, int $total_pages, int $size_bytes, HeuristicsConfig $config): ChunkingDecision
    {
        return \Kreuzberg\KreuzbergApi::analyzeWithUserChunks($user_ranges, $total_pages, $size_bytes, $config); // delegate to native extension class
    }
    /**
...
ConfidenceSignals $signals, ConfidenceWeights $weights): ExtractionConfidence
    {
        return \Kreuzberg\KreuzbergApi::scoreConfidence($signals, $weights); // delegate to native extension class
    }
    /**
...
string $mime_type, ?int $sheet_count, ?int $workbook_cells, ?int $embedded_count, HeuristicsConfig $config): ?string
    {
        return \Kreuzberg\KreuzbergApi::checkFormatLimits($mime_type, $sheet_count, $workbook_cells, $embedded_count, $config); // delegate to native extension class
    }
    /**
...
ExtractionResult $result, MultidocThresholds $thresholds): array
    {
        return \Kreuzberg\KreuzbergApi::boundariesFromExtractionResult($result, $thresholds); // delegate to native extension class
    }
    /**
...
MultidocInput $input, MultidocThresholds $thresholds): array
    {
        return \Kreuzberg\KreuzbergApi::detectBoundaries($input, $thresholds); // delegate to native extension class
    }
    /**
...
StructuredInput $input, StructuredThresholds $t): StructuredCallMode
    {
        return \Kreuzberg\KreuzbergApi::chooseCallMode($input, $t); // delegate to native extension class
    }
    /**
...
int $page_count, int $size_bytes, bool $needs_ocr, HeuristicsConfig $config): ChunkPlan
    {
        return \Kreuzberg\KreuzbergApi::calculateChunkPlan($page_count, $size_bytes, $needs_ocr, $config); // delegate to native extension class
    }
    /**
...
array $user_chunks, int $total_pages, int $size_bytes, HeuristicsConfig $config): ChunkPlan
    {
        return \Kreuzberg\KreuzbergApi::calculatePlanFromOverrides($user_chunks, $total_pages, $size_bytes, $config); // delegate to native extension class
    }
    /**
...
string $raw): string
    {
        return \Kreuzberg\KreuzbergApi::fingerprint($raw); // delegate to native extension class
    }
    /**
...
Preset $preset, ?string $custom_schema, array $context): ResolvedPreset
    {
        return \Kreuzberg\KreuzbergApi::resolve($preset, $custom_schema, $context); // delegate to native extension class
    }
    /**
...
string $bytes, string $mime, string $preset_spec_json, string $options_json): string
    {
        return \Kreuzberg\KreuzbergApi::extractStructuredJson($bytes, $mime, $preset_spec_json, $options_json); // delegate to native extension class
    }
    /**
...
string $bytes, string $mime, string $preset_spec_json, string $options_json): string
    {
        return \Kreuzberg\KreuzbergApi::splitAndExtractJson($bytes, $mime, $preset_spec_json, $options_json); // delegate to native extension class
    }
    /**
...
string $pdf_bytes, ?string $password = null): int
    {
        return \Kreuzberg\KreuzbergApi::pdfPageCount($pdf_bytes, $password); // delegate to native extension class
    }
    /**
...
string $image_bytes, LlmConfig $llm_config, ?string $custom_prompt = null): string
    {
        return \Kreuzberg\KreuzbergApi::captionImage($image_bytes, $llm_config, $custom_prompt); // delegate to native extension class
    }
    /**
...
string $path, LlmConfig $llm_config, ?string $custom_prompt = null): string
    {
        return \Kreuzberg\KreuzbergApi::captionImageFile($path, $llm_config, $custom_prompt); // delegate to native extension class
    }
    /**
