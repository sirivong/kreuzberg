...
// alef:hash:8cf26ee1fd4a1457a61becb514b6c0e38b6e35ec8fa148670ddf3bf85f619193
...
final class NativeLib {
    ...
    static final MethodHandle KREUZBERG_CLEAR_EMBEDDING_BACKENDS = LINKER.downcallHandle(
        LIB.find("kreuzberg_clear_embedding_backends").orElseThrow(),
    ...
    static final MethodHandle KREUZBERG_CLEAR_DOCUMENT_EXTRACTORS = LINKER.downcallHandle(
        LIB.find("kreuzberg_clear_document_extractors").orElseThrow(),
        FunctionDescriptor.ofVoid()
    );
