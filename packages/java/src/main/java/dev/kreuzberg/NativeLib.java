...
// alef:hash:3a42319b4119111a1e4ca5f02e7c3cb6e6c04fe27f4498d2f2fe86c642fbd5b1
...
final class NativeLib {
    ...
    static final MethodHandle KREUZBERG_CLEAR_POST_PROCESSORS = LINKER.downcallHandle(
        LIB.find("kreuzberg_clear_post_processors").orElseThrow(),
        FunctionDescriptor.ofVoid()
    );
    ...
    static final MethodHandle KREUZBERG_RENDER_PDF_PAGE_TO_PNG = LIB.find("kreuzberg_render_pdf_page_to_png").map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.ADDRESS))).orElse(null);
    ...
    static final MethodHandle KREUZBERG_EXTRACTION_RESULT_TO_JSON = LIB.find("kreuzberg_extraction_result_to_json").map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS))).orElse(null);
    ...
    static final MethodHandle KREUZBERG_EMBEDDING_PRESET_TO_JSON = LIB.find("kreuzberg_embedding_preset_to_json").map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS))).orElse(null);
    ...
    static final MethodHandle KREUZBERG_REGISTER_OCR_BACKEND = LIB.find("kreuzberg_register_ocr_backend").map(s -> LINKER.downcallHandle(s,
    ...
    static final MethodHandle KREUZBERG_UNREGISTER_OCR_BACKEND = LIB.find("kreuzberg_unregister_ocr_backend").map(s -> LINKER.downcallHandle(s,
        FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS))).orElse(null);

    static final MethodHandle KREUZBERG_REGISTER_POST_PROCESSOR = LIB.find("kreuzberg_register_post_processor").map(s -> LINKER.downcallHandle(s,
        FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS))).orElse(null);

    static final MethodHandle KREUZBERG_UNREGISTER_POST_PROCESSOR = LIB.find("kreuzberg_unregister_post_processor").map(s -> LINKER.downcallHandle(s,
        FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS))).orElse(null);

    static final MethodHandle KREUZBERG_REGISTER_VALIDATOR = LIB.find("kreuzberg_register_validator").map(s -> LINKER.downcallHandle(s,
        FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS))).orElse(null);

    static final MethodHandle KREUZBERG_UNREGISTER_VALIDATOR = LIB.find("kreuzberg_unregister_validator").map(s -> LINKER.downcallHandle(s,
        FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS))).orElse(null);

    static final MethodHandle KREUZBERG_REGISTER_EMBEDDING_BACKEND = LIB.find("kreuzberg_register_embedding_backend").map(s -> LINKER.downcallHandle(s,
        FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS))).orElse(null);

    static final MethodHandle KREUZBERG_UNREGISTER_EMBEDDING_BACKEND = LIB.find("kreuzberg_unregister_embedding_backend").map(s -> LINKER.downcallHandle(s,
        FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS))).orElse(null);
}
