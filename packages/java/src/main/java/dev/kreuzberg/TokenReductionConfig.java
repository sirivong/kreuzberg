...
// alef:hash:7483c5d099f3c1c4924f7e85979e49672a9f5af3911d66f568405176df4aee00
...
public record TokenReductionConfig(
    ...
    public static final class Builder {
        ...
        public Builder withLanguageHint(final @Nullable String value) {
            this.languageHint = Optional.ofNullable(value);
            return this;
        }
        ...
        public Builder withCustomStopwords(final @Nullable Map<String, List<String>> value) {
            this.customStopwords = Optional.ofNullable(value);
            return this;
        }
        ...
        public Builder withTargetReduction(final @Nullable Float value) {
            this.targetReduction = Optional.ofNullable(value);
            return this;
        }
