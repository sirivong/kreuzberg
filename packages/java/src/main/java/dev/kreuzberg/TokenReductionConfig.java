...
// alef:hash:47dde309f48522ef5bfb94a2926dcbfe36f47c1d5f8c1284f0b1f4c8eccaaa97
...
public record TokenReductionConfig(
    ...
    public static final class Builder {
        ...
        @JsonProperty("language_hint")
        public Builder withLanguageHint(final Optional<String> value) {
        ...
        @JsonProperty("custom_stopwords")
        public Builder withCustomStopwords(final Optional<Map<String, List<String>>> value) {
        ...
        @JsonProperty("target_reduction")
        public Builder withTargetReduction(final Optional<Float> value) {
