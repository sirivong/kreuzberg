...
// alef:hash:fc859f947839931485dd28ae4bbd3e4b06da2bef7f3a420f6017b08625a67060
...
public final class Kreuzberg {
     ...
     * {@literal @}return An {@code ExtractionResult} containing the extracted content and metadata.
     *
     * {@literal @}throws KreuzbergRsException Returns {@code KreuzbergError::Io} if the file doesn't exist (NotFound) or for other file
     * I/O errors.
     * Returns {@code KreuzbergError::UnsupportedFormat} if MIME type is not supported.
     */
     ...
     */
    public static @Nullable String getEmbeddingPreset(final String name) throws KreuzbergRsException {
