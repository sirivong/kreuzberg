...
// alef:hash:ccf14790e8c0aace7b2dafd8e1dd55885389985e79fe5e3c40173d7ca2203d3e
...
public final class KreuzbergRs {
    ...
    public static byte[] renderPdfPageToPng(final byte[] pdfBytes, final long pageIndex, final Integer dpi, final String password) throws KreuzbergRsException {
        try (var arena = Arena.ofConfined()) {
            ...
            var resultPtr = (MemorySegment) NativeLib.KREUZBERG_RENDER_PDF_PAGE_TO_PNG.invoke(pdfBytes, pageIndex, dpi, cpassword);
            if (resultPtr.equals(MemorySegment.NULL)) {
                checkLastError();
                return null;
            }
