...
// alef:hash:302a7cbe08fda5f34eb8b444672288333ac8a6f2035c8f7bdae993a98cc14ac8
...
public final class KreuzbergRs {
    ...
    public static void clearEmbeddingBackends() throws KreuzbergRsException {
        try (var arena = Arena.ofShared()) {
            NativeLib.KREUZBERG_CLEAR_EMBEDDING_BACKENDS.invoke();
            checkLastError();
        } catch (Throwable e) {
            throw new KreuzbergRsException("FFI call failed", e);
        }
    ...
    public static void clearDocumentExtractors() throws KreuzbergRsException {
        try (var arena = Arena.ofShared()) {
            NativeLib.KREUZBERG_CLEAR_DOCUMENT_EXTRACTORS.invoke();
            checkLastError();
        } catch (Throwable e) {
            throw new KreuzbergRsException("FFI call failed", e);
        }
