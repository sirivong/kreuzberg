...
final class NativeLib {
    ...
    static final MethodHandle KREUZBERG_CALCULATE_QUALITY_SCORE = LIB.find("kreuzberg_calculate_quality_score")
        .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.JAVA_DOUBLE, ValueLayout.ADDRESS, ValueLayout.ADDRESS)))
        .orElse(null);
