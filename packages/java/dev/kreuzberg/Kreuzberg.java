...
public final class Kreuzberg {
     ...
     *
     * {@literal @}throws SampleCrateRsException Returns {@code KreuzbergError.Validation} if MIME type is invalid.
     ...
     * {@literal @}return An {@code ExtractionResult} containing the extracted content and metadata.
     *
     * {@literal @}throws SampleCrateRsException Returns {@code KreuzbergError.Io} if the file doesn't exist (NotFound) or for other file
     * I/O errors.
     * Returns {@code KreuzbergError.UnsupportedFormat} if MIME type is not supported.
     */
     ...
     *
     * {@literal @}throws SampleCrateRsException Individual file errors are captured in the result metadata. System errors
    ...
    public static double calculateQualityScore(final String text) throws KreuzbergRsException {
        return KreuzbergRs.calculateQualityScore(text, null);
    }
