...
inline fn _error_with_message(comptime E: type) E {
    ...
    if (E == KreuzbergError) return _from_ffi_msg_KreuzbergError(msg_opt);
...
/// Map an FFI error message string to a `KreuzbergError` variant by prefix-matching
/// against the upstream `#[error("...")]` templates. Falls back to the
/// first declared variant when no prefix matches.
inline fn _from_ffi_msg_KreuzbergError(msg_opt: ?[]const u8) KreuzbergError {
    if (msg_opt) |msg| {
...
pub fn extract_bytes(content: []const u8, mime_type: []const u8, config: []const u8) KreuzbergError![]u8 {
    ...
    if (config_handle == null) return _error_with_message(KreuzbergError);
    ...
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
        return _error_with_message(KreuzbergError);
    }
...
pub fn list_supported_formats() error{OutOfMemory}![]u8 {
    ...
    const _result_len = c.kreuzberg_list_supported_formats_len();
    return blk: {
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        _free_string(_result);
...
///
/// Since v5.0.
pub fn list_reranker_backends() KreuzbergError![]u8 {
    const _result = c.kreuzberg_list_reranker_backends();
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
    ...
    const _result_len = c.kreuzberg_list_reranker_backends_len();
    return blk: {
        if (_result == null) return _first_error(KreuzbergError);
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
pub fn classify_pages(result: []const u8, config: []const u8) KreuzbergError!void {
    ...
    if (result_handle == null) return _error_with_message(KreuzbergError);
...
pub fn classify_text(text: []const u8, config: []const u8) KreuzbergError![]u8 {
    ...
    if (config_handle == null) return _error_with_message(KreuzbergError);
    defer c.kreuzberg_page_classification_config_free(config_handle);
    const _result = c.kreuzberg_classify_text(text_z, config_handle);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
    ...
    const _result_len = c.kreuzberg_classify_text_len(text_z, config_handle);
    return blk: {
        if (_result == null) return _first_error(KreuzbergError);
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
pub fn classify_document(pages: []const u8, config: []const u8) KreuzbergError![]u8 {
    // Vec/Map parameters are passed as JSON strings across the FFI boundary.
    ...
    if (config_handle == null) return _error_with_message(KreuzbergError);
    defer c.kreuzberg_page_classification_config_free(config_handle);
    const _result = c.kreuzberg_classify_document(pages_z, config_handle);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
    ...
    const _result_len = c.kreuzberg_classify_document_len(pages_z, config_handle);
    return blk: {
        if (_result == null) return _first_error(KreuzbergError);
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
pub fn find_footnote_anchors(markdown: []const u8) error{OutOfMemory}![]u8 {
    ...
    const _result = c.kreuzberg_find_footnote_anchors(markdown_z);
    const _result_len = c.kreuzberg_find_footnote_anchors_len(markdown_z);
    return blk: {
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        _free_string(_result);
...
pub fn parse_footnote_definitions(markdown: []const u8) error{OutOfMemory}![]u8 {
    const markdown_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{markdown}, 0);
    defer std.heap.c_allocator.free(markdown_z);
    const _result = c.kreuzberg_parse_footnote_definitions(markdown_z);
    const _result_len = c.kreuzberg_parse_footnote_definitions_len(markdown_z);
    return blk: {
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        _free_string(_result);
...
pub fn find_inference_markers(markdown: []const u8) error{OutOfMemory}![]u8 {
    const markdown_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{markdown}, 0);
    defer std.heap.c_allocator.free(markdown_z);
    const _result = c.kreuzberg_find_inference_markers(markdown_z);
    const _result_len = c.kreuzberg_find_inference_markers_len(markdown_z);
    return blk: {
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        _free_string(_result);
...
pub fn find_unmarked_claims(markdown: []const u8) error{OutOfMemory}![]u8 {
    const markdown_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{markdown}, 0);
    defer std.heap.c_allocator.free(markdown_z);
    const _result = c.kreuzberg_find_unmarked_claims(markdown_z);
    const _result_len = c.kreuzberg_find_unmarked_claims_len(markdown_z);
    return blk: {
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        _free_string(_result);
...
pub fn parse_citations(markdown: []const u8) error{OutOfMemory}![]u8 {
    const markdown_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{markdown}, 0);
    defer std.heap.c_allocator.free(markdown_z);
    const _result = c.kreuzberg_parse_citations(markdown_z);
    const _result_len = c.kreuzberg_parse_citations_len(markdown_z);
    return blk: {
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        _free_string(_result);
...
pub fn verify_excerpt(excerpt: []const u8, source_text: []const u8) error{OutOfMemory}!bool {
    ...
    const _result = c.kreuzberg_verify_excerpt(excerpt_z, source_text_z);
    return _result != 0;
}
...
pub fn chunk_for_rag(text: []const u8, config: []const u8) KreuzbergError![]u8 {
    const text_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{text}, 0);
    defer std.heap.c_allocator.free(text_z);
    const config_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{config}, 0);
    defer std.heap.c_allocator.free(config_z);
    const config_handle = c.kreuzberg_chunking_config_from_json(config_z);
    if (config_handle == null) return _error_with_message(KreuzbergError);
    defer c.kreuzberg_chunking_config_free(config_handle);
    const _result = c.kreuzberg_chunk_for_rag(text_z, config_handle);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
    ...
    return blk: {
        const _json_ptr = c.kreuzberg_chunking_result_to_json(_result.?);
        c.kreuzberg_chunking_result_free(_result.?);
        if (_json_ptr == null) return _first_error(KreuzbergError); // FFI to_json returned NULL — surface first declared variant rather than crashing on null-slice
        defer _free_string(_json_ptr);
        const slice = std.mem.sliceTo(_json_ptr, 0);
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
pub fn extract_region_with_vlm(image_bytes: []const u8, image_mime: []const u8, region_kind: RegionKind, llm_config: []const u8, custom_prompt: ?[]const u8) KreuzbergError![]u8 {
    ...
    if (llm_config_handle == null) return _error_with_message(KreuzbergError);
...
///
/// Since v5.0.
pub fn rerank_async(query: []const u8, documents: []const u8, config: []const u8) KreuzbergError![]u8 {
    ...
    const config_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{config}, 0);
    defer std.heap.c_allocator.free(config_z);
    const config_handle = c.kreuzberg_reranker_config_from_json(config_z);
    if (config_handle == null) return _error_with_message(KreuzbergError);
    defer c.kreuzberg_reranker_config_free(config_handle);
    const _result = c.kreuzberg_rerank_async(query_z, documents_z, config_handle);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
    ...
    const _result_len = c.kreuzberg_rerank_async_len(query_z, documents_z, config_handle);
    return blk: {
        if (_result == null) return _first_error(KreuzbergError);
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
pub fn extract_keywords(text: []const u8, config: []const u8) KreuzbergError![]u8 {
    const text_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{text}, 0);
    defer std.heap.c_allocator.free(text_z);
    const config_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{config}, 0);
    defer std.heap.c_allocator.free(config_z);
    const config_handle = c.kreuzberg_keyword_config_from_json(config_z);
    if (config_handle == null) return _error_with_message(KreuzbergError);
    defer c.kreuzberg_keyword_config_free(config_handle);
    const _result = c.kreuzberg_extract_keywords(text_z, config_handle);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
    ...
    const _result_len = c.kreuzberg_extract_keywords_len(text_z, config_handle);
    return blk: {
        if (_result == null) return _first_error(KreuzbergError);
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
pub fn analyze_document(metadata: []const u8, config: []const u8, document_bytes: ?[]const u8) KreuzbergError!ChunkingDecision {
    ...
    const metadata_handle = c.kreuzberg_document_metadata_from_json(metadata_z);
    if (metadata_handle == null) return _error_with_message(KreuzbergError);
    defer c.kreuzberg_document_metadata_free(metadata_handle);
    const config_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{config}, 0);
    defer std.heap.c_allocator.free(config_z);
    const config_handle = c.kreuzberg_heuristics_config_from_json(config_z);
    if (config_handle == null) return _error_with_message(KreuzbergError);
    defer c.kreuzberg_heuristics_config_free(config_handle);
    const _result = c.kreuzberg_analyze_document(metadata_handle, config_handle, document_bytes.ptr, document_bytes.len);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
...
pub fn analyze_with_user_chunks(user_ranges: []const u8, total_pages: u32, size_bytes: u64, config: []const u8) error{OutOfMemory,InvalidJson}!ChunkingDecision {
    ...
    defer c.kreuzberg_heuristics_config_free(config_handle);
    const _result = c.kreuzberg_analyze_with_user_chunks(user_ranges_z, total_pages, size_bytes, config_handle);
    return ChunkingDecision{ ._handle = _result.? };
}
...
pub fn score_confidence(signals: []const u8, weights: []const u8) error{OutOfMemory,InvalidJson}![]u8 {
    ...
    const signals_handle = c.kreuzberg_confidence_signals_from_json(signals_z);
    if (signals_handle == null) return error.InvalidJson;
    defer c.kreuzberg_confidence_signals_free(signals_handle);
    const weights_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{weights}, 0);
    defer std.heap.c_allocator.free(weights_z);
    const weights_handle = c.kreuzberg_confidence_weights_from_json(weights_z);
    if (weights_handle == null) return error.InvalidJson;
    defer c.kreuzberg_confidence_weights_free(weights_handle);
    const _result = c.kreuzberg_score_confidence(signals_handle, weights_handle);
    return blk: {
        const _json_ptr = c.kreuzberg_extraction_confidence_to_json(_result.?);
        c.kreuzberg_extraction_confidence_free(_result.?);
        defer _free_string(_json_ptr);
        const slice = std.mem.sliceTo(_json_ptr, 0);
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        break :blk owned;
...
pub fn check_format_limits(mime_type: []const u8, sheet_count: ?u32, workbook_cells: ?u64, embedded_count: ?u32, config: []const u8) error{OutOfMemory,InvalidJson}!?[]u8 {
    ...
    if (config_handle == null) return error.InvalidJson;
    defer c.kreuzberg_heuristics_config_free(config_handle);
    const _result = c.kreuzberg_check_format_limits(mime_type_z, if (sheet_count) |v| v else std.math.maxInt(u32), if (workbook_cells) |v| v else std.math.maxInt(u64), if (embedded_count) |v| v else std.math.maxInt(u32), config_handle);
    const _result_len = c.kreuzberg_check_format_limits_len(mime_type_z, if (sheet_count) |v| v else std.math.maxInt(u32), if (workbook_cells) |v| v else std.math.maxInt(u64), if (embedded_count) |v| v else std.math.maxInt(u32), config_handle);
    return blk: {
        if (_result == null) break :blk null;
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
pub fn boundaries_from_extraction_result(result: []const u8, thresholds: []const u8) error{OutOfMemory,InvalidJson}![]u8 {
    ...
    const thresholds_handle = c.kreuzberg_multidoc_thresholds_from_json(thresholds_z);
    if (thresholds_handle == null) return error.InvalidJson;
    defer c.kreuzberg_multidoc_thresholds_free(thresholds_handle);
    const _result = c.kreuzberg_boundaries_from_extraction_result(result_handle, thresholds_handle);
    const _result_len = c.kreuzberg_boundaries_from_extraction_result_len(result_handle, thresholds_handle);
    return blk: {
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        _free_string(_result);
...
pub fn detect_boundaries(input: []const u8, thresholds: []const u8) error{OutOfMemory,InvalidJson}![]u8 {
    ...
    const input_handle = c.kreuzberg_multidoc_input_from_json(input_z);
    if (input_handle == null) return error.InvalidJson;
    defer c.kreuzberg_multidoc_input_free(input_handle);
    const thresholds_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{thresholds}, 0);
    defer std.heap.c_allocator.free(thresholds_z);
    const thresholds_handle = c.kreuzberg_multidoc_thresholds_from_json(thresholds_z);
    if (thresholds_handle == null) return error.InvalidJson;
    defer c.kreuzberg_multidoc_thresholds_free(thresholds_handle);
    const _result = c.kreuzberg_detect_boundaries(input_handle, thresholds_handle);
    const _result_len = c.kreuzberg_detect_boundaries_len(input_handle, thresholds_handle);
    return blk: {
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        _free_string(_result);
...
pub fn choose_call_mode(input: []const u8, t: []const u8) error{OutOfMemory,InvalidJson}!StructuredCallMode {
    const input_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{input}, 0);
    defer std.heap.c_allocator.free(input_z);
    const input_handle = c.kreuzberg_structured_input_from_json(input_z);
    if (input_handle == null) return error.InvalidJson;
    defer c.kreuzberg_structured_input_free(input_handle);
    const t_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{t}, 0);
    defer std.heap.c_allocator.free(t_z);
    const t_handle = c.kreuzberg_structured_thresholds_from_json(t_z);
    if (t_handle == null) return error.InvalidJson;
    defer c.kreuzberg_structured_thresholds_free(t_handle);
    const _result = c.kreuzberg_choose_call_mode(input_handle, t_handle);
...
pub fn calculate_chunk_plan(page_count: u32, size_bytes: u64, needs_ocr: bool, config: []const u8) error{OutOfMemory,InvalidJson}![]u8 {
    ...
    if (config_handle == null) return error.InvalidJson;
    defer c.kreuzberg_heuristics_config_free(config_handle);
    const _result = c.kreuzberg_calculate_chunk_plan(page_count, size_bytes, needs_ocr, config_handle);
    return blk: {
        const _json_ptr = c.kreuzberg_chunk_plan_to_json(_result.?);
        c.kreuzberg_chunk_plan_free(_result.?);
        defer _free_string(_json_ptr);
        const slice = std.mem.sliceTo(_json_ptr, 0);
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        break :blk owned;
...
pub fn calculate_plan_from_overrides(user_chunks: []const u8, total_pages: u32, size_bytes: u64, config: []const u8) error{OutOfMemory,InvalidJson}![]u8 {
    ...
    if (config_handle == null) return error.InvalidJson;
    defer c.kreuzberg_heuristics_config_free(config_handle);
    const _result = c.kreuzberg_calculate_plan_from_overrides(user_chunks_z, total_pages, size_bytes, config_handle);
    return blk: {
        const _json_ptr = c.kreuzberg_chunk_plan_to_json(_result.?);
        c.kreuzberg_chunk_plan_free(_result.?);
        defer _free_string(_json_ptr);
...
pub fn fingerprint(raw: []const u8) error{OutOfMemory}![]u8 {
    const _result = c.kreuzberg_fingerprint(raw.ptr, raw.len);
    const _result_len = c.kreuzberg_fingerprint_len(raw.ptr, raw.len);
    return blk: {
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        _free_string(_result);
...
pub fn resolve(preset: []const u8, custom_schema: ?[]const u8, context: []const u8) ResolveError![]u8 {
    ...
    return blk: {
        const _json_ptr = c.kreuzberg_resolved_preset_to_json(_result.?);
        c.kreuzberg_resolved_preset_free(_result.?);
...
pub fn extract_structured_json(bytes: []const u8, mime: []const u8, preset_spec_json: []const u8, options_json: []const u8) KreuzbergError![]u8 {
    ...
    const _result = c.kreuzberg_extract_structured_json(bytes.ptr, bytes.len, mime_z, preset_spec_json_z, options_json_z);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
    ...
    const _result_len = c.kreuzberg_extract_structured_json_len(bytes.ptr, bytes.len, mime_z, preset_spec_json_z, options_json_z);
    return blk: {
        if (_result == null) return _first_error(KreuzbergError);
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
/// via `From<StructuredError>`.
pub fn split_and_extract_json(bytes: []const u8, mime: []const u8, preset_spec_json: []const u8, options_json: []const u8) KreuzbergError![]u8 {
    const mime_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{mime}, 0);
    defer std.heap.c_allocator.free(mime_z);
    const preset_spec_json_z = try std.fmt.allocPrintSentinel(
    ...
    const options_json_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{options_json}, 0);
    defer std.heap.c_allocator.free(options_json_z);
    const _result = c.kreuzberg_split_and_extract_json(bytes.ptr, bytes.len, mime_z, preset_spec_json_z, options_json_z);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
    ...
    const _result_len = c.kreuzberg_split_and_extract_json_len(bytes.ptr, bytes.len, mime_z, preset_spec_json_z, options_json_z);
    return blk: {
        if (_result == null) return _first_error(KreuzbergError);
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
pub fn pdf_page_count(pdf_bytes: []const u8, password: ?[]const u8) KreuzbergError!u64 {
    const password_z: ?[:0]u8 = if (password) |v| try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{v}, 0) else null;
    defer if (password_z) |z| std.heap.c_allocator.free(z);
    const _result = c.kreuzberg_pdf_page_count(pdf_bytes.ptr, pdf_bytes.len, if (password_z) |z| z.ptr else null);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    return _result;
...
pub fn caption_image(image_bytes: []const u8, llm_config: []const u8, custom_prompt: ?[]const u8) KreuzbergError![]u8 {
    const llm_config_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{llm_config}, 0);
    defer std.heap.c_allocator.free(llm_config_z);
    const llm_config_handle = c.kreuzberg_llm_config_from_json(llm_config_z);
    ...
    const custom_prompt_z: ?[:0]u8 = if (custom_prompt) |v| try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{v}, 0) else null;
    defer if (custom_prompt_z) |z| std.heap.c_allocator.free(z);
    const _result = c.kreuzberg_caption_image(image_bytes.ptr, image_bytes.len, llm_config_handle, if (custom_prompt_z) |z| z.ptr else null);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
    ...
    const _result_len = c.kreuzberg_caption_image_len(image_bytes.ptr, image_bytes.len, llm_config_handle, if (custom_prompt_z) |z| z.ptr else null);
    return blk: {
        if (_result == null) return _first_error(KreuzbergError);
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
pub fn caption_image_file(path: []const u8, llm_config: []const u8, custom_prompt: ?[]const u8) KreuzbergError![]u8 {
    const path_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{path}, 0);
    defer std.heap.c_allocator.free(path_z);
    const llm_config_z = try std.fmt.allocPrintSentinel(
    ...
    const custom_prompt_z: ?[:0]u8 = if (custom_prompt) |v| try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{v}, 0) else null;
    defer if (custom_prompt_z) |z| std.heap.c_allocator.free(z);
    const _result = c.kreuzberg_caption_image_file(path_z, llm_config_handle, if (custom_prompt_z) |z| z.ptr else null);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
    ...
    const _result_len = c.kreuzberg_caption_image_file_len(path_z, llm_config_handle, if (custom_prompt_z) |z| z.ptr else null);
    return blk: {
        if (_result == null) return _first_error(KreuzbergError);
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
pub fn embed_texts_async(_texts: []const u8, _config: []const u8) KreuzbergError![]u8 {
    ...
    if (_config_handle == null) return _error_with_message(KreuzbergError);
...
///
/// Since v5.0.
pub fn rerank(query: []const u8, documents: []const u8, config: []const u8) KreuzbergError![]u8 {
    const query_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{query}, 0);
    defer std.heap.c_allocator.free(query_z);
    // Vec/Map parameters are passed as JSON strings across the FFI boundary.
    ...
    if (config_handle == null) return _error_with_message(KreuzbergError);
    defer c.kreuzberg_reranker_config_free(config_handle);
    const _result = c.kreuzberg_rerank(query_z, documents_z, config_handle);
    if (c.kreuzberg_last_error_code() != 0) {
        return _error_with_message(KreuzbergError);
    }
    if (_result == null) {
    ...
    const _result_len = c.kreuzberg_rerank_len(query_z, documents_z, config_handle);
    return blk: {
        if (_result == null) return _first_error(KreuzbergError);
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
...
pub fn get_reranker_preset(name: []const u8) error{OutOfMemory}!?[]u8 {
    const name_z = try std.fmt.allocPrintSentinel(
        std.heap.c_allocator, "{s}", .{name}, 0);
    defer std.heap.c_allocator.free(name_z);
    const _result = c.kreuzberg_get_reranker_preset(name_z);
    return if (_result == null) null else blk: {
        const _json_ptr = c.kreuzberg_reranker_preset_to_json(_result.?);
        c.kreuzberg_reranker_preset_free(_result.?);
        defer _free_string(_json_ptr);
        const slice = std.mem.sliceTo(_json_ptr, 0);
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        break :blk owned;
...
pub fn list_reranker_presets() error{OutOfMemory}![]u8 {
    const _result = c.kreuzberg_list_reranker_presets();
    const _result_len = c.kreuzberg_list_reranker_presets_len();
    return blk: {
        const slice = _result[0.._result_len];
        const owned = try std.heap.c_allocator.dupe(u8, slice);
        _free_string(_result);
...
pub fn register_reranker_backend(name: [*c]const u8, vtable: IRerankerBackend, user_data: ?*anyopaque, out_error: ?*?[*c]u8) i32 {
    ...
    // layout-preserving reinterpretation that crosses the nominal boundary.
    // The C FFI layer expects a typed pointer to the vtable, so pass `&_c_vtable`.
    const _c_vtable: c.struct_KREUZBERGKreuzbergRerankerBackendVTable = @bitCast(vtable);
    const _rc = c.kreuzberg_register_reranker_backend(name, &_c_vtable, user_data, @ptrCast(&_out_error));
    if (out_error) |ptr| {
        ptr.* = _out_error;
    }
    return _rc;
...
///
/// Returns 0 on success; non-zero on failure.
pub fn unregister_reranker_backend(name: [*c]const u8) KreuzbergError!void {
    var _out_error: [*c]u8 = null;
    const _rc = c.kreuzberg_unregister_reranker_backend(name, &_out_error);
    if (_out_error != null) _free_string(_out_error);
    if (_rc != 0 or c.kreuzberg_last_error_code() != 0) {
        return _first_error(KreuzbergError);
    }
...
///
/// Returns 0 on success; non-zero on failure.
pub fn clear_reranker_backends() KreuzbergError!void {
    var _out_error: [*c]u8 = null;
    const _rc = c.kreuzberg_clear_reranker_backend(&_out_error);
    if (_out_error != null) _free_string(_out_error);
    if (_rc != 0 or c.kreuzberg_last_error_code() != 0) {
        return _first_error(KreuzbergError);
    }
...
pub fn compile_meta_schema(meta_schema_json: []const u8) error{OutOfMemory}!MetaSchema {
    ...
    const _handle = c.kreuzberg_meta_schema_compile(meta_schema_json_z.ptr);
    if (_handle == null) return _first_error(anyerror);
    return .{ ._handle = @as(*c.KREUZBERGMetaSchema, @ptrCast(_handle.?)) };
}
...
pub const MetaSchema = struct {
    ...
    pub fn parse_preset(self: *MetaSchema, path: []const u8, raw: []const u8) (LoadError||error{OutOfMemory})![]u8 {
        ...
        defer std.heap.c_allocator.free(path_z);
        const _result = c.kreuzberg_meta_schema_parse_preset(@as(*c.KREUZBERGMetaSchema, @ptrCast(self._handle)), path_z, raw.ptr, raw.len);
        if (_result == null) {
            return _first_error(LoadError);
        }
        return blk: {
            const _json_ptr = c.kreuzberg_preset_to_json(_result);
            const _json_slice = std.mem.span(_json_ptr);
            const owned = try std.heap.c_allocator.dupe(u8, _json_slice);
            c.kreuzberg_free_string(_json_ptr);
            c.kreuzberg_preset_free(_result);
            break :blk owned;
        };
    }
    ...
    pub fn free(self: *MetaSchema) void {
        c.kreuzberg_meta_schema_free(@as(*c.KREUZBERGMetaSchema, @ptrCast(self._handle)));
    }
};
...
pub fn load_embedded_registry() Registry {
    const _handle = c.kreuzberg_registry_load_embedded();
    if (_handle == null) return _first_error(anyerror);
    return .{ ._handle = @as(*c.KREUZBERGRegistry, @ptrCast(_handle.?)) };
}
...
pub const Registry = struct {
    ...
    pub fn get(self: *Registry, id: []const u8) error{OutOfMemory}!?[]u8 {
        ...
        const _result = c.kreuzberg_registry_get(@as(*c.KREUZBERGRegistry, @ptrCast(self._handle)), id_z);
        return _result;
    }

    /// Materialize a `PresetSummary` list for the public registry endpoint.
    pub fn summaries(self: *Registry) error{OutOfMemory}![]u8 {
        const _result = c.kreuzberg_registry_summaries(@as(*c.KREUZBERGRegistry, @ptrCast(self._handle)));
        return blk: {
            const slice = std.mem.span(_result);
            const owned = try std.heap.c_allocator.dupe(u8, slice);
            c.kreuzberg_free_string(_result);
    ...
    pub fn len(self: *Registry) u64 {
        const _result = c.kreuzberg_registry_len(@as(*c.KREUZBERGRegistry, @ptrCast(self._handle)));
        return _result;
    }

    /// Whether the registry contains zero presets.
    pub fn is_empty(self: *Registry) bool {
        const _result = c.kreuzberg_registry_is_empty(@as(*c.KREUZBERGRegistry, @ptrCast(self._handle)));
        return _result;
    }
    ...
    pub fn sample_bytes(self: *Registry, preset_id: []const u8, name: []const u8) error{OutOfMemory}!?[]const u8 {
        ...
        defer std.heap.c_allocator.free(name_z);
        const _result = c.kreuzberg_registry_sample_bytes(@as(*c.KREUZBERGRegistry, @ptrCast(self._handle)), preset_id_z, name_z);
        return _result;
    }
    ...
    pub fn extend_from_dir(self: *Registry, dir: []const u8) (LoadError||error{OutOfMemory})!u64 {
        ...
        const _result = c.kreuzberg_registry_extend_from_dir(@as(*c.KREUZBERGRegistry, @ptrCast(self._handle)), dir_z);
        if (_result == null) {
            return _first_error(LoadError);
        }
        return _result;
    ...
    pub fn free(self: *Registry) void {
        c.kreuzberg_registry_free(@as(*c.KREUZBERGRegistry, @ptrCast(self._handle)));
    }
};
...
pub const ClassificationEnrichmentConfig = struct {
    ...
    pub fn free(self: *ClassificationEnrichmentConfig) void {
        c.kreuzberg_classification_enrichment_config_free(@as(*c.KREUZBERGClassificationEnrichmentConfig, @ptrCast(self._handle)));
    }
};
...
pub const CaptioningEnrichmentConfig = struct {
    ...
    pub fn free(self: *CaptioningEnrichmentConfig) void {
        c.kreuzberg_captioning_enrichment_config_free(@as(*c.KREUZBERGCaptioningEnrichmentConfig, @ptrCast(self._handle)));
    }
};
