...
func RegisterOcrBackend(impl OcrBackend) error {
	...
	// Build the C vtable
	vtable := &C.struct_KREUZBERGKreuzbergOcrBackendVTable{
...
func RegisterPostProcessor(impl PostProcessor) error {
	handle := cgo.NewHandle(impl)
	// Build the C vtable
	vtable := &C.struct_KREUZBERGKreuzbergPostProcessorVTable{
...
func RegisterValidator(impl Validator) error {
	handle := cgo.NewHandle(impl)
	// Build the C vtable
	vtable := &C.struct_KREUZBERGKreuzbergValidatorVTable{
...
func RegisterEmbeddingBackend(impl EmbeddingBackend) error {
	handle := cgo.NewHandle(impl)
	// Build the C vtable
	vtable := &C.struct_KREUZBERGKreuzbergEmbeddingBackendVTable{
...
func RegisterDocumentExtractor(impl DocumentExtractor) error {
	handle := cgo.NewHandle(impl)
	// Build the C vtable
	vtable := &C.struct_KREUZBERGKreuzbergDocumentExtractorVTable{
...
func RegisterRenderer(impl Renderer) error {
	handle := cgo.NewHandle(impl)
	// Build the C vtable
	vtable := &C.struct_KREUZBERGKreuzbergRendererVTable{
