...
// alef:hash:c5224667ffe12301a2373331ece246df57caad76136cb18eef2b76588400d636
...
// clear_ocr_backends removes all registered OcrBackend implementations.
func clear_ocr_backends() error {
	var cErr *C.char
...
// clear_post_processors removes all registered PostProcessor implementations.
func clear_post_processors() error {
	var cErr *C.char
...
// clear_validators removes all registered Validator implementations.
func clear_validators() error {
	var cErr *C.char
...
// clear_embedding_backends removes all registered EmbeddingBackend implementations.
func clear_embedding_backends() error {
	var cErr *C.char
...
// clear_document_extractors removes all registered DocumentExtractor implementations.
func clear_document_extractors() error {
	var cErr *C.char
...
// clear_renderers removes all registered Renderer implementations.
func clear_renderers() error {
	var cErr *C.char
