...
// alef:hash:8ed16a99354be383fd0727cb6806da4ab146aff26508f8defda2a03f68ab82dd
...
// TransformListType is an enumeration type.
type TransformListType string

const (
	// TransformListTypeBullet TransformListTypeBullet bullet points (-, *, •, etc.)
	TransformListTypeBullet TransformListType = "bullet"
	// TransformListTypeNumbered TransformListTypeNumbered numbered lists (1., 2., etc.)
	TransformListTypeNumbered TransformListType = "numbered"
	// TransformListTypeLettered TransformListTypeLettered lettered lists (a., b., A., B., etc.)
	TransformListTypeLettered TransformListType = "lettered"
	// TransformListTypeIndented TransformListTypeIndented indented items
	TransformListTypeIndented TransformListType = "indented"
)

// DrawingType whether the drawing is inline or anchored.
type DrawingType string

const (
	// DrawingTypeInline is the Inline variant of DrawingType.
	DrawingTypeInline DrawingType = "inline"
)
...
// NodeContent2 tagged enum for node content. Each variant carries only type-specific data.
//
...
// Sealed interface — use one of NodeContent2Title, NodeContent2Heading.
type NodeContent2 interface {
	isNodeContent2()
	Type() string
}

// NodeContent2Title document title.
type NodeContent2Title struct {
	Text string `json:"text"`
}

func (NodeContent2Title) isNodeContent2() {}

func (NodeContent2Title) Type() string { return "title" }

func (v NodeContent2Title) MarshalJSON() ([]byte, error) {
	type aux struct {
...
// NodeContent2Heading section heading with level (1-6).
type NodeContent2Heading struct {
	Level uint8  `json:"level"`
	Text  string `json:"text"`
}

func (NodeContent2Heading) isNodeContent2() {}

func (NodeContent2Heading) Type() string { return "heading" }

func (v NodeContent2Heading) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
		Level    uint8  `json:"level"`
		Text     string `json:"text"`
...
// NodeContent2Paragraph body text paragraph.
type NodeContent2Paragraph struct {
	Text string `json:"text"`
}

func (NodeContent2Paragraph) isNodeContent2() {}

func (NodeContent2Paragraph) Type() string { return "paragraph" }

func (v NodeContent2Paragraph) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
		Text     string `json:"text"`
	}
...
// NodeContent2List list container — children are `ListItem` nodes.
type NodeContent2List struct {
	Ordered bool `json:"ordered"`
}

func (NodeContent2List) isNodeContent2() {}

func (NodeContent2List) Type() string { return "list" }

func (v NodeContent2List) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
		Ordered  bool   `json:"ordered"`
	}
...
// NodeContent2ListItem individual list item.
type NodeContent2ListItem struct {
	Text string `json:"text"`
}

func (NodeContent2ListItem) isNodeContent2() {}

func (NodeContent2ListItem) Type() string { return "list_item" }

func (v NodeContent2ListItem) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
		Text     string `json:"text"`
	}
...
// NodeContent2Table table with structured cell grid.
type NodeContent2Table struct {
	Grid TableGrid `json:"grid"`
}

func (NodeContent2Table) isNodeContent2() {}

func (NodeContent2Table) Type() string { return "table" }

func (v NodeContent2Table) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string    `json:"node_type"`
		Grid     TableGrid `json:"grid"`
	}
...
// NodeContent2Image image reference.
type NodeContent2Image struct {
...
func (NodeContent2Image) isNodeContent2() {}

func (NodeContent2Image) Type() string { return "image" }

func (v NodeContent2Image) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType    string `json:"node_type"`
		Description string `json:"description"`
		ImageIndex  uint32 `json:"image_index"`
...
// NodeContent2Code code block.
type NodeContent2Code struct {
	Text     string `json:"text"`
	Language string `json:"language"`
}

func (NodeContent2Code) isNodeContent2() {}

func (NodeContent2Code) Type() string { return "code" }

func (v NodeContent2Code) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
		Text     string `json:"text"`
		Language string `json:"language"`
...
// NodeContent2Quote block quote — container, children carry the quoted content.
type NodeContent2Quote struct {
}

func (NodeContent2Quote) isNodeContent2() {}

func (NodeContent2Quote) Type() string { return "quote" }

func (v NodeContent2Quote) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
	}
	return json.Marshal(aux{
...
// NodeContent2Formula mathematical formula / equation.
type NodeContent2Formula struct {
	Text string `json:"text"`
}

func (NodeContent2Formula) isNodeContent2() {}

func (NodeContent2Formula) Type() string { return "formula" }

func (v NodeContent2Formula) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
		Text     string `json:"text"`
	}
...
// NodeContent2Footnote footnote reference content.
type NodeContent2Footnote struct {
	Text string `json:"text"`
}

func (NodeContent2Footnote) isNodeContent2() {}

func (NodeContent2Footnote) Type() string { return "footnote" }

func (v NodeContent2Footnote) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
		Text     string `json:"text"`
	}
...
// NodeContent2Group logical grouping container (section, key-value area).
//
...
type NodeContent2Group struct {
	Label        string `json:"label"`
	HeadingLevel uint8  `json:"heading_level"`
	HeadingText  string `json:"heading_text"`
}

func (NodeContent2Group) isNodeContent2() {}

func (NodeContent2Group) Type() string { return "group" }

func (v NodeContent2Group) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType     string `json:"node_type"`
		Label        string `json:"label"`
		HeadingLevel uint8  `json:"heading_level"`
...
// NodeContent2PageBreak page break marker.
type NodeContent2PageBreak struct {
}

func (NodeContent2PageBreak) isNodeContent2() {}

func (NodeContent2PageBreak) Type() string { return "page_break" }

func (v NodeContent2PageBreak) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
	}
	return json.Marshal(aux{
...
// NodeContent2Slide presentation slide container — children are the slide's content nodes.
type NodeContent2Slide struct {
	// 1-indexed slide number.
	Number uint32 `json:"number"`
	Title  string `json:"title"`
}

func (NodeContent2Slide) isNodeContent2() {}

func (NodeContent2Slide) Type() string { return "slide" }

func (v NodeContent2Slide) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
		Number   uint32 `json:"number"`
		Title    string `json:"title"`
...
// NodeContent2DefinitionList definition list container — children are `DefinitionItem` nodes.
type NodeContent2DefinitionList struct {
}

func (NodeContent2DefinitionList) isNodeContent2() {}

func (NodeContent2DefinitionList) Type() string { return "definition_list" }

func (v NodeContent2DefinitionList) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
	}
	return json.Marshal(aux{
...
// NodeContent2DefinitionItem individual definition list entry with term and definition.
type NodeContent2DefinitionItem struct {
	Term       string `json:"term"`
	Definition string `json:"definition"`
}

func (NodeContent2DefinitionItem) isNodeContent2() {}

func (NodeContent2DefinitionItem) Type() string { return "definition_item" }

func (v NodeContent2DefinitionItem) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType   string `json:"node_type"`
		Term       string `json:"term"`
		Definition string `json:"definition"`
...
// NodeContent2Citation citation or bibliographic reference.
type NodeContent2Citation struct {
	Key  string `json:"key"`
	Text string `json:"text"`
}

func (NodeContent2Citation) isNodeContent2() {}

func (NodeContent2Citation) Type() string { return "citation" }

func (v NodeContent2Citation) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
		Key      string `json:"key"`
		Text     string `json:"text"`
...
// NodeContent2Admonition admonition / callout container (note, warning, tip, etc.).
//
// Children carry the admonition body content.
type NodeContent2Admonition struct {
	// Kind of admonition (e.g. "note", "warning", "tip", "danger").
	Kind  string `json:"kind"`
	Title string `json:"title"`
}

func (NodeContent2Admonition) isNodeContent2() {}

func (NodeContent2Admonition) Type() string { return "admonition" }

func (v NodeContent2Admonition) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
		Kind     string `json:"kind"`
		Title    string `json:"title"`
...
// NodeContent2RawBlock raw block preserved verbatim from the source format.
//
// Used for content that cannot be mapped to a semantic node type
// (e.g. JSX in MDX, raw LaTeX in markdown, embedded HTML).
type NodeContent2RawBlock struct {
	// Source format identifier (e.g. "html", "latex", "jsx").
	Format  string `json:"format"`
	Content string `json:"content"`
}

func (NodeContent2RawBlock) isNodeContent2() {}

func (NodeContent2RawBlock) Type() string { return "raw_block" }

func (v NodeContent2RawBlock) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string `json:"node_type"`
		Format   string `json:"format"`
		Content  string `json:"content"`
...
// NodeContent2MetadataBlock structured metadata block (email headers, YAML frontmatter, etc.).
type NodeContent2MetadataBlock struct {
	Entries []string `json:"entries"`
}

func (NodeContent2MetadataBlock) isNodeContent2() {}

func (NodeContent2MetadataBlock) Type() string { return "metadata_block" }

func (v NodeContent2MetadataBlock) MarshalJSON() ([]byte, error) {
	type aux struct {
		NodeType string   `json:"node_type"`
		Entries  []string `json:"entries"`
	}
...
// UnmarshalNodeContent2 decodes JSON data into the appropriate concrete NodeContent2 variant.
func UnmarshalNodeContent2(data []byte) (NodeContent2, error) {
	var wire struct {
		NodeType string `json:"node_type"`
	}
	if err := json.Unmarshal(data, &wire); err != nil {
	...
	case "title":
		var v NodeContent2Title
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "heading":
		var v NodeContent2Heading
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "paragraph":
		var v NodeContent2Paragraph
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "list":
		var v NodeContent2List
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "list_item":
		var v NodeContent2ListItem
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "table":
		var v NodeContent2Table
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "image":
		var v NodeContent2Image
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "code":
		var v NodeContent2Code
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "quote":
		var v NodeContent2Quote
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "formula":
		var v NodeContent2Formula
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "footnote":
		var v NodeContent2Footnote
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "group":
		var v NodeContent2Group
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "page_break":
		var v NodeContent2PageBreak
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "slide":
		var v NodeContent2Slide
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "definition_list":
		var v NodeContent2DefinitionList
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "definition_item":
		var v NodeContent2DefinitionItem
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "citation":
		var v NodeContent2Citation
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "admonition":
		var v NodeContent2Admonition
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "raw_block":
		var v NodeContent2RawBlock
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	case "metadata_block":
		var v NodeContent2MetadataBlock
		if err := json.Unmarshal(data, &v); err != nil {
			return nil, err
		}
		return v, nil
	}
	return nil, fmt.Errorf("unknown NodeContent2 type: %q", wire.NodeType)
}
...
// ExtractionMethod2 is an enumeration type.
type ExtractionMethod2 string

const (
	// ExtractionMethod2Native ExtractionMethod2Native is the Native variant of ExtractionMethod2.
	ExtractionMethod2Native ExtractionMethod2 = "native"
	// ExtractionMethod2Ocr ExtractionMethod2Ocr is the Ocr variant of ExtractionMethod2.
	ExtractionMethod2Ocr ExtractionMethod2 = "ocr"
	// ExtractionMethod2Mixed ExtractionMethod2Mixed is the Mixed variant of ExtractionMethod2.
	ExtractionMethod2Mixed ExtractionMethod2 = "mixed"
)
...
// FormatMetadata2 format-specific metadata (discriminated union).
//
...
func (t FormatMetadata2) MarshalJSON() ([]byte, error) {
	switch t.FormatType {
	case "docx":
		if t.Docx != nil {
...
func (t *FormatMetadata2) UnmarshalJSON(data []byte) error {
...
// PaddleLanguage2 is an enumeration type.
type PaddleLanguage2 string

const (
	// PaddleLanguage2English PaddleLanguage2English english
	PaddleLanguage2English PaddleLanguage2 = "english"
	// PaddleLanguage2Chinese PaddleLanguage2Chinese simplified Chinese
	PaddleLanguage2Chinese PaddleLanguage2 = "chinese"
	// PaddleLanguage2Japanese PaddleLanguage2Japanese japanese
	PaddleLanguage2Japanese PaddleLanguage2 = "japanese"
	// PaddleLanguage2Korean PaddleLanguage2Korean korean
	PaddleLanguage2Korean PaddleLanguage2 = "korean"
	// PaddleLanguage2German PaddleLanguage2German german
	PaddleLanguage2German PaddleLanguage2 = "german"
	// PaddleLanguage2French PaddleLanguage2French french
	PaddleLanguage2French PaddleLanguage2 = "french"
	// PaddleLanguage2Latin PaddleLanguage2Latin latin script (covers most European languages)
	PaddleLanguage2Latin PaddleLanguage2 = "latin"
	// PaddleLanguage2Cyrillic PaddleLanguage2Cyrillic cyrillic (Russian and related)
	PaddleLanguage2Cyrillic PaddleLanguage2 = "cyrillic"
	// PaddleLanguage2TraditionalChinese PaddleLanguage2TraditionalChinese traditional Chinese
	PaddleLanguage2TraditionalChinese PaddleLanguage2 = "traditional_chinese"
	// PaddleLanguage2Thai PaddleLanguage2Thai thai
	PaddleLanguage2Thai PaddleLanguage2 = "thai"
	// PaddleLanguage2Greek PaddleLanguage2Greek greek
	PaddleLanguage2Greek PaddleLanguage2 = "greek"
	// PaddleLanguage2EastSlavic PaddleLanguage2EastSlavic east Slavic (Russian, Ukrainian, Belarusian)
	PaddleLanguage2EastSlavic PaddleLanguage2 = "east_slavic"
	// PaddleLanguage2Arabic PaddleLanguage2Arabic arabic (Arabic, Persian, Urdu)
	PaddleLanguage2Arabic PaddleLanguage2 = "arabic"
	// PaddleLanguage2Devanagari PaddleLanguage2Devanagari devanagari (Hindi, Marathi, Sanskrit, Nepali)
	PaddleLanguage2Devanagari PaddleLanguage2 = "devanagari"
	// PaddleLanguage2Tamil PaddleLanguage2Tamil tamil
	PaddleLanguage2Tamil PaddleLanguage2 = "tamil"
	// PaddleLanguage2Telugu PaddleLanguage2Telugu telugu
	PaddleLanguage2Telugu PaddleLanguage2 = "telugu"
)

// LayoutClass2 is an enumeration type.
type LayoutClass2 string

const (
	// LayoutClass2Caption LayoutClass2Caption is the Caption variant of LayoutClass2.
	LayoutClass2Caption LayoutClass2 = "caption"
	// LayoutClass2Footnote LayoutClass2Footnote is the Footnote variant of LayoutClass2.
	LayoutClass2Footnote LayoutClass2 = "footnote"
	// LayoutClass2Formula LayoutClass2Formula is the Formula variant of LayoutClass2.
	LayoutClass2Formula LayoutClass2 = "formula"
	// LayoutClass2ListItem LayoutClass2ListItem is the ListItem variant of LayoutClass2.
	LayoutClass2ListItem LayoutClass2 = "list_item"
	// LayoutClass2PageFooter LayoutClass2PageFooter is the PageFooter variant of LayoutClass2.
	LayoutClass2PageFooter LayoutClass2 = "page_footer"
	// LayoutClass2PageHeader LayoutClass2PageHeader is the PageHeader variant of LayoutClass2.
	LayoutClass2PageHeader LayoutClass2 = "page_header"
	// LayoutClass2Picture LayoutClass2Picture is the Picture variant of LayoutClass2.
	LayoutClass2Picture LayoutClass2 = "picture"
	// LayoutClass2SectionHeader LayoutClass2SectionHeader is the SectionHeader variant of LayoutClass2.
	LayoutClass2SectionHeader LayoutClass2 = "section_header"
	// LayoutClass2Table LayoutClass2Table is the Table variant of LayoutClass2.
	LayoutClass2Table LayoutClass2 = "table"
	// LayoutClass2Text LayoutClass2Text is the Text variant of LayoutClass2.
	LayoutClass2Text LayoutClass2 = "text"
	// LayoutClass2Title LayoutClass2Title is the Title variant of LayoutClass2.
	LayoutClass2Title LayoutClass2 = "title"
	// LayoutClass2DocumentIndex LayoutClass2DocumentIndex is the DocumentIndex variant of LayoutClass2.
	LayoutClass2DocumentIndex LayoutClass2 = "document_index"
	// LayoutClass2Code LayoutClass2Code is the Code variant of LayoutClass2.
	LayoutClass2Code LayoutClass2 = "code"
	// LayoutClass2CheckboxSelected LayoutClass2CheckboxSelected is the CheckboxSelected variant of LayoutClass2.
	LayoutClass2CheckboxSelected LayoutClass2 = "checkbox_selected"
	// LayoutClass2CheckboxUnselected LayoutClass2CheckboxUnselected is the CheckboxUnselected variant of LayoutClass2.
	LayoutClass2CheckboxUnselected LayoutClass2 = "checkbox_unselected"
	// LayoutClass2Form LayoutClass2Form is the Form variant of LayoutClass2.
	LayoutClass2Form LayoutClass2 = "form"
	// LayoutClass2KeyValueRegion LayoutClass2KeyValueRegion is the KeyValueRegion variant of LayoutClass2.
	LayoutClass2KeyValueRegion LayoutClass2 = "key_value_region"
)
...
func WithExtractionConfigForceOcrPages(v []uint32) ExtractionConfigOption {
...
// WithOcrConfigBackendOptions sets the backend_options field.
func WithOcrConfigBackendOptions(v json.RawMessage) OcrConfigOption {
	return func(c *OcrConfig) { c.BackendOptions = &v }
}
...
// WithOcrConfigTessdataBytes sets the tessdata_bytes field.
func WithOcrConfigTessdataBytes(v map[string][]byte) OcrConfigOption {
	return func(c *OcrConfig) { c.TessdataBytes = v }
}
...
// WithPdfConfigExtractTables sets the extract_tables field.
func WithPdfConfigExtractTables(v bool) PdfConfigOption {
	return func(c *PdfConfig) { c.ExtractTables = &v }
}
...
// WithPdfConfigOcrInlineImages sets the ocr_inline_images field.
func WithPdfConfigOcrInlineImages(v bool) PdfConfigOption {
	return func(c *PdfConfig) { c.OcrInlineImages = v }
}
...
// EmbeddingPreset2 preset configurations for common RAG use cases.
//
...
func GetEmbeddingPreset(name string) *string {
...
// Default is a method.
func ContentFilterConfigDefault() *ContentFilterConfig {
	ptr := C.kreuzberg_content_filter_config_default()
	defer C.kreuzberg_content_filter_config_free(ptr)
	return func() *ContentFilterConfig {
		jsonPtr := C.kreuzberg_content_filter_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result ContentFilterConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func ExtractionConfigDefault() *ExtractionConfig {
	ptr := C.kreuzberg_extraction_config_default()
...
// Default is a method.
func ImageExtractionConfigDefault() *ImageExtractionConfig {
	ptr := C.kreuzberg_image_extraction_config_default()
	defer C.kreuzberg_image_extraction_config_free(ptr)
	return func() *ImageExtractionConfig {
		jsonPtr := C.kreuzberg_image_extraction_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result ImageExtractionConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func TokenReductionOptionsDefault() *TokenReductionOptions {
	ptr := C.kreuzberg_token_reduction_options_default()
	defer C.kreuzberg_token_reduction_options_free(ptr)
	return func() *TokenReductionOptions {
		jsonPtr := C.kreuzberg_token_reduction_options_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result TokenReductionOptions
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func LanguageDetectionConfigDefault() *LanguageDetectionConfig {
	ptr := C.kreuzberg_language_detection_config_default()
	defer C.kreuzberg_language_detection_config_free(ptr)
	return func() *LanguageDetectionConfig {
		jsonPtr := C.kreuzberg_language_detection_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result LanguageDetectionConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func HTMLOutputConfigDefault() *HTMLOutputConfig {
	ptr := C.kreuzberg_html_output_config_default()
	defer C.kreuzberg_html_output_config_free(ptr)
	return func() *HTMLOutputConfig {
		jsonPtr := C.kreuzberg_html_output_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result HTMLOutputConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func LayoutDetectionConfigDefault() *LayoutDetectionConfig {
	ptr := C.kreuzberg_layout_detection_config_default()
	defer C.kreuzberg_layout_detection_config_free(ptr)
	return func() *LayoutDetectionConfig {
		jsonPtr := C.kreuzberg_layout_detection_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result LayoutDetectionConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func OcrQualityThresholdsDefault() *OcrQualityThresholds {
	ptr := C.kreuzberg_ocr_quality_thresholds_default()
	defer C.kreuzberg_ocr_quality_thresholds_free(ptr)
	return func() *OcrQualityThresholds {
		jsonPtr := C.kreuzberg_ocr_quality_thresholds_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result OcrQualityThresholds
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func OcrConfigDefault() *OcrConfig {
	ptr := C.kreuzberg_ocr_config_default()
	defer C.kreuzberg_ocr_config_free(ptr)
	return func() *OcrConfig {
		jsonPtr := C.kreuzberg_ocr_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
...
// Default is a method.
func PageConfigDefault() *PageConfig {
	ptr := C.kreuzberg_page_config_default()
	defer C.kreuzberg_page_config_free(ptr)
	return func() *PageConfig {
		jsonPtr := C.kreuzberg_page_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result PageConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func PdfConfigDefault() *PdfConfig {
	ptr := C.kreuzberg_pdf_config_default()
	defer C.kreuzberg_pdf_config_free(ptr)
	return func() *PdfConfig {
		jsonPtr := C.kreuzberg_pdf_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result PdfConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func HierarchyConfigDefault() *HierarchyConfig {
	ptr := C.kreuzberg_hierarchy_config_default()
	defer C.kreuzberg_hierarchy_config_free(ptr)
	return func() *HierarchyConfig {
		jsonPtr := C.kreuzberg_hierarchy_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result HierarchyConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func PostProcessorConfigDefault() *PostProcessorConfig {
	ptr := C.kreuzberg_post_processor_config_default()
	defer C.kreuzberg_post_processor_config_free(ptr)
	return func() *PostProcessorConfig {
		jsonPtr := C.kreuzberg_post_processor_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result PostProcessorConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func ChunkingConfigDefault() *ChunkingConfig {
	ptr := C.kreuzberg_chunking_config_default()
	defer C.kreuzberg_chunking_config_free(ptr)
	return func() *ChunkingConfig {
		jsonPtr := C.kreuzberg_chunking_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result ChunkingConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func EmbeddingConfigDefault() *EmbeddingConfig {
	ptr := C.kreuzberg_embedding_config_default()
	defer C.kreuzberg_embedding_config_free(ptr)
	return func() *EmbeddingConfig {
		jsonPtr := C.kreuzberg_embedding_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
...
// Default is a method.
func TreeSitterConfigDefault() *TreeSitterConfig {
	ptr := C.kreuzberg_tree_sitter_config_default()
	defer C.kreuzberg_tree_sitter_config_free(ptr)
	return func() *TreeSitterConfig {
		jsonPtr := C.kreuzberg_tree_sitter_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result TreeSitterConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func TreeSitterProcessConfigDefault() *TreeSitterProcessConfig {
	ptr := C.kreuzberg_tree_sitter_process_config_default()
	defer C.kreuzberg_tree_sitter_process_config_free(ptr)
	return func() *TreeSitterProcessConfig {
		jsonPtr := C.kreuzberg_tree_sitter_process_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result TreeSitterProcessConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func ServerConfigDefault() *ServerConfig {
	ptr := C.kreuzberg_server_config_default()
...
// Default is a method.
func SecurityLimitsDefault() *SecurityLimits {
	ptr := C.kreuzberg_security_limits_default()
	defer C.kreuzberg_security_limits_free(ptr)
	return func() *SecurityLimits {
		jsonPtr := C.kreuzberg_security_limits_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result SecurityLimits
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func TokenReductionConfigDefault() *TokenReductionConfig {
	ptr := C.kreuzberg_token_reduction_config_default()
	defer C.kreuzberg_token_reduction_config_free(ptr)
	return func() *TokenReductionConfig {
		jsonPtr := C.kreuzberg_token_reduction_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result TokenReductionConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func DocumentStructureDefault() *DocumentStructure {
	ptr := C.kreuzberg_document_structure_default()
...
// Default is a method.
func ImagePreprocessingConfigDefault() *ImagePreprocessingConfig {
	ptr := C.kreuzberg_image_preprocessing_config_default()
	defer C.kreuzberg_image_preprocessing_config_free(ptr)
	return func() *ImagePreprocessingConfig {
		jsonPtr := C.kreuzberg_image_preprocessing_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result ImagePreprocessingConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func TesseractConfigDefault() *TesseractConfig {
	ptr := C.kreuzberg_tesseract_config_default()
	defer C.kreuzberg_tesseract_config_free(ptr)
	return func() *TesseractConfig {
		jsonPtr := C.kreuzberg_tesseract_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result TesseractConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func YakeParamsDefault() *YakeParams {
	ptr := C.kreuzberg_yake_params_default()
	defer C.kreuzberg_yake_params_free(ptr)
	return func() *YakeParams {
		jsonPtr := C.kreuzberg_yake_params_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result YakeParams
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func RakeParamsDefault() *RakeParams {
	ptr := C.kreuzberg_rake_params_default()
	defer C.kreuzberg_rake_params_free(ptr)
	return func() *RakeParams {
		jsonPtr := C.kreuzberg_rake_params_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result RakeParams
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func KeywordConfigDefault() *KeywordConfig {
	ptr := C.kreuzberg_keyword_config_default()
	defer C.kreuzberg_keyword_config_free(ptr)
	return func() *KeywordConfig {
		jsonPtr := C.kreuzberg_keyword_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
...
// Default creates a default configuration with English language support.
func PaddleOcrConfigDefault() *PaddleOcrConfig {
	ptr := C.kreuzberg_paddle_ocr_config_default()
	defer C.kreuzberg_paddle_ocr_config_free(ptr)
	return func() *PaddleOcrConfig {
		jsonPtr := C.kreuzberg_paddle_ocr_config_to_json(ptr)
		if jsonPtr == nil {
