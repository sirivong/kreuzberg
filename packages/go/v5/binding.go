...
#cgo darwin,amd64 LDFLAGS: -L${SRCDIR}/.lib/macos-x86_64 -Wl,-rpath,${SRCDIR}/.lib/macos-x86_64 -lkreuzberg_ffi
#cgo linux,amd64 LDFLAGS: -L${SRCDIR}/.lib/linux-x86_64 -Wl,-rpath,${SRCDIR}/.lib/linux-x86_64 -lkreuzberg_ffi
#cgo linux,arm64 LDFLAGS: -L${SRCDIR}/.lib/linux-aarch64 -Wl,-rpath,${SRCDIR}/.lib/linux-aarch64 -lkreuzberg_ffi
#cgo windows,amd64 LDFLAGS: -L${SRCDIR}/.lib/windows-x86_64 -lkreuzberg_ffi
#include "kreuzberg.h"
*/
import "C"
...
var (
	// ErrKreuzbergIo is returned when IO error.
	ErrKreuzbergIo = errors.New("IO error")
...
func (h *MetaSchema) Free() {
	if h.ptr != nil {
		C.kreuzberg_meta_schema_free((*C.KREUZBERGMetaSchema)(h.ptr))
		h.ptr = nil
	}
}
...
func (h *Registry) Free() {
	if h.ptr != nil {
		C.kreuzberg_registry_free((*C.KREUZBERGRegistry)(h.ptr))
		h.ptr = nil
	}
}
...
func ClassifyDocument(pages []string, config PageClassificationConfig) ([]ClassificationLabel, error) {
	...
	ptr := C.kreuzberg_classify_document(cPages, cConfig)
	if err := lastError(); err != nil {
		return nil, err
	}
	if ptr == nil {
...
func FindFootnoteAnchors(markdown string) []FootnoteAnchor {
	...
	ptr := C.kreuzberg_find_footnote_anchors(cMarkdown)
...
func ParseFootnoteDefinitions(markdown string) []FootnoteDefinition {
	...
	ptr := C.kreuzberg_parse_footnote_definitions(cMarkdown)
...
func FindInferenceMarkers(markdown string) []uint {
	...
	ptr := C.kreuzberg_find_inference_markers(cMarkdown)
	return func() []uint {
		if ptr == nil {
			return nil
		}
...
func FindUnmarkedClaims(markdown string) []string {
	...
	ptr := C.kreuzberg_find_unmarked_claims(cMarkdown)
	return func() []string {
		if ptr == nil {
			return nil
		}
...
func ParseCitations(markdown string) []Citation {
	...
	ptr := C.kreuzberg_parse_citations(cMarkdown)
...
func VerifyExcerpt(excerpt string, sourceText string) bool {
	...
	ptr := C.kreuzberg_verify_excerpt(cExcerpt, cSourceText)
	return ptr != 0
}
...
func ChunkForRag(text string, config ChunkingConfig) (*ChunkingResult, error) {
	...
	C.free(unsafe.Pointer(tmpStrcConfig))
	if cConfig == nil {
		return nil, fmt.Errorf("failed to create chunking_config: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_chunking_config_free(cConfig)

	ptr := C.kreuzberg_chunk_for_rag(cText, cConfig)
	if err := lastError(); err != nil {
		if ptr != nil {
...
func ScoreConfidence(signals ConfidenceSignals, weights ConfidenceWeights) (*ExtractionConfidence, error) {
	...
	cSignals := C.kreuzberg_confidence_signals_from_json(tmpStrcSignals)
	C.free(unsafe.Pointer(tmpStrcSignals))
	if cSignals == nil {
		return nil, fmt.Errorf("failed to create confidence_signals: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_confidence_signals_free(cSignals)
	...
	cWeights := C.kreuzberg_confidence_weights_from_json(tmpStrcWeights)
	C.free(unsafe.Pointer(tmpStrcWeights))
	if cWeights == nil {
		return nil, fmt.Errorf("failed to create confidence_weights: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_confidence_weights_free(cWeights)

	ptr := C.kreuzberg_score_confidence(cSignals, cWeights)
	defer C.kreuzberg_extraction_confidence_free(ptr)
	jsonPtr := C.kreuzberg_extraction_confidence_to_json(ptr)
	if jsonPtr == nil {
		return nil, fmt.Errorf("failed to convert to JSON")
	}
	defer C.kreuzberg_free_string(jsonPtr)
...
func CheckFormatLimits(mimeType string, sheetCount *uint32, workbookCells *uint64, embeddedCount *uint32, config HeuristicsConfig) (*string, error) {
	...
	tmpStrcConfig := C.CString(string(jsonBytescConfig))
	cConfig := C.kreuzberg_heuristics_config_from_json(tmpStrcConfig)
	C.free(unsafe.Pointer(tmpStrcConfig))
	if cConfig == nil {
		return nil, fmt.Errorf("failed to create heuristics_config: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_heuristics_config_free(cConfig)

	ptr := C.kreuzberg_check_format_limits(cMimeType, cSheetCount, cWorkbookCells, cEmbeddedCount, cConfig)
	return func() *string {
		if ptr == nil {
			return nil
		}
...
func BoundariesFromExtractionResult(resultArg ExtractionResult, thresholds MultidocThresholds) ([]DocumentBoundary, error) {
	...
	cThresholds := C.kreuzberg_multidoc_thresholds_from_json(tmpStrcThresholds)
	C.free(unsafe.Pointer(tmpStrcThresholds))
	if cThresholds == nil {
		return nil, fmt.Errorf("failed to create multidoc_thresholds: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_multidoc_thresholds_free(cThresholds)

	ptr := C.kreuzberg_boundaries_from_extraction_result(cResult, cThresholds)
	if ptr == nil {
		return nil, fmt.Errorf("failed to get result")
	}
	defer C.kreuzberg_free_string(ptr)
...
func DetectBoundaries(input MultidocInput, thresholds MultidocThresholds) ([]DocumentBoundary, error) {
	...
	cInput := C.kreuzberg_multidoc_input_from_json(tmpStrcInput)
	C.free(unsafe.Pointer(tmpStrcInput))
	if cInput == nil {
		return nil, fmt.Errorf("failed to create multidoc_input: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_multidoc_input_free(cInput)
	...
	ptr := C.kreuzberg_detect_boundaries(cInput, cThresholds)
	if ptr == nil {
		return nil, fmt.Errorf("failed to get result")
	}
	defer C.kreuzberg_free_string(ptr)
...
func ChooseCallMode(input StructuredInput, t StructuredThresholds) (*StructuredCallMode, error) {
	...
	tmpStrcInput := C.CString(string(jsonBytescInput))
	cInput := C.kreuzberg_structured_input_from_json(tmpStrcInput)
	C.free(unsafe.Pointer(tmpStrcInput))
	if cInput == nil {
		return nil, fmt.Errorf("failed to create structured_input: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_structured_input_free(cInput)
	...
	ct := C.kreuzberg_structured_thresholds_from_json(tmpStrct)
	C.free(unsafe.Pointer(tmpStrct))
	if ct == nil {
		return nil, fmt.Errorf("failed to create structured_thresholds: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_structured_thresholds_free(ct)

	ptr := C.kreuzberg_choose_call_mode(cInput, ct)
	defer C.kreuzberg_structured_call_mode_free(ptr)
	jsonPtr := C.kreuzberg_structured_call_mode_to_json(ptr)
	if jsonPtr == nil {
		return nil, fmt.Errorf("failed to convert to JSON")
	}
	defer C.kreuzberg_free_string(jsonPtr)
...
func CalculateChunkPlan(pageCount uint32, sizeBytes uint64, needsOcr bool, config HeuristicsConfig) (*ChunkPlan, error) {
	...
	ptr := C.kreuzberg_calculate_chunk_plan(cPageCount, cSizeBytes, cNeedsOcr, cConfig)
	defer C.kreuzberg_chunk_plan_free(ptr)
	jsonPtr := C.kreuzberg_chunk_plan_to_json(ptr)
	if jsonPtr == nil {
		return nil, fmt.Errorf("failed to convert to JSON")
	}
	defer C.kreuzberg_free_string(jsonPtr)
...
func CalculatePlanFromOverrides(userChunks []PageRange, totalPages uint32, sizeBytes uint64, config HeuristicsConfig) (*ChunkPlan, error) {
	...
	ptr := C.kreuzberg_calculate_plan_from_overrides(cUserChunks, cTotalPages, cSizeBytes, cConfig)
	defer C.kreuzberg_chunk_plan_free(ptr)
	jsonPtr := C.kreuzberg_chunk_plan_to_json(ptr)
	if jsonPtr == nil {
		return nil, fmt.Errorf("failed to convert to JSON")
...
func Fingerprint(raw []byte) string {
	...
	ptr := C.kreuzberg_fingerprint(cRaw, cRawLen)
	defer C.kreuzberg_free_string(ptr)
	return C.GoString(ptr)
}
...
func Resolve(preset Preset, customSchema *json.RawMessage, context map[string]string) (*ResolvedPreset, error) {
	...
	cPreset := C.kreuzberg_preset_from_json(tmpStrcPreset)
	C.free(unsafe.Pointer(tmpStrcPreset))
	if cPreset == nil {
		return nil, fmt.Errorf("failed to create preset: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_preset_free(cPreset)
	...
	ptr := C.kreuzberg_resolve(cPreset, cCustomSchema, cContext)
	if err := lastError(); err != nil {
		if ptr != nil {
			C.kreuzberg_resolved_preset_free(ptr)
		}
		return nil, err
	}
	defer C.kreuzberg_resolved_preset_free(ptr)
	jsonPtr := C.kreuzberg_resolved_preset_to_json(ptr)
	if jsonPtr == nil {
		return nil, fmt.Errorf("failed to convert to JSON")
	}
	defer C.kreuzberg_free_string(jsonPtr)
...
func ExtractStructuredJSON(bytes []byte, mime string, presetSpecJSON string, optionsJSON string) (string, error) {
	...
	ptr := C.kreuzberg_extract_structured_json(cBytes, cBytesLen, cMime, cPresetSpecJSON, cOptionsJSON)
	if err := lastError(); err != nil {
		if ptr != nil {
			C.kreuzberg_free_string(ptr)
		}
...
func SplitAndExtractJSON(bytes []byte, mime string, presetSpecJSON string, optionsJSON string) (string, error) {
	...
	ptr := C.kreuzberg_split_and_extract_json(cBytes, cBytesLen, cMime, cPresetSpecJSON, cOptionsJSON)
	if err := lastError(); err != nil {
		if ptr != nil {
			C.kreuzberg_free_string(ptr)
		}
...
func PdfPageCount(pdfBytes []byte, password *string) (uint, error) {
	...
	ptr := C.kreuzberg_pdf_page_count(cPdfBytes, cPdfBytesLen, cPassword)
	if err := lastError(); err != nil {
		return 0, err
	}
	return uint(ptr), nil
...
func CaptionImage(imageBytes []byte, llmConfig LlmConfig, customPrompt *string) (string, error) {
	...
	ptr := C.kreuzberg_caption_image(cImageBytes, cImageBytesLen, cLlmConfig, cCustomPrompt)
	if err := lastError(); err != nil {
		if ptr != nil {
			C.kreuzberg_free_string(ptr)
		}
...
func CaptionImageFile(path string, llmConfig LlmConfig, customPrompt *string) (string, error) {
	...
	ptr := C.kreuzberg_caption_image_file(cPath, cLlmConfig, cCustomPrompt)
	if err := lastError(); err != nil {
		if ptr != nil {
			C.kreuzberg_free_string(ptr)
		}
...
func (r *FootnoteConfig) WithParseCitations(enabled bool) (*FootnoteConfig, error) {
	...
	tmpStrRecv := C.CString(string(jsonBytesRecv))
	cRecv := C.kreuzberg_footnote_config_from_json(tmpStrRecv)
	C.free(unsafe.Pointer(tmpStrRecv))
	if cRecv == nil {
		return nil, fmt.Errorf("failed to create receiver: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_footnote_config_free(cRecv)
	ptr := C.kreuzberg_footnote_config_with_parse_citations(cRecv, cEnabled)
	defer C.kreuzberg_footnote_config_free(ptr)
	return func() *FootnoteConfig {
		jsonPtr := C.kreuzberg_footnote_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
...
func ConfidenceSignalsFromExtractionResult(resultArg ExtractionResult, schemaCompliance SchemaCompliance, textCoverage float32) (*ConfidenceSignals, error) {
	...
	cSchemaCompliance := C.kreuzberg_schema_compliance_from_str(cSchemaComplianceStr)

	cTextCoverage := C.float(float32(textCoverage))

	ptr := C.kreuzberg_confidence_signals_from_extraction_result(cResult, cSchemaCompliance, cTextCoverage)
	defer C.kreuzberg_confidence_signals_free(ptr)
	return func() *ConfidenceSignals {
		jsonPtr := C.kreuzberg_confidence_signals_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
...
func (r *ConfidenceWeights) IsNormalized() (bool, error) {
	...
	tmpStrRecv := C.CString(string(jsonBytesRecv))
	cRecv := C.kreuzberg_confidence_weights_from_json(tmpStrRecv)
	C.free(unsafe.Pointer(tmpStrRecv))
	if cRecv == nil {
		return false, fmt.Errorf("failed to create receiver: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_confidence_weights_free(cRecv)
	ptr := C.kreuzberg_confidence_weights_is_normalized(cRecv)
	return ptr != 0, nil
}
...
func (r *HeuristicsConfig) Validate() error {
	...
	tmpStrRecv := C.CString(string(jsonBytesRecv))
	cRecv := C.kreuzberg_heuristics_config_from_json(tmpStrRecv)
	C.free(unsafe.Pointer(tmpStrRecv))
	if cRecv == nil {
		return fmt.Errorf("failed to create receiver: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_heuristics_config_free(cRecv)
	C.kreuzberg_heuristics_config_validate(cRecv)
	jsonPtrUpdated := C.kreuzberg_heuristics_config_to_json(cRecv)
	if jsonPtrUpdated != nil {
		_ = json.Unmarshal([]byte(C.GoString(jsonPtrUpdated)), r)
		C.kreuzberg_free_string(jsonPtrUpdated)
	}
...
func (r *ChunkPlan) TotalPages() (uint32, error) {
	...
	tmpStrRecv := C.CString(string(jsonBytesRecv))
	cRecv := C.kreuzberg_chunk_plan_from_json(tmpStrRecv)
	C.free(unsafe.Pointer(tmpStrRecv))
	if cRecv == nil {
		return 0, fmt.Errorf("failed to create receiver: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_chunk_plan_free(cRecv)
	ptr := C.kreuzberg_chunk_plan_total_pages(cRecv)
...
func (r *PageRange) PageCount() (uint32, error) {
	...
	tmpStrRecv := C.CString(string(jsonBytesRecv))
	cRecv := C.kreuzberg_page_range_from_json(tmpStrRecv)
	C.free(unsafe.Pointer(tmpStrRecv))
	if cRecv == nil {
		return 0, fmt.Errorf("failed to create receiver: %s", C.GoString(C.kreuzberg_last_error_context()))
	}
	defer C.kreuzberg_page_range_free(cRecv)
	ptr := C.kreuzberg_page_range_page_count(cRecv)
	return uint32(ptr), nil
}
...
func PageSignalsFromPageText(pageNumber uint32, text string, layoutTextDensity float32) *PageSignals {
	...
	ptr := C.kreuzberg_page_signals_from_page_text(cPageNumber, cText, cLayoutTextDensity)
	defer C.kreuzberg_page_signals_free(ptr)
	return func() *PageSignals {
		jsonPtr := C.kreuzberg_page_signals_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
...
func (h *MetaSchema) ParsePreset(path string, raw []byte) (*Preset, error) {
	...
	ptr := C.kreuzberg_meta_schema_parse_preset((*C.KREUZBERGMetaSchema)(unsafe.Pointer(h.ptr)), cPath, cRaw, cRawLen)
	if err := lastError(); err != nil {
		return nil, err
	}
	defer C.kreuzberg_preset_free(ptr)
	return func() *Preset {
		jsonPtr := C.kreuzberg_preset_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
...
func (h *Registry) Get(id string) *Preset {
	...
	ptr := C.kreuzberg_registry_get((*C.KREUZBERGRegistry)(unsafe.Pointer(h.ptr)), cid)
	return func() *Preset {
		jsonPtr := C.kreuzberg_preset_to_json(ptr)
		if jsonPtr == nil {
			return nil
...
func (h *Registry) Summaries() []PresetSummary {
	ptr := C.kreuzberg_registry_summaries((*C.KREUZBERGRegistry)(unsafe.Pointer(h.ptr)))
...
func (h *Registry) Len() uint {
	ptr := C.kreuzberg_registry_len((*C.KREUZBERGRegistry)(unsafe.Pointer(h.ptr)))
	return uint(ptr)
}

// IsEmpty whether the registry contains zero presets.
func (h *Registry) IsEmpty() bool {
	ptr := C.kreuzberg_registry_is_empty((*C.KREUZBERGRegistry)(unsafe.Pointer(h.ptr)))
	return ptr != 0
}
...
func (h *Registry) SampleBytes(presetID string, name string) *[]byte {
	...
	ptr := C.kreuzberg_registry_sample_bytes((*C.KREUZBERGRegistry)(unsafe.Pointer(h.ptr)), cPresetID, cName)
	return func() *[]byte {
		if ptr == nil {
			return nil
		}
...
func (h *Registry) ExtendFromDir(dir string) (uint, error) {
	...
	ptr := C.kreuzberg_registry_extend_from_dir((*C.KREUZBERGRegistry)(unsafe.Pointer(h.ptr)), cDir)
	if err := lastError(); err != nil {
		return 0, err
	}
	return uint(ptr), nil
