...
static inline XBERGXbergRendererVTable* xberg_renderer_vtable_new(void) {
	...
	if (!vtable) return NULL;
	memset(vtable, 0, sizeof(XBERGXbergRendererVTable));	vtable->render = (void(*)(void))goRendererRender;	vtable->free_string = (void(*)(void))goRendererFreeString;
...
func goOcrBackendEmitsStructuredMarkdown(
	...
	// Call the method
		result := impl.EmitsStructuredMarkdown()
