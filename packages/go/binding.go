...
type ExtractionOutput struct {
	...
	Crawl map[string]json.RawMessage `json:"crawl,omitempty"`
}
...
// ExtractSync synchronous wrapper for `extract`.
func ExtractSync(input ExtractInput, config ExtractionConfig) (*ExtractionOutput, error) {
	...
	ptr := C.xberg_extract_sync(cInput, cConfig)
...
// ExtractBatchSync synchronous wrapper for `extract_batch`.
func ExtractBatchSync(inputs []ExtractInput, config ExtractionConfig) (*ExtractionOutput, error) {
	...
	ptr := C.xberg_extract_batch_sync(cInputs, cConfig)
	if err := lastError(); err != nil {
		if ptr != nil {
			C.xberg_extraction_output_free(ptr)
		}
