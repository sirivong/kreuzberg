defmodule KreuzbergOcrBackendBridge do
  @moduledoc """
  GenServer bridge for OcrBackend implementation in kreuzberg.
  ...
  def register(impl_module) do
    ...
    Kreuzberg.Native.register_ocr_backend(pid, plugin_name)
  end
end
