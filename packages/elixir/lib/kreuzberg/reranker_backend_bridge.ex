defmodule KreuzbergRerankerBackendBridge do
  @moduledoc """
  GenServer bridge for RerankerBackend implementation in kreuzberg.
  ...
  def register(impl_module) do
    ...
    Kreuzberg.Native.register_reranker_backend(pid, plugin_name)
  end
end
