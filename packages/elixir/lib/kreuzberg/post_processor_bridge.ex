defmodule KreuzbergPostProcessorBridge do
  @moduledoc """
  GenServer bridge for PostProcessor implementation in kreuzberg.
  ...
  def register(impl_module) do
    ...
    Kreuzberg.Native.register_post_processor(pid, plugin_name)
  end
end
