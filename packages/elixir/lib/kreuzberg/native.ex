...
defmodule Kreuzberg.Native do
  ...
  * `mime_type` - The MIME type to look up
  ...
  """
  def apply_strategy(_strategy, _original, _category, _counter), do: :erlang.nif_error(:nif_not_loaded)
  ...
  * `origin` - The origin to check (e.g., "https://example.com")
  ...
  """
  def glinebackend_new(_repo_id), do: :erlang.nif_error(:nif_not_loaded)
  def glinebackend_detect_async(_obj, _text, _categories), do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def glinebackend_detect_with_custom_async(_obj, _text, _categories, _custom_labels),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def tokencounter_next_token(_obj, _category, _original), do: :erlang.nif_error(:nif_not_loaded)
