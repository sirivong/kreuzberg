...
defmodule Kreuzberg do
  ...
  @doc "Apply `strategy` to `original` for `category` and return the replacement token."
  @spec apply_strategy(map(), String.t(), map(), reference()) :: String.t()
  def apply_strategy(strategy, original, category, counter) do
    Kreuzberg.Native.apply_strategy(strategy, original, category, counter)
  end
  ...
  def tokencounter_next_token(obj, category, original) do
    Kreuzberg.Native.tokencounter_next_token(obj, category, original)
  end
