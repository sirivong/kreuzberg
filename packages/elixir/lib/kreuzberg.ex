...
defmodule Kreuzberg do
  ...
  @doc "Clear all OcrBackend plugins from the global registry."
  @spec clear_ocr_backends() :: :ok | :error
  def clear_ocr_backends do
    Kreuzberg.Native.clear_ocr_backends()
  end
  ...
  @doc "Clear all PostProcessor plugins from the global registry."
  @spec clear_post_processors() :: :ok | :error
  def clear_post_processors do
    Kreuzberg.Native.clear_post_processors()
  end
  ...
  @doc "Clear all Validator plugins from the global registry."
  @spec clear_validators() :: :ok | :error
  def clear_validators do
    Kreuzberg.Native.clear_validators()
  end
  ...
  @doc "Clear all EmbeddingBackend plugins from the global registry."
  @spec clear_embedding_backends() :: :ok | :error
  def clear_embedding_backends do
    Kreuzberg.Native.clear_embedding_backends()
  end
  ...
  @doc "Clear all DocumentExtractor plugins from the global registry."
  @spec clear_document_extractors() :: :ok | :error
  def clear_document_extractors do
    Kreuzberg.Native.clear_document_extractors()
  end
  ...
  @doc "Clear all Renderer plugins from the global registry."
  @spec clear_renderers() :: :ok | :error
  def clear_renderers do
    Kreuzberg.Native.clear_renderers()
  end
end
