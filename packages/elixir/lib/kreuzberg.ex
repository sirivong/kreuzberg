...
# alef:hash:2e8b7cb6a71e2f8401640fe6319b76bd2f7b797e6dc6fe9ad7d2066a8c7a737f
...
defmodule Kreuzberg do
  ...
  def extract_bytes_async(content, mime_type, config \\ nil) do
  ...
  @spec extract_bytes_sync(binary(), String.t(), String.t() | nil) ::
          {:ok, map()} | {:error, atom, String.t()}
  def extract_bytes_sync(content, mime_type, config \\ nil) do
  ...
  def embed_texts_async(texts, config \\ nil) do
  ...
  @spec embed_texts([String.t()], String.t() | nil) ::
          {:ok, [[float()]]} | {:error, atom, String.t()}
  def embed_texts(texts, config \\ nil) do
