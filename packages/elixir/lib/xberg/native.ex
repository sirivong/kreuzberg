...
defmodule Xberg.Native do
  ...
  """
  def classify_chunks_async(_result, _config), do: :erlang.nif_error(:nif_not_loaded)
  ...
  * `version` - `"pp-ocrv6"` (default) or `"pp-ocrv5"`. Under `"pp-ocrv6"`, `model_tier`
  ...
  @doc false
  def chunk_classification_definition_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)

  @doc false
  def chunk_classification_config_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
  ...
  @doc false
  def page_span_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
  ...
  @doc false
  def code_data_attribute_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)

  @doc false
  def code_data_node_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
