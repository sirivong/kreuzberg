...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Xberg.FootnoteDefinition"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Xberg.OcrExtractionResult"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Xberg.OcrTableBoundingBox"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Xberg.ConfidenceSignals"]
...
#[rustler::nif]
pub fn extract_sync(input: Option<String>, config: Option<String>) -> Result<ExtractionOutput, String> {
...
#[rustler::nif]
pub fn extract_batch_sync(inputs: Option<String>, config: Option<String>) -> Result<ExtractionOutput, String> {
    ...
    let config_core: Option<xberg::ExtractionConfig> = config
        ...
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = xberg::extract_batch_sync(inputs_core, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn extract_async(input: Option<String>, config: Option<String>) -> Result<ExtractionOutput, String> {
    let input_core: Option<xberg::ExtractInput> = input
        .map(|s| serde_json::from_str::<xberg::ExtractInput>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
...
#[rustler::nif(schedule = "DirtyCpu")]
pub fn extract_batch_async(inputs: Option<String>, config: Option<String>) -> Result<ExtractionOutput, String> {
    let inputs_core: Vec<xberg::ExtractInput> = inputs
        .map(|s| serde_json::from_str::<Vec<xberg::ExtractInput>>(&s).map_err(|e| e.to_string()))
        .transpose()?
        .unwrap_or_default();
...
pub fn detect_mime_type_from_bytes(content: rustler::Binary) -> Result<String, String> {
    let result = xberg::detect_mime_type_from_bytes(content.as_slice()).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn get_extensions_for_mime(mime_type: String) -> Result<Vec<String>, String> {
    let result = xberg::get_extensions_for_mime(&mime_type).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn detect_qr_codes(image_bytes: rustler::Binary, _format_hint: Option<String>) -> Vec<QrCode> {
    xberg::extractors::qr::detect_qr_codes(image_bytes.as_slice(), _format_hint.as_deref())
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn register_builtin() -> Result<(), String> {
    let result = xberg::plugins::processor::builtin::register_builtin().map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn classify_pages_async(result: Option<String>, config: PageClassificationConfig) -> Result<(), String> {
    let result_core: Option<xberg::ExtractionResult> = result
        .map(|s| serde_json::from_str::<xberg::ExtractionResult>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        xberg::text::classification::classify_pages(&mut result_mut, &config.clone().into()).await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result)
            })
...
pub fn download_model(name: String, cache_dir: Option<String>) -> Result<String, String> {
    let result =
        xberg::text::ner::download_model(&name, cache_dir.map(std::path::PathBuf::from)).map_err(|e| e.to_string())?;
...
pub fn download_model(_name: String, _cache_dir: Option<String>) -> Result<String, String> {
    let result = xberg::text::ner::download_model(&_name, _cache_dir.map(std::path::PathBuf::from))
        .map_err(|e| e.to_string())?;
    Ok(result.to_string_lossy().to_string())
}
...
pub fn redact_async(result: Option<String>, config: Option<String>) -> Result<(), String> {
    let result_core: Option<xberg::ExtractionResult> = result
        ...
        .map_err(|e| e.to_string())?;
    let mut result_mut = result_core.unwrap_or_default();
    let config_core: Option<xberg::RedactionConfig> = config
        .map(|s| serde_json::from_str::<xberg::RedactionConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
...
pub fn scan_text(text: String, categories: Option<String>) -> Vec<PatternMatch> {
    let categories_core: Vec<xberg::PiiCategory> = categories
        .and_then(|s| serde_json::from_str::<Vec<xberg::PiiCategory>>(&s).ok())
        .unwrap_or_default();
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        xberg::text::translation::translate_result(&mut result_mut, &config.clone().into()).await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result)
            })
...
pub fn chunk_for_rag(text: String, config: Option<String>) -> Result<ChunkingResult, String> {
    let config_core: Option<xberg::ChunkingConfig> = config
        .map(|s| serde_json::from_str::<xberg::ChunkingConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = xberg::chunking::chunk_for_rag(&text, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn compare(a: Option<String>, b: Option<String>, opts: Option<String>) -> ExtractionDiff {
    let a_core: Option<xberg::ExtractionResult> =
        a.and_then(|s| serde_json::from_str::<xberg::ExtractionResult>(&s).ok());
    let b_core: Option<xberg::ExtractionResult> =
        b.and_then(|s| serde_json::from_str::<xberg::ExtractionResult>(&s).ok());
    let opts_core: Option<xberg::DiffOptions> = opts.and_then(|s| serde_json::from_str::<xberg::DiffOptions>(&s).ok());
    xberg::compare(
...
pub fn extract_region_with_vlm_async(
    ...
    let llm_config_core: Option<xberg::LlmConfig> = llm_config
        .map(|s| serde_json::from_str::<xberg::LlmConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
...
pub fn rerank_async(
    ...
    let config_core: Option<xberg::RerankerConfig> = config
        .map(|s| serde_json::from_str::<xberg::RerankerConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        xberg::rerank_async(query, documents, config_core.as_ref().unwrap_or(&Default::default())).await
                    })
                    .map_err(|e| e.to_string())?;
...
pub fn extract_keywords(text: String, config: Option<String>) -> Result<Vec<Keyword>, String> {
    let config_core: Option<xberg::KeywordConfig> = config
        .map(|s| serde_json::from_str::<xberg::KeywordConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = xberg::keywords::extract_keywords(&text, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
...
pub fn analyze_document(
    ...
    let config_core: Option<xberg::HeuristicsConfig> = config
        .map(|s| serde_json::from_str::<xberg::HeuristicsConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
...
pub fn analyze_with_user_chunks(
    ...
    let user_ranges_core: Vec<xberg::PageRange> = user_ranges
        .and_then(|s| serde_json::from_str::<Vec<xberg::PageRange>>(&s).ok())
        .unwrap_or_default();
    let config_core: Option<xberg::HeuristicsConfig> =
        config.and_then(|s| serde_json::from_str::<xberg::HeuristicsConfig>(&s).ok());
    xberg::analyze_with_user_chunks(
        &user_ranges_core,
        total_pages,
        size_bytes,
        config_core.as_ref().unwrap_or(&Default::default()),
...
pub fn score_confidence(signals: ConfidenceSignals, weights: Option<String>) -> ExtractionConfidence {
    let weights_core: Option<xberg::ConfidenceWeights> =
        weights.and_then(|s| serde_json::from_str::<xberg::ConfidenceWeights>(&s).ok());
    xberg::score_confidence(signals.into(), weights_core.unwrap_or_default()).into()
}
...
pub fn boundaries_from_extraction_result(result: Option<String>, thresholds: Option<String>) -> Vec<DocumentBoundary> {
    let result_core: Option<xberg::ExtractionResult> =
        result.and_then(|s| serde_json::from_str::<xberg::ExtractionResult>(&s).ok());
    let thresholds_core: Option<xberg::MultidocThresholds> =
        thresholds.and_then(|s| serde_json::from_str::<xberg::MultidocThresholds>(&s).ok());
    xberg::boundaries_from_extraction_result(
...
pub fn choose_call_mode(input: StructuredInput, t: Option<String>) -> StructuredCallMode {
    let t_core: Option<xberg::StructuredThresholds> =
        t.and_then(|s| serde_json::from_str::<xberg::StructuredThresholds>(&s).ok());
    xberg::choose_call_mode(&input.clone().into(), t_core.as_ref().unwrap_or(&Default::default())).into()
}
...
pub fn calculate_plan_from_overrides(
    ...
    let user_chunks_core: Vec<xberg::PageRange> = user_chunks
        .and_then(|s| serde_json::from_str::<Vec<xberg::PageRange>>(&s).ok())
        .unwrap_or_default();
    let config_core: Option<xberg::HeuristicsConfig> =
        config.and_then(|s| serde_json::from_str::<xberg::HeuristicsConfig>(&s).ok());
    xberg::calculate_plan_from_overrides(
        &user_chunks_core,
        total_pages,
        size_bytes,
        config_core.as_ref().unwrap_or(&Default::default()),
...
pub fn fingerprint(raw: rustler::Binary) -> String {
    xberg::presets::loader::fingerprint(raw.as_slice())
}
...
pub fn resolve(
    ...
    let preset_core: xberg::Preset = serde_json::from_str(&preset_json).map_err(|e| e.to_string())?;
    ...
    let result = xberg::resolve(&preset_core, custom_schema_json, &__context_btree).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn extract_structured_json(
    ...
    let result = xberg::extract_structured_json(bytes.as_slice(), &mime, &preset_spec_json, &options_json)
        .map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn split_and_extract_json(
    ...
    let result = xberg::split_and_extract_json(bytes.as_slice(), &mime, &preset_spec_json, &options_json)
        .map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn render_pdf_page_to_png(
    ...
    let result = xberg::render_pdf_page_to_png(pdf_bytes.as_slice(), page_index, dpi, password.as_deref())
        .map_err(|e| e.to_string())?;
    Ok(result.to_vec())
}
...
pub fn pdf_page_count(pdf_bytes: rustler::Binary, password: Option<String>) -> Result<usize, String> {
    let result = xberg::pdf_page_count(pdf_bytes.as_slice(), password.as_deref()).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn detect_mime_type(path: String, check_exists: bool) -> Result<String, String> {
    let result = xberg::detect_mime_type(path, check_exists).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn embed_texts_async(_texts: Vec<String>, _config: Option<String>) -> Result<Vec<Vec<f32>>, String> {
    let _config_core: Option<xberg::EmbeddingConfig> = _config
        .map(|s| serde_json::from_str::<xberg::EmbeddingConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        xberg::embed_texts_async(_texts, _config_core.as_ref().unwrap_or(&Default::default())).await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result)
            })
...
pub fn get_embedding_preset(name: String) -> Option<EmbeddingPreset> {
    xberg::get_embedding_preset(&name).map(|v| v.into())
}
...
pub fn get_embedding_preset(_name: String) -> Option<EmbeddingPreset> {
    xberg::get_embedding_preset(&_name).map(|v| v.into())
}
...
pub fn rerank(query: String, documents: Vec<String>, config: Option<String>) -> Result<Vec<RerankedDocument>, String> {
    let config_core: Option<xberg::RerankerConfig> = config
        ...
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = xberg::rerank(query, documents, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
...
pub fn rerank(
    ...
    let _config_core: Option<xberg::RerankerConfig> = _config
        .map(|s| serde_json::from_str::<xberg::RerankerConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = xberg::rerank(_query, _documents, _config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        xberg::rerank_async(_query, _documents, _config_core.as_ref().unwrap_or(&Default::default()))
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into_iter().map(Into::into).collect())
...
pub fn get_reranker_preset(name: String) -> Option<RerankerPreset> {
    xberg::get_reranker_preset(&name).map(|v| v.into())
}
...
pub fn get_reranker_preset(_name: String) -> Option<RerankerPreset> {
    xberg::get_reranker_preset(&_name).map(|v| v.into())
}
...
impl xberg::DocumentExtractor for RustlerDocumentExtractorBridge {
    async fn extract_bytes(
        ...
        mime_type: &str,
        config: &xberg::ExtractionConfig,
    ) -> std::result::Result<xberg::InternalDocument, xberg::XbergError> {
        let reply_id = TRAIT_REPLY_COUNTER.fetch_add(1, std::sync::atomic::Ordering::Relaxed);
        let (tx, rx) = tokio::sync::oneshot::channel::<Result<String, String>>();
        TRAIT_REPLY_CHANNELS.lock().unwrap().insert(reply_id, tx);
...
#[rustler::nif]
pub fn extractinput_bytes(bytes: Vec<u8>, mime_type: String, filename: Option<String>) -> ExtractInput {
    xberg::ExtractInput::bytes(bytes.as_slice().to_vec(), mime_type, filename).into()
}

/// Build a URI input from a local path, `file://` URI, or HTTP(S) URL.
#[rustler::nif]
pub fn extractinput_uri(uri: String) -> ExtractInput {
    xberg::ExtractInput::uri(uri).into()
}

/// Build an output containing one successful result.
#[rustler::nif]
pub fn extractionoutput_single(result: Option<String>) -> ExtractionOutput {
    let result_core: Option<xberg::ExtractionResult> =
        result.and_then(|s| serde_json::from_str::<xberg::ExtractionResult>(&s).ok());
    xberg::ExtractionOutput::single(result_core.unwrap_or_default()).into()
}
...
pub fn llmbackend_new(config: Option<String>) -> ResourceArc<LlmBackend> {
    let config_core: Option<xberg::LlmConfig> = config.and_then(|s| serde_json::from_str::<xberg::LlmConfig>(&s).ok());
    ResourceArc::new(LlmBackend {
        inner: Arc::new(xberg::LlmBackend::new(config_core.unwrap_or_default())),
    })
}
...
pub fn confidencesignals_from_extraction_result(
    ...
    xberg::ConfidenceSignals::from_extraction_result(
        result_core.as_ref().unwrap_or(&Default::default()),
...
pub fn confidenceweights_is_normalized(obj: ConfidenceWeights) -> bool {
    xberg::ConfidenceWeights::from(obj).is_normalized()
}
...
pub fn chunkplan_total_pages(obj: ChunkPlan) -> u32 {
    xberg::ChunkPlan::from(obj).total_pages()
}
...
pub fn registry_global() -> ResourceArc<Registry> {
    ResourceArc::new(Registry {
        inner: Arc::new(xberg::Registry::global().clone()),
    })
}
...
impl From<xberg::core::config::extraction::ImageOutputFormat> for ImageOutputFormat {
    fn from(val: xberg::core::config::extraction::ImageOutputFormat) -> Self {
        match val {
            ...
            xberg::core::config::extraction::ImageOutputFormat::Jpeg { quality } => Self::Jpeg { quality },
            xberg::core::config::extraction::ImageOutputFormat::Webp { quality } => Self::Webp { quality },
            xberg::core::config::extraction::ImageOutputFormat::Heif { quality } => Self::Heif { quality },
...
impl From<xberg::VlmFallbackPolicy> for VlmFallbackPolicy {
    fn from(val: xberg::VlmFallbackPolicy) -> Self {
        match val {
            ...
            xberg::VlmFallbackPolicy::OnLowQuality { quality_threshold } => Self::OnLowQuality { quality_threshold },
...
impl From<xberg::NodeContent> for NodeContent {
    fn from(val: xberg::NodeContent) -> Self {
        match val {
            ...
            xberg::NodeContent::List { ordered } => Self::List { ordered },
...
impl From<xberg::RevisionAnchor> for RevisionAnchor {
    fn from(val: xberg::RevisionAnchor) -> Self {
        match val {
            xberg::RevisionAnchor::Paragraph { index } => Self::Paragraph { index },
            xberg::RevisionAnchor::TableCell { row, col, table_index } => Self::TableCell { row, col, table_index },
            xberg::RevisionAnchor::Page { index } => Self::Page { index },
            xberg::RevisionAnchor::Slide { index } => Self::Slide { index },
...
impl From<xberg::enrichment::EnrichStatus> for EnrichStatus {
    fn from(val: xberg::enrichment::EnrichStatus) -> Self {
        match val {
            xberg::enrichment::EnrichStatus::Pending => Self::Pending,
            xberg::enrichment::EnrichStatus::Completed { result } => Self::Completed { result: result.into() },
            xberg::enrichment::EnrichStatus::Failed { error } => Self::Failed {
...
impl From<xberg::ChunkingDecision> for ChunkingDecision {
    fn from(val: xberg::ChunkingDecision) -> Self {
        match val {
            xberg::ChunkingDecision::NoChunking { reason } => Self::NoChunking { reason: reason.into() },
            xberg::ChunkingDecision::Chunk(_0) => Self::Chunk { _0: _0.into() },
            xberg::ChunkingDecision::UseOverrides { user_chunks } => Self::UseOverrides {
                user_chunks: user_chunks.into_iter().map(Into::into).collect(),
            },
        }
    }
...
impl From<xberg::NoChunkingReason> for NoChunkingReason {
    fn from(val: xberg::NoChunkingReason) -> Self {
        match val {
            ...
            xberg::NoChunkingReason::FewPages { page_count, threshold } => Self::FewPages { page_count, threshold },
...
impl From<xberg::ChunkingReason> for ChunkingReason {
    fn from(val: xberg::ChunkingReason) -> Self {
        match val {
            ...
            xberg::ChunkingReason::ManyPages { page_count, threshold } => Self::ManyPages { page_count, threshold },
            xberg::ChunkingReason::OcrRequired { page_count, force_ocr } => Self::OcrRequired { page_count, force_ocr },
            xberg::ChunkingReason::LargeAndManyPages { size_bytes, page_count } => {
                Self::LargeAndManyPages { size_bytes, page_count }
            }
        }
    }
...
pub fn enrich_result_from_json(json: String) -> Result<EnrichResult, String> {
    serde_json::from_str::<xberg::enrichment::EnrichResult>(&json)
...
pub fn confidence_signals_from_json(json: String) -> Result<ConfidenceSignals, String> {
    serde_json::from_str::<xberg::ConfidenceSignals>(&json)
...
pub fn confidence_weights_from_json(json: String) -> Result<ConfidenceWeights, String> {
    serde_json::from_str::<xberg::ConfidenceWeights>(&json)
...
pub fn chunk_plan_from_json(json: String) -> Result<ChunkPlan, String> {
    serde_json::from_str::<xberg::ChunkPlan>(&json)
        .map(ChunkPlan::from)
        .map_err(|e| e.to_string())
}
...
pub fn structured_input_from_json(json: String) -> Result<StructuredInput, String> {
    serde_json::from_str::<xberg::StructuredInput>(&json)
...
pub fn structured_thresholds_from_json(json: String) -> Result<StructuredThresholds, String> {
    serde_json::from_str::<xberg::StructuredThresholds>(&json)
