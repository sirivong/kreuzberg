...
// alef:hash:f009c40d26fef6a0440e6794d4ed5963ee6fee23a80ed9489f0a3d5e58a43007
...
impl CharShape {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            bold: opts.get("bold").and_then(|t| t.decode().ok()).unwrap_or_default(),
            italic: opts.get("italic").and_then(|t| t.decode().ok()).unwrap_or_default(),
            underline: opts.get("underline").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}
