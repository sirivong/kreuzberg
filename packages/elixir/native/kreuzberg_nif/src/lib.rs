...
#[module = "Kreuzberg.CaptioningConfig"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.PageClassificationConfig"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.RedactionTerm"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.RedactionPattern"]
...
impl TranscriptionConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            verify_hash: opts.get("verify_hash").and_then(|t| t.decode().ok()).unwrap_or(true),
        }
    }
}

#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.TranslationConfig"]
...
impl std::panic::RefUnwindSafe for LlmBackend {}

impl rustler::Resource for LlmBackend {}

#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.PatternMatch"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.FootnoteAnchor"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.FootnoteDefinition"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.PageClassification"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.ClassificationLabel"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.QrBoundingBox"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.RedactionReport"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.RedactionFinding"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.DocumentRevision"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.DocumentSummary"]
    ...
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            tables_changed: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            metadata_changed: opts
                .get("metadata_changed")
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            embedded_changes: opts
                .get("embedded_changes")
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
        }
    }
...
impl EmbeddedChanges {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            added: opts.get("added").and_then(|t| t.decode().ok()).unwrap_or_default(),
            removed: opts.get("removed").and_then(|t| t.decode().ok()).unwrap_or_default(),
            changed: opts.get("changed").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}

#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.EmbeddedDiff"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.RerankedDocument"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.RerankerPreset"]
...
impl EnrichResult {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            keywords: opts.get("keywords").and_then(|t| t.decode().ok()).unwrap_or_default(),
            entities: opts.get("entities").and_then(|t| t.decode().ok()).unwrap_or_default(),
            labels: opts.get("labels").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}

#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.DocumentMetadata"]
...
impl UserChunkConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            page_ranges: opts.get("page_ranges").and_then(|t| t.decode().ok()),
            pages_per_chunk: opts.get("pages_per_chunk").and_then(|t| t.decode().ok()),
            force_chunking: opts
                .get("force_chunking")
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            disable_chunking: opts
                .get("disable_chunking")
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
        }
    }
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.ConfidenceSignals"]
...
impl ConfidenceWeights {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            text_coverage: opts.get("text_coverage").and_then(|t| t.decode().ok()).unwrap_or(0.3),
            ocr_aggregate: opts.get("ocr_aggregate").and_then(|t| t.decode().ok()).unwrap_or(0.3),
            schema_compliance: opts
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.ExtractionConfidence"]
...
impl ChunkPlan {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            total_chunks: opts.get("total_chunks").and_then(|t| t.decode().ok()).unwrap_or(0),
            chunks: opts.get("chunks").and_then(|t| t.decode().ok()).unwrap_or_default(),
            total_estimated_time_ms: opts
                .get("total_estimated_time_ms")
                .and_then(|t| t.decode().ok())
                .unwrap_or(0),
            use_disk_processing: opts
                .get("use_disk_processing")
                .and_then(|t| t.decode().ok())
                .unwrap_or(false),
            reason: opts.get("reason").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}

#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.ChunkInfo"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.MultidocInput"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.DocumentBoundary"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.StructuredInput"]
...
impl StructuredThresholds {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            scan_max_coverage: opts
                .get("scan_max_coverage")
                .and_then(|t| t.decode().ok())
                .unwrap_or(0.1),
            digital_min_coverage: opts
                .get("digital_min_coverage")
                .and_then(|t| t.decode().ok())
                .unwrap_or(0.9),
            docx_text_min_density: opts
                .get("docx_text_min_density")
                .and_then(|t| t.decode().ok())
                .unwrap_or(200.0),
            enable_vision_fallback: opts
                .get("enable_vision_fallback")
                .and_then(|t| t.decode().ok())
                .unwrap_or(false),
        }
    }
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.ResolvedPreset"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.PresetSummary"]
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.EntityCategory"]
...
pub enum EnrichStatus {
    Pending,
    Completed { result: EnrichResult },
    Failed { error: String },
}

#[allow(clippy::derivable_impls)]
impl Default for EnrichStatus {
    fn default() -> Self {
        Self::Pending
    }
}
...
pub enum ChunkingDecision {
    NoChunking { reason: NoChunkingReason },
    Chunk { _0: ChunkPlan },
    UseOverrides { user_chunks: Vec<PageRange> },
}

#[allow(clippy::derivable_impls)]
impl Default for ChunkingDecision {
    fn default() -> Self {
        Self::NoChunking {
...
#[allow(clippy::derivable_impls)]
impl Default for StructuredCallMode {
    fn default() -> Self {
        Self::Skip
    }
}
...
pub fn batch_extract_files_sync(
    ...
    let items_core: Vec<kreuzberg::BatchFileItem> = items
        .map(|s| serde_json::from_str::<Vec<kreuzberg::BatchFileItem>>(&s).map_err(|e| e.to_string()))
        .transpose()?
        .unwrap_or_default();
    let config_core: Option<kreuzberg::ExtractionConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::ExtractionConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = kreuzberg::batch_extract_files_sync(items_core, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
...
pub fn batch_extract_bytes_sync(
    ...
    let items_core: Vec<kreuzberg::BatchBytesItem> = items
        .map(|s| serde_json::from_str::<Vec<kreuzberg::BatchBytesItem>>(&s).map_err(|e| e.to_string()))
        .transpose()?
        .unwrap_or_default();
    let config_core: Option<kreuzberg::ExtractionConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::ExtractionConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = kreuzberg::batch_extract_bytes_sync(items_core, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        kreuzberg::batch_extract_files(items_core, config_core.as_ref().unwrap_or(&Default::default()))
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into_iter().map(Into::into).collect())
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        kreuzberg::batch_extract_bytes(items_core, config_core.as_ref().unwrap_or(&Default::default()))
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into_iter().map(Into::into).collect())
...
#[rustler::nif]
pub fn detect_qr_codes(image_bytes: rustler::Binary, _format_hint: Option<String>) -> Vec<QrCode> {
    kreuzberg::extractors::qr::detect_qr_codes(image_bytes.as_slice(), _format_hint.as_deref())
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn register_builtin() -> Result<(), String> {
    let result = kreuzberg::plugins::processor::builtin::register_builtin().map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn list_reranker_backends() -> Result<Vec<String>, String> {
    let result = kreuzberg::list_reranker_backends().map_err(|e| e.to_string())?;
    Ok(result)
}
...
#[rustler::nif(schedule = "DirtyCpu")]
pub fn classify_pages_async(result: Option<String>, config: PageClassificationConfig) -> Result<(), String> {
    let result_core: Option<kreuzberg::ExtractionResult> = result
        .map(|s| serde_json::from_str::<kreuzberg::ExtractionResult>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let mut result_mut = result_core.unwrap_or_default();
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        kreuzberg::text::classification::classify_pages(&mut result_mut, &config.clone().into()).await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result)
            })
...
#[rustler::nif(schedule = "DirtyCpu")]
pub fn classify_text_async(text: String, config: PageClassificationConfig) -> Result<Vec<ClassificationLabel>, String> {
    Err(String::from("Not implemented: classify_text_async"))
}
...
/// ```
#[rustler::nif(schedule = "DirtyCpu")]
pub fn classify_document_async(
    pages: Vec<String>,
    config: PageClassificationConfig,
) -> Result<Vec<ClassificationLabel>, String> {
    Err(String::from("Not implemented: classify_document_async"))
}
...
pub fn download_model(name: String, cache_dir: Option<String>) -> Result<String, String> {
    let result = kreuzberg::text::ner::download_model(&name, cache_dir.map(std::path::PathBuf::from))
        .map_err(|e| e.to_string())?;
...
#[rustler::nif]
pub fn download_model(_name: String, _cache_dir: Option<String>) -> Result<String, String> {
    let result = kreuzberg::text::ner::download_model(&_name, _cache_dir.map(std::path::PathBuf::from))
        .map_err(|e| e.to_string())?;
    Ok(result.to_string_lossy().to_string())
}
...
#[cfg(not(any(feature = "ner-onnx", not(feature = "ner-onnx"))))]
...
#[rustler::nif(schedule = "DirtyCpu")]
pub fn redact_async(result: Option<String>, config: Option<String>) -> Result<(), String> {
    let result_core: Option<kreuzberg::ExtractionResult> = result
        .map(|s| serde_json::from_str::<kreuzberg::ExtractionResult>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let mut result_mut = result_core.unwrap_or_default();
    let config_core: Option<kreuzberg::RedactionConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::RedactionConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
...
#[rustler::nif]
pub fn scan_text(text: String, categories: Option<String>) -> Vec<PatternMatch> {
    let categories_core: Vec<kreuzberg::PiiCategory> = categories
        .and_then(|s| serde_json::from_str::<Vec<kreuzberg::PiiCategory>>(&s).ok())
        .unwrap_or_default();
...
/// `result.llm_usage`.
#[rustler::nif(schedule = "DirtyCpu")]
pub fn translate_result_async(result: Option<String>, config: TranslationConfig) -> Result<(), String> {
    let result_core: Option<kreuzberg::ExtractionResult> = result
        .map(|s| serde_json::from_str::<kreuzberg::ExtractionResult>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        kreuzberg::text::translation::translate_result(&mut result_mut, &config.clone().into()).await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result)
            })
...
#[rustler::nif]
pub fn chunk_for_rag(text: String, config: Option<String>) -> Result<ChunkingResult, String> {
    let config_core: Option<kreuzberg::ChunkingConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::ChunkingConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = kreuzberg::chunking::chunk_for_rag(&text, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
/// ```
#[rustler::nif]
pub fn compare(a: Option<String>, b: Option<String>, opts: Option<String>) -> ExtractionDiff {
    let a_core: Option<kreuzberg::ExtractionResult> =
        a.and_then(|s| serde_json::from_str::<kreuzberg::ExtractionResult>(&s).ok());
    let b_core: Option<kreuzberg::ExtractionResult> =
        b.and_then(|s| serde_json::from_str::<kreuzberg::ExtractionResult>(&s).ok());
    let opts_core: Option<kreuzberg::DiffOptions> =
        opts.and_then(|s| serde_json::from_str::<kreuzberg::DiffOptions>(&s).ok());
    kreuzberg::compare(
        a_core.as_ref().unwrap_or(&Default::default()),
        b_core.as_ref().unwrap_or(&Default::default()),
        opts_core.as_ref().unwrap_or(&Default::default()),
    )
    .into()
}
...
/// ```
#[rustler::nif(schedule = "DirtyCpu")]
pub fn extract_region_with_vlm_async(
    image_bytes: rustler::Binary,
    image_mime: String,
    region_kind: RegionKind,
    llm_config: Option<String>,
    custom_prompt: Option<String>,
) -> Result<String, String> {
    let image_bytes: Vec<u8> = image_bytes.as_slice().to_vec();
    let llm_config_core: Option<kreuzberg::LlmConfig> = llm_config
                ...
                let result = rt
                    .block_on(async {
                        kreuzberg::llm::region_extractor::extract_region_with_vlm(
                            ...
                            &image_mime,
                            region_kind.into(),
                            llm_config_core.as_ref().unwrap_or(&Default::default()),
...
pub fn rerank_async(
    ...
    let config_core: Option<kreuzberg::RerankerConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::RerankerConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        kreuzberg::rerank_async(query, documents, config_core.as_ref().unwrap_or(&Default::default()))
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into_iter().map(Into::into).collect())
...
pub fn extract_keywords(text: String, config: Option<String>) -> Result<Vec<Keyword>, String> {
    let config_core: Option<kreuzberg::KeywordConfig> = config
        ...
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = kreuzberg::keywords::extract_keywords(&text, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
...
pub fn analyze_document(
    ...
    config: Option<String>,
    document_bytes: Option<rustler::Binary>,
) -> Result<ChunkingDecision, String> {
    let config_core: Option<kreuzberg::HeuristicsConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::HeuristicsConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = kreuzberg::analyze_document(
        &metadata.clone().into(),
        config_core.as_ref().unwrap_or(&Default::default()),
        document_bytes.map(|b| b.as_slice()),
    )
    .map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn analyze_with_user_chunks(
    user_ranges: Option<String>,
    total_pages: u32,
    size_bytes: u64,
    config: Option<String>,
) -> ChunkingDecision {
    let user_ranges_core: Vec<kreuzberg::PageRange> = user_ranges
        .and_then(|s| serde_json::from_str::<Vec<kreuzberg::PageRange>>(&s).ok())
        .unwrap_or_default();
    let config_core: Option<kreuzberg::HeuristicsConfig> =
        config.and_then(|s| serde_json::from_str::<kreuzberg::HeuristicsConfig>(&s).ok());
...
#[rustler::nif]
pub fn score_confidence(signals: ConfidenceSignals, weights: Option<String>) -> ExtractionConfidence {
    let weights_core: Option<kreuzberg::ConfidenceWeights> =
        weights.and_then(|s| serde_json::from_str::<kreuzberg::ConfidenceWeights>(&s).ok());
    kreuzberg::score_confidence(signals.into(), weights_core.unwrap_or_default()).into()
}
...
#[rustler::nif]
pub fn boundaries_from_extraction_result(result: Option<String>, thresholds: Option<String>) -> Vec<DocumentBoundary> {
    let result_core: Option<kreuzberg::ExtractionResult> =
        result.and_then(|s| serde_json::from_str::<kreuzberg::ExtractionResult>(&s).ok());
    let thresholds_core: Option<kreuzberg::MultidocThresholds> =
        thresholds.and_then(|s| serde_json::from_str::<kreuzberg::MultidocThresholds>(&s).ok());
    kreuzberg::boundaries_from_extraction_result(
        result_core.as_ref().unwrap_or(&Default::default()),
        thresholds_core.as_ref().unwrap_or(&Default::default()),
    )
    .into_iter()
    .map(Into::into)
    .collect()
...
#[rustler::nif]
pub fn detect_boundaries(input: MultidocInput, thresholds: Option<String>) -> Vec<DocumentBoundary> {
    let thresholds_core: Option<kreuzberg::MultidocThresholds> =
        thresholds.and_then(|s| serde_json::from_str::<kreuzberg::MultidocThresholds>(&s).ok());
    kreuzberg::detect_boundaries(
        &input.clone().into(),
        thresholds_core.as_ref().unwrap_or(&Default::default()),
    )
    .into_iter()
...
///   `Skip`).
#[rustler::nif]
pub fn choose_call_mode(input: StructuredInput, t: Option<String>) -> StructuredCallMode {
    let t_core: Option<kreuzberg::StructuredThresholds> =
        t.and_then(|s| serde_json::from_str::<kreuzberg::StructuredThresholds>(&s).ok());
    kreuzberg::choose_call_mode(&input.clone().into(), t_core.as_ref().unwrap_or(&Default::default())).into()
}
...
#[rustler::nif]
pub fn calculate_chunk_plan(page_count: u32, size_bytes: u64, needs_ocr: bool, config: Option<String>) -> ChunkPlan {
    let config_core: Option<kreuzberg::HeuristicsConfig> =
        config.and_then(|s| serde_json::from_str::<kreuzberg::HeuristicsConfig>(&s).ok());
    kreuzberg::calculate_chunk_plan(
        page_count,
        size_bytes,
        needs_ocr,
        config_core.as_ref().unwrap_or(&Default::default()),
...
pub fn calculate_plan_from_overrides(
    user_chunks: Option<String>,
    total_pages: u32,
    size_bytes: u64,
    config: Option<String>,
) -> ChunkPlan {
    let user_chunks_core: Vec<kreuzberg::PageRange> = user_chunks
        .and_then(|s| serde_json::from_str::<Vec<kreuzberg::PageRange>>(&s).ok())
        .unwrap_or_default();
    let config_core: Option<kreuzberg::HeuristicsConfig> =
        config.and_then(|s| serde_json::from_str::<kreuzberg::HeuristicsConfig>(&s).ok());
...
#[rustler::nif]
pub fn fingerprint(raw: rustler::Binary) -> String {
    kreuzberg::presets::loader::fingerprint(raw.as_slice())
}
...
pub fn resolve(
    ...
    let preset_core: kreuzberg::Preset = serde_json::from_str(&preset_json).map_err(|e| e.to_string())?;
    let custom_schema_json: Option<serde_json::Value> = custom_schema
        .map(|s| serde_json::from_str(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let __context_btree = context.into_iter().collect::<std::collections::BTreeMap<_, _>>();
    let result = kreuzberg::resolve(&preset_core, custom_schema_json, &__context_btree).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn extract_structured_json(
    ...
    let result = kreuzberg::extract_structured_json(bytes.as_slice(), &mime, &preset_spec_json, &options_json)
        .map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn split_and_extract_json(
    ...
    let result = kreuzberg::split_and_extract_json(bytes.as_slice(), &mime, &preset_spec_json, &options_json)
        .map_err(|e| e.to_string())?;
    Ok(result)
}
...
#[rustler::nif]
pub fn pdf_page_count(pdf_bytes: rustler::Binary, password: Option<String>) -> Result<usize, String> {
    let result = kreuzberg::pdf_page_count(pdf_bytes.as_slice(), password.as_deref()).map_err(|e| e.to_string())?;
    Ok(result)
}
...
/// ```
#[rustler::nif(schedule = "DirtyCpu")]
pub fn caption_image_file_async(
    path: String,
    llm_config: Option<String>,
    custom_prompt: Option<String>,
) -> Result<String, String> {
...
#[rustler::nif(schedule = "DirtyCpu")]
pub fn embed_texts_async(_texts: Vec<String>, _config: Option<String>) -> Result<Vec<Vec<f32>>, String> {
    let _config_core: Option<kreuzberg::EmbeddingConfig> = _config
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        kreuzberg::embed_texts_async(_texts, _config_core.as_ref().unwrap_or(&Default::default())).await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result)
            })
...
#[rustler::nif]
pub fn get_embedding_preset(_name: String) -> Option<EmbeddingPreset> {
    kreuzberg::get_embedding_preset(&_name).map(|v| v.into())
}
...
/// Since v5.0.0.
#[rustler::nif]
pub fn rerank(query: String, documents: Vec<String>, config: Option<String>) -> Result<Vec<RerankedDocument>, String> {
    let config_core: Option<kreuzberg::RerankerConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::RerankerConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = kreuzberg::rerank(query, documents, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
...
pub fn rerank(
    ...
    let _config_core: Option<kreuzberg::RerankerConfig> = _config
        .map(|s| serde_json::from_str::<kreuzberg::RerankerConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = kreuzberg::rerank(_query, _documents, _config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        kreuzberg::rerank_async(
                            _query,
                            _documents,
                            _config_core.as_ref().unwrap_or(&Default::default()),
                        )
                        .await
                    })
                    .map_err(|e| e.to_string())?;
...
pub fn get_reranker_preset(name: String) -> Option<RerankerPreset> {
    kreuzberg::get_reranker_preset(&name).map(|v| v.into())
}
...
/// Since v5.0.0.
#[rustler::nif]
pub fn get_reranker_preset(_name: String) -> Option<RerankerPreset> {
    kreuzberg::get_reranker_preset(&_name).map(|v| v.into())
}
...
impl kreuzberg::OcrBackend for RustlerOcrBackendBridge {
...
pub fn register_ocr_backend(
    ...
    let wrapper = RustlerOcrBackendBridge::new(genserver_pid, plugin_name);
    let arc: std::sync::Arc<dyn kreuzberg::OcrBackend> = std::sync::Arc::new(wrapper);

    match kreuzberg::plugins::registry::get_ocr_backend_registry()
        .write()
        .register(arc)
    {
...
#[async_trait::async_trait]
impl kreuzberg::PostProcessor for RustlerPostProcessorBridge {
    async fn process(
        &self,
        ...
        let pid = self.inner;
        let result_arg = ExtractionResult::from((*result).clone());
...
pub fn register_post_processor(
    ...
    let wrapper = RustlerPostProcessorBridge::new(genserver_pid, plugin_name);
    let arc: std::sync::Arc<dyn kreuzberg::PostProcessor> = std::sync::Arc::new(wrapper);

    match kreuzberg::plugins::registry::get_post_processor_registry()
        .write()
        .register(arc)
    {
        Ok(_) => rustler::types::atom::Atom::from_str(env, "ok").unwrap(),
...
#[async_trait::async_trait]
impl kreuzberg::Validator for RustlerValidatorBridge {
    async fn validate(
        &self,
...
pub fn register_validator(
    ...
    let wrapper = RustlerValidatorBridge::new(genserver_pid, plugin_name);
    let arc: std::sync::Arc<dyn kreuzberg::Validator> = std::sync::Arc::new(wrapper);

    match kreuzberg::plugins::registry::get_validator_registry()
        .write()
        .register(arc)
    {
        Ok(_) => rustler::types::atom::Atom::from_str(env, "ok").unwrap(),
...
#[async_trait::async_trait]
impl kreuzberg::EmbeddingBackend for RustlerEmbeddingBackendBridge {
...
pub fn register_embedding_backend(
    ...
    let wrapper = RustlerEmbeddingBackendBridge::new(genserver_pid, plugin_name);
    let arc: std::sync::Arc<dyn kreuzberg::EmbeddingBackend> = std::sync::Arc::new(wrapper);

    match kreuzberg::plugins::registry::get_embedding_backend_registry()
        .write()
        .register(arc)
    {
        Ok(_) => rustler::types::atom::Atom::from_str(env, "ok").unwrap(),
...
#[async_trait::async_trait]
impl kreuzberg::DocumentExtractor for RustlerDocumentExtractorBridge {
    async fn extract_bytes(
        ...
        let pid = self.inner;
        let content_arg = format!("{:?}", content);
        let mime_type_arg = mime_type.to_string();
        let config_arg = ExtractionConfig::from((*config).clone());
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let _ = env.send_and_clear(&pid, |env| {
                let mut args_map = rustler::Term::map_new(env);
                args_map = args_map
                    .map_put("content".encode(env), content_arg.encode(env))
                    .expect("map_put");
                args_map = args_map
                    .map_put("mime_type".encode(env), mime_type_arg.encode(env))
                    .expect("map_put");
                args_map = args_map
                    .map_put("config".encode(env), config_arg.encode(env))
                    .expect("map_put");
...
pub fn register_document_extractor(
    ...
    let wrapper = RustlerDocumentExtractorBridge::new(genserver_pid, plugin_name);
    let arc: std::sync::Arc<dyn kreuzberg::DocumentExtractor> = std::sync::Arc::new(wrapper);

    match kreuzberg::plugins::registry::get_document_extractor_registry()
        .write()
        .register(arc)
    {
        Ok(_) => rustler::types::atom::Atom::from_str(env, "ok").unwrap(),
...
impl kreuzberg::Renderer for RustlerRendererBridge {
    fn render(&self, doc: &kreuzberg::InternalDocument) -> std::result::Result<String, kreuzberg::KreuzbergError> {
        ...
        drop(tokio::task::spawn_blocking(move || {
            ...
            let _ = env.send_and_clear(&pid, |env| {
                let mut args_map = rustler::Term::map_new(env);
                args_map = args_map
                    .map_put("doc".encode(env), doc_arg.encode(env))
                    .expect("map_put");
                (
                    rustler::types::atom::Atom::from_str(env, "trait_call").unwrap(),
                    method,
...
pub fn register_renderer(
    ...
    let wrapper = RustlerRendererBridge::new(genserver_pid, plugin_name);
    let arc: std::sync::Arc<dyn kreuzberg::Renderer> = std::sync::Arc::new(wrapper);

    match kreuzberg::plugins::registry::get_renderer_registry()
        .write()
        .register(arc)
    {
        Ok(_) => rustler::types::atom::Atom::from_str(env, "ok").unwrap(),
...
impl kreuzberg::plugins::Plugin for RustlerRerankerBackendBridge {
    fn name(&self) -> &str {
        &self.cached_name
    }
...
#[async_trait::async_trait]
impl kreuzberg::RerankerBackend for RustlerRerankerBackendBridge {
    async fn rerank(
        &self,
        query: String,
        documents: Vec<String>,
...
pub fn register_reranker_backend(
    ...
    let wrapper = RustlerRerankerBackendBridge::new(genserver_pid, plugin_name);
    let arc: std::sync::Arc<dyn kreuzberg::RerankerBackend> = std::sync::Arc::new(wrapper);

    match kreuzberg::plugins::registry::get_reranker_backend_registry()
        .write()
        .register(arc)
    {
        Ok(_) => rustler::types::atom::Atom::from_str(env, "ok").unwrap(),
...
pub fn unregister_reranker_backend(env: rustler::Env<'_>, name: String) -> rustler::Atom {
    match kreuzberg::plugins::reranker_backend::unregister_reranker_backend(&name) {
        Ok(_) => rustler::types::atom::Atom::from_str(env, "ok").unwrap(),
        Err(_) => rustler::types::atom::Atom::from_str(env, "error").unwrap(),
    }
}
...
pub fn clear_reranker_backends(env: rustler::Env<'_>) -> rustler::Atom {
    match kreuzberg::plugins::reranker_backend::clear_reranker_backends() {
        Ok(_) => rustler::types::atom::Atom::from_str(env, "ok").unwrap(),
        Err(_) => rustler::types::atom::Atom::from_str(env, "error").unwrap(),
    }
}
...
pub fn extractionconfig_needs_image_data(obj: ExtractionConfig) -> bool {
    kreuzberg::ExtractionConfig::from(obj).needs_image_data()
}
...
pub fn redactionconfig_validate(obj: RedactionConfig) -> Result<(), String> {
    let result = kreuzberg::RedactionConfig::from(obj)
        .validate()
        .map_err(|e| e.to_string())?;
    Ok(result)
}
...
#[rustler::nif]
pub fn llmbackend_new(config: Option<String>) -> ResourceArc<LlmBackend> {
    let config_core: Option<kreuzberg::LlmConfig> =
        config.and_then(|s| serde_json::from_str::<kreuzberg::LlmConfig>(&s).ok());
    ResourceArc::new(LlmBackend {
        inner: Arc::new(kreuzberg::LlmBackend::new(config_core.unwrap_or_default())),
    })
}

#[rustler::nif(schedule = "DirtyCpu")]
pub fn llmbackend_detect_async(
    resource: rustler::ResourceArc<LlmBackend>,
    text: String,
    categories: Vec<EntityCategory>,
) -> Result<Vec<Entity>, String> {
    Err(String::from("Not implemented: llmbackend_detect_async"))
}

#[rustler::nif(schedule = "DirtyCpu")]
pub fn llmbackend_detect_with_custom_async(
    resource: rustler::ResourceArc<LlmBackend>,
    text: String,
    categories: Vec<EntityCategory>,
    custom_labels: Vec<String>,
) -> Result<Vec<Entity>, String> {
    Err(String::from("Not implemented: llmbackend_detect_with_custom_async"))
}
...
pub fn footnoteconfig_with_parse_citations(obj: FootnoteConfig, enabled: bool) -> FootnoteConfig {
    kreuzberg::FootnoteConfig::from(obj)
...
#[rustler::nif]
pub fn confidencesignals_from_extraction_result(
    ...
    kreuzberg::ConfidenceSignals::from_extraction_result(
        result_core.as_ref().unwrap_or(&Default::default()),
        schema_compliance_core,
        text_coverage,
    )
    .into()
}
...
#[rustler::nif]
pub fn confidenceweights_default() -> ConfidenceWeights {
    kreuzberg::ConfidenceWeights::default().into()
}

/// Validate that weights sum to approximately 1.0.
#[rustler::nif]
pub fn confidenceweights_is_normalized(obj: ConfidenceWeights) -> bool {
    kreuzberg::ConfidenceWeights::from(obj).is_normalized()
}
...
pub fn heuristicsconfig_validate(obj: HeuristicsConfig) -> Result<(), String> {
    let result = kreuzberg::HeuristicsConfig::from(obj)
        .validate()
        .map_err(|e| e.to_string())?;
    Ok(result)
}
...
#[rustler::nif]
pub fn structuredthresholds_default() -> StructuredThresholds {
...
pub fn metaschema_compile(meta_schema_json: String) -> Result<ResourceArc<MetaSchema>, String> {
    let result = kreuzberg::MetaSchema::compile(&meta_schema_json).map_err(|e| e.to_string())?;
...
pub fn registry_load_embedded() -> Result<ResourceArc<Registry>, String> {
    let result = kreuzberg::Registry::load_embedded().map_err(|e| e.to_string())?;
...
pub fn registry_global() -> ResourceArc<Registry> {
    ResourceArc::new(Registry {
        inner: Arc::new(kreuzberg::Registry::global().clone()),
    })
}
...
pub fn registry_get(resource: rustler::ResourceArc<Registry>, id: String) -> Option<Preset> {
    resource.inner.as_ref().get(&id).map(|v| v.clone().into())
}
...
pub fn registry_extend_from_dir(resource: rustler::ResourceArc<Registry>, dir: String) -> Result<usize, String> {
    Err(String::from("Not implemented: registry_extend_from_dir"))
}
...
impl From<ImageOutputFormat> for kreuzberg::core::config::extraction::ImageOutputFormat {
    fn from(val: ImageOutputFormat) -> Self {
        match val {
            ...
            ImageOutputFormat::Webp { quality } => Self::Webp { quality },
            ImageOutputFormat::Heif { quality } => Self::Heif { quality },
...
impl From<kreuzberg::core::config::extraction::ImageOutputFormat> for ImageOutputFormat {
    fn from(val: kreuzberg::core::config::extraction::ImageOutputFormat) -> Self {
        match val {
            kreuzberg::core::config::extraction::ImageOutputFormat::Native => Self::Native,
            kreuzberg::core::config::extraction::ImageOutputFormat::Png => Self::Png,
            kreuzberg::core::config::extraction::ImageOutputFormat::Jpeg { quality } => Self::Jpeg { quality },
            kreuzberg::core::config::extraction::ImageOutputFormat::Webp { quality } => Self::Webp { quality },
            kreuzberg::core::config::extraction::ImageOutputFormat::Heif { quality } => Self::Heif { quality },
            kreuzberg::core::config::extraction::ImageOutputFormat::Svg => Self::Svg,
        }
    }
}
...
impl From<OutputFormat> for kreuzberg::OutputFormat {
    fn from(val: OutputFormat) -> Self {
        match val.format_type.as_str() {
            ...
            "custom" => kreuzberg::OutputFormat::Custom(val.custom.unwrap_or_default()),
            _ => Default::default(),
        }
    }
}
...
impl From<VlmFallbackPolicy> for kreuzberg::VlmFallbackPolicy {
    fn from(val: VlmFallbackPolicy) -> Self {
        match val {
            ...
            VlmFallbackPolicy::OnLowQuality { quality_threshold } => Self::OnLowQuality { quality_threshold },
...
impl From<kreuzberg::VlmFallbackPolicy> for VlmFallbackPolicy {
    fn from(val: kreuzberg::VlmFallbackPolicy) -> Self {
        match val {
            ...
            kreuzberg::VlmFallbackPolicy::OnLowQuality { quality_threshold } => {
                Self::OnLowQuality { quality_threshold }
            }
...
impl From<kreuzberg::EmbeddingModelType> for EmbeddingModelType {
    fn from(val: kreuzberg::EmbeddingModelType) -> Self {
        match val {
            kreuzberg::EmbeddingModelType::Preset { name } => Self::Preset { name: name.to_string() },
            ...
            kreuzberg::EmbeddingModelType::Plugin { name } => Self::Plugin { name: name.to_string() },
        }
    }
}
...
impl From<RerankerModelType> for kreuzberg::RerankerModelType {
    fn from(val: RerankerModelType) -> Self {
        match val {
            RerankerModelType::Preset { name } => Self::Preset { name },
...
impl From<kreuzberg::RerankerModelType> for RerankerModelType {
    fn from(val: kreuzberg::RerankerModelType) -> Self {
        match val {
            kreuzberg::RerankerModelType::Preset { name } => Self::Preset { name: name.to_string() },
            ...
            kreuzberg::RerankerModelType::Llm { llm } => Self::Llm { llm: llm.into() },
            kreuzberg::RerankerModelType::Plugin { name } => Self::Plugin { name: name.to_string() },
        }
    }
}
...
impl From<kreuzberg::NodeContent> for NodeContent {
    fn from(val: kreuzberg::NodeContent) -> Self {
        match val {
            kreuzberg::NodeContent::Title { text } => Self::Title { text: text.to_string() },
            kreuzberg::NodeContent::Heading { level, text } => Self::Heading {
                level,
                text: text.to_string(),
            },
            kreuzberg::NodeContent::Paragraph { text } => Self::Paragraph { text: text.to_string() },
            kreuzberg::NodeContent::List { ordered } => Self::List { ordered },
            kreuzberg::NodeContent::ListItem { text } => Self::ListItem { text: text.to_string() },
            ...
            kreuzberg::NodeContent::Formula { text } => Self::Formula { text: text.to_string() },
            kreuzberg::NodeContent::Footnote { text } => Self::Footnote { text: text.to_string() },
...
impl From<kreuzberg::AnnotationKind> for AnnotationKind {
    fn from(val: kreuzberg::AnnotationKind) -> Self {
        match val {
            ...
            kreuzberg::AnnotationKind::Color { value } => Self::Color {
                value: value.to_string(),
            },
            kreuzberg::AnnotationKind::FontSize { value } => Self::FontSize {
                value: value.to_string(),
            },
...
impl From<kreuzberg::EntityCategory> for EntityCategory {
    fn from(val: kreuzberg::EntityCategory) -> Self {
        match val {
            kreuzberg::EntityCategory::Person => Self {
                format_type: "person".to_string(),
                ..Default::default()
            },
            kreuzberg::EntityCategory::Organization => Self {
                format_type: "organization".to_string(),
                ..Default::default()
            },
            kreuzberg::EntityCategory::Location => Self {
                format_type: "location".to_string(),
                ..Default::default()
            },
            kreuzberg::EntityCategory::Date => Self {
                format_type: "date".to_string(),
                ..Default::default()
            },
            kreuzberg::EntityCategory::Time => Self {
                format_type: "time".to_string(),
                ..Default::default()
            },
            kreuzberg::EntityCategory::Money => Self {
                format_type: "money".to_string(),
                ..Default::default()
            },
            kreuzberg::EntityCategory::Percent => Self {
                format_type: "percent".to_string(),
                ..Default::default()
            },
            kreuzberg::EntityCategory::Email => Self {
                format_type: "email".to_string(),
                ..Default::default()
            },
            kreuzberg::EntityCategory::Phone => Self {
                format_type: "phone".to_string(),
                ..Default::default()
            },
            kreuzberg::EntityCategory::Url => Self {
                format_type: "url".to_string(),
                ..Default::default()
            },
            kreuzberg::EntityCategory::Custom(_0) => Self {
                format_type: "custom".to_string(),
                custom: Some(_0),
            },
        }
...
impl From<EntityCategory> for kreuzberg::EntityCategory {
    fn from(val: EntityCategory) -> Self {
        match val.format_type.as_str() {
            ...
            "custom" => kreuzberg::EntityCategory::Custom(val.custom.unwrap_or_default()),
            _ => Default::default(),
        }
    }
}
...
impl From<FormatMetadata> for kreuzberg::FormatMetadata {
    fn from(val: FormatMetadata) -> Self {
        match val.format_type.as_str() {
            ...
            "audio" => kreuzberg::FormatMetadata::Audio(val.audio.unwrap_or_default().into()),
...
impl From<kreuzberg::PiiCategory> for PiiCategory {
    fn from(val: kreuzberg::PiiCategory) -> Self {
        match val {
            kreuzberg::PiiCategory::Email => Self {
                format_type: "email".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::Phone => Self {
                format_type: "phone".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::Ssn => Self {
                format_type: "ssn".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::CreditCard => Self {
                format_type: "credit_card".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::PostalCode => Self {
                format_type: "postal_code".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::IpAddress => Self {
                format_type: "ip_address".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::Iban => Self {
                format_type: "iban".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::SwiftBic => Self {
                format_type: "swift_bic".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::DateOfBirth => Self {
                format_type: "date_of_birth".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::Person => Self {
                format_type: "person".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::Organization => Self {
                format_type: "organization".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::Location => Self {
                format_type: "location".to_string(),
                ..Default::default()
            },
            kreuzberg::PiiCategory::Custom(_0) => Self {
                format_type: "custom".to_string(),
                custom: Some(_0),
            },
        }
...
impl From<PiiCategory> for kreuzberg::PiiCategory {
    fn from(val: PiiCategory) -> Self {
        match val.format_type.as_str() {
            ...
            "custom" => kreuzberg::PiiCategory::Custom(val.custom.unwrap_or_default()),
            _ => Default::default(),
        }
    }
}
...
impl From<RevisionAnchor> for kreuzberg::RevisionAnchor {
    fn from(val: RevisionAnchor) -> Self {
        match val {
            RevisionAnchor::Paragraph { index } => Self::Paragraph { index },
            RevisionAnchor::TableCell { row, col, table_index } => Self::TableCell { row, col, table_index },
            RevisionAnchor::Page { index } => Self::Page { index },
            RevisionAnchor::Slide { index } => Self::Slide { index },
            RevisionAnchor::Sheet { index, name } => Self::Sheet { index, name },
        }
    }
}
...
impl From<kreuzberg::RevisionAnchor> for RevisionAnchor {
    fn from(val: kreuzberg::RevisionAnchor) -> Self {
        match val {
            kreuzberg::RevisionAnchor::Paragraph { index } => Self::Paragraph { index },
            kreuzberg::RevisionAnchor::TableCell { row, col, table_index } => Self::TableCell { row, col, table_index },
            kreuzberg::RevisionAnchor::Page { index } => Self::Page { index },
            kreuzberg::RevisionAnchor::Slide { index } => Self::Slide { index },
            kreuzberg::RevisionAnchor::Sheet { index, name } => Self::Sheet {
                index,
...
impl From<kreuzberg::enrichment::EnrichStatus> for EnrichStatus {
    fn from(val: kreuzberg::enrichment::EnrichStatus) -> Self {
        match val {
            kreuzberg::enrichment::EnrichStatus::Pending => Self::Pending,
            kreuzberg::enrichment::EnrichStatus::Completed { result } => Self::Completed { result: result.into() },
            kreuzberg::enrichment::EnrichStatus::Failed { error } => Self::Failed {
...
impl From<ChunkingDecision> for kreuzberg::ChunkingDecision {
    fn from(val: ChunkingDecision) -> Self {
        match val {
            ChunkingDecision::NoChunking { reason } => Self::NoChunking { reason: reason.into() },
            ChunkingDecision::Chunk { _0 } => Self::Chunk(_0.into()),
            ChunkingDecision::UseOverrides { user_chunks } => Self::UseOverrides {
                user_chunks: user_chunks.into_iter().map(Into::into).collect(),
            },
        }
    }
}
...
impl From<kreuzberg::ChunkingDecision> for ChunkingDecision {
    fn from(val: kreuzberg::ChunkingDecision) -> Self {
        match val {
            kreuzberg::ChunkingDecision::NoChunking { reason } => Self::NoChunking { reason: reason.into() },
            kreuzberg::ChunkingDecision::Chunk(_0) => Self::Chunk { _0: _0.into() },
            kreuzberg::ChunkingDecision::UseOverrides { user_chunks } => Self::UseOverrides {
                user_chunks: user_chunks.into_iter().map(Into::into).collect(),
            },
        }
    }
...
impl From<NoChunkingReason> for kreuzberg::NoChunkingReason {
    fn from(val: NoChunkingReason) -> Self {
        match val {
            ...
            NoChunkingReason::FewPages { page_count, threshold } => Self::FewPages { page_count, threshold },
            ...
            NoChunkingReason::FormatNotChunkable { mime_type } => Self::FormatNotChunkable { mime_type },
            NoChunkingReason::ChunkingDisabled => Self::ChunkingDisabled,
            NoChunkingReason::FastTextExtraction => Self::FastTextExtraction,
        }
    }
}
...
impl From<kreuzberg::NoChunkingReason> for NoChunkingReason {
    fn from(val: kreuzberg::NoChunkingReason) -> Self {
        match val {
            kreuzberg::NoChunkingReason::SmallFile {
                size_bytes,
                threshold_bytes,
            } => Self::SmallFile {
                size_bytes,
            ...
            kreuzberg::NoChunkingReason::FewPages { page_count, threshold } => Self::FewPages { page_count, threshold },
            kreuzberg::NoChunkingReason::TextLayerDetected {
                text_coverage,
                avg_chars_per_page,
            } => Self::TextLayerDetected {
                text_coverage,
            ...
            kreuzberg::NoChunkingReason::FormatNotChunkable { mime_type } => Self::FormatNotChunkable {
                mime_type: mime_type.to_string(),
            },
            kreuzberg::NoChunkingReason::ChunkingDisabled => Self::ChunkingDisabled,
            kreuzberg::NoChunkingReason::FastTextExtraction => Self::FastTextExtraction,
        }
    }
}
...
impl From<ChunkingReason> for kreuzberg::ChunkingReason {
    fn from(val: ChunkingReason) -> Self {
        match val {
            ...
            ChunkingReason::ManyPages { page_count, threshold } => Self::ManyPages { page_count, threshold },
            ChunkingReason::OcrRequired { page_count, force_ocr } => Self::OcrRequired { page_count, force_ocr },
            ChunkingReason::LargeAndManyPages { size_bytes, page_count } => {
                Self::LargeAndManyPages { size_bytes, page_count }
            }
        }
    }
}
...
impl From<kreuzberg::ChunkingReason> for ChunkingReason {
    fn from(val: kreuzberg::ChunkingReason) -> Self {
        match val {
            kreuzberg::ChunkingReason::LargeFile {
                size_bytes,
                threshold_bytes,
            } => Self::LargeFile {
                size_bytes,
            ...
            kreuzberg::ChunkingReason::ManyPages { page_count, threshold } => Self::ManyPages { page_count, threshold },
            kreuzberg::ChunkingReason::OcrRequired { page_count, force_ocr } => {
                Self::OcrRequired { page_count, force_ocr }
            }
            kreuzberg::ChunkingReason::LargeAndManyPages { size_bytes, page_count } => {
                Self::LargeAndManyPages { size_bytes, page_count }
            }
        }
    }
...
/// Convert a `kreuzberg::heuristics::error::HeuristicsError` error to a Rustler error string.
#[allow(dead_code)]
fn heuristics_error_to_rustler_err(e: kreuzberg::heuristics::error::HeuristicsError) -> String {
    e.to_string()
}

/// Convert a `kreuzberg::presets::loader::LoadError` error to a Rustler error string.
#[allow(dead_code)]
fn load_error_to_rustler_err(e: kreuzberg::presets::loader::LoadError) -> String {
    e.to_string()
}

/// Convert a `kreuzberg::presets::resolve::ResolveError` error to a Rustler error string.
#[allow(dead_code)]
fn resolve_error_to_rustler_err(e: kreuzberg::presets::resolve::ResolveError) -> String {
    e.to_string()
}
...
pub fn svg_options_from_json(json: String) -> Result<SvgOptions, String> {
    serde_json::from_str::<kreuzberg::core::config::extraction::SvgOptions>(&json)
        .map(SvgOptions::from)
        .map_err(|e| e.to_string())
}
...
pub fn footnote_config_from_json(json: String) -> Result<FootnoteConfig, String> {
    serde_json::from_str::<kreuzberg::FootnoteConfig>(&json)
...
pub fn footnote_anchor_from_json(json: String) -> Result<FootnoteAnchor, String> {
    serde_json::from_str::<kreuzberg::FootnoteAnchor>(&json)
        .map(FootnoteAnchor::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn footnote_definition_from_json(json: String) -> Result<FootnoteDefinition, String> {
    serde_json::from_str::<kreuzberg::FootnoteDefinition>(&json)
        .map(FootnoteDefinition::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn citation_from_json(json: String) -> Result<Citation, String> {
    serde_json::from_str::<kreuzberg::Citation>(&json)
        .map(Citation::from)
        .map_err(|e| e.to_string())
}
...
pub fn pdf_form_field_from_json(json: String) -> Result<PdfFormField, String> {
    serde_json::from_str::<kreuzberg::PdfFormField>(&json)
...
pub fn formula_from_json(json: String) -> Result<Formula, String> {
    serde_json::from_str::<kreuzberg::Formula>(&json)
        .map(Formula::from)
        .map_err(|e| e.to_string())
}
...
#[rustler::nif]
pub fn enrich_result_from_json(json: String) -> Result<EnrichResult, String> {
    serde_json::from_str::<kreuzberg::enrichment::EnrichResult>(&json)
        .map(EnrichResult::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn document_metadata_from_json(json: String) -> Result<DocumentMetadata, String> {
    serde_json::from_str::<kreuzberg::DocumentMetadata>(&json)
...
pub fn user_chunk_config_from_json(json: String) -> Result<UserChunkConfig, String> {
    serde_json::from_str::<kreuzberg::UserChunkConfig>(&json)
        .map(UserChunkConfig::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn confidence_signals_from_json(json: String) -> Result<ConfidenceSignals, String> {
    serde_json::from_str::<kreuzberg::ConfidenceSignals>(&json)
        .map(ConfidenceSignals::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn confidence_weights_from_json(json: String) -> Result<ConfidenceWeights, String> {
    serde_json::from_str::<kreuzberg::ConfidenceWeights>(&json)
        .map(ConfidenceWeights::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn extraction_confidence_from_json(json: String) -> Result<ExtractionConfidence, String> {
    serde_json::from_str::<kreuzberg::heuristics::ExtractionConfidence>(&json)
...
pub fn heuristics_config_from_json(json: String) -> Result<HeuristicsConfig, String> {
    serde_json::from_str::<kreuzberg::HeuristicsConfig>(&json)
        .map(HeuristicsConfig::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn chunk_plan_from_json(json: String) -> Result<ChunkPlan, String> {
    serde_json::from_str::<kreuzberg::ChunkPlan>(&json)
        .map(ChunkPlan::from)
        .map_err(|e| e.to_string())
}
...
pub fn chunk_info_from_json(json: String) -> Result<ChunkInfo, String> {
    serde_json::from_str::<kreuzberg::ChunkInfo>(&json)
        .map(ChunkInfo::from)
        .map_err(|e| e.to_string())
}
...
pub fn page_range_from_json(json: String) -> Result<PageRange, String> {
    serde_json::from_str::<kreuzberg::PageRange>(&json)
        .map(PageRange::from)
        .map_err(|e| e.to_string())
}
...
pub fn multidoc_input_from_json(json: String) -> Result<MultidocInput, String> {
    serde_json::from_str::<kreuzberg::MultidocInput>(&json)
        .map(MultidocInput::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn page_signals_from_json(json: String) -> Result<PageSignals, String> {
    serde_json::from_str::<kreuzberg::PageSignals>(&json)
...
pub fn document_boundary_from_json(json: String) -> Result<DocumentBoundary, String> {
    serde_json::from_str::<kreuzberg::DocumentBoundary>(&json)
        .map(DocumentBoundary::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn multidoc_thresholds_from_json(json: String) -> Result<MultidocThresholds, String> {
    serde_json::from_str::<kreuzberg::MultidocThresholds>(&json)
        .map(MultidocThresholds::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn structured_input_from_json(json: String) -> Result<StructuredInput, String> {
    serde_json::from_str::<kreuzberg::StructuredInput>(&json)
        .map(StructuredInput::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn structured_thresholds_from_json(json: String) -> Result<StructuredThresholds, String> {
    serde_json::from_str::<kreuzberg::StructuredThresholds>(&json)
        .map(StructuredThresholds::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn resolved_preset_from_json(json: String) -> Result<ResolvedPreset, String> {
    serde_json::from_str::<kreuzberg::ResolvedPreset>(&json)
        .map(ResolvedPreset::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn preset_sample_from_json(json: String) -> Result<PresetSample, String> {
    serde_json::from_str::<kreuzberg::PresetSample>(&json)
...
pub fn preset_from_json(json: String) -> Result<Preset, String> {
    serde_json::from_str::<kreuzberg::Preset>(&json)
        .map(Preset::from)
        .map_err(|e| e.to_string())
}
...
pub fn preset_summary_from_json(json: String) -> Result<PresetSummary, String> {
    serde_json::from_str::<kreuzberg::PresetSummary>(&json)
...
fn on_load(env: rustler::Env, _info: rustler::Term) -> bool {
    env.register::<LlmBackend>()
        .expect("Failed to register resource type LlmBackend");
