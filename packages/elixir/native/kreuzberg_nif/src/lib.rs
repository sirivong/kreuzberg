...
// alef:hash:34ba185f53f213ffedb6bab8a08ae1a40f5441f72f493b85749a5a1b49e6eee4
...
#[rustler::nif]
pub fn htmlmetadata_from(metadata: Option<String>) -> HtmlMetadata {
    let metadata_core: Option<kreuzberg::HtmlMetadata> =
        metadata.and_then(|s| serde_json::from_str::<kreuzberg::HtmlMetadata>(&s).ok());
    kreuzberg::HtmlMetadata::from(metadata_core.unwrap_or_default()).into()
}
...
impl From<ChunkMetadata> for kreuzberg::ChunkMetadata {
    fn from(val: ChunkMetadata) -> Self {
        Self {
            ...
            image_indices: val.image_indices,
        }
    }
}
