...
// alef:hash:f68c2effaba65726b14d841418ef72790ea67c763c986afd9ed3d8998449b719
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.ExtractedImageMetadata"]
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.EmbeddingPreset2"]
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.FormatMetadata2"]
...
impl From<kreuzberg::extraction::docx::drawing::DrawingType> for DrawingType {
    fn from(val: kreuzberg::extraction::docx::drawing::DrawingType) -> Self {
        match val {
            kreuzberg::extraction::docx::drawing::DrawingType::Inline => Self {
                format_type: "Inline".to_string(),
                ..Default::default()
            },
            kreuzberg::extraction::docx::drawing::DrawingType::Anchored(_0) => Self {
