...
// alef:hash:6d5dcd6f6e6def61a874e4fc65e7a122206bc18496f4fa0b22932250cacf628a
...
pub fn clear_ocr_backends() -> Result<(), String> {
    let result = kreuzberg::clear_ocr_backends().map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn clear_post_processors() -> Result<(), String> {
    let result = kreuzberg::clear_post_processors().map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn clear_validators() -> Result<(), String> {
    let result = kreuzberg::clear_validators().map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn tessdatamanager_is_language_cached(resource: rustler::ResourceArc<TessdataManager>, lang: String) -> bool {
    resource.inner.is_language_cached(&lang)
}
...
pub fn tessdatamanager_ensure_all_languages(resource: rustler::ResourceArc<TessdataManager>) -> Result<usize, String> {
    let result = resource.inner.ensure_all_languages().map_err(|e| e.to_string())?;
    Ok(result)
}
