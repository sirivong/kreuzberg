...
impl From<EntityCategory> for kreuzberg::EntityCategory {
    fn from(val: EntityCategory) -> Self {
        match val.format_type.as_str() {
            ...
            "custom" => kreuzberg::EntityCategory::Custom(val.custom.unwrap_or_default().into()),
            _ => Default::default(),
        }
    }
}
...
impl From<PiiCategory> for kreuzberg::PiiCategory {
    fn from(val: PiiCategory) -> Self {
        match val.format_type.as_str() {
            ...
            "custom" => kreuzberg::PiiCategory::Custom(val.custom.unwrap_or_default().into()),
            _ => Default::default(),
        }
    }
}
...
impl From<DiffLine> for kreuzberg::DiffLine {
    fn from(val: DiffLine) -> Self {
        match val.kind.as_str() {
            "context" => kreuzberg::DiffLine::Context(val.context.unwrap_or_default().into()),
            "added" => kreuzberg::DiffLine::Added(val.added.unwrap_or_default().into()),
            "removed" => kreuzberg::DiffLine::Removed(val.removed.unwrap_or_default().into()),
            _ => Default::default(),
        }
    }
}
