...
// alef:hash:15a4ef9f9332e2fe179949d9c49ac708cdef07188a74f83288b67e900b38656a
...
impl magnus::TryConvert for BatchBytesItem {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &BatchBytesItem = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl magnus::TryConvert for BatchFileItem {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &BatchFileItem = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl Default for TokenReductionOptions {
    fn default() -> Self {
        Self {
            ...
            preserve_important_words: Default::default(),
        }
    }
}
...
impl Default for LanguageDetectionConfig {
    fn default() -> Self {
        Self {
            ...
            detect_multiple: Default::default(),
        }
    }
}
...
impl magnus::TryConvert for EmbeddingPreset {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &EmbeddingPreset = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_method("sheet_count", method!(Metadata::sheet_count, 0))?;
    class.define_method("sheet_names", method!(Metadata::sheet_names, 0))?;
    class.define_method("additional", method!(Metadata::additional, 0))?;
    class.define_method("is_empty", method!(Metadata::is_empty, 0))?;

    let _class = module.define_class("ExcelMetadata", ruby.class_object())?;
