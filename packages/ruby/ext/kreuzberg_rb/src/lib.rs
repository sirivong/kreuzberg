...
// alef:hash:7efd828a3647643f6e40ed385be8944bf9d756f2190adba606014ac0dca4f1f8
...
impl AccelerationConfig {
    fn new(provider: ExecutionProviderType, device_id: u32) -> Self {
...
impl ContentFilterConfig {
    fn new(include_headers: bool, include_footers: bool, strip_repeating_text: bool, include_watermarks: bool) -> Self {
        Self {
            include_headers,
            include_footers,
...
impl BatchBytesItem {
    fn new(content: Vec<u8>, mime_type: String, config: Option<FileExtractionConfig>) -> Self {
        Self {
            content,
            mime_type,
            config,
...
impl BatchFileItem {
    fn new(path: String, config: Option<FileExtractionConfig>) -> Self {
        Self { path, config }
    }
...
impl PageConfig {
    fn new(extract_pages: bool, insert_page_markers: bool, marker_format: String) -> Self {
        Self {
            extract_pages,
            insert_page_markers,
            marker_format,
...
impl HierarchyConfig {
    fn new(enabled: bool, k_clusters: usize, include_bbox: bool, ocr_coverage_threshold: Option<f32>) -> Self {
        Self {
            enabled,
            k_clusters,
            include_bbox,
...
impl ResolvedStyle {
    fn new(paragraph_properties: String, run_properties: String) -> Self {
        Self {
            paragraph_properties,
            run_properties,
        }
...
impl Default for ImagePreprocessingConfig {
    fn default() -> Self {
        Self {
            ...
            binarization_method: String::from("otsu"),
            invert_colors: false,
        }
    }
}
...
impl Default for TesseractConfig {
    fn default() -> Self {
        Self {
            ...
            psm: 3,
            output_format: String::from("markdown"),
            oem: 3,
            min_confidence: Default::default(),
            preprocessing: None,
            ...
            tessedit_char_whitelist: String::from(""),
            tessedit_char_blacklist: String::from(""),
...
impl FictionBookMetadata {
    fn new(genres: Vec<String>, sequences: Vec<String>, annotation: Option<String>) -> Self {
        Self {
            genres,
            sequences,
            annotation,
...
impl DbfMetadata {
    fn new(record_count: usize, field_count: usize, fields: Vec<DbfFieldInfo>) -> Self {
        Self {
            record_count,
            field_count,
            fields,
...
impl OcrElementConfig {
    fn new(include_elements: bool, min_level: OcrElementLevel, min_confidence: f64, build_hierarchy: bool) -> Self {
        Self {
            include_elements,
            min_level,
            min_confidence,
...
impl LayoutRegion {
    fn new(class_name: String, confidence: f64, bounding_box: String, area_fraction: f64) -> Self {
        Self {
            class_name,
            confidence,
            bounding_box,
...
impl RakeParams {
    fn new(min_word_length: usize, max_words_per_phrase: usize) -> Self {
        Self {
            min_word_length,
...
impl OcrCacheStats {
    fn new(total_files: usize, total_size_mb: f64) -> Self {
        Self {
            total_files,
            total_size_mb,
        }
...
impl magnus::TryConvert for PdfImage {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        if let Ok(r) = <&PdfImage as magnus::TryConvert>::try_convert(val) {
            return Ok(r.clone());
        }
        let json_str: String = if let Ok(s) = <String as magnus::TryConvert>::try_convert(val) {
            s
            ...
            val.funcall::<_, _, String>("to_json", ()).map_err(|e| {
                magnus::Error::new(
                    unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                    format!("no implicit conversion into PdfImage: {}", e),
                )
            })?
        };
        serde_json::from_str::<PdfImage>(&json_str).map_err(|e| {
            magnus::Error::new(
                unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                format!("failed to deserialize PdfImage: {}", e),
            )
        })
    }
}
...
impl magnus::TryConvert for PageLayoutResult {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        if let Ok(r) = <&PageLayoutResult as magnus::TryConvert>::try_convert(val) {
            return Ok(r.clone());
        }
        let json_str: String = if let Ok(s) = <String as magnus::TryConvert>::try_convert(val) {
            s
            ...
            val.funcall::<_, _, String>("to_json", ()).map_err(|e| {
                magnus::Error::new(
                    unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                    format!("no implicit conversion into PageLayoutResult: {}", e),
                )
            })?
        };
        serde_json::from_str::<PageLayoutResult>(&json_str).map_err(|e| {
            magnus::Error::new(
                unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                format!("failed to deserialize PageLayoutResult: {}", e),
            )
        })
    }
}
...
impl magnus::TryConvert for PageTiming {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        if let Ok(r) = <&PageTiming as magnus::TryConvert>::try_convert(val) {
            return Ok(r.clone());
        }
        let json_str: String = if let Ok(s) = <String as magnus::TryConvert>::try_convert(val) {
            s
            ...
            val.funcall::<_, _, String>("to_json", ()).map_err(|e| {
                magnus::Error::new(
                    unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                    format!("no implicit conversion into PageTiming: {}", e),
                )
            })?
        };
        serde_json::from_str::<PageTiming>(&json_str).map_err(|e| {
            magnus::Error::new(
                unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                format!("failed to deserialize PageTiming: {}", e),
            )
        })
    }
}
...
fn extract_file(args: &[magnus::Value]) -> Result<ExtractionResult, Error> {
    let args =
        magnus::scan_args::scan_args::<(String,), (Option<String>, Option<magnus::Value>), (), (), (), ()>(args)?;
...
fn render_pdf_page_to_png(args: &[magnus::Value]) -> Result<Vec<u8>, Error> {
    let args = magnus::scan_args::scan_args::<(Vec<u8>, usize), (Option<i32>, Option<String>), (), (), (), ()>(args)?;
...
fn ruby_init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_singleton_method("new", function!(BatchBytesItem::new, 3))?;
    ...
    class.define_singleton_method("new", function!(BatchFileItem::new, 2))?;
    ...
    class.define_singleton_method("new", function!(DocumentStructure::new, 4))?;
    ...
    class.define_singleton_method("new", function!(PageInfo::new, 8))?;
    ...
    class.define_singleton_method("new", function!(EmbeddingPreset::new, 8))?;
