...
// alef:hash:c76b5b9aecfe49cd4371f9932f696f552546b925cd365cf41a830c3c189ae72d
...
impl CharShape {
    fn new(bold: bool, italic: bool, underline: bool) -> Self {
        Self {
            bold,
            italic,
            underline,
...
fn ruby_init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_singleton_method("new", function!(PdfConfig::new, 8))?;
    ...
    class.define_singleton_method("new", function!(CharShape::new, 3))?;
    ...
    class.define_singleton_method("new", function!(HwpImage::new, 2))?;
