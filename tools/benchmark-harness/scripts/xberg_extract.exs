...
debug = System.get_env("XBERG_BENCHMARK_DEBUG", "false") == "true"

defmodule XbergExtract do
  @moduledoc """
  Xberg extraction wrapper for benchmarking.
  """

  def debug_log(message) when is_binary(message) do
    if System.get_env("XBERG_BENCHMARK_DEBUG", "false") == "true" do
