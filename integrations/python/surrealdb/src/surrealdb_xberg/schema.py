...
def build_document_schema(*, table: str = "documents", analyzer_language: str = "english") -> list[str]:
    ...
    stmts.extend(
        [
            ...
            f"DEFINE FIELD IF NOT EXISTS detected_languages ON TABLE {table} TYPE option<array<string>>;",
            f"DEFINE FIELD IF NOT EXISTS keywords ON TABLE {table} TYPE option<array<string>>;",
            f"DEFINE FIELD IF NOT EXISTS summary ON TABLE {table} TYPE option<string>;",
            f"DEFINE FIELD IF NOT EXISTS entities ON TABLE {table} TYPE option<array>;",
            f"DEFINE FIELD IF NOT EXISTS entities[*] ON TABLE {table} TYPE object FLEXIBLE;",
            f"DEFINE FIELD IF NOT EXISTS tables ON TABLE {table} TYPE option<array>;",
            f"DEFINE FIELD IF NOT EXISTS tables[*] ON TABLE {table} TYPE object FLEXIBLE;",
