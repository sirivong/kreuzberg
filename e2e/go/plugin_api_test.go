...
func (testStub_register_ocr_backend_trait_bridge) BackendType() json.RawMessage { return nil }
...
func (testStub_register_post_processor_trait_bridge) ProcessingStage() json.RawMessage { return nil }
