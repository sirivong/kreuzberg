...
func (testStub_register_post_processor_trait_bridge) Process(resultArg kreuzberg.ExtractionResult, config kreuzberg.ExtractionConfig) error { return nil }
...
func (testStub_register_validator_trait_bridge) Validate(resultArg kreuzberg.ExtractionResult, config kreuzberg.ExtractionConfig) error { return nil }
