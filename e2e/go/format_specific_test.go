...
// alef:hash:003b5d5d6264e0d408f7daad0f94fac1530aeb6d0cde052588366d3c7eec5eef
...
func Test_FormatDocxStandalone(t *testing.T) {
	...
	dataBytes, dataBytesErr := os.ReadFile(`docx/fake.docx`)
	if dataBytesErr != nil {
		t.Fatalf("read fixture docx/fake.docx: %v", dataBytesErr)
	}
...
func Test_FormatPdfText(t *testing.T) {
	...
	dataBytes, dataBytesErr := os.ReadFile(`pdf/fake_memo.pdf`)
	if dataBytesErr != nil {
		t.Fatalf("read fixture pdf/fake_memo.pdf: %v", dataBytesErr)
	}
