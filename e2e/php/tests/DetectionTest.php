...
// alef:hash:0076c8313fbfa8e1ba772262bc15c52d56312680ff1231d272d3531250cfb3ff
...
final class DetectionTest extends TestCase
{
    ...
    public function test_detect_mime_bytes_html(): void
    {
        ...
        $result = Kreuzberg::detectMimeTypeFromBytes("html/html.html");
    }
    ...
    {
        $this->expectNotToPerformAssertions();
        $result = Kreuzberg::detectMimeTypeFromBytes("pdf/fake_memo.pdf");
    }
    ...
    {
        $this->expectNotToPerformAssertions();
        $result = Kreuzberg::detectMimeTypeFromBytes("images/test_hello_world.png");
    }
