...
final class PluginApiTest extends TestCase
{
    ...
    public function test_register_embedding_backend_trait_bridge(): void
    {
        $stub = new class implements \Xberg\EmbeddingBackend {
            ...
            public function embed($texts): mixed
            {
                return [];
            }
    ...
    public function test_register_ocr_backend_trait_bridge(): void
    {
        $stub = new class implements \Xberg\OcrBackend {
            ...
            public function process_image($image_bytes, $config): mixed
            {
                return '{}';
            }

            public function process_image_file($path, $config): mixed
            {
                return '{}';
            }

            public function supports_language($lang): bool
            {
                return false;
            }
            ...
            public function process_document($_path, $_config): mixed
            {
                return '{}';
            }
    ...
    public function test_register_post_processor_trait_bridge(): void
    {
        $stub = new class implements \Xberg\PostProcessor {
            ...
            public function process($result, $config): mixed
            {
                return null;
            }
            ...
            public function should_process($_result, $_config): bool
            {
                return false;
            }

            public function estimated_duration_ms($_result): int
            {
                return 1;
            }
    ...
    public function test_register_reranker_backend_trait_bridge(): void
    {
        $stub = new class implements \Xberg\RerankerBackend {
            ...
            public function rerank($query, $documents): mixed
            {
                return [];
            }
    ...
    public function test_register_validator_trait_bridge(): void
    {
        $stub = new class implements \Xberg\Validator {
            ...
            public function validate($result, $config): mixed
            {
                return null;
            }

            public function should_validate($_result, $_config): bool
            {
                return false;
            }
