...
// alef:hash:ea3f079320bbc3760807b48504d609b28f1dc25af001b25576d898780c98ced9
...
final class EmbeddingsTest extends TestCase
{
    ...
    {        $config = EmbeddingConfig::from_json(json_encode(["model" => ["name" => "multilingual", "type" => "preset"]]));
