...
// alef:hash:538bf0941f024a0d01cebabbc77d1e8fc23cd80acca350d41ba22d63e1e05248
...
final class SmokeTest extends TestCase
{
    ...
    {        $config = ExtractionConfig::from_json(json_encode(["disableOcr" => true]));
        $result = Kreuzberg::extractFile("images/sample.png", null, $config);

            $this->assertEquals("image/png", trim($result->mimeType));
            $this->assertEquals("PNG", trim($result->getMetadata()->format));
    ...
    {        $config = ExtractionConfig::from_json('{}');
        ...
        $metadataFormatExcelSheetNames = $result->getMetadata()->format->excel->sheetNames;
    ...
    $this->assertStringContainsString("TOR", $result->getContent());
            ...
            $found = false;
    foreach ($metadataFormatExcelSheetNames as $item) {
