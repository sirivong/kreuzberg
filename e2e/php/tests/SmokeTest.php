...
// alef:hash:b2c8ea9ddf4102c41a1bcff683410e0597675f03a847543f083b93d840f7ebea
...
final class SmokeTest extends TestCase
{
    ...
    $this->assertStringContainsString("TOR", $result->content);
            ...
            $this->assertGreaterThanOrEqual(2, $result->metadata->format->excel->sheetCount);
            $found = false;
    foreach ($result->metadata->format->excel->sheetNames as $item) {
