...
// alef:hash:78f4b4e68c415c8b214aa50a4f2200c208390e4022b5e9cd7d1ba97e9d875afd
...
final class SmokeTest extends TestCase
{
    ...
    public function test_smoke_xlsx_basic(): void
    {
        ...
        $this->assertGreaterThanOrEqual(2, $result->metadata->format->excel->sheet_count);
        $this->assertStringContainsString("Stanley Cups", json_encode($result->metadata->format->excel->sheet_names));
    }
}
