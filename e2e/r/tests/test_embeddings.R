...
test_that("embed_texts_different_preset: embed_texts: multilingual preset", {
  result <- embed_texts_async(texts = c("Hello world", "Test"), config = EmbeddingConfig$from_json(jsonlite::toJSON(list("model" = list("name" = "multilingual", "type" = "preset")), auto_unbox = TRUE)))
  expect_true(TRUE)
