...
// alef:hash:23390f5eeaea9ba0d8214b1e8ea9901a1d74733b8b7ec56a607cfc2eee3e79ff
...
// AFTER setupFiles complete, so this hook installs in time.
{
  ...
  const PatchedInstance = function (
    ...
    if (exportsMem instanceof WebAssembly.Memory) {
      (
        globalThis as unknown as { __kreuzberg_wasm_memory__?: WebAssembly.Memory }
      ).__kreuzberg_wasm_memory__ = exportsMem;
    }
    return inst;
