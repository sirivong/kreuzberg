...
use kreuzberg::{
    ...
    register_renderer, register_reranker_backend, register_validator, unregister_document_extractor,
    unregister_embedding_backend, unregister_post_processor, unregister_renderer, unregister_reranker_backend,
...
fn test_register_reranker_backend_trait_bridge() {
    ...
    #[allow(unused_imports)]
    use kreuzberg::RerankerBackend;
    struct TestStubRegisterRerankerBackendTraitBridge {
        _name: &'static str,
    }
    impl kreuzberg::plugins::Plugin for TestStubRegisterRerankerBackendTraitBridge {
        fn name(&self) -> &str {
            self._name
        }
    }
    ...
    impl RerankerBackend for TestStubRegisterRerankerBackendTraitBridge {
        async fn rerank(&self, _p0: String, _p1: Vec<String>) -> kreuzberg::Result<Vec<f32>> {
            Ok(Vec::new())
        }
    }
