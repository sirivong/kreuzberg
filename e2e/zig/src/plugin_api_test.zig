...
test "register_document_extractor_trait_bridge" {
    ...
    const vtable_register_document_extractor_trait_bridge = xberg.make_document_extractor_vtable(TestStub_register_document_extractor_trait_bridge, &stub_register_document_extractor_trait_bridge);
    var out_err_register_document_extractor_trait_bridge: ?[*c]u8 = null;
    _ = xberg.register_document_extractor("test", vtable_register_document_extractor_trait_bridge, &stub_register_document_extractor_trait_bridge, @ptrCast(&out_err_register_document_extractor_trait_bridge));
}
...
test "unregister_document_extractor_after_register" {
    ...
    suppress_abort();
    _ = try xberg.unregister_document_extractor("test-extractor");
}
