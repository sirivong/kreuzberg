...
test "extensions_docx" {
    ...
    suppress_abort();
    _ = try xberg.get_extensions_for_mime("application/vnd.openxmlformats-officedocument.wordprocessingml.document");
}

test "extensions_html" {
    // Get file extensions for HTML MIME type
    suppress_abort();
    _ = try xberg.get_extensions_for_mime("text/html");
}

test "extensions_pdf" {
    // Get file extensions for PDF MIME type
    suppress_abort();
    _ = try xberg.get_extensions_for_mime("application/pdf");
}
