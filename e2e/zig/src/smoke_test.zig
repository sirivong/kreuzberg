...
// alef:hash:b14d86ea72232f0b49f7194017284e3776aa499a7787a4ca785c7c50c8c8504d
...
test "smoke_xlsx_basic" {
    ...
    try testing.expect(result.object.get("metadata").?.object.get("format").?.object.get("sheet_count").?.integer >= 2);
    {
