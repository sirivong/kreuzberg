...
// alef:hash:8f30783de9f09791ca74e3e4e07dc4236474c3006c1749f5a990f672afca4190
...
namespace Kreuzberg
{
    ...
    public class EmbeddingsTests
    {
        ...
        public void Test_EmbedTextsDifferentPreset()
        {
            ...
            var result = KreuzbergLib.EmbedTexts(new List<String>() { JsonSerializer.Deserialize<String>("\"Hello world\"", ConfigOptions)!, JsonSerializer.Deserialize<String>("\"Test\"", ConfigOptions)! }, new EmbeddingConfig { Model = "{\"name\":\"multilingual\",\"type\":\"preset\"}" });
