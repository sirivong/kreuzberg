...
// alef:hash:bedb137032e8195091692bbbec90df657e4491f8e11dc606bead6998d2485fde
...
public class SmokeTests
{
    ...
    public async Task Test_SmokeXlsxBasic()
    {
        ...
        Assert.True(result.Metadata.Format!.Excel!.SheetCount >= 2, "expected >= 2");
        Assert.Contains("stanley cups", JsonSerializer.Serialize(result.Metadata.Format!.Excel!.SheetNames).ToLower());
    }
}
