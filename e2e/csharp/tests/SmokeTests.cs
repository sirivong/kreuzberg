...
namespace Kreuzberg
{
    ...
    public class SmokeTests
    {
        ...
        public async Task Test_OcrImagePng()
        {
            ...
            var result = await KreuzbergConverter.ExtractBytesAsync(System.IO.File.ReadAllBytes("images/test_hello_world.png"), "image/png", ExtractionConfig.FromJson("{}"));
    ...
    Assert.True(result.Content.ToString().Contains("Hello") || result.Content.ToString().Contains("World") || result.Content.ToString().Contains("hello") || result.Content.ToString().Contains("world"), "expected to contain at least one of the specified values");
        ...
        public async Task Test_SmokeDocxBasic()
        {
            ...
            var result = await KreuzbergConverter.ExtractFileAsync("docx/fake.docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", new ExtractionConfig());
    ...
    Assert.True(result.Content.ToString().Contains("Lorem") || result.Content.ToString().Contains("ipsum") || result.Content.ToString().Contains("document") || result.Content.ToString().Contains("text"), "expected to contain at least one of the specified values");
        ...
        public async Task Test_SmokeHtmlBasic()
        {
            ...
            var result = await KreuzbergConverter.ExtractFileAsync("html/simple_table.html", "text/html", new ExtractionConfig());
    ...
    Assert.True(result.Content.ToString().Contains("Sample Data Table") || result.Content.ToString().Contains("Laptop") || result.Content.ToString().Contains("Electronics") || result.Content.ToString().Contains("Product"), "expected to contain at least one of the specified values");
        ...
        public async Task Test_SmokeImagePng()
        {
            ...
            var result = await KreuzbergConverter.ExtractFileAsync("images/sample.png", null, new ExtractionConfig { DisableOcr = true });
    Assert.Equal("image/png", result.MimeType!.Trim());
        ...
        public async Task Test_SmokeJsonBasic()
        {
            ...
            var result = await KreuzbergConverter.ExtractFileAsync("json/simple.json", "application/json", new ExtractionConfig());
    ...
    Assert.True(result.Content.Length >= 5, "expected length >= 5");
        ...
        public async Task Test_SmokePdfBasic()
        {
            ...
            var result = await KreuzbergConverter.ExtractFileAsync("pdf/fake_memo.pdf", "application/pdf", new ExtractionConfig());
    ...
    Assert.True(result.Content.ToString().Contains("May 5, 2023") || result.Content.ToString().Contains("To Whom it May Concern"), "expected to contain at least one of the specified values");
        ...
        public async Task Test_SmokeTxtBasic()
        {
            ...
            var result = await KreuzbergConverter.ExtractFileAsync("text/report.txt", "text/plain", new ExtractionConfig());
    ...
    Assert.True(result.Content.Length >= 5, "expected length >= 5");
        ...
        public async Task Test_SmokeXlsxBasic()
        {
            ...
            var result = await KreuzbergConverter.ExtractFileAsync("xlsx/stanley_cups.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", new ExtractionConfig());
    ...
    Assert.True(result.Tables.Count >= 1, "expected at least 1 elements");
            if (result.Metadata.Format is FormatMetadata.Excel variant_46da1050)
            {
                Assert.True(variant_46da1050.Value.SheetCount >= 2, "expected >= 2");
            }
            else
            {
                Assert.Fail("Expected excel format metadata");
            }
            if (result.Metadata.Format is FormatMetadata.Excel variant_112e47aa)
            {
                Assert.Contains("stanley cups", JsonSerializer.Serialize(variant_112e47aa.Value.SheetNames).ToLower());
            }
            else
            {
                Assert.Fail("Expected excel format metadata");
