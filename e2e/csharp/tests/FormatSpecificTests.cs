...
namespace Kreuzberg
{
    ...
    Assert.True(result.Content.ToString().Contains("Mallori") || result.Content.ToString().Contains("May"), "expected to contain at least one of the specified values");
        ...
        public void Test_FormatPptx()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("pptx/simple.pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation", ExtractionConfig.FromJson("{}"));
        ...
        public void Test_FormatXlsx()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("xlsx/stanley_cups.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", ExtractionConfig.FromJson("{}"));
