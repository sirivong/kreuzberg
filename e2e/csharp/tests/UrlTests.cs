...
namespace Xberg
{
    ...
    public class UrlTests
    {
        ...
        public void Test_UrlBatchMixedInputs()
        {
            ...
            XbergConverter.RegisterValidator(new List<ExtractInput>() { JsonSerializer.Deserialize<ExtractInput>("{\"kind\":\"uri\",\"uri\":\"$mock_url\"}", ConfigOptions)!, JsonSerializer.Deserialize<ExtractInput>("{\"bytes\":[66,97,116,99,104,32,98,121,116,101,115,32,99,111,110,116,101,110,116],\"filename\":\"inline.txt\",\"kind\":\"bytes\",\"mime_type\":\"text/plain\"}", ConfigOptions)! }, new ExtractionConfig { Url = JsonSerializer.Deserialize<UrlExtractionConfig>("{\"mode\":\"document\"}", ConfigOptions)! });
        }
