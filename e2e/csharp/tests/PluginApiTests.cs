...
// alef:hash:36fc33992c6a3fb29facd012a1994ed840ccb7130939736dae54d2a4c78e6b9e
...
namespace Kreuzberg
{
    ...
    public class PluginApiTests
    {
        ...
        private class TestStub_RegisterDocumentExtractorTraitBridge : IDocumentExtractor
        {
            ...
            public async System.Threading.Tasks.Task<InternalDocument> ExtractFile(string path, string mimeType, ExtractionConfig config)
            {
                await System.Threading.Tasks.Task.CompletedTask;
                return new InternalDocument();
            }
        ...
        private class TestStub_RegisterOcrBackendTraitBridge : IOcrBackend
        {
            ...
            public async System.Threading.Tasks.Task<ExtractionResult> ProcessImageFile(string path, OcrConfig config)
            {
                await System.Threading.Tasks.Task.CompletedTask;
                return new ExtractionResult();
            }
            ...
            public bool SupportsDocumentProcessing()
                => false;
            public async System.Threading.Tasks.Task<ExtractionResult> ProcessDocument(string path, OcrConfig config)
            {
                await System.Threading.Tasks.Task.CompletedTask;
                return new ExtractionResult();
            }
