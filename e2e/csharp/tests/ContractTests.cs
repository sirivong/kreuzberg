...
namespace Kreuzberg
{
    ...
    public class ContractTests
    {
        ...
        public async Task Test_ApiBatchBytesAsync()
        {
            ...
            var result = await KreuzbergLib.ExtractFileAsync("pdf/fake_memo.pdf", "", null);
    ...
    Assert.True(result.Content.ToString().Contains("May 5, 2023") || result.Content.ToString().Contains("Mallori"), "expected to contain at least one of the specified values");
        ...
        public async Task Test_ApiBatchBytesWithConfigsAsync()
        {
            ...
            var result = await KreuzbergLib.ExtractFileAsync("pdf/fake_memo.pdf", "", new ExtractionConfig { OutputFormat = OutputFormat.Markdown });
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
    ...
    Assert.True(result.Content.ToString().Contains("May 5, 2023") || result.Content.ToString().Contains("Mallori"), "expected to contain at least one of the specified values");
        ...
        public void Test_ConfigDocumentStructureWithHeadings()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("docx/fake.docx", "", ExtractionConfig.FromJson("{\"include_document_structure\":true}"));
    Assert.Equal("application/vnd.openxmlformats-officedocument.wordprocessingml.document", result.MimeType!.Trim());
        ...
        public void Test_ConfigElementTypes()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("docx/unit_test_headers.docx", "", ExtractionConfig.FromJson("{\"result_format\":\"element_based\"}"));
    Assert.True(result.MimeType.ToString().Contains("application/vnd.openxmlformats-officedocument.wordprocessingml.document"), "expected to contain at least one of the specified values");
        ...
        public void Test_ConfigExtractionTimeout()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("pdf/fake_memo.pdf", "", ExtractionConfig.FromJson("{\"extraction_timeout_secs\":300}"));
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
        ...
        public void Test_ConfigKeywords()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("pdf/fake_memo.pdf", "", ExtractionConfig.FromJson("{\"keywords\":{\"algorithm\":\"yake\",\"max_keywords\":10}}"));
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
        ...
        public void Test_ConfigPages()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("pdf/fake_memo.pdf", "", ExtractionConfig.FromJson("{\"pages\":{\"extract_pages\":true,\"insert_page_markers\":true}}"));
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
    Assert.True(result.Content.ToString().Contains("PAGE"), "expected to contain at least one of the specified values");
        ...
        public void Test_ConfigQualityEnabled()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("pdf/fake_memo.pdf", "", ExtractionConfig.FromJson("{\"enable_quality_processing\":true}"));
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
        ...
        public void Test_ConfigSecurityLimits()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("archives/documents.zip", "", ExtractionConfig.FromJson("{\"security_limits\":{\"max_archive_size\":104857600,\"max_compression_ratio\":50,\"max_files_in_archive\":100}}"));
    ...
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
        ...
        public void Test_ConfigTreeSitter()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("code/hello.py", "", ExtractionConfig.FromJson("{\"tree_sitter\":{\"groups\":[\"web\"],\"languages\":[\"python\",\"rust\"],\"process\":{\"comments\":false,\"diagnostics\":false,\"docstrings\":false,\"exports\":true,\"imports\":true,\"structure\":true,\"symbols\":false}}}"));
    ...
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
        ...
        public void Test_OutputFormatMarkdown()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("pdf/fake_memo.pdf", "", ExtractionConfig.FromJson("{\"output_format\":\"markdown\"}"));
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
            // skipped: field 'metadata.output_format' not available on result type
        }
