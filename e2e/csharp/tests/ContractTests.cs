...
// alef:hash:fe8895d07b2a1901b6b67ab0a47cf6c33a7a9a047ea61d272cbb3b462b43f77e
...
namespace Kreuzberg
{
    ...
    Assert.True(result.Content.ToString().Contains("May 5, 2023") || result.Content.ToString().Contains("Mallori"), "expected to contain at least one of the specified values");
        ...
        public void Test_ConfigChunkingPrependHeadingContext()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("markdown/extraction_test.md", null, new ExtractionConfig { Chunking = "{\"chunker_type\":\"markdown\",\"max_chars\":300,\"max_overlap\":50,\"prepend_heading_context\":true}" });
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
    ...
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
        ...
        public void Test_ConfigPages()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("pdf/fake_memo.pdf", null, new ExtractionConfig { Pages = "{\"extract_pages\":true,\"insert_page_markers\":true}" });
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
    ...
    Assert.True(result.QualityScore <= 1.0d, "expected <= 1.0d");
        ...
        public void Test_ConfigSecurityLimits()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("archives/documents.zip", null, new ExtractionConfig { SecurityLimits = "{\"max_archive_size\":104857600,\"max_compression_ratio\":50,\"max_files_in_archive\":100}" });
    ...
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
        ...
        public void Test_ConfigTreeSitter()
        {
            ...
            var result = KreuzbergLib.ExtractFileSync("code/hello.py", null, new ExtractionConfig { TreeSitter = "{\"groups\":[\"web\"],\"languages\":[\"python\",\"rust\"],\"process\":{\"comments\":false,\"diagnostics\":false,\"docstrings\":false,\"exports\":true,\"imports\":true,\"structure\":true,\"symbols\":false}}" });
