...
void main() {
  ...
  test('Detect HTML MIME from bytes', () async {
    final result = await XbergBridge.detectMimeTypeFromBytes(File('html/html.html').readAsBytesSync());
  });
  ...
  test('get_extensions unknown MIME', () async {
    await expectLater(XbergBridge.getExtensionsForMime('application/x-totally-unknown'), throwsA(anything));
  });
