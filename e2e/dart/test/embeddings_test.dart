...
void main() {
  ...
  test('embed_texts: multilingual preset', () async {
    ...
    final result = await XbergBridge.embedTextsAsync(<String>['Hello world', 'Test'], _config);
    expect(result.length, greaterThanOrEqualTo(2));
  });

  test('get_embedding_preset: known preset', () async {
    final result = await XbergBridge.getEmbeddingPreset('balanced');
  });
  ...
  test('get_embedding_preset: unknown preset fails', () async {
    final result = await XbergBridge.getEmbeddingPreset('nonexistent-xyz');
    expect(result, anyOf(isNull, isEmpty));
  });

  test('list_embedding_presets: returns at least one', () async {
    final result = await XbergBridge.listEmbeddingPresets();
