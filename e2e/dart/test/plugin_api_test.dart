...
void main() {
  ...
  test('register_document_extractor: trait bridge', () async {
    final result = await XbergBridge.registerDocumentExtractor(await _createTestStubRegisterDocumentExtractorTraitBridgeWrapper());
  });
  ...
  test('unregister_document_extractor', () async {
    final result = await XbergBridge.unregisterDocumentExtractor('test-extractor');
  });
