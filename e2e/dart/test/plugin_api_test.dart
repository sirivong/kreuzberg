...
void main() {
  ...
  test('register_reranker_backend: trait bridge', () async {
    final result = await KreuzbergBridge.registerRerankerBackend(await _createTestStubRegisterRerankerBackendTraitBridgeWrapper());
  });
  ...
  test('unregister_reranker_backend', () async {
    final result = await KreuzbergBridge.unregisterRerankerBackend('test-reranker-backend');
  });
