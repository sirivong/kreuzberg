...
void main() {
  ...
  test('Smoke test: XLSX with basic spreadsheet data including tables', () async {
    ...
    // skipped: field 'results.0.content' not available on dart result type
    // skipped: field 'results.0.content' not available on dart result type
    // skipped: field 'results.0.tables' not available on dart result type
    // skipped: field 'results.0.metadata.format.excel.sheet_count' not available on dart result type
    // skipped: field 'results.0.metadata.format.excel.sheet_names' not available on dart result type
  });
