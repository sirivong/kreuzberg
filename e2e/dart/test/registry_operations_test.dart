...
void main() {
  ...
  test('Get file extensions for DOCX MIME type', () async {
    final result = await XbergBridge.getExtensionsForMime('application/vnd.openxmlformats-officedocument.wordprocessingml.document');
  });

  test('Get file extensions for HTML MIME type', () async {
    final result = await XbergBridge.getExtensionsForMime('text/html');
  });
