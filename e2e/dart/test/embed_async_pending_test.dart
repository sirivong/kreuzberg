...
void main() {
  ...
  test('embed_texts_async: empty text list', () async {
    ...
    final result = await KreuzbergBridge.embedTextsAsync(<String>[], config: _config);
    expect(result.length, equals(0));
  });

  test('embed_texts_async: basic async embedding', () async {
    final _config = await createEmbeddingConfigFromJson(json: '{}');
    final result = await KreuzbergBridge.embedTextsAsync(<String>['First', 'Second'], config: _config);
  ...
  test('embed_texts_async: preset override', () async {
    ...
    final result = await KreuzbergBridge.embedTextsAsync(<String>['Text'], config: _config);
  });
