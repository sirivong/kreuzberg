...
# alef:hash:a5c1ecc4fb7c385393f1b18dc4915958c7acb2e384da250825db1ad9e524b07a
...
def test_format_docx_standalone() -> None:
    ...
    data = Path("docx/fake.docx").read_bytes()
    mime_type = (
...
def test_format_pptx() -> None:
    ...
    _ = extract_file_sync(path=path, mime_type=mime_type)
