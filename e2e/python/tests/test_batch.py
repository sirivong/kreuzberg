...
# alef:hash:d72ce0e5629bec471b03bf09f8300af4c253357692735a7fde8748bf97bf6310
...
@pytest.mark.skip(
    reason="SecurityLimits.max_content_size is only enforced by archive/Excel extractors; text/plain does not check it — error path not triggerable via fixture content alone"
)
@pytest.mark.asyncio
