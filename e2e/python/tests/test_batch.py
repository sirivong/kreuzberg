...
def test_batch_bytes_invalid_mime() -> None:
    ...
    items = [BatchBytesItem(content=[72, 101, 108, 108, 111], mime_type="application/x-nonexistent")]
...
async def test_batch_extract_bytes_happy() -> None:
    ...
    items = [BatchBytesItem(content=[72, 101, 108, 108, 111, 44, 32, 119, 111, 114, 108, 100, 33], mime_type="text/plain"), BatchBytesItem(content=[60, 104, 116, 109, 108, 62, 60, 98, 111, 100, 121, 62, 84, 101, 115, 116, 60, 47, 98, 111, 100, 121, 62, 60, 47, 104, 116, 109, 108, 62], mime_type="text/html")]
...
async def test_batch_extract_bytes_mixed_format() -> None:
    ...
    items = [BatchBytesItem(content=[80, 68, 70, 32, 112, 108, 97, 99, 101, 104, 111, 108, 100, 101, 114], mime_type="application/x-unknown")]
...
def test_batch_extract_bytes_sync_invalid_mime() -> None:
    ...
    items = [BatchBytesItem(content=[100, 97, 116, 97], mime_type="application/x-unknown")]
