...
async def test_smoke_xlsx_basic() -> None:
    ...
    assert result.metadata.format.excel.sheet_count >= 2  # noqa: S101
    assert any("Stanley Cups" in text for item in result.metadata.format.excel.sheet_names for text in _alef_e2e_item_texts(item))  # noqa: S101
