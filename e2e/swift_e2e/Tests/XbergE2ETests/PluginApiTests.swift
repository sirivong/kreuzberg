...
final class PluginApiTests: XCTestCase {
    ...
    func countTokens(text: String) -> UInt { 3 }
        ...
        let result = try Xberg.registerTokenizerBackend(TestStubRegisterTokenizerBackendTraitBridge())
    ...
    func testUnregisterTokenizerBackendAfterRegister() throws {
        ...
        let result = try Xberg.unregisterTokenizerBackend(name: "test-tokenizer-backend")
    }
