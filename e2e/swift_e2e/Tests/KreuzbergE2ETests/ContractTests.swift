...
// alef:hash:fb44dff528674fd83004504a56d41044c6be804f2a40c1491988fc6ef9156b4d
...
final class ContractTests: XCTestCase {
    ...
    func testApiBatchBytesAsync() async throws {
        ...
        let result = try await Kreuzberg.extractFile(path: "pdf/fake_memo.pdf", mime_type: nil, config: configObj)
    ...
    func testConfigChunkingPrependHeadingContext() throws {
        ...
        let result = try Kreuzberg.extractFileSync(path: "markdown/extraction_test.md", mime_type: nil, config: configObj)
        XCTAssertGreaterThanOrEqual(result.content.count, 10)
    ...
    func testConfigDocumentStructureWithHeadings() throws {
        ...
        let result = try Kreuzberg.extractFileSync(path: "docx/fake.docx", mime_type: nil, config: configObj)
    ...
    func testConfigElementTypes() throws {
        ...
        let result = try Kreuzberg.extractFileSync(path: "docx/unit_test_headers.docx", mime_type: nil, config: configObj)
    ...
    func testConfigExtractionTimeout() throws {
        ...
        let result = try Kreuzberg.extractFileSync(path: "pdf/fake_memo.pdf", mime_type: nil, config: configObj)
        XCTAssertEqual(result.mimeType.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines), "application/pdf")
        XCTAssertGreaterThanOrEqual(result.content.count, 10)
    }
    ...
    func testConfigSecurityLimits() throws {
        ...
        let result = try Kreuzberg.extractFileSync(path: "archives/documents.zip", mime_type: nil, config: configObj)
    ...
    func testConfigTreeSitter() throws {
        ...
        let result = try Kreuzberg.extractFileSync(path: "code/hello.py", mime_type: nil, config: configObj)
