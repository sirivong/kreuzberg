...
// alef:hash:eeb2c44d721aff921c2bd477101ec45d3f7ff6caeb8e6389d035e653d5725df6
...
final class SmokeTests: XCTestCase {
    ...
    func testOcrImagePng() async throws {
        ...
        let result = try await Kreuzberg.extractBytes(content: contentVec, mime_type: "image/png", config: configObj)
    ...
    func testSmokeDocxBasic() async throws {
        ...
        let configObj = try extractionConfigFromJson("{}")
        let result = try await Kreuzberg.extractFile(path: "docx/fake.docx", mime_type: "application/vnd.openxmlformats-officedocument.wordprocessingml.document", config: configObj)
    ...
    func testSmokeHtmlBasic() async throws {
        ...
        let configObj = try extractionConfigFromJson("{}")
        let result = try await Kreuzberg.extractFile(path: "html/simple_table.html", mime_type: "text/html", config: configObj)
    ...
    func testSmokeImagePng() async throws {
        ...
        let result = try await Kreuzberg.extractFile(path: "images/sample.png", mime_type: nil, config: configObj)
        XCTAssertEqual(result.mimeType.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines), "image/png")
    ...
    func testSmokeJsonBasic() async throws {
        ...
        let configObj = try extractionConfigFromJson("{}")
        let result = try await Kreuzberg.extractFile(path: "json/simple.json", mime_type: "application/json", config: configObj)
    ...
    func testSmokePdfBasic() async throws {
        ...
        let configObj = try extractionConfigFromJson("{}")
        let result = try await Kreuzberg.extractFile(path: "pdf/fake_memo.pdf", mime_type: "application/pdf", config: configObj)
    ...
    func testSmokeTxtBasic() async throws {
        ...
        let configObj = try extractionConfigFromJson("{}")
        let result = try await Kreuzberg.extractFile(path: "text/report.txt", mime_type: "text/plain", config: configObj)
    ...
    func testSmokeXlsxBasic() async throws {
        ...
        let configObj = try extractionConfigFromJson("{}")
        let result = try await Kreuzberg.extractFile(path: "xlsx/stanley_cups.xlsx", mime_type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", config: configObj)
