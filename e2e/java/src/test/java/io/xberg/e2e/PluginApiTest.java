...
public class PluginApiTest {
    ...
    void testRegisterDocumentExtractorTraitBridge() throws Exception {
        ...
        class TestStubRegisterDocumentExtractorTraitBridge implements io.xberg.IDocumentExtractor {
    @Override
    public String extract_bytes(byte[] content, String mimeType, io.xberg.ExtractionConfig config) {
        return "null";
    }
    @Override
    public String extract_file(java.nio.file.Path path, String mimeType, io.xberg.ExtractionConfig config) {
        return "null";
    }
    @Override
