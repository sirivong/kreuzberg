...
// alef:hash:3138268be4754056d50c893ec107c58c47cdb9db0631a932836f12412ce1ff7d
...
class BatchTest {
    ...
    void testBatchExtractBytesSizeCap() throws Exception {
        ...
        var config = ExtractionConfig.builder().withSecurityLimits(Optional.of(SecurityLimits.builder().withMaxContentSize(1L).build())).build();
