...
// alef:hash:b8b50d5069b96b030bc0d4054b4f6cbc16e877af0cdfab9a57016dec38c465a0
...
class BatchTest {
    ...
    void testBatchExtractBytesSizeCap() throws Exception {
        ...
        var config = ExtractionConfig.builder().withSecurityLimits(SecurityLimits.builder().withMaxContentSize(Optional.of(1L)).build()).build();
