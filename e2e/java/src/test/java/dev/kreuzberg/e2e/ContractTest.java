...
// alef:hash:81ef825402ca2a3b40d03b6125b48506a60b63f62aaaf455c340d4c25e86961b
...
assertTrue(result.content().length() >= 10, "expected length >= 10");assertTrue(java.util.Optional.ofNullable(result.chunks()).orElse(java.util.List.of()).size() >= 2, "expected at least 2 elements");        assertTrue(java.util.Optional.ofNullable(result.chunks()).orElse(java.util.List.of()).stream().allMatch(c -> c.content() != null && !c.content().isBlank()), "expected true");        assertTrue(java.util.Optional.ofNullable(result.chunks()).orElse(java.util.List.of()).stream().allMatch(c -> c.metadata().headingContext() != null), "expected true");        assertTrue(java.util.Optional.ofNullable(result.chunks()).orElse(java.util.List.of()).stream().findFirst().map(c -> c.metadata().headingContext() != null).orElse(false), "expected true");
    }
