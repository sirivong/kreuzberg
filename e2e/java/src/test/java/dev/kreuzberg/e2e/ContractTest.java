...
// alef:hash:3837cb561a39ce79d23110d223794da9256cedf0451b68cdd5a3ce873abb3bc9
...
class ContractTest {
    ...
    void testConfigDocumentStructureWithHeadings() throws Exception {
        ...
        assertFalse(java.util.Optional.ofNullable(result.document()) == null || java.util.Optional.ofNullable(result.document()).isEmpty(), "expected non-empty value");
    ...
    void testOutputFormatBytesMarkdown() throws Exception {
        ...
        assertEquals("application/pdf", result.mimeType().trim());
        assertTrue(result.content().length() >= 10, "expected length >= 10");
        assertEquals("markdown", java.util.Optional.ofNullable(result.metadata().outputFormat()).orElse("").trim());
    }
