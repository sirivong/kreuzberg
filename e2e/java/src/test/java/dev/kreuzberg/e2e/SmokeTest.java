...
// alef:hash:8a7a56eb7a40edc045eb603cc7fcef7a4c672c517d1dee89dfe8590346f45b8d
...
class SmokeTest {
    ...
    void testSmokeXlsxBasic() throws Exception {
        ...
        assertTrue(java.util.Optional.ofNullable(result.metadata().sheetNames()).orElse(java.util.List.of()).toString().contains("Stanley Cups"), "expected to contain: " + "Stanley Cups");
    }
