...
// alef:hash:ecf8d78db1a627474d116e0d33351d7b338e76f4ba93037d360b470fe04feba4
...
class SmokeTest {
    ...
    void testSmokeXlsxBasic() throws Exception {
        ...
        assertTrue(java.util.Optional.ofNullable(result.metadata().format().excel().sheetCount()).orElse(0L) >= 2, "expected >= 2");
        assertTrue(result.metadata().format().excel().sheetNames().toString().contains("Stanley Cups"), "expected to contain: " + "Stanley Cups");
    }
