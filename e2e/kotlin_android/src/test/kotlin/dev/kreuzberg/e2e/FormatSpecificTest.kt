...
// alef:hash:5d64c1736a4e966eb2459c357694ac0f0cfcc7346228dddd6622d733da30617c
...
class FormatSpecificTest {
    ...
    fun testFormatDocxStandalone() = runBlocking {
        ...
        val result = Kreuzberg.extractBytesSync(java.nio.file.Files.readAllBytes(java.nio.file.Path.of("docx/fake.docx")), "application/vnd.openxmlformats-officedocument.wordprocessingml.document", null)
    ...
    fun testFormatHwpxStandalone() = runBlocking {
        ...
        val result = Kreuzberg.extractBytesSync(java.nio.file.Files.readAllBytes(java.nio.file.Path.of("hwpx/simple.hwpx")), "application/haansofthwpx", null)
        assertTrue(result.content.length >= 20, "expected length >= 20")
    ...
    fun testFormatPdfText() = runBlocking {
        ...
        val result = Kreuzberg.extractBytesSync(java.nio.file.Files.readAllBytes(java.nio.file.Path.of("pdf/fake_memo.pdf")), "application/pdf", null)
    ...
    fun testFormatPptx() = runBlocking {
        ...
        val result = Kreuzberg.extractFileSync(java.nio.file.Path.of("pptx/simple.pptx"), "application/vnd.openxmlformats-officedocument.presentationml.presentation", null)
    }

    @Test
    fun testFormatXlsx() = runBlocking {
        // XLSX spreadsheet extraction using extract_file_sync
        val result = Kreuzberg.extractFileSync(java.nio.file.Path.of("xlsx/stanley_cups.xlsx"), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", null)
    }
