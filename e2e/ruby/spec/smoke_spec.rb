...
# alef:hash:330fc093b6d9c5f8ca4690638b105d524cbb60481b4b75c11020cc21fd3ddb4f
...
RSpec.describe 'smoke' do
  ...
  it 'ocr_image_png: OCR: PNG image extraction with OCR enabled. In WASM this exercises the Uint8Array bridge parameter and Promise await in the generated OcrBackend bridge.' do
    data = File.read("images/test_hello_world.png").bytes
    result = Kreuzberg.extract_bytes(data, 'image/png', Kreuzberg::ExtractionConfig.new())
