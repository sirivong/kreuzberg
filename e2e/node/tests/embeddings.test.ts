...
import { describe, expect, it } from 'vitest';import { extractFile, embedTexts, getEmbeddingPreset, listEmbeddingPresets, type JsExtractionConfig } from 'kreuzberg';
...
describe('embeddings', () => {  it('embed_texts_different_preset: embed_texts: multilingual preset', () => {    const result = embedTexts(["Hello world", "Test"], { model: { name: "multilingual", type: "preset" } } as JsExtractionConfig);    expect(result.length).toBeGreaterThanOrEqual(2);
