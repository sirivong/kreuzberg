...
describe("format_specific", () => {
  ...
  it("format_pptx: PPTX presentation extraction using extract", async () => {
    const inputMockBaseUrl =
      process.env.MOCK_SERVER_FORMAT_PPTX ?? `${process.env.MOCK_SERVER_URL}/fixtures/format_pptx`;
    const inputJson = JSON.stringify({
      kind: "uri",
  ...
  it("format_xlsx: XLSX spreadsheet extraction using extract", async () => {
    const inputMockBaseUrl =
      process.env.MOCK_SERVER_FORMAT_XLSX ?? `${process.env.MOCK_SERVER_URL}/fixtures/format_xlsx`;
    const inputJson = JSON.stringify({
      kind: "uri",
