...
describe("plugin_api", () => {
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await registerDocumentExtractor(_bridge_extractor);
		await unregisterDocumentExtractor(_bridge_extractor.name());	}, 30000);
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await registerEmbeddingBackend(_bridge_backend);
		await unregisterEmbeddingBackend(_bridge_backend.name());	}, 30000);
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await registerOcrBackend(_bridge_backend);
		await unregisterOcrBackend(_bridge_backend.name());	}, 30000);
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await registerPostProcessor(_bridge_processor);
		await unregisterPostProcessor(_bridge_processor.name());	}, 30000);
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await registerRenderer(_bridge_renderer);
		await unregisterRenderer(_bridge_renderer.name());	}, 30000);
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await registerRerankerBackend(_bridge_backend);
		await unregisterRerankerBackend(_bridge_backend.name());	}, 30000);
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await registerValidator(_bridge_validator);
		await unregisterValidator(_bridge_validator.name());	}, 30000);
