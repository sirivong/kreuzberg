...
describe("plugin_api", () => {
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await unregisterDocumentExtractor(_bridge_extractor.name());
  ...
  async dispose(): Promise<void> { return undefined; }
		...
		await unregisterRenderer(_bridge_renderer.name());
