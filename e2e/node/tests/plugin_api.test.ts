...
import { extractFile, registerDocumentExtractor, registerEmbeddingBackend, registerOcrBackend, registerPostProcessor, registerRenderer, registerValidator, unregisterDocumentExtractor, unregisterEmbeddingBackend, unregisterPostProcessor, unregisterRenderer, unregisterValidator } from "@kreuzberg/node";
...
describe("plugin_api", () => {
  ...
  canHandle(_p0?: any, _p1?: any): boolean { return false; }
		...
		await _bridge_extractor.dispose();	}, 30000);
  ...
  async embed(_p0?: any): Promise<string> { return []; }
		...
		await _bridge_backend.dispose();	}, 30000);
  ...
  priority(): number { return 1; }
		...
		await _bridge_processor.dispose();	}, 30000);
  ...
  render(_p0?: any): string { return ""; }
		...
		await _bridge_renderer.dispose();	}, 30000);
  ...
  priority(): number { return 1; }
		...
		await _bridge_validator.dispose();	}, 30000);
