...
import { describe, expect, it } from 'vitest';import { extractFile, embedTexts, type JsExtractionConfig } from 'kreuzberg';
...
describe('embed_extra', () => {  it('embed_texts_batch: Batch embed texts', () => {    embedTexts(["Hello", "World"], { model: { name: "balanced", type: "preset" } } as JsExtractionConfig);
  }, 600000);
});
