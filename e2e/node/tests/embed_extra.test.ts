...
import { extractFile, embedTexts, type EmbeddingConfig, type ExtractionConfig } from "@kreuzberg/node";
...
describe("embed_extra", () => {
	...
	it("embed_texts_batch: Batch embed texts", () => {
		embedTexts(["Hello", "World"], { model: { name: "balanced", type: "preset" } } as ExtractionConfig);
