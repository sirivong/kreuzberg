...
import { extractFile, embedTextsAsync, type EmbeddingConfig, type ExtractionConfig } from "@kreuzberg/node";
...
describe("embed_extra", () => {
	...
	it("embed_texts_batch: Batch embed texts", async () => {
		await embedTextsAsync(["Hello", "World"], { model: { name: "balanced", type: "preset" } } as ExtractionConfig);
	}, 30000);
});
