...
# alef:hash:fd5b5bec52aaa71a436824b65c9f1f09b5e909af7555f60eb1f2d57d05e7c2cd
...
defmodule E2e.SmokeTest do
  ...
  describe "smoke_docx_basic" do
    test "smoke_docx_basic" do
      ...
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/docx/fake.docx", options, mime_type: "application/vnd.openxmlformats-officedocument.wordprocessingml.document")
  ...
  describe "smoke_html_basic" do
    test "smoke_html_basic" do
      options = %Kreuzberg.ExtractionConfig{}
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/html/simple_table.html", options, mime_type: "text/html")
  ...
  describe "smoke_image_png" do
    test "smoke_image_png" do
      ...
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/images/sample.png", options)
      assert String.trim(result.mime_type) == "image/png"
  ...
  describe "smoke_json_basic" do
    test "smoke_json_basic" do
      options = %Kreuzberg.ExtractionConfig{}
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/json/simple.json", options, mime_type: "application/json")
  ...
  describe "smoke_pdf_basic" do
    test "smoke_pdf_basic" do
      options = %Kreuzberg.ExtractionConfig{}
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/pdf/fake_memo.pdf", options, mime_type: "application/pdf")
  ...
  describe "smoke_txt_basic" do
    test "smoke_txt_basic" do
      options = %Kreuzberg.ExtractionConfig{}
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/text/report.txt", options, mime_type: "text/plain")
  ...
  describe "smoke_xlsx_basic" do
    test "smoke_xlsx_basic" do
      options = %Kreuzberg.ExtractionConfig{}
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/xlsx/stanley_cups.xlsx", options, mime_type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
