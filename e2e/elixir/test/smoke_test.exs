...
# alef:hash:4a586bfe6ad2547abbaf0baa63290e474df5cd7766f5009e66e2180a7c914314
...
defmodule E2e.SmokeTest do
  ...
  describe "smoke_docx_basic" do
    test "smoke_docx_basic" do
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/docx/fake.docx", mime_type: "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "{}")
  ...
  describe "smoke_html_basic" do
    test "smoke_html_basic" do
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/html/simple_table.html", mime_type: "text/html", "{}")
  ...
  describe "smoke_image_png" do
    test "smoke_image_png" do
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/images/sample.png", "{\"disable_ocr\":true}")
      assert String.trim(result.mime_type) == "image/png"
      assert String.trim(alef_e2e_format_to_string(result.metadata.format)) == "PNG"
    end
  end

  describe "smoke_json_basic" do
    test "smoke_json_basic" do
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/json/simple.json", mime_type: "application/json", "{}")
  ...
  describe "smoke_pdf_basic" do
    test "smoke_pdf_basic" do
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/pdf/fake_memo.pdf", mime_type: "application/pdf", "{}")
  ...
  describe "smoke_txt_basic" do
    test "smoke_txt_basic" do
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/text/report.txt", mime_type: "text/plain", "{}")
  ...
  describe "smoke_xlsx_basic" do
    test "smoke_xlsx_basic" do
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/xlsx/stanley_cups.xlsx", mime_type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "{}")
