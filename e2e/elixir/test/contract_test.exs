...
# alef:hash:fafcb9a6f6d0dd4d665374c1ac3af301366a073c53015a59c68ed42a708b297e
...
defmodule E2e.ContractTest do
  ...
  describe "api_batch_bytes_with_configs_async" do
    test "api_batch_bytes_with_configs_async" do
      {:ok, result} = Kreuzberg.extract_file_async("../../test_documents/pdf/fake_memo.pdf", "{\"output_format\":\"markdown\"}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10) || (is_binary(result.content) == false && is_list(result.content) == false && String.length(result.content) >= 10)
  ...
  describe "config_chunking_prepend_heading_context" do
    test "config_chunking_prepend_heading_context" do
      {:ok, result} = Kreuzberg.extract_file_sync("../../test_documents/markdown/extraction_test.md", "{\"chunking\":{\"chunker_type\":\"markdown\",\"max_chars\":300,\"max_overlap\":50,\"prepend_heading_context\":true}}")
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10) || (is_binary(result.content) == false && is_list(result.content) == false && String.length(result.content) >= 10)
  ...
  describe "config_document_structure_with_headings" do
    test "config_document_structure_with_headings" do
      {:ok, result} = Kreuzberg.extract_file_sync("../../test_documents/docx/fake.docx", "{\"include_document_structure\":true}")
  ...
  describe "config_element_types" do
    test "config_element_types" do
      {:ok, result} = Kreuzberg.extract_file_sync("../../test_documents/docx/unit_test_headers.docx", "{\"result_format\":\"element_based\"}")
  ...
  describe "config_extraction_timeout" do
    test "config_extraction_timeout" do
      {:ok, result} = Kreuzberg.extract_file_sync("../../test_documents/pdf/fake_memo.pdf", "{\"extraction_timeout_secs\":300}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10) || (is_binary(result.content) == false && is_list(result.content) == false && String.length(result.content) >= 10)
    end
  end
  ...
  describe "config_keywords" do
    test "config_keywords" do
      {:ok, result} = Kreuzberg.extract_file_sync("../../test_documents/pdf/fake_memo.pdf", "{\"keywords\":{\"algorithm\":\"yake\",\"max_keywords\":10}}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10) || (is_binary(result.content) == false && is_list(result.content) == false && String.length(result.content) >= 10)
  ...
  describe "config_pages" do
    test "config_pages" do
      {:ok, result} = Kreuzberg.extract_file_sync("../../test_documents/pdf/fake_memo.pdf", "{\"pages\":{\"extract_pages\":true,\"insert_page_markers\":true}}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10) || (is_binary(result.content) == false && is_list(result.content) == false && String.length(result.content) >= 10)
  ...
  describe "config_quality_enabled" do
    test "config_quality_enabled" do
      {:ok, result} = Kreuzberg.extract_file_sync("../../test_documents/pdf/fake_memo.pdf", "{\"enable_quality_processing\":true}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10) || (is_binary(result.content) == false && is_list(result.content) == false && String.length(result.content) >= 10)
  ...
  describe "config_security_limits" do
    test "config_security_limits" do
      {:ok, result} = Kreuzberg.extract_file_sync("../../test_documents/archives/documents.zip", "{\"security_limits\":{\"max_archive_size\":104857600,\"max_compression_ratio\":50,\"max_files_in_archive\":100}}")
  ...
  describe "config_tree_sitter" do
    test "config_tree_sitter" do
      {:ok, result} = Kreuzberg.extract_file_sync("../../test_documents/code/hello.py", "{\"tree_sitter\":{\"groups\":[\"web\"],\"languages\":[\"python\",\"rust\"],\"process\":{\"comments\":false,\"diagnostics\":false,\"docstrings\":false,\"exports\":true,\"imports\":true,\"structure\":true,\"symbols\":false}}}")
  ...
  describe "output_format_markdown" do
    test "output_format_markdown" do
      {:ok, result} = Kreuzberg.extract_file_sync("../../test_documents/pdf/fake_memo.pdf", "{\"output_format\":\"markdown\"}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10) || (is_binary(result.content) == false && is_list(result.content) == false && String.length(result.content) >= 10)
      assert String.trim(result.metadata.output_format) == "markdown"
    end
